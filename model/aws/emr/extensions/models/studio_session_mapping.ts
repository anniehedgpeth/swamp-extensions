...
/**
 * Swamp extension model for EMR StudioSessionMapping (AWS::EMR::StudioSessionMapping).
 *
...
/** Swamp extension model for EMR StudioSessionMapping. Registered at `@swamp/aws/emr/studio-session-mapping`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EMR StudioSessionMapping resources",
      arguments: z.object({
