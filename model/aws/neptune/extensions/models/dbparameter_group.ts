...
// Auto-generated extension model for @swamp/aws/neptune/dbparameter-group
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Neptune DBParameterGroup (AWS::Neptune::DBParameterGroup).
 *
...
const GlobalArgsSchema = z.object({
  ...
  Name: z.string().describe("Provides the name of the DB parameter group.")
    .optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "Neptune DBParameterGroup resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Neptune DBParameterGroup",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Neptune DBParameterGroup",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Neptune DBParameterGroup",
        ),
      }),
    ...
    update: {
      description: "Update a Neptune DBParameterGroup",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Neptune DBParameterGroup",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Neptune DBParameterGroup",
        ),
    ...
    sync: {
      description: "Sync Neptune DBParameterGroup state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Neptune DBParameterGroup resources",
      arguments: z.object({
