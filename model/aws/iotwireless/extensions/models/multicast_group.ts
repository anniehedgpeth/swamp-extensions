...
/**
 * Swamp extension model for IoTWireless MulticastGroup (AWS::IoTWireless::MulticastGroup).
 *
...
/** Swamp extension model for IoTWireless MulticastGroup. Registered at `@swamp/aws/iotwireless/multicast-group`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTWireless MulticastGroup resources",
      arguments: z.object({
