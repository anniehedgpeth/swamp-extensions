...
/**
 * Swamp extension model for IoTWireless Destination (AWS::IoTWireless::Destination).
 *
...
/** Swamp extension model for IoTWireless Destination. Registered at `@swamp/aws/iotwireless/destination`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTWireless Destination resources",
      arguments: z.object({
