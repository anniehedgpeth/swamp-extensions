...
/**
 * Swamp extension model for IoTWireless FuotaTask (AWS::IoTWireless::FuotaTask).
 *
...
/** Swamp extension model for IoTWireless FuotaTask. Registered at `@swamp/aws/iotwireless/fuota-task`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTWireless FuotaTask resources",
      arguments: z.object({
