...
/**
 * Swamp extension model for IoTWireless DeviceProfile (AWS::IoTWireless::DeviceProfile).
 *
...
/** Swamp extension model for IoTWireless DeviceProfile. Registered at `@swamp/aws/iotwireless/device-profile`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTWireless DeviceProfile resources",
      arguments: z.object({
