...
/**
 * Swamp extension model for IoTWireless WirelessDeviceImportTask (AWS::IoTWireless::WirelessDeviceImportTask).
 *
...
/** Swamp extension model for IoTWireless WirelessDeviceImportTask. Registered at `@swamp/aws/iotwireless/wireless-device-import-task`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTWireless WirelessDeviceImportTask resources",
      arguments: z.object({
