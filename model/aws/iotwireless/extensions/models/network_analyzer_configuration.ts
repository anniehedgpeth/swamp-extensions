...
/**
 * Swamp extension model for IoTWireless NetworkAnalyzerConfiguration (AWS::IoTWireless::NetworkAnalyzerConfiguration).
 *
...
/** Swamp extension model for IoTWireless NetworkAnalyzerConfiguration. Registered at `@swamp/aws/iotwireless/network-analyzer-configuration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTWireless NetworkAnalyzerConfiguration resources",
      arguments: z.object({
