...
/**
 * Swamp extension model for IoTWireless WirelessGateway (AWS::IoTWireless::WirelessGateway).
 *
...
/** Swamp extension model for IoTWireless WirelessGateway. Registered at `@swamp/aws/iotwireless/wireless-gateway`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTWireless WirelessGateway resources",
      arguments: z.object({
