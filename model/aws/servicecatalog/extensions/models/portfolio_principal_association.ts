...
/**
 * Swamp extension model for ServiceCatalog PortfolioPrincipalAssociation (AWS::ServiceCatalog::PortfolioPrincipalAssociation).
 *
...
/** Swamp extension model for ServiceCatalog PortfolioPrincipalAssociation. Registered at `@swamp/aws/servicecatalog/portfolio-principal-association`. */
export const model = {
