...
/**
 * Swamp extension model for ServiceCatalog StackSetConstraint (AWS::ServiceCatalog::StackSetConstraint).
 *
...
/** Swamp extension model for ServiceCatalog StackSetConstraint. Registered at `@swamp/aws/servicecatalog/stack-set-constraint`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ServiceCatalog StackSetConstraint resources",
      arguments: z.object({
