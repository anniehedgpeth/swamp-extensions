...
Use
`swamp model type describe @swamp/aws/usernotifications/managed_notification_configuration`
...
```bash
# Create a new managed_notification_configuration model
swamp model create @swamp/aws/usernotifications/managed_notification_configuration my-managed_notification_configuration

# Edit the model to configure its properties
swamp model edit my-managed_notification_configuration

# Create the resource in AWS
swamp model method run my-managed_notification_configuration create

# Sync current state from AWS
swamp model method run my-managed_notification_configuration sync
```
