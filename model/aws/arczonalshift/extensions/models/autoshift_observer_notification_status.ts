...
/**
 * Swamp extension model for ARCZonalShift AutoshiftObserverNotificationStatus (AWS::ARCZonalShift::AutoshiftObserverNotificationStatus).
 *
...
/** Swamp extension model for ARCZonalShift AutoshiftObserverNotificationStatus. Registered at `@swamp/aws/arczonalshift/autoshift-observer-notification-status`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description:
        "List ARCZonalShift AutoshiftObserverNotificationStatus resources",
      arguments: z.object({
