...
/**
 * Swamp extension model for QuickSight VPCConnection (AWS::QuickSight::VPCConnection).
 *
...
/** Swamp extension model for QuickSight VPCConnection. Registered at `@swamp/aws/quicksight/vpcconnection`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List QuickSight VPCConnection resources",
      arguments: z.object({
