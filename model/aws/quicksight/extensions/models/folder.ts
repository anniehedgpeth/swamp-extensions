...
/**
 * Swamp extension model for QuickSight Folder (AWS::QuickSight::Folder).
 *
...
/** Swamp extension model for QuickSight Folder. Registered at `@swamp/aws/quicksight/folder`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List QuickSight Folder resources",
      arguments: z.object({
