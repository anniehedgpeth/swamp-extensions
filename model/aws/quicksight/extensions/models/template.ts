...
// Auto-generated extension model for @swamp/aws/quicksight/template
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any no-control-regex

/**
 * Swamp extension model for QuickSight Template (AWS::QuickSight::Template).
 *
...
const ColumnSchemaSchema = z.object({
  DataType: z.string().describe("The data type of the column schema.")
    .optional(),
  GeographicRole: z.string().describe(
    "The geographic role of the column schema.",
  ).optional(),
  Name: z.string().describe("The name of the column schema.").optional(),
});

const DataSetSchemaSchema = z.object({
  ColumnSchemaList: z.array(ColumnSchemaSchema).describe(
    "A structure containing the list of column schemas.",
  ).optional(),
});

const ColumnGroupColumnSchemaSchema = z.object({
  Name: z.string().describe("The name of the column group's column schema.")
    .optional(),
});

const ColumnGroupSchemaSchema = z.object({
  ColumnGroupColumnSchemaList: z.array(ColumnGroupColumnSchemaSchema).describe(
...
const DataSetConfigurationSchema = z.object({
  Placeholder: z.string().describe("Placeholder.").optional(),
  DataSetSchema: DataSetSchemaSchema.describe("Dataset schema.").optional(),
  ColumnGroupSchemaList: z.array(ColumnGroupSchemaSchema).describe(
...
const TemplateErrorSchema = z.object({
  Type: z.enum([
    "SOURCE_NOT_FOUND",
    "DATA_SET_NOT_FOUND",
    "INTERNAL_FAILURE",
  ...
  Message: z.string().regex(new RegExp("\\S")).describe(
...
const GlobalArgsSchema = z.object({
  ...
  SourceEntity: z.object({
    SourceAnalysis: TemplateSourceAnalysisSchema.describe(
      "The source analysis of the template.",
    ).optional(),
  }).describe("The source entity of the template.").optional(),
  Definition: z.object({
  ...
  Version: z.object({
    ...
    Errors: z.array(TemplateErrorSchema).describe(
    ...
    DataSetConfigurations: z.array(DataSetConfigurationSchema).describe(
      "Schema of the dataset identified by the placeholder. Any dashboard created from this template should be bound to new datasets matching the same schema described through this API operation.",
    ).optional(),
    SourceEntityArn: z.string().describe(
...
const StateSchema = z.object({
  ...
  SourceEntity: z.object({
    SourceAnalysis: TemplateSourceAnalysisSchema,
...
export const model = {
  ...
  resources: {
    state: {
      description: "QuickSight Template resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a QuickSight Template",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a QuickSight Template",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the QuickSight Template",
        ),
      }),
    ...
    update: {
      description: "Update a QuickSight Template",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a QuickSight Template",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the QuickSight Template",
        ),
    ...
    sync: {
      description: "Sync QuickSight Template state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List QuickSight Template resources",
      arguments: z.object({
