...
/**
 * Swamp extension model for Route53Resolver FirewallRuleGroupAssociation (AWS::Route53Resolver::FirewallRuleGroupAssociation).
 *
...
/** Swamp extension model for Route53Resolver FirewallRuleGroupAssociation. Registered at `@swamp/aws/route53resolver/firewall-rule-group-association`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description:
        "List Route53Resolver FirewallRuleGroupAssociation resources",
      arguments: z.object({
