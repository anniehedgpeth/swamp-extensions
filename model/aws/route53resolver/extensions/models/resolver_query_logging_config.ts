...
/**
 * Swamp extension model for Route53Resolver ResolverQueryLoggingConfig (AWS::Route53Resolver::ResolverQueryLoggingConfig).
 *
...
/** Swamp extension model for Route53Resolver ResolverQueryLoggingConfig. Registered at `@swamp/aws/route53resolver/resolver-query-logging-config`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Route53Resolver ResolverQueryLoggingConfig resources",
      arguments: z.object({
