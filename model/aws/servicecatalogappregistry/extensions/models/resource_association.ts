...
/**
 * Swamp extension model for ServiceCatalogAppRegistry ResourceAssociation (AWS::ServiceCatalogAppRegistry::ResourceAssociation).
 *
...
/** Swamp extension model for ServiceCatalogAppRegistry ResourceAssociation. Registered at `@swamp/aws/servicecatalogappregistry/resource-association`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description:
        "List ServiceCatalogAppRegistry ResourceAssociation resources",
      arguments: z.object({
