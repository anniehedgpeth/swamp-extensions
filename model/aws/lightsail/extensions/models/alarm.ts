...
/**
 * Swamp extension model for Lightsail Alarm (AWS::Lightsail::Alarm).
 *
...
/** Swamp extension model for Lightsail Alarm. Registered at `@swamp/aws/lightsail/alarm`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Lightsail Alarm resources",
      arguments: z.object({
