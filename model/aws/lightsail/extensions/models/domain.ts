...
/**
 * Swamp extension model for Lightsail Domain (AWS::Lightsail::Domain).
 *
...
/** Swamp extension model for Lightsail Domain. Registered at `@swamp/aws/lightsail/domain`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Lightsail Domain resources",
      arguments: z.object({
