...
/**
 * Swamp extension model for Deadline StorageProfile (AWS::Deadline::StorageProfile).
 *
...
const FileSystemLocationSchema = z.object({
...
/** Swamp extension model for Deadline StorageProfile. Registered at `@swamp/aws/deadline/storage-profile`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Deadline StorageProfile resources",
      arguments: z.object({
