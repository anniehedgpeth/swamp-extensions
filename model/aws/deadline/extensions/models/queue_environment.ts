...
/**
 * Swamp extension model for Deadline QueueEnvironment (AWS::Deadline::QueueEnvironment).
 *
...
/** Swamp extension model for Deadline QueueEnvironment. Registered at `@swamp/aws/deadline/queue-environment`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Deadline QueueEnvironment resources",
      arguments: z.object({
