...
// Auto-generated extension model for @swamp/aws/deadline/monitor
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Deadline Monitor (AWS::Deadline::Monitor).
 *
...
const GlobalArgsSchema = z.object({
  ...
  Subdomain: z.string().regex(new RegExp("^[a-z0-9-]{1,100}$")),
...
const InputsSchema = z.object({
  ...
  Subdomain: z.string().regex(new RegExp("^[a-z0-9-]{1,100}$")).optional(),
  Tags: z.array(TagSchema).describe(
    "An array of key-value pairs to apply to this resource.",
  ).optional(),
});
...
/** Swamp extension model for Deadline Monitor. Registered at `@swamp/aws/deadline/monitor`. */
export const model = {
  ...
  resources: {
    state: {
      description: "Deadline Monitor resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Deadline Monitor",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Deadline Monitor",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Deadline Monitor",
        ),
      }),
    ...
    update: {
      description: "Update a Deadline Monitor",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Deadline Monitor",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Deadline Monitor",
        ),
    ...
    sync: {
      description: "Sync Deadline Monitor state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Deadline Monitor resources",
      arguments: z.object({
