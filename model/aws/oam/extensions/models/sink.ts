...
// Auto-generated extension model for @swamp/aws/oam/sink
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Oam Sink (AWS::Oam::Sink).
 *
...
const GlobalArgsSchema = z.object({
  ...
  ).describe("Tags to apply to the sink").optional(),
});
...
export const model = {
  ...
  resources: {
    state: {
      description: "Oam Sink resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    get: {
      description: "Get a Oam Sink",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Oam Sink",
        ),
      }),
    ...
    sync: {
      description: "Sync Oam Sink state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Oam Sink resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::Oam::Sink", {
