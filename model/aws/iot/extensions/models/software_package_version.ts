...
/**
 * Swamp extension model for IoT SoftwarePackageVersion (AWS::IoT::SoftwarePackageVersion).
 *
...
/** Swamp extension model for IoT SoftwarePackageVersion. Registered at `@swamp/aws/iot/software-package-version`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoT SoftwarePackageVersion resources",
      arguments: z.object({
