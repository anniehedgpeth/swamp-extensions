...
/**
 * Swamp extension model for IoT FleetMetric (AWS::IoT::FleetMetric).
 *
...
/** Swamp extension model for IoT FleetMetric. Registered at `@swamp/aws/iot/fleet-metric`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoT FleetMetric resources",
      arguments: z.object({
