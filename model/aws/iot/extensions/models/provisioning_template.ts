...
/**
 * Swamp extension model for IoT ProvisioningTemplate (AWS::IoT::ProvisioningTemplate).
 *
...
/** Swamp extension model for IoT ProvisioningTemplate. Registered at `@swamp/aws/iot/provisioning-template`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoT ProvisioningTemplate resources",
      arguments: z.object({
