...
/**
 * Swamp extension model for IoT CACertificate (AWS::IoT::CACertificate).
 *
...
/** Swamp extension model for IoT CACertificate. Registered at `@swamp/aws/iot/cacertificate`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoT CACertificate resources",
      arguments: z.object({
