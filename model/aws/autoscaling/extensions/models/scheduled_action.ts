...
/**
 * Swamp extension model for AutoScaling ScheduledAction (AWS::AutoScaling::ScheduledAction).
 *
...
/** Swamp extension model for AutoScaling ScheduledAction. Registered at `@swamp/aws/autoscaling/scheduled-action`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AutoScaling ScheduledAction resources",
      arguments: z.object({
