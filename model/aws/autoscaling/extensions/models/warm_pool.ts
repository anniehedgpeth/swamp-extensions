...
/**
 * Swamp extension model for AutoScaling WarmPool (AWS::AutoScaling::WarmPool).
 *
...
/** Swamp extension model for AutoScaling WarmPool. Registered at `@swamp/aws/autoscaling/warm-pool`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AutoScaling WarmPool resources",
      arguments: z.object({
