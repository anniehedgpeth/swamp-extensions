...
/**
 * Swamp extension model for Wisdom AssistantAssociation (AWS::Wisdom::AssistantAssociation).
 *
...
const ExternalBedrockKnowledgeBaseConfigSchema = z.object({
...
/** Swamp extension model for Wisdom AssistantAssociation. Registered at `@swamp/aws/wisdom/assistant-association`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Wisdom AssistantAssociation resources",
      arguments: z.object({
