...
/**
 * Swamp extension model for IoTTwinMaker SyncJob (AWS::IoTTwinMaker::SyncJob).
 *
...
/** Swamp extension model for IoTTwinMaker SyncJob. Registered at `@swamp/aws/iottwinmaker/sync-job`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTTwinMaker SyncJob resources",
      arguments: z.object({
