...
/**
 * Swamp extension model for IoTTwinMaker Scene (AWS::IoTTwinMaker::Scene).
 *
...
/** Swamp extension model for IoTTwinMaker Scene. Registered at `@swamp/aws/iottwinmaker/scene`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTTwinMaker Scene resources",
      arguments: z.object({
