...
/**
 * Swamp extension model for GuardDuty PublishingDestination (AWS::GuardDuty::PublishingDestination).
 *
...
/** Swamp extension model for GuardDuty PublishingDestination. Registered at `@swamp/aws/guardduty/publishing-destination`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List GuardDuty PublishingDestination resources",
      arguments: z.object({
