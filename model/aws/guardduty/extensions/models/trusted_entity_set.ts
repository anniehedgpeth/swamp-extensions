...
/**
 * Swamp extension model for GuardDuty TrustedEntitySet (AWS::GuardDuty::TrustedEntitySet).
 *
...
/** Swamp extension model for GuardDuty TrustedEntitySet. Registered at `@swamp/aws/guardduty/trusted-entity-set`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List GuardDuty TrustedEntitySet resources",
      arguments: z.object({
