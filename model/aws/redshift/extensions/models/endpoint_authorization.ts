...
/**
 * Swamp extension model for Redshift EndpointAuthorization (AWS::Redshift::EndpointAuthorization).
 *
...
/** Swamp extension model for Redshift EndpointAuthorization. Registered at `@swamp/aws/redshift/endpoint-authorization`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Redshift EndpointAuthorization resources",
      arguments: z.object({
