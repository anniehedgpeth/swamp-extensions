...
/**
 * Swamp extension model for Redshift ClusterParameterGroup (AWS::Redshift::ClusterParameterGroup).
 *
...
/** Swamp extension model for Redshift ClusterParameterGroup. Registered at `@swamp/aws/redshift/cluster-parameter-group`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Redshift ClusterParameterGroup resources",
      arguments: z.object({
