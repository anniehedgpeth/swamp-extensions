...
// Auto-generated extension model for @swamp/aws/ssm/resource-policy
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for SSM ResourcePolicy (AWS::SSM::ResourcePolicy).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "SSM ResourcePolicy resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a SSM ResourcePolicy",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a SSM ResourcePolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the SSM ResourcePolicy",
        ),
      }),
    ...
    update: {
      description: "Update a SSM ResourcePolicy",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a SSM ResourcePolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the SSM ResourcePolicy",
        ),
    ...
    sync: {
      description: "Sync SSM ResourcePolicy state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List SSM ResourcePolicy resources",
      arguments: z.object({
