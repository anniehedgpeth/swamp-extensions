...
/**
 * Swamp extension model for SSM MaintenanceWindowTarget (AWS::SSM::MaintenanceWindowTarget).
 *
...
/** Swamp extension model for SSM MaintenanceWindowTarget. Registered at `@swamp/aws/ssm/maintenance-window-target`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SSM MaintenanceWindowTarget resources",
      arguments: z.object({
