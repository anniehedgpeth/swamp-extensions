...
/**
 * Swamp extension model for ApiGateway DomainName (AWS::ApiGateway::DomainName).
 *
...
/** Swamp extension model for ApiGateway DomainName. Registered at `@swamp/aws/apigateway/domain-name`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ApiGateway DomainName resources",
      arguments: z.object({
