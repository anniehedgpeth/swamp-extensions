...
/**
 * Swamp extension model for ApiGateway DocumentationVersion (AWS::ApiGateway::DocumentationVersion).
 *
...
/** Swamp extension model for ApiGateway DocumentationVersion. Registered at `@swamp/aws/apigateway/documentation-version`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ApiGateway DocumentationVersion resources",
      arguments: z.object({
