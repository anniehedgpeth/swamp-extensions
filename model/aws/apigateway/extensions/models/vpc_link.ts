...
/**
 * Swamp extension model for ApiGateway VpcLink (AWS::ApiGateway::VpcLink).
 *
...
/** Swamp extension model for ApiGateway VpcLink. Registered at `@swamp/aws/apigateway/vpc-link`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ApiGateway VpcLink resources",
      arguments: z.object({
