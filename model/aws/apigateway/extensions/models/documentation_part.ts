...
/**
 * Swamp extension model for ApiGateway DocumentationPart (AWS::ApiGateway::DocumentationPart).
 *
...
/** Swamp extension model for ApiGateway DocumentationPart. Registered at `@swamp/aws/apigateway/documentation-part`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ApiGateway DocumentationPart resources",
      arguments: z.object({
