...
/**
 * Swamp extension model for ApiGateway UsagePlanKey (AWS::ApiGateway::UsagePlanKey).
 *
...
/** Swamp extension model for ApiGateway UsagePlanKey. Registered at `@swamp/aws/apigateway/usage-plan-key`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ApiGateway UsagePlanKey resources",
      arguments: z.object({
