...
/**
 * Swamp extension model for Shield DRTAccess (AWS::Shield::DRTAccess).
 *
...
/** Swamp extension model for Shield DRTAccess. Registered at `@swamp/aws/shield/drtaccess`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Shield DRTAccess resources",
      arguments: z.object({
