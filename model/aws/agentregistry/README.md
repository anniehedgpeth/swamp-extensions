...
Use `swamp model type describe @swamp/aws/agentregistry/registry_record` to see
...
```bash
# Create a new registry_record model
swamp model create @swamp/aws/agentregistry/registry_record my-registry_record

# Edit the model to configure its properties
swamp model edit my-registry_record

# Create the resource in AWS
swamp model method run my-registry_record create

# Sync current state from AWS
swamp model method run my-registry_record sync
```
