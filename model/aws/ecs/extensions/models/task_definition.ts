...
// Auto-generated extension model for @swamp/aws/ecs/task-definition
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for ECS TaskDefinition (AWS::ECS::TaskDefinition).
 *
...
const InferenceAcceleratorSchema = z.object({
  DeviceType: z.string().optional(),
  DeviceName: z.string().optional(),
});

const TaskDefinitionPlacementConstraintSchema = z.object({
...
const EFSVolumeConfigurationSchema = z.object({
  FilesystemId: z.string().describe("The Amazon EFS file system ID to use."),
  TransitEncryption: z.enum(["ENABLED", "DISABLED"]).describe(
...
const DockerVolumeConfigurationSchema = z.object({
  DriverOpts: z.record(z.string(), z.string()).describe(
  ...
  Autoprovision: z.boolean().describe(
...
const FSxAuthorizationConfigSchema = z.object({
...
const FSxWindowsFileServerVolumeConfigurationSchema = z.object({
  AuthorizationConfig: FSxAuthorizationConfigSchema.describe(
...
const VolumeSchema = z.object({
  ...
  ConfiguredAtLaunch: z.boolean().describe(
  ...
  DockerVolumeConfiguration: DockerVolumeConfigurationSchema.describe(
  ...
  FSxWindowsFileServerVolumeConfiguration:
    FSxWindowsFileServerVolumeConfigurationSchema.describe(
...
const VolumeFromSchema = z.object({
  ReadOnly: z.boolean().describe(
    "If this value is true, the container has read-only access to the volume. If this value is false, then the container can write to the volume. The default value is false.",
  ).optional(),
  SourceContainer: z.string().describe(
...
const HostEntrySchema = z.object({
  Hostname: z.string().describe("The hostname to use in the /etc/hosts entry.")
    .optional(),
...
const LinuxParametersSchema = z.object({
  ...
  Swappiness: z.number().int().describe(
...
const RestartPolicySchema = z.object({
  IgnoredExitCodes: z.array(z.number().int()).describe(
  ...
  RestartAttemptPeriod: z.number().int().describe(
...
const PortMappingSchema = z.object({
  AppProtocol: z.enum(["http", "http2", "grpc"]).describe(
  ...
  ContainerPortRange: z.string().describe(
  ...
  HostPort: z.number().int().describe(
...
const ContainerDefinitionSchema = z.object({
  ...
  VolumesFrom: z.array(VolumeFromSchema).describe(
  ...
  DockerSecurityOptions: z.array(z.string()).describe(
  ...
  DnsSearchDomains: z.array(z.string()).describe(
  ...
  CredentialSpecs: z.array(z.string()).describe(
  ...
  ExtraHosts: z.array(HostEntrySchema).describe(
  ...
  VersionConsistency: z.enum(["enabled", "disabled"]).describe(
  ...
  DisableNetworking: z.boolean().describe(
  ...
  DockerLabels: z.record(z.string(), z.string()).describe(
  ...
  PortMappings: z.array(PortMappingSchema).describe(
  ...
  Links: z.array(z.string()).describe(
...
const GlobalArgsSchema = z.object({
  ...
  InferenceAccelerators: z.array(InferenceAcceleratorSchema).optional(),
  ...
  PlacementConstraints: z.array(TaskDefinitionPlacementConstraintSchema)
    .describe(
  ...
  RequiresCompatibilities: z.array(z.string()).describe(
  ...
  EnableFaultInjection: z.boolean().describe(
  ...
  RuntimePlatform: z.object({
    OperatingSystemFamily: z.string().describe("The operating system.")
      .optional(),
  ...
  }).describe("The operating system that your tasks definitions run on.")
    .optional(),
  ProxyConfiguration: z.object({
    ProxyConfigurationProperties: z.array(KeyValuePairSchema).describe(
  ...
  ContainerDefinitions: z.array(ContainerDefinitionSchema).describe(
  ...
  EphemeralStorage: z.object({
    SizeInGiB: z.number().int().describe(
...
const StateSchema = z.object({
  ...
  RequiresCompatibilities: z.array(z.string()).optional(),
  NetworkMode: z.string().optional(),
  PidMode: z.string().optional(),
  EnableFaultInjection: z.boolean().optional(),
  ExecutionRoleArn: z.string().optional(),
  RuntimePlatform: z.object({
    OperatingSystemFamily: z.string(),
    CpuArchitecture: z.string(),
  }).optional(),
  ProxyConfiguration: z.object({
    ProxyConfigurationProperties: z.array(KeyValuePairSchema),
    Type: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "ECS TaskDefinition resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a ECS TaskDefinition",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a ECS TaskDefinition",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the ECS TaskDefinition",
        ),
      }),
    ...
    update: {
      description: "Update a ECS TaskDefinition",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
        ...
        const identifier = existing.TaskDefinitionArn?.toString();
        if (!identifier) {
    ...
    delete: {
      description: "Delete a ECS TaskDefinition",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the ECS TaskDefinition",
        ),
    ...
    sync: {
      description: "Sync ECS TaskDefinition state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List ECS TaskDefinition resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        for (let i = 0; i < items.length; i++) {
          const item = items[i];
          const instanceName =
            (item.properties?.TaskDefinitionArn?.toString() ?? item.identifier)
