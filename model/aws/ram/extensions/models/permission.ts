...
// Auto-generated extension model for @swamp/aws/ram/permission
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for RAM Permission (AWS::RAM::Permission).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "RAM Permission resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a RAM Permission",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a RAM Permission",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the RAM Permission",
        ),
      }),
    ...
    update: {
      description: "Update a RAM Permission",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
        ...
        const result = await updateResource(
          ...
          currentState,
          desiredState,
          ["Name", "ResourceType", "PolicyTemplate"],
          credentials,
        );
        const handle = await context.writeResource(
          "state",
    ...
    delete: {
      description: "Delete a RAM Permission",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the RAM Permission",
        ),
    ...
    sync: {
      description: "Sync RAM Permission state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List RAM Permission resources",
      arguments: z.object({
