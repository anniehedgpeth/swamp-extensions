...
// Auto-generated extension model for @swamp/aws/organizations/resource-policy
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Organizations ResourcePolicy (AWS::Organizations::ResourcePolicy).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Organizations ResourcePolicy resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Organizations ResourcePolicy",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Organizations ResourcePolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Organizations ResourcePolicy",
        ),
      }),
    ...
    update: {
      description: "Update a Organizations ResourcePolicy",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Organizations ResourcePolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Organizations ResourcePolicy",
        ),
    ...
    sync: {
      description: "Sync Organizations ResourcePolicy state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Organizations ResourcePolicy resources",
      arguments: z.object({
