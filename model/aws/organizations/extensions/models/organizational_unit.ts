...
/**
 * Swamp extension model for Organizations OrganizationalUnit (AWS::Organizations::OrganizationalUnit).
 *
...
/** Swamp extension model for Organizations OrganizationalUnit. Registered at `@swamp/aws/organizations/organizational-unit`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Organizations OrganizationalUnit resources",
      arguments: z.object({
