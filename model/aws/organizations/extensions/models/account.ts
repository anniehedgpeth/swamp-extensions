...
/**
 * Swamp extension model for Organizations Account (AWS::Organizations::Account).
 *
...
/** Swamp extension model for Organizations Account. Registered at `@swamp/aws/organizations/account`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Organizations Account resources",
      arguments: z.object({
