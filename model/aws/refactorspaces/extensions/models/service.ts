...
/**
 * Swamp extension model for RefactorSpaces Service (AWS::RefactorSpaces::Service).
 *
...
/** Swamp extension model for RefactorSpaces Service. Registered at `@swamp/aws/refactorspaces/service`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List RefactorSpaces Service resources",
      arguments: z.object({
