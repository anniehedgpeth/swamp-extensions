...
/**
 * Swamp extension model for CodeStarNotifications NotificationRule (AWS::CodeStarNotifications::NotificationRule).
 *
...
/** Swamp extension model for CodeStarNotifications NotificationRule. Registered at `@swamp/aws/codestarnotifications/notification-rule`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CodeStarNotifications NotificationRule resources",
      arguments: z.object({
