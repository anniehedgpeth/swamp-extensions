...
/**
 * Swamp extension model for WAFv2 IPSet (AWS::WAFv2::IPSet).
 *
...
/** Swamp extension model for WAFv2 IPSet. Registered at `@swamp/aws/wafv2/ipset`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List WAFv2 IPSet resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::WAFv2::IPSet", {
