...
/**
 * Swamp extension model for DSQL Cluster (AWS::DSQL::Cluster).
 *
...
/** Swamp extension model for DSQL Cluster. Registered at `@swamp/aws/dsql/cluster`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List DSQL Cluster resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::DSQL::Cluster", {
