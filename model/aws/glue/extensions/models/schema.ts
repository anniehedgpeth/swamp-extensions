...
/**
 * Swamp extension model for Glue Schema (AWS::Glue::Schema).
 *
...
/** Swamp extension model for Glue Schema. Registered at `@swamp/aws/glue/schema`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Glue Schema resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::Glue::Schema", {
