...
/**
 * Swamp extension model for Glue Database (AWS::Glue::Database).
 *
...
const PrincipalPrivilegesSchema = z.object({
...
const FederatedDatabaseSchema = z.object({
...
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Glue Database resources",
      arguments: z.object({
