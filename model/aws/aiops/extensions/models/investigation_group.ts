...
/**
 * Swamp extension model for AIOps InvestigationGroup (AWS::AIOps::InvestigationGroup).
 *
...
const ChatbotNotificationChannelSchema = z.object({
  SNSTopicArn: z.string().min(20).max(2048).optional(),
  ChatConfigurationArns: z.array(z.string()).optional(),
});

const CrossAccountConfigurationSchema = z.object({
...
/** Swamp extension model for AIOps InvestigationGroup. Registered at `@swamp/aws/aiops/investigation-group`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AIOps InvestigationGroup resources",
      arguments: z.object({
