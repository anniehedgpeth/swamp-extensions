...
Use `swamp model type describe @swamp/aws/opensearch/data_source` to see the
...
```bash
# Create a new data_source model
swamp model create @swamp/aws/opensearch/data_source my-data_source

# Edit the model to configure its properties
swamp model edit my-data_source

# Create the resource in AWS
swamp model method run my-data_source create

# Sync current state from AWS
swamp model method run my-data_source sync
```
