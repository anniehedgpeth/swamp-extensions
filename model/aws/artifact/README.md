...
Use `swamp model type describe @swamp/aws/artifact/report` to see the full list
...
swamp model create @swamp/aws/artifact/report my-report

# Edit the model to configure its properties
swamp model edit my-report

# Create the resource in AWS
swamp model method run my-report create

# Sync current state from AWS
swamp model method run my-report sync
```
