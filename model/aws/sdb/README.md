...
Use `swamp model type describe @swamp/aws/sdb/domain` to see the full list of
...
swamp model create @swamp/aws/sdb/domain my-domain

# Edit the model to configure its properties
swamp model edit my-domain

# Create the resource in AWS
swamp model method run my-domain create

# Sync current state from AWS
swamp model method run my-domain sync
```
