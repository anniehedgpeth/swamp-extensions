...
/**
 * Swamp extension model for Athena CapacityReservation (AWS::Athena::CapacityReservation).
 *
...
const CapacityAssignmentSchema = z.object({
...
/** Swamp extension model for Athena CapacityReservation. Registered at `@swamp/aws/athena/capacity-reservation`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Athena CapacityReservation resources",
      arguments: z.object({
