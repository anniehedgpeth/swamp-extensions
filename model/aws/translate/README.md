...
Use `swamp model type describe @swamp/aws/translate/parallel_data` to see the
...
```bash
# Create a new parallel_data model
swamp model create @swamp/aws/translate/parallel_data my-parallel_data

# Edit the model to configure its properties
swamp model edit my-parallel_data

# Create the resource in AWS
swamp model method run my-parallel_data create

# Sync current state from AWS
swamp model method run my-parallel_data sync
```
