...
/**
 * Swamp extension model for Cognito IdentityPool (AWS::Cognito::IdentityPool).
 *
...
const CognitoIdentityProviderSchema = z.object({
...
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Cognito IdentityPool resources",
      arguments: z.object({
