...
/**
 * Swamp extension model for Cognito UserPoolClient (AWS::Cognito::UserPoolClient).
 *
...
/** Swamp extension model for Cognito UserPoolClient. Registered at `@swamp/aws/cognito/user-pool-client`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Cognito UserPoolClient resources",
      arguments: z.object({
