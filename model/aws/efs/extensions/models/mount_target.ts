...
/**
 * Swamp extension model for EFS MountTarget (AWS::EFS::MountTarget).
 *
...
/** Swamp extension model for EFS MountTarget. Registered at `@swamp/aws/efs/mount-target`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EFS MountTarget resources",
      arguments: z.object({
