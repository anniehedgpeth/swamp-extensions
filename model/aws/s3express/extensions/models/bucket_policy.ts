...
// Auto-generated extension model for @swamp/aws/s3express/bucket-policy
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for S3Express BucketPolicy (AWS::S3Express::BucketPolicy).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "S3Express BucketPolicy resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a S3Express BucketPolicy",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a S3Express BucketPolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the S3Express BucketPolicy",
        ),
      }),
    ...
    update: {
      description: "Update a S3Express BucketPolicy",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a S3Express BucketPolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the S3Express BucketPolicy",
        ),
    ...
    sync: {
      description: "Sync S3Express BucketPolicy state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List S3Express BucketPolicy resources",
      arguments: z.object({
