...
/**
 * Swamp extension model for EntityResolution PolicyStatement (AWS::EntityResolution::PolicyStatement).
 *
...
/** Swamp extension model for EntityResolution PolicyStatement. Registered at `@swamp/aws/entityresolution/policy-statement`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EntityResolution PolicyStatement resources",
      arguments: z.object({
