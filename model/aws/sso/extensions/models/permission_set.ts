...
/**
 * Swamp extension model for SSO PermissionSet (AWS::SSO::PermissionSet).
 *
...
const CustomerManagedPolicyReferenceSchema = z.object({
...
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SSO PermissionSet resources",
      arguments: z.object({
