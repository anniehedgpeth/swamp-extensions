...
/**
 * Swamp extension model for AppConfig Deployment (AWS::AppConfig::Deployment).
 *
...
const DynamicExtensionParametersSchema = z.object({
...
/** Swamp extension model for AppConfig Deployment. Registered at `@swamp/aws/appconfig/deployment`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AppConfig Deployment resources",
      arguments: z.object({
