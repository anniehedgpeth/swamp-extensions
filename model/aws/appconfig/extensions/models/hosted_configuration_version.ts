...
/**
 * Swamp extension model for AppConfig HostedConfigurationVersion (AWS::AppConfig::HostedConfigurationVersion).
 *
...
/** Swamp extension model for AppConfig HostedConfigurationVersion. Registered at `@swamp/aws/appconfig/hosted-configuration-version`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AppConfig HostedConfigurationVersion resources",
      arguments: z.object({
