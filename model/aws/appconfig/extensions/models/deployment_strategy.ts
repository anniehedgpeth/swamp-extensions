...
/**
 * Swamp extension model for AppConfig DeploymentStrategy (AWS::AppConfig::DeploymentStrategy).
 *
...
/** Swamp extension model for AppConfig DeploymentStrategy. Registered at `@swamp/aws/appconfig/deployment-strategy`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AppConfig DeploymentStrategy resources",
      arguments: z.object({
