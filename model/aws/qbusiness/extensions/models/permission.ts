...
// Auto-generated extension model for @swamp/aws/qbusiness/permission
...
const GlobalArgsSchema = z.object({
  ...
  StatementId: z.string().min(1).max(100).regex(new RegExp("^[a-zA-Z0-9_-]+$")),
  Actions: z.array(z.string().regex(new RegExp("^qbusiness:[a-zA-Z]+$"))),
...
export const model = {
  ...
  resources: {
    state: {
      description: "QBusiness Permission resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a QBusiness Permission",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a QBusiness Permission",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the QBusiness Permission",
        ),
      }),
    ...
    delete: {
      description: "Delete a QBusiness Permission",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the QBusiness Permission",
        ),
    ...
    sync: {
      description: "Sync QBusiness Permission state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List QBusiness Permission resources",
      arguments: z.object({
