...
/**
 * Swamp extension model for SSMContacts ContactChannel (AWS::SSMContacts::ContactChannel).
 *
...
/** Swamp extension model for SSMContacts ContactChannel. Registered at `@swamp/aws/ssmcontacts/contact-channel`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SSMContacts ContactChannel resources",
      arguments: z.object({
