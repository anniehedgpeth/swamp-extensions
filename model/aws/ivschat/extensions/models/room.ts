...
/**
 * Swamp extension model for IVSChat Room (AWS::IVSChat::Room).
 *
...
/** Swamp extension model for IVSChat Room. Registered at `@swamp/aws/ivschat/room`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IVSChat Room resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::IVSChat::Room", {
