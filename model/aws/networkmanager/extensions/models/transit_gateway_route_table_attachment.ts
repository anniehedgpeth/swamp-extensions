...
// Auto-generated extension model for @swamp/aws/networkmanager/transit-gateway-route-table-attachment
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for NetworkManager TransitGatewayRouteTableAttachment (AWS::NetworkManager::TransitGatewayRouteTableAttachment).
 *
...
const GlobalArgsSchema = z.object({
  ...
  PeeringId: z.string().describe(
    "The Id of peering between transit gateway and core network.",
  ),
  TransitGatewayRouteTableArn: z.string().describe(
...
const StateSchema = z.object({
  ...
  TransitGatewayRouteTableArn: z.string().optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "NetworkManager TransitGatewayRouteTableAttachment resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a NetworkManager TransitGatewayRouteTableAttachment",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a NetworkManager TransitGatewayRouteTableAttachment",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the NetworkManager TransitGatewayRouteTableAttachment",
        ),
      }),
    ...
    update: {
      description: "Update a NetworkManager TransitGatewayRouteTableAttachment",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a NetworkManager TransitGatewayRouteTableAttachment",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the NetworkManager TransitGatewayRouteTableAttachment",
        ),
    ...
    sync: {
      description:
        "Sync NetworkManager TransitGatewayRouteTableAttachment state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description:
        "List NetworkManager TransitGatewayRouteTableAttachment resources",
      arguments: z.object({
