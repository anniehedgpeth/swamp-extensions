...
// Auto-generated extension model for @swamp/aws/networkmanager/connect-attachment
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for NetworkManager ConnectAttachment (AWS::NetworkManager::ConnectAttachment).
 *
...
const GlobalArgsSchema = z.object({
  ...
  EdgeLocation: z.string().describe("Edge location of the attachment."),
  ...
  TransportAttachmentId: z.string().describe("Id of transport attachment"),
  Options: z.object({
    Protocol: z.string().describe("Tunnel protocol for connect attachment")
      .optional(),
  }).describe("Protocol options for connect attachment"),
});
...
const StateSchema = z.object({
  ...
  TransportAttachmentId: z.string().optional(),
  Options: z.object({
    Protocol: z.string(),
  }).optional(),
...
const InputsSchema = z.object({
  ...
  Options: z.object({
    Protocol: z.string().describe("Tunnel protocol for connect attachment")
      .optional(),
  }).describe("Protocol options for connect attachment").optional(),
});
...
export const model = {
  ...
  resources: {
    state: {
      description: "NetworkManager ConnectAttachment resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a NetworkManager ConnectAttachment",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a NetworkManager ConnectAttachment",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the NetworkManager ConnectAttachment",
        ),
      }),
    ...
    update: {
      description: "Update a NetworkManager ConnectAttachment",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a NetworkManager ConnectAttachment",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the NetworkManager ConnectAttachment",
        ),
    ...
    sync: {
      description: "Sync NetworkManager ConnectAttachment state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List NetworkManager ConnectAttachment resources",
      arguments: z.object({
