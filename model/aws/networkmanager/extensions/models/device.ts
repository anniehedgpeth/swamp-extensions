...
/**
 * Swamp extension model for NetworkManager Device (AWS::NetworkManager::Device).
 *
...
/** Swamp extension model for NetworkManager Device. Registered at `@swamp/aws/networkmanager/device`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List NetworkManager Device resources",
      arguments: z.object({
