...
/**
 * Swamp extension model for NetworkManager Link (AWS::NetworkManager::Link).
 *
...
/** Swamp extension model for NetworkManager Link. Registered at `@swamp/aws/networkmanager/link`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List NetworkManager Link resources",
      arguments: z.object({
