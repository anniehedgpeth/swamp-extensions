...
// Auto-generated extension model for @swamp/aws/kms/replica-key
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for KMS ReplicaKey (AWS::KMS::ReplicaKey).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "KMS ReplicaKey resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a KMS ReplicaKey",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a KMS ReplicaKey",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the KMS ReplicaKey",
        ),
      }),
    ...
    update: {
      description: "Update a KMS ReplicaKey",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a KMS ReplicaKey",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the KMS ReplicaKey",
        ),
    ...
    sync: {
      description: "Sync KMS ReplicaKey state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List KMS ReplicaKey resources",
      arguments: z.object({
