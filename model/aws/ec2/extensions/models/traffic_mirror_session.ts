...
/**
 * Swamp extension model for EC2 TrafficMirrorSession (AWS::EC2::TrafficMirrorSession).
 *
...
/** Swamp extension model for EC2 TrafficMirrorSession. Registered at `@swamp/aws/ec2/traffic-mirror-session`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EC2 TrafficMirrorSession resources",
      arguments: z.object({
