...
/**
 * Swamp extension model for EC2 NetworkInterfaceAttachment (AWS::EC2::NetworkInterfaceAttachment).
 *
...
/** Swamp extension model for EC2 NetworkInterfaceAttachment. Registered at `@swamp/aws/ec2/network-interface-attachment`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EC2 NetworkInterfaceAttachment resources",
      arguments: z.object({
