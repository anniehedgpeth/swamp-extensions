...
/**
 * Swamp extension model for EC2 NetworkPerformanceMetricSubscription (AWS::EC2::NetworkPerformanceMetricSubscription).
 *
...
/** Swamp extension model for EC2 NetworkPerformanceMetricSubscription. Registered at `@swamp/aws/ec2/network-performance-metric-subscription`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EC2 NetworkPerformanceMetricSubscription resources",
      arguments: z.object({
