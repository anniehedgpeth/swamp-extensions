...
/**
 * Swamp extension model for EC2 IPAMPoolCidr (AWS::EC2::IPAMPoolCidr).
 *
...
/** Swamp extension model for EC2 IPAMPoolCidr. Registered at `@swamp/aws/ec2/ipampool-cidr`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EC2 IPAMPoolCidr resources",
      arguments: z.object({
