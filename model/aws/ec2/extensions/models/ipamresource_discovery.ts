...
// Auto-generated extension model for @swamp/aws/ec2/ipamresource-discovery
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for EC2 IPAMResourceDiscovery (AWS::EC2::IPAMResourceDiscovery).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "EC2 IPAMResourceDiscovery resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a EC2 IPAMResourceDiscovery",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a EC2 IPAMResourceDiscovery",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the EC2 IPAMResourceDiscovery",
        ),
      }),
    ...
    update: {
      description: "Update a EC2 IPAMResourceDiscovery",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
        ...
        const identifier = existing.IpamResourceDiscoveryId?.toString();
        if (!identifier) {
    ...
    delete: {
      description: "Delete a EC2 IPAMResourceDiscovery",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the EC2 IPAMResourceDiscovery",
        ),
    ...
    sync: {
      description: "Sync EC2 IPAMResourceDiscovery state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List EC2 IPAMResourceDiscovery resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        for (let i = 0; i < items.length; i++) {
          const item = items[i];
          const instanceName =
            (item.properties?.IpamResourceDiscoveryId?.toString() ??
