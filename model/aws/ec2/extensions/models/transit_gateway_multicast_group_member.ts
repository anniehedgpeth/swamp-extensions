...
/**
 * Swamp extension model for EC2 TransitGatewayMulticastGroupMember (AWS::EC2::TransitGatewayMulticastGroupMember).
 *
...
/** Swamp extension model for EC2 TransitGatewayMulticastGroupMember. Registered at `@swamp/aws/ec2/transit-gateway-multicast-group-member`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EC2 TransitGatewayMulticastGroupMember resources",
      arguments: z.object({
