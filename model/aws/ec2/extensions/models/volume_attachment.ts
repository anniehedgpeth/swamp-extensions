...
/**
 * Swamp extension model for EC2 VolumeAttachment (AWS::EC2::VolumeAttachment).
 *
...
/** Swamp extension model for EC2 VolumeAttachment. Registered at `@swamp/aws/ec2/volume-attachment`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EC2 VolumeAttachment resources",
      arguments: z.object({
