...
/**
 * Swamp extension model for MediaLive SignalMap (AWS::MediaLive::SignalMap).
 *
...
/** Swamp extension model for MediaLive SignalMap. Registered at `@swamp/aws/medialive/signal-map`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List MediaLive SignalMap resources",
      arguments: z.object({
