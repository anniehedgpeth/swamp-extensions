...
Use `swamp model type describe @swamp/aws/wickr/network` to see the full list of
...
swamp model create @swamp/aws/wickr/network my-network

# Edit the model to configure its properties
swamp model edit my-network

# Create the resource in AWS
swamp model method run my-network create

# Sync current state from AWS
swamp model method run my-network sync
```
