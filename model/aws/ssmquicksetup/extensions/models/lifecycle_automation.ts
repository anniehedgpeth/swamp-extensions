...
/**
 * Swamp extension model for SSMQuickSetup LifecycleAutomation (AWS::SSMQuickSetup::LifecycleAutomation).
 *
...
/** Swamp extension model for SSMQuickSetup LifecycleAutomation. Registered at `@swamp/aws/ssmquicksetup/lifecycle-automation`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SSMQuickSetup LifecycleAutomation resources",
      arguments: z.object({
