...
/**
 * Swamp extension model for BcmPricingCalculator BillScenario (AWS::BcmPricingCalculator::BillScenario).
 *
...
/** Swamp extension model for BcmPricingCalculator BillScenario. Registered at `@swamp/aws/bcmpricingcalculator/bill-scenario`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List BcmPricingCalculator BillScenario resources",
      arguments: z.object({
