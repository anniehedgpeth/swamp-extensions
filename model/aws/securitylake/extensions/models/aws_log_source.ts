...
/**
 * Swamp extension model for SecurityLake AwsLogSource (AWS::SecurityLake::AwsLogSource).
 *
...
/** Swamp extension model for SecurityLake AwsLogSource. Registered at `@swamp/aws/securitylake/aws-log-source`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SecurityLake AwsLogSource resources",
      arguments: z.object({
