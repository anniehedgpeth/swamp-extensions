...
/**
 * Swamp extension model for Billing BillingView (AWS::Billing::BillingView).
 *
...
/** Swamp extension model for Billing BillingView. Registered at `@swamp/aws/billing/billing-view`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Billing BillingView resources",
      arguments: z.object({
