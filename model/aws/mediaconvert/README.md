...
Use `swamp model type describe @swamp/aws/mediaconvert/preset` to see the full
...
```bash
# Create a new preset model
swamp model create @swamp/aws/mediaconvert/preset my-preset

# Edit the model to configure its properties
swamp model edit my-preset

# Create the resource in AWS
swamp model method run my-preset create

# Sync current state from AWS
swamp model method run my-preset sync
```
