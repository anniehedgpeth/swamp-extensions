...
// Auto-generated extension model for @swamp/aws/connect/data-table-attribute
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Connect DataTableAttribute (AWS::Connect::DataTableAttribute).
 *
...
const GlobalArgsSchema = z.object({
  ...
  Validation: z.object({
    ...
    MinValues: z.number().int().min(0).optional(),
    MaxValues: z.number().int().min(0).optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "Connect DataTableAttribute resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Connect DataTableAttribute",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Connect DataTableAttribute",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Connect DataTableAttribute",
        ),
      }),
    ...
    update: {
      description: "Update a Connect DataTableAttribute",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Connect DataTableAttribute",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Connect DataTableAttribute",
        ),
    ...
    sync: {
      description: "Sync Connect DataTableAttribute state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Connect DataTableAttribute resources",
      arguments: z.object({
