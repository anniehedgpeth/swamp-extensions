...
/**
 * Swamp extension model for Connect PredefinedAttribute (AWS::Connect::PredefinedAttribute).
 *
...
/** Swamp extension model for Connect PredefinedAttribute. Registered at `@swamp/aws/connect/predefined-attribute`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Connect PredefinedAttribute resources",
      arguments: z.object({
