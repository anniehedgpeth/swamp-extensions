...
Use `swamp model type describe @swamp/aws/serverlessrepo/application` to see the
...
swamp model create @swamp/aws/serverlessrepo/application my-application

# Edit the model to configure its properties
swamp model edit my-application

# Create the resource in AWS
swamp model method run my-application create

# Sync current state from AWS
swamp model method run my-application sync
```
