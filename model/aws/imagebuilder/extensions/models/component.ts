...
/**
 * Swamp extension model for ImageBuilder Component (AWS::ImageBuilder::Component).
 *
...
/** Swamp extension model for ImageBuilder Component. Registered at `@swamp/aws/imagebuilder/component`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ImageBuilder Component resources",
      arguments: z.object({
