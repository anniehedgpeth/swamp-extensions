...
/**
 * Swamp extension model for ImageBuilder Workflow (AWS::ImageBuilder::Workflow).
 *
...
/** Swamp extension model for ImageBuilder Workflow. Registered at `@swamp/aws/imagebuilder/workflow`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ImageBuilder Workflow resources",
      arguments: z.object({
