...
Use `swamp model type describe @swamp/aws/networkflowmonitor/monitor` to see the
...
```bash
# Create a new monitor model
swamp model create @swamp/aws/networkflowmonitor/monitor my-monitor

# Edit the model to configure its properties
swamp model edit my-monitor

# Create the resource in AWS
swamp model method run my-monitor create

# Sync current state from AWS
swamp model method run my-monitor sync
```
