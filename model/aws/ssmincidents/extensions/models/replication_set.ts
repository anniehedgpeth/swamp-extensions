...
// Auto-generated extension model for @swamp/aws/ssmincidents/replication-set
...
const GlobalArgsSchema = z.object({
  ...
  Regions: z.array(ReplicationRegionSchema).describe(
    "The ReplicationSet configuration.",
  ),
  DeletionProtected: z.boolean().describe(
    "Configures the ReplicationSet deletion protection.",
  ).optional(),
  Tags: z.array(TagSchema).describe("The tags to apply to the replication set.")
    .optional(),
});

const StateSchema = z.object({
  Arn: z.string(),
  Regions: z.array(ReplicationRegionSchema).optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "SSMIncidents ReplicationSet resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a SSMIncidents ReplicationSet",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a SSMIncidents ReplicationSet",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the SSMIncidents ReplicationSet",
        ),
      }),
    ...
    update: {
      description: "Update a SSMIncidents ReplicationSet",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a SSMIncidents ReplicationSet",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the SSMIncidents ReplicationSet",
        ),
    ...
    sync: {
      description: "Sync SSMIncidents ReplicationSet state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List SSMIncidents ReplicationSet resources",
      arguments: z.object({
