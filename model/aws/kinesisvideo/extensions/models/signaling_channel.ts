...
/**
 * Swamp extension model for KinesisVideo SignalingChannel (AWS::KinesisVideo::SignalingChannel).
 *
...
/** Swamp extension model for KinesisVideo SignalingChannel. Registered at `@swamp/aws/kinesisvideo/signaling-channel`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List KinesisVideo SignalingChannel resources",
      arguments: z.object({
