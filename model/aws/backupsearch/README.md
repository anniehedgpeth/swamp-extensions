...
Use `swamp model type describe @swamp/aws/backupsearch/search_job` to see the
...
```bash
# Create a new search_job model
swamp model create @swamp/aws/backupsearch/search_job my-search_job

# Edit the model to configure its properties
swamp model edit my-search_job

# Create the resource in AWS
swamp model method run my-search_job create

# Sync current state from AWS
swamp model method run my-search_job sync
```
