...
/**
 * Swamp extension model for MediaConnect BridgeOutput (AWS::MediaConnect::BridgeOutput).
 *
...
/** Swamp extension model for MediaConnect BridgeOutput. Registered at `@swamp/aws/mediaconnect/bridge-output`. */
export const model = {
