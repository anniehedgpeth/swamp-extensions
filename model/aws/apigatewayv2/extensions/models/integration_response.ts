...
/**
 * Swamp extension model for ApiGatewayV2 IntegrationResponse (AWS::ApiGatewayV2::IntegrationResponse).
 *
...
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ApiGatewayV2 IntegrationResponse resources",
      arguments: z.object({
