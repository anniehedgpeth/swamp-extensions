...
/**
 * Swamp extension model for Detective OrganizationAdmin (AWS::Detective::OrganizationAdmin).
 *
...
/** Swamp extension model for Detective OrganizationAdmin. Registered at `@swamp/aws/detective/organization-admin`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Detective OrganizationAdmin resources",
      arguments: z.object({
