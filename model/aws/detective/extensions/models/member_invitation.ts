...
/**
 * Swamp extension model for Detective MemberInvitation (AWS::Detective::MemberInvitation).
 *
...
/** Swamp extension model for Detective MemberInvitation. Registered at `@swamp/aws/detective/member-invitation`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Detective MemberInvitation resources",
      arguments: z.object({
