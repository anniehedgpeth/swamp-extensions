...
/**
 * Swamp extension model for CloudFront TrustStore (AWS::CloudFront::TrustStore).
 *
...
const CaCertificatesBundleS3LocationSchema = z.object({
...
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CloudFront TrustStore resources",
      arguments: z.object({
