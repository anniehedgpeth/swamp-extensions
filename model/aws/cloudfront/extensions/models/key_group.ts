...
/**
 * Swamp extension model for CloudFront KeyGroup (AWS::CloudFront::KeyGroup).
 *
...
/** Swamp extension model for CloudFront KeyGroup. Registered at `@swamp/aws/cloudfront/key-group`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CloudFront KeyGroup resources",
      arguments: z.object({
