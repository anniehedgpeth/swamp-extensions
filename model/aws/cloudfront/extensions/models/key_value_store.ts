...
// Auto-generated extension model for @swamp/aws/cloudfront/key-value-store
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for CloudFront KeyValueStore (AWS::CloudFront::KeyValueStore).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "CloudFront KeyValueStore resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a CloudFront KeyValueStore",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a CloudFront KeyValueStore",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the CloudFront KeyValueStore",
        ),
      }),
    ...
    update: {
      description: "Update a CloudFront KeyValueStore",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a CloudFront KeyValueStore",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the CloudFront KeyValueStore",
        ),
    ...
    sync: {
      description: "Sync CloudFront KeyValueStore state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List CloudFront KeyValueStore resources",
      arguments: z.object({
