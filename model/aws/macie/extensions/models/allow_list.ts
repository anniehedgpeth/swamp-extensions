...
// Auto-generated extension model for @swamp/aws/macie/allow-list
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Macie AllowList (AWS::Macie::AllowList).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Macie AllowList resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Macie AllowList",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Macie AllowList",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Macie AllowList",
        ),
      }),
    ...
    update: {
      description: "Update a Macie AllowList",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Macie AllowList",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Macie AllowList",
        ),
    ...
    sync: {
      description: "Sync Macie AllowList state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Macie AllowList resources",
      arguments: z.object({
