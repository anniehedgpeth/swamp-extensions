...
/**
 * Swamp extension model for S3Outposts Endpoint (AWS::S3Outposts::Endpoint).
 *
...
/** Swamp extension model for S3Outposts Endpoint. Registered at `@swamp/aws/s3outposts/endpoint`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List S3Outposts Endpoint resources",
      arguments: z.object({
