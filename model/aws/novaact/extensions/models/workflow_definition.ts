...
/**
 * Swamp extension model for NovaAct WorkflowDefinition (AWS::NovaAct::WorkflowDefinition).
 *
...
/** Swamp extension model for NovaAct WorkflowDefinition. Registered at `@swamp/aws/novaact/workflow-definition`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List NovaAct WorkflowDefinition resources",
      arguments: z.object({
