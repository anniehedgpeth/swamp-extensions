...
/**
 * Swamp extension model for IoTFleetWise StateTemplate (AWS::IoTFleetWise::StateTemplate).
 *
...
/** Swamp extension model for IoTFleetWise StateTemplate. Registered at `@swamp/aws/iotfleetwise/state-template`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IoTFleetWise StateTemplate resources",
      arguments: z.object({
