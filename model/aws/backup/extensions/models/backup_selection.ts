...
/**
 * Swamp extension model for Backup BackupSelection (AWS::Backup::BackupSelection).
 *
...
const ConditionResourceTypeSchema = z.object({
  ConditionKey: z.string(),
  ConditionValue: z.string(),
  ConditionType: z.string(),
});

const ConditionParameterSchema = z.object({
...
/** Swamp extension model for Backup BackupSelection. Registered at `@swamp/aws/backup/backup-selection`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Backup BackupSelection resources",
      arguments: z.object({
