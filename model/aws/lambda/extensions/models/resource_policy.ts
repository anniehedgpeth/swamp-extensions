...
// Auto-generated extension model for @swamp/aws/lambda/resource-policy
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Lambda ResourcePolicy (AWS::Lambda::ResourcePolicy).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Lambda ResourcePolicy resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Lambda ResourcePolicy",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Lambda ResourcePolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Lambda ResourcePolicy",
        ),
      }),
    ...
    update: {
      description: "Update a Lambda ResourcePolicy",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Lambda ResourcePolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Lambda ResourcePolicy",
        ),
    ...
    sync: {
      description: "Sync Lambda ResourcePolicy state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
