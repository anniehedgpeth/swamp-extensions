...
/**
 * Swamp extension model for Lambda Url (AWS::Lambda::Url).
 *
...
/** Swamp extension model for Lambda Url. Registered at `@swamp/aws/lambda/url`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Lambda Url resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::Lambda::Url", {
