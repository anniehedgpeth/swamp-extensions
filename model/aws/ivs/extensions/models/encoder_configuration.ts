...
/**
 * Swamp extension model for IVS EncoderConfiguration (AWS::IVS::EncoderConfiguration).
 *
...
/** Swamp extension model for IVS EncoderConfiguration. Registered at `@swamp/aws/ivs/encoder-configuration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IVS EncoderConfiguration resources",
      arguments: z.object({
