...
/**
 * Swamp extension model for IVS IngestConfiguration (AWS::IVS::IngestConfiguration).
 *
...
/** Swamp extension model for IVS IngestConfiguration. Registered at `@swamp/aws/ivs/ingest-configuration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IVS IngestConfiguration resources",
      arguments: z.object({
