...
/**
 * Swamp extension model for IVS PublicKey (AWS::IVS::PublicKey).
 *
...
/** Swamp extension model for IVS PublicKey. Registered at `@swamp/aws/ivs/public-key`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IVS PublicKey resources",
      arguments: z.object({
