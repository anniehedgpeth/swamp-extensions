...
/**
 * Swamp extension model for IVS Channel (AWS::IVS::Channel).
 *
...
/** Swamp extension model for IVS Channel. Registered at `@swamp/aws/ivs/channel`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List IVS Channel resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::IVS::Channel", {
