...
/**
 * Swamp extension model for AppSync SourceApiAssociation (AWS::AppSync::SourceApiAssociation).
 *
...
/** Swamp extension model for AppSync SourceApiAssociation. Registered at `@swamp/aws/appsync/source-api-association`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AppSync SourceApiAssociation resources",
      arguments: z.object({
