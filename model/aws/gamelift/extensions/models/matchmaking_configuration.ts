...
/**
 * Swamp extension model for GameLift MatchmakingConfiguration (AWS::GameLift::MatchmakingConfiguration).
 *
...
const GamePropertySchema = z.object({
...
/** Swamp extension model for GameLift MatchmakingConfiguration. Registered at `@swamp/aws/gamelift/matchmaking-configuration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List GameLift MatchmakingConfiguration resources",
      arguments: z.object({
