...
/**
 * Swamp extension model for GameLift Script (AWS::GameLift::Script).
 *
...
/** Swamp extension model for GameLift Script. Registered at `@swamp/aws/gamelift/script`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List GameLift Script resources",
      arguments: z.object({
