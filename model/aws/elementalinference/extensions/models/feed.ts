...
// Auto-generated extension model for @swamp/aws/elementalinference/feed
...
const GlobalArgsSchema = z.object({
  ...
  Outputs: z.array(GetOutputSchema),
...
const StateSchema = z.object({
  ...
  Outputs: z.array(GetOutputSchema).optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "ElementalInference Feed resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a ElementalInference Feed",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a ElementalInference Feed",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the ElementalInference Feed",
        ),
      }),
    ...
    update: {
      description: "Update a ElementalInference Feed",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a ElementalInference Feed",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the ElementalInference Feed",
        ),
    ...
    sync: {
      description: "Sync ElementalInference Feed state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List ElementalInference Feed resources",
      arguments: z.object({
