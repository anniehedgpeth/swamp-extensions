...
/**
 * Swamp extension model for ResilienceHub ResiliencyPolicy (AWS::ResilienceHub::ResiliencyPolicy).
 *
...
/** Swamp extension model for ResilienceHub ResiliencyPolicy. Registered at `@swamp/aws/resiliencehub/resiliency-policy`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List ResilienceHub ResiliencyPolicy resources",
      arguments: z.object({
