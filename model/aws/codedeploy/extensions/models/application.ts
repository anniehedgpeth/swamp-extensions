...
/**
 * Swamp extension model for CodeDeploy Application (AWS::CodeDeploy::Application).
 *
...
/** Swamp extension model for CodeDeploy Application. Registered at `@swamp/aws/codedeploy/application`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CodeDeploy Application resources",
      arguments: z.object({
