...
/**
 * Swamp extension model for M2 Application (AWS::M2::Application).
 *
...
/** Swamp extension model for M2 Application. Registered at `@swamp/aws/m2/application`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List M2 Application resources",
      arguments: z.object({
