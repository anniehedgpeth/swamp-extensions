...
/**
 * Swamp extension model for CloudFormation ResourceDefaultVersion (AWS::CloudFormation::ResourceDefaultVersion).
 *
...
/** Swamp extension model for CloudFormation ResourceDefaultVersion. Registered at `@swamp/aws/cloudformation/resource-default-version`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CloudFormation ResourceDefaultVersion resources",
      arguments: z.object({
