...
/**
 * Swamp extension model for CloudFormation HookDefaultVersion (AWS::CloudFormation::HookDefaultVersion).
 *
...
/** Swamp extension model for CloudFormation HookDefaultVersion. Registered at `@swamp/aws/cloudformation/hook-default-version`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CloudFormation HookDefaultVersion resources",
      arguments: z.object({
