...
// Auto-generated extension model for @swamp/aws/cloudformation/resource-version
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for CloudFormation ResourceVersion (AWS::CloudFormation::ResourceVersion).
 *
...
const GlobalArgsSchema = z.object({
  ...
  LoggingConfig: z.object({
    ...
    .optional(),
  SchemaHandlerPackage: z.string().describe(
...
/** Swamp extension model for CloudFormation ResourceVersion. Registered at `@swamp/aws/cloudformation/resource-version`. */
export const model = {
  type: "@swamp/aws/cloudformation/resource-version",
  version: "2026.08.17.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "CloudFormation ResourceVersion resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a CloudFormation ResourceVersion",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a CloudFormation ResourceVersion",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the CloudFormation ResourceVersion",
        ),
      }),
    ...
    delete: {
      description: "Delete a CloudFormation ResourceVersion",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the CloudFormation ResourceVersion",
        ),
    ...
    sync: {
      description: "Sync CloudFormation ResourceVersion state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List CloudFormation ResourceVersion resources",
      arguments: z.object({
