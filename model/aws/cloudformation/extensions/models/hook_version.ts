...
/**
 * Swamp extension model for CloudFormation HookVersion (AWS::CloudFormation::HookVersion).
 *
...
/** Swamp extension model for CloudFormation HookVersion. Registered at `@swamp/aws/cloudformation/hook-version`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CloudFormation HookVersion resources",
      arguments: z.object({
