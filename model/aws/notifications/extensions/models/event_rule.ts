...
/**
 * Swamp extension model for Notifications EventRule (AWS::Notifications::EventRule).
 *
...
/** Swamp extension model for Notifications EventRule. Registered at `@swamp/aws/notifications/event-rule`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Notifications EventRule resources",
      arguments: z.object({
