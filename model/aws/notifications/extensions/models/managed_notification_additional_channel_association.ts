...
// Auto-generated extension model for @swamp/aws/notifications/managed-notification-additional-channel-association
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Notifications ManagedNotificationAdditionalChannelAssociation (AWS::Notifications::ManagedNotificationAdditionalChannelAssociation).
 *
...
/** Swamp extension model for Notifications ManagedNotificationAdditionalChannelAssociation. Registered at `@swamp/aws/notifications/managed-notification-additional-channel-association`. */
export const model = {
  type:
  ...
  resources: {
    state: {
      description:
        "Notifications ManagedNotificationAdditionalChannelAssociation resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Notifications ManagedNotificationAdditionalChannelAssociation",
        ),
      }),
    ...
    list: {
      description:
        "List Notifications ManagedNotificationAdditionalChannelAssociation resources",
      arguments: z.object({
