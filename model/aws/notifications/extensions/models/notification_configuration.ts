...
/**
 * Swamp extension model for Notifications NotificationConfiguration (AWS::Notifications::NotificationConfiguration).
 *
...
/** Swamp extension model for Notifications NotificationConfiguration. Registered at `@swamp/aws/notifications/notification-configuration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Notifications NotificationConfiguration resources",
      arguments: z.object({
