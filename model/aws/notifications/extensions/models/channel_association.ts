...
/**
 * Swamp extension model for Notifications ChannelAssociation (AWS::Notifications::ChannelAssociation).
 *
...
/** Swamp extension model for Notifications ChannelAssociation. Registered at `@swamp/aws/notifications/channel-association`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Notifications ChannelAssociation resources",
      arguments: z.object({
