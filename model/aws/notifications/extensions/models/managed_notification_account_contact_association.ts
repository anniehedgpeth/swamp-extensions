...
/**
 * Swamp extension model for Notifications ManagedNotificationAccountContactAssociation (AWS::Notifications::ManagedNotificationAccountContactAssociation).
 *
...
/** Swamp extension model for Notifications ManagedNotificationAccountContactAssociation. Registered at `@swamp/aws/notifications/managed-notification-account-contact-association`. */
export const model = {
  type:
  ...
  methods: {
    ...
    list: {
      description:
        "List Notifications ManagedNotificationAccountContactAssociation resources",
      arguments: z.object({
