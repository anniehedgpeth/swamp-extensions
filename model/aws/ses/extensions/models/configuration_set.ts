...
/**
 * Swamp extension model for SES ConfigurationSet (AWS::SES::ConfigurationSet).
 *
...
const GuardianOptionsSchema = z.object({
...
/** Swamp extension model for SES ConfigurationSet. Registered at `@swamp/aws/ses/configuration-set`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SES ConfigurationSet resources",
      arguments: z.object({
