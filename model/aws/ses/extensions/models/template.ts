...
/**
 * Swamp extension model for SES Template (AWS::SES::Template).
 *
...
/** Swamp extension model for SES Template. Registered at `@swamp/aws/ses/template`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SES Template resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::SES::Template", {
