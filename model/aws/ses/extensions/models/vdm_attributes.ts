...
/**
 * Swamp extension model for SES VdmAttributes (AWS::SES::VdmAttributes).
 *
...
/** Swamp extension model for SES VdmAttributes. Registered at `@swamp/aws/ses/vdm-attributes`. */
export const model = {
