...
/**
 * Swamp extension model for Forecast Dataset (AWS::Forecast::Dataset).
 *
...
/** Swamp extension model for Forecast Dataset. Registered at `@swamp/aws/forecast/dataset`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Forecast Dataset resources",
      arguments: z.object({
