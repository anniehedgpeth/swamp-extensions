...
/**
 * Swamp extension model for Bedrock FlowAlias (AWS::Bedrock::FlowAlias).
 *
...
const FlowAliasRoutingConfigurationListItemSchema = z.object({
...
/** Swamp extension model for Bedrock FlowAlias. Registered at `@swamp/aws/bedrock/flow-alias`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Bedrock FlowAlias resources",
      arguments: z.object({
