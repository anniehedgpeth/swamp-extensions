...
/**
 * Swamp extension model for Bedrock Flow (AWS::Bedrock::Flow).
 *
...
/** Swamp extension model for Bedrock Flow. Registered at `@swamp/aws/bedrock/flow`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Bedrock Flow resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::Bedrock::Flow", {
