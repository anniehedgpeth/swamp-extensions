...
/**
 * Swamp extension model for DataZone EnvironmentActions (AWS::DataZone::EnvironmentActions).
 *
...
/** Swamp extension model for DataZone EnvironmentActions. Registered at `@swamp/aws/datazone/environment-actions`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List DataZone EnvironmentActions resources",
      arguments: z.object({
