...
/**
 * Swamp extension model for DataZone DomainUnit (AWS::DataZone::DomainUnit).
 *
...
/** Swamp extension model for DataZone DomainUnit. Registered at `@swamp/aws/datazone/domain-unit`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List DataZone DomainUnit resources",
      arguments: z.object({
