...
/**
 * Swamp extension model for DataZone Environment (AWS::DataZone::Environment).
 *
...
/** Swamp extension model for DataZone Environment. Registered at `@swamp/aws/datazone/environment`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List DataZone Environment resources",
      arguments: z.object({
