...
// Auto-generated extension model for @swamp/aws/datazone/group-profile
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for DataZone GroupProfile (AWS::DataZone::GroupProfile).
 *
...
const GlobalArgsSchema = z.object({
  ...
  GroupIdentifier: z.string().regex(
    new RegExp(
...
export const model = {
  ...
  resources: {
    state: {
      description: "DataZone GroupProfile resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a DataZone GroupProfile",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a DataZone GroupProfile",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the DataZone GroupProfile",
        ),
      }),
    ...
    update: {
      description: "Update a DataZone GroupProfile",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a DataZone GroupProfile",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the DataZone GroupProfile",
        ),
    ...
    sync: {
      description: "Sync DataZone GroupProfile state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List DataZone GroupProfile resources",
      arguments: z.object({
