...
/**
 * Swamp extension model for SecurityHub Hub (AWS::SecurityHub::Hub).
 *
...
/** Swamp extension model for SecurityHub Hub. Registered at `@swamp/aws/securityhub/hub`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SecurityHub Hub resources",
      arguments: z.object({
