...
/**
 * Swamp extension model for AmplifyUIBuilder Theme (AWS::AmplifyUIBuilder::Theme).
 *
...
/** Swamp extension model for AmplifyUIBuilder Theme. Registered at `@swamp/aws/amplifyuibuilder/theme`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AmplifyUIBuilder Theme resources",
      arguments: z.object({
