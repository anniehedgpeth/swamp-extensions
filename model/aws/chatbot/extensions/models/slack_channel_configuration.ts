...
/**
 * Swamp extension model for Chatbot SlackChannelConfiguration (AWS::Chatbot::SlackChannelConfiguration).
 *
...
/** Swamp extension model for Chatbot SlackChannelConfiguration. Registered at `@swamp/aws/chatbot/slack-channel-configuration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Chatbot SlackChannelConfiguration resources",
      arguments: z.object({
