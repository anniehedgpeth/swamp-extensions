...
/**
 * Swamp extension model for AmazonMQ Configuration (AWS::AmazonMQ::Configuration).
 *
...
/** Swamp extension model for AmazonMQ Configuration. Registered at `@swamp/aws/amazonmq/configuration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AmazonMQ Configuration resources",
      arguments: z.object({
