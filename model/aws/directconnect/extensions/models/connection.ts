...
/**
 * Swamp extension model for DirectConnect Connection (AWS::DirectConnect::Connection).
 *
...
/** Swamp extension model for DirectConnect Connection. Registered at `@swamp/aws/directconnect/connection`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List DirectConnect Connection resources",
      arguments: z.object({
