...
Use `swamp model type describe @swamp/aws/controlcatalog/objective` to see the
...
```bash
# Create a new objective model
swamp model create @swamp/aws/controlcatalog/objective my-objective

# Edit the model to configure its properties
swamp model edit my-objective

# Create the resource in AWS
swamp model method run my-objective create

# Sync current state from AWS
swamp model method run my-objective sync
```
