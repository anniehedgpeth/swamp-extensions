...
/**
 * Swamp extension model for AppIntegrations EventIntegration (AWS::AppIntegrations::EventIntegration).
 *
...
/** Swamp extension model for AppIntegrations EventIntegration. Registered at `@swamp/aws/appintegrations/event-integration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List AppIntegrations EventIntegration resources",
      arguments: z.object({
