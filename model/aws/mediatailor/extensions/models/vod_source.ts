...
/**
 * Swamp extension model for MediaTailor VodSource (AWS::MediaTailor::VodSource).
 *
...
/** Swamp extension model for MediaTailor VodSource. Registered at `@swamp/aws/mediatailor/vod-source`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List MediaTailor VodSource resources",
      arguments: z.object({
