...
/**
 * Swamp extension model for EventSchemas Schema (AWS::EventSchemas::Schema).
 *
...
/** Swamp extension model for EventSchemas Schema. Registered at `@swamp/aws/eventschemas/schema`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EventSchemas Schema resources",
      arguments: z.object({
