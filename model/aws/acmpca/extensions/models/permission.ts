...
/**
 * Swamp extension model for ACMPCA Permission (AWS::ACMPCA::Permission).
 *
...
/** Swamp extension model for ACMPCA Permission. Registered at `@swamp/aws/acmpca/permission`. */
export const model = {
