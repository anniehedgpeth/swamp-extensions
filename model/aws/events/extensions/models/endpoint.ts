...
/**
 * Swamp extension model for Events Endpoint (AWS::Events::Endpoint).
 *
...
const EndpointEventBusSchema = z.object({
...
/** Swamp extension model for Events Endpoint. Registered at `@swamp/aws/events/endpoint`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Events Endpoint resources",
      arguments: z.object({
