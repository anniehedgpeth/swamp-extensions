...
// Auto-generated extension model for @swamp/aws/rtbfabric/inbound-external-link
...
export const model = {
  ...
  resources: {
    state: {
      description: "RTBFabric InboundExternalLink resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a RTBFabric InboundExternalLink",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a RTBFabric InboundExternalLink",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the RTBFabric InboundExternalLink",
        ),
      }),
    ...
    update: {
      description: "Update a RTBFabric InboundExternalLink",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a RTBFabric InboundExternalLink",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the RTBFabric InboundExternalLink",
        ),
    ...
    sync: {
      description: "Sync RTBFabric InboundExternalLink state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List RTBFabric InboundExternalLink resources",
      arguments: z.object({
