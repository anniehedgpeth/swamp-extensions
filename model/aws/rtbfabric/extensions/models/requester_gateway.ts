...
/**
 * Swamp extension model for RTBFabric RequesterGateway (AWS::RTBFabric::RequesterGateway).
 *
...
/** Swamp extension model for RTBFabric RequesterGateway. Registered at `@swamp/aws/rtbfabric/requester-gateway`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List RTBFabric RequesterGateway resources",
      arguments: z.object({
