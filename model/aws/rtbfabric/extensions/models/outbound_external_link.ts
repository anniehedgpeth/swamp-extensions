...
// Auto-generated extension model for @swamp/aws/rtbfabric/outbound-external-link
...
const GlobalArgsSchema = z.object({
  ...
  PublicEndpoint: z.string().min(0).max(255).regex(
...
export const model = {
  ...
  resources: {
    state: {
      description: "RTBFabric OutboundExternalLink resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a RTBFabric OutboundExternalLink",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a RTBFabric OutboundExternalLink",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the RTBFabric OutboundExternalLink",
        ),
      }),
    ...
    update: {
      description: "Update a RTBFabric OutboundExternalLink",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a RTBFabric OutboundExternalLink",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the RTBFabric OutboundExternalLink",
        ),
    ...
    sync: {
      description: "Sync RTBFabric OutboundExternalLink state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List RTBFabric OutboundExternalLink resources",
      arguments: z.object({
