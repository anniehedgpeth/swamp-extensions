...
Use `swamp model type describe @swamp/aws/iotsecuretunneling/tunnel` to see the
...
```bash
# Create a new tunnel model
swamp model create @swamp/aws/iotsecuretunneling/tunnel my-tunnel

# Edit the model to configure its properties
swamp model edit my-tunnel

# Create the resource in AWS
swamp model method run my-tunnel create

# Sync current state from AWS
swamp model method run my-tunnel sync
```
