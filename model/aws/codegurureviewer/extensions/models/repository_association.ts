...
/**
 * Swamp extension model for CodeGuruReviewer RepositoryAssociation (AWS::CodeGuruReviewer::RepositoryAssociation).
 *
...
/** Swamp extension model for CodeGuruReviewer RepositoryAssociation. Registered at `@swamp/aws/codegurureviewer/repository-association`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CodeGuruReviewer RepositoryAssociation resources",
      arguments: z.object({
