...
/**
 * Swamp extension model for APS Scraper (AWS::APS::Scraper).
 *
...
const ScraperComponentSchema = z.object({
...
const ScraperLoggingDestinationSchema = z.object({
...
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List APS Scraper resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::APS::Scraper", {
