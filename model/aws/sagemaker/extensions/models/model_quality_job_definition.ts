...
// Auto-generated extension model for @swamp/aws/sagemaker/model-quality-job-definition
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for SageMaker ModelQualityJobDefinition (AWS::SageMaker::ModelQualityJobDefinition).
 *
...
const GlobalArgsSchema = z.object({
  ...
  ModelQualityBaselineConfig: z.object({
  ...
  ModelQualityAppSpecification: z.object({
  ...
  ModelQualityJobOutputConfig: z.object({
...
/** Swamp extension model for SageMaker ModelQualityJobDefinition. Registered at `@swamp/aws/sagemaker/model-quality-job-definition`. */
export const model = {
  type: "@swamp/aws/sagemaker/model-quality-job-definition",
  ...
  resources: {
    state: {
      description: "SageMaker ModelQualityJobDefinition resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a SageMaker ModelQualityJobDefinition",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a SageMaker ModelQualityJobDefinition",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the SageMaker ModelQualityJobDefinition",
        ),
      }),
    ...
    delete: {
      description: "Delete a SageMaker ModelQualityJobDefinition",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the SageMaker ModelQualityJobDefinition",
        ),
    ...
    sync: {
      description: "Sync SageMaker ModelQualityJobDefinition state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List SageMaker ModelQualityJobDefinition resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        for (let i = 0; i < items.length; i++) {
          const item = items[i];
          const instanceName =
            (item.properties?.JobDefinitionArn?.toString() ?? item.identifier)
