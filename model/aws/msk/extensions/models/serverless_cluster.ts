...
// Auto-generated extension model for @swamp/aws/msk/serverless-cluster
...
const GlobalArgsSchema = z.object({
  ...
  VpcConfigs: z.array(VpcConfigSchema),
...
const StateSchema = z.object({
  ...
  VpcConfigs: z.array(VpcConfigSchema).optional(),
  ClientAuthentication: z.object({
    Sasl: SaslSchema,
  }).optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "MSK ServerlessCluster resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a MSK ServerlessCluster",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a MSK ServerlessCluster",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the MSK ServerlessCluster",
        ),
      }),
    ...
    delete: {
      description: "Delete a MSK ServerlessCluster",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the MSK ServerlessCluster",
        ),
    ...
    sync: {
      description: "Sync MSK ServerlessCluster state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List MSK ServerlessCluster resources",
      arguments: z.object({
