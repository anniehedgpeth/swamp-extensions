...
/**
 * Swamp extension model for OpenSearchServerless SecurityConfig (AWS::OpenSearchServerless::SecurityConfig).
 *
...
/** Swamp extension model for OpenSearchServerless SecurityConfig. Registered at `@swamp/aws/opensearchserverless/security-config`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List OpenSearchServerless SecurityConfig resources",
      arguments: z.object({
