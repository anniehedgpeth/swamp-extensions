...
/**
 * Swamp extension model for OpenSearchServerless VpcEndpoint (AWS::OpenSearchServerless::VpcEndpoint).
 *
...
/** Swamp extension model for OpenSearchServerless VpcEndpoint. Registered at `@swamp/aws/opensearchserverless/vpc-endpoint`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List OpenSearchServerless VpcEndpoint resources",
      arguments: z.object({
