...
// Auto-generated extension model for @swamp/aws/opensearchserverless/collection-group
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for OpenSearchServerless CollectionGroup (AWS::OpenSearchServerless::CollectionGroup).
 *
...
const GlobalArgsSchema = z.object({
  ...
  Name: z.string().min(3).max(32).regex(new RegExp("^[a-z][a-z0-9-]{2,31}$"))
    .describe("The name of the collection group."),
  ...
  CapacityLimits: z.object({
    ...
    MaxIndexingCapacityInOcu: z.number().describe(
      "The maximum indexing capacity for collections in the group.",
    ).optional(),
    MinSearchCapacityInOcu: z.number().describe(
      "The minimum search capacity for collections in the group.",
    ).optional(),
    MinIndexingCapacityInOcu: z.number().describe(
...
const StateSchema = z.object({
  ...
  CapacityLimits: z.object({
    ...
    MinSearchCapacityInOcu: z.number(),
    MinIndexingCapacityInOcu: z.number(),
  }).optional(),
...
const InputsSchema = z.object({
  ...
  Name: z.string().min(3).max(32).regex(new RegExp("^[a-z][a-z0-9-]{2,31}$"))
    .describe("The name of the collection group.").optional(),
  Description: z.string().max(1000).describe(
    "The description of the collection group.",
  ).optional(),
  StandbyReplicas: z.enum(["ENABLED", "DISABLED"]).describe(
...
export const model = {
  ...
  resources: {
    state: {
      description: "OpenSearchServerless CollectionGroup resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a OpenSearchServerless CollectionGroup",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a OpenSearchServerless CollectionGroup",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the OpenSearchServerless CollectionGroup",
        ),
      }),
    ...
    update: {
      description: "Update a OpenSearchServerless CollectionGroup",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a OpenSearchServerless CollectionGroup",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the OpenSearchServerless CollectionGroup",
        ),
    ...
    sync: {
      description: "Sync OpenSearchServerless CollectionGroup state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List OpenSearchServerless CollectionGroup resources",
      arguments: z.object({
