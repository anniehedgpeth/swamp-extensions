...
Use `swamp model type describe @swamp/aws/textract/adapter` to see the full list
...
swamp model create @swamp/aws/textract/adapter my-adapter

# Edit the model to configure its properties
swamp model edit my-adapter

# Create the resource in AWS
swamp model method run my-adapter create

# Sync current state from AWS
swamp model method run my-adapter sync
```
