...
/**
 * Swamp extension model for RDS Integration (AWS::RDS::Integration).
 *
...
/** Swamp extension model for RDS Integration. Registered at `@swamp/aws/rds/integration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List RDS Integration resources",
      arguments: z.object({
