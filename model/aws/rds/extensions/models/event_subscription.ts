...
/**
 * Swamp extension model for RDS EventSubscription (AWS::RDS::EventSubscription).
 *
...
/** Swamp extension model for RDS EventSubscription. Registered at `@swamp/aws/rds/event-subscription`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List RDS EventSubscription resources",
      arguments: z.object({
