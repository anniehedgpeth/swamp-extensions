...
// Auto-generated extension model for @swamp/aws/rds/dbsubnet-group
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for RDS DBSubnetGroup (AWS::RDS::DBSubnetGroup).
 *
...
const GlobalArgsSchema = z.object({
  ...
  Tags: z.array(TagSchema).describe("Tags to assign to the DB subnet group.")
    .optional(),
});
...
export const model = {
  ...
  resources: {
    state: {
      description: "RDS DBSubnetGroup resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a RDS DBSubnetGroup",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a RDS DBSubnetGroup",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the RDS DBSubnetGroup",
        ),
      }),
    ...
    update: {
      description: "Update a RDS DBSubnetGroup",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a RDS DBSubnetGroup",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the RDS DBSubnetGroup",
        ),
    ...
    sync: {
      description: "Sync RDS DBSubnetGroup state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List RDS DBSubnetGroup resources",
      arguments: z.object({
