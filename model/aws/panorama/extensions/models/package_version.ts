...
/**
 * Swamp extension model for Panorama PackageVersion (AWS::Panorama::PackageVersion).
 *
...
/** Swamp extension model for Panorama PackageVersion. Registered at `@swamp/aws/panorama/package-version`. */
export const model = {
