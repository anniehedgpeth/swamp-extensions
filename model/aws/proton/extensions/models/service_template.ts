...
/**
 * Swamp extension model for Proton ServiceTemplate (AWS::Proton::ServiceTemplate).
 *
...
/** Swamp extension model for Proton ServiceTemplate. Registered at `@swamp/aws/proton/service-template`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Proton ServiceTemplate resources",
      arguments: z.object({
