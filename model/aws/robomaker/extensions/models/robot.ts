...
/**
 * Swamp extension model for RoboMaker Robot (AWS::RoboMaker::Robot).
 *
...
/** Swamp extension model for RoboMaker Robot. Registered at `@swamp/aws/robomaker/robot`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List RoboMaker Robot resources",
      arguments: z.object({
