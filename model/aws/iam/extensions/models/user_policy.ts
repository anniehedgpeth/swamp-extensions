...
// Auto-generated extension model for @swamp/aws/iam/user-policy
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for IAM UserPolicy (AWS::IAM::UserPolicy).
 *
...
/** Swamp extension model for IAM UserPolicy. Registered at `@swamp/aws/iam/user-policy`. */
export const model = {
  type: "@swamp/aws/iam/user-policy",
  ...
  resources: {
    state: {
      description: "IAM UserPolicy resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a IAM UserPolicy",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a IAM UserPolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the IAM UserPolicy",
        ),
      }),
    ...
    update: {
      description: "Update a IAM UserPolicy",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a IAM UserPolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the IAM UserPolicy",
        ),
    ...
    sync: {
      description: "Sync IAM UserPolicy state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
