...
/**
 * Swamp extension model for BedrockAgentCore WorkloadIdentity (AWS::BedrockAgentCore::WorkloadIdentity).
 *
...
/** Swamp extension model for BedrockAgentCore WorkloadIdentity. Registered at `@swamp/aws/bedrockagentcore/workload-identity`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List BedrockAgentCore WorkloadIdentity resources",
      arguments: z.object({
