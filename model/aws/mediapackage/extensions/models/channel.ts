...
/**
 * Swamp extension model for MediaPackage Channel (AWS::MediaPackage::Channel).
 *
...
const IngestEndpointSchema = z.object({
...
/** Swamp extension model for MediaPackage Channel. Registered at `@swamp/aws/mediapackage/channel`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List MediaPackage Channel resources",
      arguments: z.object({
