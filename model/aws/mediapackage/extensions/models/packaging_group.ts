...
/**
 * Swamp extension model for MediaPackage PackagingGroup (AWS::MediaPackage::PackagingGroup).
 *
...
/** Swamp extension model for MediaPackage PackagingGroup. Registered at `@swamp/aws/mediapackage/packaging-group`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List MediaPackage PackagingGroup resources",
      arguments: z.object({
