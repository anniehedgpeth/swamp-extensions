...
/**
 * Swamp extension model for MediaPackage Asset (AWS::MediaPackage::Asset).
 *
...
const EgressEndpointSchema = z.object({
...
/** Swamp extension model for MediaPackage Asset. Registered at `@swamp/aws/mediapackage/asset`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List MediaPackage Asset resources",
      arguments: z.object({
