...
Use `swamp model type describe @swamp/aws/cognitosync/dataset` to see the full
...
swamp model create @swamp/aws/cognitosync/dataset my-dataset

# Edit the model to configure its properties
swamp model edit my-dataset

# Create the resource in AWS
swamp model method run my-dataset create

# Sync current state from AWS
swamp model method run my-dataset sync
```
