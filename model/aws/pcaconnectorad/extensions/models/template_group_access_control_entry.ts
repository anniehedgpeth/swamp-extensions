...
/**
 * Swamp extension model for PCAConnectorAD TemplateGroupAccessControlEntry (AWS::PCAConnectorAD::TemplateGroupAccessControlEntry).
 *
...
/** Swamp extension model for PCAConnectorAD TemplateGroupAccessControlEntry. Registered at `@swamp/aws/pcaconnectorad/template-group-access-control-entry`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description:
        "List PCAConnectorAD TemplateGroupAccessControlEntry resources",
      arguments: z.object({
