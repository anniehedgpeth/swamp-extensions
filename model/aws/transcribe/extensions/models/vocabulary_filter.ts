...
// Auto-generated extension model for @swamp/aws/transcribe/vocabulary-filter
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Transcribe VocabularyFilter (AWS::Transcribe::VocabularyFilter).
 *
...
const GlobalArgsSchema = z.object({
  ...
  VocabularyFilterName: z.string().min(1).max(200).regex(
  ...
  Words: z.array(z.string().min(1).max(256)).describe(
  ...
  VocabularyFilterFileUri: z.string().min(1).max(2000).regex(
...
const StateSchema = z.object({
  ...
  VocabularyFilterFileUri: z.string().optional(),
...
const InputsSchema = z.object({
  ...
  VocabularyFilterName: z.string().min(1).max(200).regex(
    new RegExp("^[0-9a-zA-Z._-]+$"),
  ).describe("A unique name, chosen by you, for your custom vocabulary filter.")
    .optional(),
  LanguageCode: z.string().describe(
    "The language code that represents the language of the entries in your vocabulary filter.",
  ).optional(),
...
/** Swamp extension model for Transcribe VocabularyFilter. Registered at `@swamp/aws/transcribe/vocabulary-filter`. */
export const model = {
  type: "@swamp/aws/transcribe/vocabulary-filter",
  ...
  resources: {
    state: {
      description: "Transcribe VocabularyFilter resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Transcribe VocabularyFilter",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Transcribe VocabularyFilter",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Transcribe VocabularyFilter",
        ),
      }),
    ...
    update: {
      description: "Update a Transcribe VocabularyFilter",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Transcribe VocabularyFilter",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Transcribe VocabularyFilter",
        ),
    ...
    sync: {
      description: "Sync Transcribe VocabularyFilter state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Transcribe VocabularyFilter resources",
      arguments: z.object({
