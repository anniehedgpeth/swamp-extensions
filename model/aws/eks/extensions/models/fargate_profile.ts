...
/**
 * Swamp extension model for EKS FargateProfile (AWS::EKS::FargateProfile).
 *
...
/** Swamp extension model for EKS FargateProfile. Registered at `@swamp/aws/eks/fargate-profile`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EKS FargateProfile resources",
      arguments: z.object({
