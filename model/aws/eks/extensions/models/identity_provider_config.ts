...
/**
 * Swamp extension model for EKS IdentityProviderConfig (AWS::EKS::IdentityProviderConfig).
 *
...
const RequiredClaimSchema = z.object({
...
/** Swamp extension model for EKS IdentityProviderConfig. Registered at `@swamp/aws/eks/identity-provider-config`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EKS IdentityProviderConfig resources",
      arguments: z.object({
