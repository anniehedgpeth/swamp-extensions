...
/**
 * Swamp extension model for EKS Addon (AWS::EKS::Addon).
 *
...
const PodIdentityAssociationSchema = z.object({
...
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List EKS Addon resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::EKS::Addon", {
