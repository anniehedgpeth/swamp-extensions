...
// Auto-generated extension model for @swamp/aws/devopsagent/association
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for DevOpsAgent Association (AWS::DevOpsAgent::Association).
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "DevOpsAgent Association resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a DevOpsAgent Association",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a DevOpsAgent Association",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the DevOpsAgent Association",
        ),
      }),
    ...
    update: {
      description: "Update a DevOpsAgent Association",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a DevOpsAgent Association",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the DevOpsAgent Association",
        ),
    ...
    sync: {
      description: "Sync DevOpsAgent Association state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List DevOpsAgent Association resources",
      arguments: z.object({
