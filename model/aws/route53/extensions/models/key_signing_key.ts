...
/**
 * Swamp extension model for Route53 KeySigningKey (AWS::Route53::KeySigningKey).
 *
...
/** Swamp extension model for Route53 KeySigningKey. Registered at `@swamp/aws/route53/key-signing-key`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Route53 KeySigningKey resources",
      arguments: z.object({
