...
/**
 * Swamp extension model for Transfer Profile (AWS::Transfer::Profile).
 *
...
/** Swamp extension model for Transfer Profile. Registered at `@swamp/aws/transfer/profile`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Transfer Profile resources",
      arguments: z.object({
