...
/**
 * Swamp extension model for Transfer Agreement (AWS::Transfer::Agreement).
 *
...
/** Swamp extension model for Transfer Agreement. Registered at `@swamp/aws/transfer/agreement`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Transfer Agreement resources",
      arguments: z.object({
