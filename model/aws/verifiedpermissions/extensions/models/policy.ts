...
// Auto-generated extension model for @swamp/aws/verifiedpermissions/policy
...
const TemplateLinkedPolicyDefinitionSchema = z.object({
  ...
  Principal: EntityIdentifierSchema.optional(),
  Resource: EntityIdentifierSchema.optional(),
});
...
const StateSchema = z.object({
  Definition: z.object({
    Static: StaticPolicyDefinitionSchema,
    TemplateLinked: TemplateLinkedPolicyDefinitionSchema,
  }).optional(),
  PolicyId: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "VerifiedPermissions Policy resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a VerifiedPermissions Policy",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a VerifiedPermissions Policy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the VerifiedPermissions Policy",
        ),
      }),
    ...
    update: {
      description: "Update a VerifiedPermissions Policy",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a VerifiedPermissions Policy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the VerifiedPermissions Policy",
        ),
    ...
    sync: {
      description: "Sync VerifiedPermissions Policy state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List VerifiedPermissions Policy resources",
      arguments: z.object({
