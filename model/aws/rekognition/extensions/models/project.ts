...
/**
 * Swamp extension model for Rekognition Project (AWS::Rekognition::Project).
 *
...
/** Swamp extension model for Rekognition Project. Registered at `@swamp/aws/rekognition/project`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List Rekognition Project resources",
      arguments: z.object({
