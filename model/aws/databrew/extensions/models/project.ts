...
/**
 * Swamp extension model for DataBrew Project (AWS::DataBrew::Project).
 *
...
/** Swamp extension model for DataBrew Project. Registered at `@swamp/aws/databrew/project`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List DataBrew Project resources",
      arguments: z.object({
