...
// Auto-generated extension model for @swamp/aws/s3objectlambda/access-point-policy
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for S3ObjectLambda AccessPointPolicy (AWS::S3ObjectLambda::AccessPointPolicy).
 *
...
const GlobalArgsSchema = z.object({
  ...
  ObjectLambdaAccessPoint: z.string().min(3).max(45).regex(
...
export const model = {
  ...
  resources: {
    state: {
      description: "S3ObjectLambda AccessPointPolicy resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a S3ObjectLambda AccessPointPolicy",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a S3ObjectLambda AccessPointPolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the S3ObjectLambda AccessPointPolicy",
        ),
      }),
    ...
    update: {
      description: "Update a S3ObjectLambda AccessPointPolicy",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
        ...
        const identifier = existing.ObjectLambdaAccessPoint?.toString();
        if (!identifier) {
    ...
    delete: {
      description: "Delete a S3ObjectLambda AccessPointPolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the S3ObjectLambda AccessPointPolicy",
        ),
    ...
    sync: {
      description: "Sync S3ObjectLambda AccessPointPolicy state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
