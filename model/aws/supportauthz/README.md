...
Use `swamp model type describe @swamp/aws/supportauthz/support_permit` to see
...
```bash
# Create a new support_permit model
swamp model create @swamp/aws/supportauthz/support_permit my-support_permit

# Edit the model to configure its properties
swamp model edit my-support_permit

# Create the resource in AWS
swamp model method run my-support_permit create

# Sync current state from AWS
swamp model method run my-support_permit sync
```
