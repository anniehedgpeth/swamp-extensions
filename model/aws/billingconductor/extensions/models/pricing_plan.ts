...
/**
 * Swamp extension model for BillingConductor PricingPlan (AWS::BillingConductor::PricingPlan).
 *
...
/** Swamp extension model for BillingConductor PricingPlan. Registered at `@swamp/aws/billingconductor/pricing-plan`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List BillingConductor PricingPlan resources",
      arguments: z.object({
