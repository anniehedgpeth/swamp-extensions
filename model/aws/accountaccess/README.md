...
Use `swamp model type describe @swamp/aws/accountaccess/application` to see the
...
swamp model create @swamp/aws/accountaccess/application my-application
