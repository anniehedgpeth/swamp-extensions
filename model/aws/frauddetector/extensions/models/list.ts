...
/**
 * Swamp extension model for FraudDetector List (AWS::FraudDetector::List).
 *
...
/** Swamp extension model for FraudDetector List. Registered at `@swamp/aws/frauddetector/list`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List FraudDetector List resources",
      arguments: z.object({
