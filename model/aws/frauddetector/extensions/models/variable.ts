...
/**
 * Swamp extension model for FraudDetector Variable (AWS::FraudDetector::Variable).
 *
...
/** Swamp extension model for FraudDetector Variable. Registered at `@swamp/aws/frauddetector/variable`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List FraudDetector Variable resources",
      arguments: z.object({
