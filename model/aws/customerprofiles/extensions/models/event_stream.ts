...
/**
 * Swamp extension model for CustomerProfiles EventStream (AWS::CustomerProfiles::EventStream).
 *
...
/** Swamp extension model for CustomerProfiles EventStream. Registered at `@swamp/aws/customerprofiles/event-stream`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List CustomerProfiles EventStream resources",
      arguments: z.object({
