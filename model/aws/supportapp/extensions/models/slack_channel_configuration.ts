...
/**
 * Swamp extension model for SupportApp SlackChannelConfiguration (AWS::SupportApp::SlackChannelConfiguration).
 *
...
/** Swamp extension model for SupportApp SlackChannelConfiguration. Registered at `@swamp/aws/supportapp/slack-channel-configuration`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List SupportApp SlackChannelConfiguration resources",
      arguments: z.object({
