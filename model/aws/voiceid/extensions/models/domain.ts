...
/**
 * Swamp extension model for VoiceID Domain (AWS::VoiceID::Domain).
 *
...
/** Swamp extension model for VoiceID Domain. Registered at `@swamp/aws/voiceid/domain`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List VoiceID Domain resources",
      arguments: z.object({
