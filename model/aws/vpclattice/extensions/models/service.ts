...
// Auto-generated extension model for @swamp/aws/vpclattice/service
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for VpcLattice Service (AWS::VpcLattice::Service).
 *
...
const GlobalArgsSchema = z.object({
  ...
  Name: z.string().min(3).max(40).regex(
    new RegExp("^(?!svc-)(?![-])(?!.*[-]$)(?!.*[-]{2})[a-z0-9-]+$"),
  ).optional(),
  CertificateArn: z.string().max(2048).regex(
    new RegExp(
...
export const model = {
  ...
  resources: {
    state: {
      description: "VpcLattice Service resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a VpcLattice Service",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a VpcLattice Service",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the VpcLattice Service",
        ),
      }),
    ...
    update: {
      description: "Update a VpcLattice Service",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a VpcLattice Service",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the VpcLattice Service",
        ),
    ...
    sync: {
      description: "Sync VpcLattice Service state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List VpcLattice Service resources",
      arguments: z.object({
