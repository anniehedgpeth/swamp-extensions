...
/**
 * Swamp extension model for VpcLattice TargetGroup (AWS::VpcLattice::TargetGroup).
 *
...
/** Swamp extension model for VpcLattice TargetGroup. Registered at `@swamp/aws/vpclattice/target-group`. */
export const model = {
  ...
  methods: {
    ...
    list: {
      description: "List VpcLattice TargetGroup resources",
      arguments: z.object({
