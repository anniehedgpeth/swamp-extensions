...
/**
 * Swamp extension model for VpcLattice AuthPolicy (AWS::VpcLattice::AuthPolicy).
 *
...
/** Swamp extension model for VpcLattice AuthPolicy. Registered at `@swamp/aws/vpclattice/auth-policy`. */
export const model = {
