...
// Auto-generated extension model for @swamp/aws/cloudtrail/resource-policy
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for CloudTrail ResourcePolicy (AWS::CloudTrail::ResourcePolicy).
 *
...
/** Swamp extension model for CloudTrail ResourcePolicy. Registered at `@swamp/aws/cloudtrail/resource-policy`. */
export const model = {
  type: "@swamp/aws/cloudtrail/resource-policy",
  ...
  resources: {
    state: {
      description: "CloudTrail ResourcePolicy resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a CloudTrail ResourcePolicy",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a CloudTrail ResourcePolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the CloudTrail ResourcePolicy",
        ),
      }),
    ...
    update: {
      description: "Update a CloudTrail ResourcePolicy",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a CloudTrail ResourcePolicy",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the CloudTrail ResourcePolicy",
        ),
    ...
    sync: {
      description: "Sync CloudTrail ResourcePolicy state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
