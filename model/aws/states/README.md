...
Use `swamp model type describe @swamp/aws/states/execution` to see the full list
...
swamp model create @swamp/aws/states/execution my-execution

# Edit the model to configure its properties
swamp model edit my-execution

# Create the resource in AWS
swamp model method run my-execution create

# Sync current state from AWS
swamp model method run my-execution sync
```
