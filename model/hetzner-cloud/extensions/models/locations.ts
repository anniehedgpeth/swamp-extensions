...
// Auto-generated extension model for @swamp/hetzner-cloud/locations
// Do not edit manually. Re-generate with: deno task generate:hetzner

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Hetzner Cloud location.
 *
 * Wraps the `/locations` API as a swamp model so get, list, adopt
...
export const model = {
  ...
  resources: {
    state: {
      description: "Location resource state",
  ...
  methods: {
    get: {
      ...
      arguments: z.object({
        id: z.number().int().describe("The ID of the location"),
      }),
    ...
    adopt: {
      description: "Adopt an existing location by ID into managed state",
      arguments: z.object({
        id: z.number().int().describe("The ID of the location to adopt"),
