 ...
 *
 * Wraps the `/isos` API as a swamp model so get, list, adopt
...
export const model = {
  ...
  methods: {
    ...
    adopt: {
      description: "Adopt an existing iso by ID into managed state",
      arguments: z.object({
        id: z.number().int().describe("The ID of the iso to adopt"),
