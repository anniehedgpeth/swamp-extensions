...
Use `swamp model type describe @swamp/vercel/networking/networks` to see the
...
swamp extension install @swamp/vercel/networking

# Create a model instance
swamp model create @swamp/vercel/networking/networks my-networks

# Configure it
swamp model edit my-networks

# Create the resource in Vercel
swamp model method run my-networks create

# Sync current state from Vercel
swamp model method run my-networks sync
```
