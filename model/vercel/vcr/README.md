...
Use `swamp model type describe @swamp/vercel/vcr/repository` to see the full
...
swamp extension install @swamp/vercel/vcr

# Create a model instance
swamp model create @swamp/vercel/vcr/repository my-repository

# Configure it
swamp model edit my-repository

# Create the resource in Vercel
swamp model method run my-repository create

# Sync current state from Vercel
swamp model method run my-repository sync
```
