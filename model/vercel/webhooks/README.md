...
Use `swamp model type describe @swamp/vercel/webhooks/webhooks` to see the full
...
swamp extension install @swamp/vercel/webhooks

# Create a model instance
swamp model create @swamp/vercel/webhooks/webhooks my-webhooks
