...
Use `swamp model type describe @swamp/vercel/dns/records` to see the full list
...
swamp extension install @swamp/vercel/dns

# Create a model instance
swamp model create @swamp/vercel/dns/records my-records

# Configure it
swamp model edit my-records

# Create the resource in Vercel
swamp model method run my-records create

# Sync current state from Vercel
swamp model method run my-records sync
```
