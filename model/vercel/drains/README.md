...
Use `swamp model type describe @swamp/vercel/drains/drains` to see the full list
...
swamp extension install @swamp/vercel/drains

# Create a model instance
swamp model create @swamp/vercel/drains/drains my-drains

# Configure it
swamp model edit my-drains

# Create the resource in Vercel
swamp model method run my-drains create

# Sync current state from Vercel
swamp model method run my-drains sync
```
