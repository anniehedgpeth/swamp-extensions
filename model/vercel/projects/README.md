...
Use `swamp model type describe @swamp/vercel/projects/projects` to see the full
...
swamp extension install @swamp/vercel/projects

# Create a model instance
swamp model create @swamp/vercel/projects/projects my-projects

# Configure it
swamp model edit my-projects

# Create the resource in Vercel
swamp model method run my-projects create

# Sync current state from Vercel
swamp model method run my-projects sync
```
