...
Use `swamp model type describe @swamp/vercel/kms/issuers` to see the full list
...
swamp extension install @swamp/vercel/kms

# Create a model instance
swamp model create @swamp/vercel/kms/issuers my-issuers

# Configure it
swamp model edit my-issuers

# Create the resource in Vercel
swamp model method run my-issuers create

# Sync current state from Vercel
swamp model method run my-issuers sync
```
