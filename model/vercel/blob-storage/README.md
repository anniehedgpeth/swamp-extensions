...
Use `swamp model type describe @swamp/vercel/blob-storage/blob` to see the full
...
swamp extension install @swamp/vercel/blob-storage

# Create a model instance
swamp model create @swamp/vercel/blob-storage/blob my-blob

# Configure it
swamp model edit my-blob

# Create the resource in Vercel
swamp model method run my-blob create

# Sync current state from Vercel
swamp model method run my-blob sync
```
