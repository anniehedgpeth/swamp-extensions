...
// Auto-generated extension model for @swamp/vercel/certs/certs
// Do not edit manually. Re-generate with: deno task generate:vercel

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Vercel Certs.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Certs resource state",
  ...
  methods: {
    create: {
      description: "Create a Certs",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/v8/certs";
        const body: Record<string, unknown> = {};
        if (g.cns !== undefined) body.cns = g.cns;
    ...
    get: {
      description: "Get a Certs",
      arguments: z.object({ id: z.string().describe("The ID of the Certs") }),
    ...
    lookup: {
      description:
        "Look up an existing Certs by matching global argument values and import it into state",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/v8/certs";
        ...
        if (matches.length === 0) {
          ...
          throw new Error(`No certs found matching filters: ${filterDesc}`);
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
            `${k}=${JSON.stringify(v)}`
    ...
    adopt: {
      description: "Import an existing Certs by ID into state for management",
      arguments: z.object({
        id: z.string().describe("The ID of the Certs to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/v8/certs";
    ...
    sync: {
      description: "Sync Certs state from Vercel",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Certs by id (e.g. one discovered by list)",
        ).optional(),
      }),
