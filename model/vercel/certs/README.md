...
Use `swamp model type describe @swamp/vercel/certs/certs` to see the full list
...
swamp extension install @swamp/vercel/certs

# Create a model instance
swamp model create @swamp/vercel/certs/certs my-certs

# Configure it
swamp model edit my-certs

# Create the resource in Vercel
swamp model method run my-certs create

# Sync current state from Vercel
swamp model method run my-certs sync
```
