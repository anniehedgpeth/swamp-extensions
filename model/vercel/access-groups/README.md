...
Use `swamp model type describe @swamp/vercel/access-groups/access-groups` to see
...
swamp extension install @swamp/vercel/access-groups

# Create a model instance
swamp model create @swamp/vercel/access-groups/access-groups my-access-groups

# Configure it
swamp model edit my-access-groups

# Create the resource in Vercel
swamp model method run my-access-groups create

# Sync current state from Vercel
swamp model method run my-access-groups sync
```
