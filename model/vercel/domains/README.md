...
Use `swamp model type describe @swamp/vercel/domains/domains` to see the full
...
swamp extension install @swamp/vercel/domains

# Create a model instance
swamp model create @swamp/vercel/domains/domains my-domains
