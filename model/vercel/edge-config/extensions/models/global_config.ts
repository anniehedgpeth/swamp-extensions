...
// Auto-generated extension model for @swamp/vercel/edge-config/global-config
// Do not edit manually. Re-generate with: deno task generate:vercel

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Vercel Global Config.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Global Config resource state",
  ...
  methods: {
    ...
    get: {
      description: "Get a Global Config",
      arguments: z.object({
        id: z.string().describe("The ID of the Global Config"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (matches.length === 0) {
          ...
          throw new Error(
            `No global config found matching filters: ${filterDesc}`,
          );
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Global Config to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/v1/global-config";
    ...
    update: {
      description: "Update Global Config attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Global Config by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        const body: Record<string, unknown> = {};
        let result = await update(endpoint, existing.id, body, "PUT", {
          token: g.token,
    ...
    delete: {
      description: "Delete the Global Config",
      arguments: z.object({
        id: z.string().describe("The ID of the Global Config"),
      }),
      execute: async (args: { id: string }, context: any) => {
    ...
    sync: {
      description: "Sync Global Config state from Vercel",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Global Config by id (e.g. one discovered by list)",
        ).optional(),
