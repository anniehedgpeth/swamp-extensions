...
Use `swamp model type describe @swamp/vercel/environment/env` to see the full
...
swamp extension install @swamp/vercel/environment

# Create a model instance
swamp model create @swamp/vercel/environment/env my-env

# Configure it
swamp model edit my-env

# Create the resource in Vercel
swamp model method run my-env create

# Sync current state from Vercel
swamp model method run my-env sync
```
