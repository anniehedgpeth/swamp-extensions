...
Use `swamp model type describe @swamp/cloudflare/logpush/jobs` to see the full
...
```bash
# Create a new jobs model
swamp model create @swamp/cloudflare/logpush/jobs my-jobs

# Edit the model to configure its properties
swamp model edit my-jobs

# Create the resource in Cloudflare
swamp model method run my-jobs create

# Sync current state from Cloudflare
swamp model method run my-jobs sync
```
