...
Use `swamp model type describe @swamp/cloudflare/cni/cnis` to see the full list
...
```bash
# Create a new cnis model
swamp model create @swamp/cloudflare/cni/cnis my-cnis

# Edit the model to configure its properties
swamp model edit my-cnis

# Create the resource in Cloudflare
swamp model method run my-cnis create

# Sync current state from Cloudflare
swamp model method run my-cnis sync
```
