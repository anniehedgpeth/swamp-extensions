...
Use `swamp model type describe @swamp/cloudflare/pages/projects` to see the full
...
```bash
# Create a new projects model
swamp model create @swamp/cloudflare/pages/projects my-projects
