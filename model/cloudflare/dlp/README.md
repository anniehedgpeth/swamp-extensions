...
Use `swamp model type describe @swamp/cloudflare/dlp/custom-prompt-topics` to
...
```bash
# Create a new custom-prompt-topics model
swamp model create @swamp/cloudflare/dlp/custom-prompt-topics my-custom-prompt-topics

# Edit the model to configure its properties
swamp model edit my-custom-prompt-topics

# Create the resource in Cloudflare
swamp model method run my-custom-prompt-topics create

# Sync current state from Cloudflare
swamp model method run my-custom-prompt-topics sync
```
