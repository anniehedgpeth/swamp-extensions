...
Use `swamp model type describe @swamp/cloudflare/custom-pages/assets` to see the
...
swamp model create @swamp/cloudflare/custom-pages/assets my-assets

# Edit the model to configure its properties
swamp model edit my-assets

# Create the resource in Cloudflare
swamp model method run my-assets create

# Sync current state from Cloudflare
swamp model method run my-assets sync
```
