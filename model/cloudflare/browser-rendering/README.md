...
Use `swamp model type describe @swamp/cloudflare/browser-rendering/crawl` to see
...
```bash
# Create a new crawl model
swamp model create @swamp/cloudflare/browser-rendering/crawl my-crawl

# Edit the model to configure its properties
swamp model edit my-crawl

# Create the resource in Cloudflare
swamp model method run my-crawl create

# Sync current state from Cloudflare
swamp model method run my-crawl sync
```
