...
Use `swamp model type describe @swamp/cloudflare/workers/namespaces` to see the
...
swamp model create @swamp/cloudflare/workers/namespaces my-namespaces
