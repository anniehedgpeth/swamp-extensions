...
// Auto-generated extension model for @swamp/cloudflare/workers/namespaces
...
const GlobalArgsSchema = z.object({
  ...
  name: z.string().describe("The name of the dispatch namespace.").optional(),
  trusted_workers: z.boolean().describe(
...
const ResourceSchema = z.object({
  ...
  script_count: z.number().optional(),
  trusted_workers: z.boolean().optional(),
  id: z.string(),
}).passthrough();
...
/** Swamp extension model for Cloudflare Namespaces. Registered at `@swamp/cloudflare/workers/namespaces`. */
export const model = {
  type: "@swamp/cloudflare/workers/namespaces",
  ...
  methods: {
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.trusted_workers !== undefined) {
          filters.push(["trusted_workers", String(g.trusted_workers)]);
        }
        if (filters.length === 0) {
          throw new Error(
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Namespaces by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        if (g.name !== undefined) body.name = g.name;
        if (g.trusted_workers !== undefined) {
          body.trusted_workers = g.trusted_workers;
        }
