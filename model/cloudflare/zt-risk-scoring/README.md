...
Use `swamp model type describe @swamp/cloudflare/zt-risk-scoring/integrations`
...
```bash
# Create a new integrations model
swamp model create @swamp/cloudflare/zt-risk-scoring/integrations my-integrations

# Edit the model to configure its properties
swamp model edit my-integrations

# Create the resource in Cloudflare
swamp model method run my-integrations create

# Sync current state from Cloudflare
swamp model method run my-integrations sync
```
