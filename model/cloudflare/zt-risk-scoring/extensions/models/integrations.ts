...
// Auto-generated extension model for @swamp/cloudflare/zt-risk-scoring/integrations
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.integration_type !== undefined) {
          body.integration_type = g.integration_type;
        }
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.active !== undefined) filters.push(["active", String(g.active)]);
        if (g.reference_id !== undefined) {
          filters.push(["reference_id", String(g.reference_id)]);
        }
        if (g.tenant_url !== undefined) {
          filters.push(["tenant_url", String(g.tenant_url)]);
        }
        if (g.integration_type !== undefined) {
          filters.push(["integration_type", String(g.integration_type)]);
        }
        if (filters.length === 0) {
          throw new Error(
