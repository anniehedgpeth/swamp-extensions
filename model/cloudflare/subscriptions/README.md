...
Use `swamp model type describe @swamp/cloudflare/subscriptions/subscriptions` to
...
swamp model create @swamp/cloudflare/subscriptions/subscriptions my-subscriptions
