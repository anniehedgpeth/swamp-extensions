...
Use `swamp model type describe @swamp/cloudflare/rules/lists` to see the full
...
```bash
# Create a new lists model
swamp model create @swamp/cloudflare/rules/lists my-lists

# Edit the model to configure its properties
swamp model edit my-lists

# Create the resource in Cloudflare
swamp model method run my-lists create

# Sync current state from Cloudflare
swamp model method run my-lists sync
```
