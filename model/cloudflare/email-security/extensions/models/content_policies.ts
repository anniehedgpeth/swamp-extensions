...
// Auto-generated extension model for @swamp/cloudflare/email-security/content-policies
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Content Policies.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Content Policies resource state",
  ...
  methods: {
    create: {
      description: "Create a Content Policies",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
          "/email-security/settings/content_policies";
    ...
    get: {
      description: "Get a Content Policies",
      arguments: z.object({
        id: z.string().describe("The ID of the Content Policies"),
      }),
    ...
    lookup: {
      description:
        "Look up an existing Content Policies by matching global argument values and import it into state",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
        ...
        if (matches.length === 0) {
          ...
          throw new Error(
            `No content policies found matching filters: ${filterDesc}`,
          );
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
    ...
    adopt: {
      description:
        "Import an existing Content Policies by ID into state for management",
      arguments: z.object({
        id: z.string().describe("The ID of the Content Policies to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
    ...
    update: {
      description: "Update Content Policies attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Content Policies by id (e.g. one discovered by list)",
        ).optional(),
      }),
    ...
    delete: {
      description: "Delete the Content Policies",
      arguments: z.object({
        id: z.string().describe("The ID of the Content Policies"),
      }),
      execute: async (args: { id: string }, context: any) => {
    ...
    sync: {
      description: "Sync Content Policies state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Content Policies by id (e.g. one discovered by list)",
        ).optional(),
