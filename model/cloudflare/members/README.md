...
Use `swamp model type describe @swamp/cloudflare/members/members` to see the
...
```bash
# Create a new members model
swamp model create @swamp/cloudflare/members/members my-members
