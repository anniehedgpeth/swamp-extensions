...
Use `swamp model type describe @swamp/cloudflare/resource-library/applications`
...
```bash
# Create a new applications model
swamp model create @swamp/cloudflare/resource-library/applications my-applications

# Edit the model to configure its properties
swamp model edit my-applications

# Create the resource in Cloudflare
swamp model method run my-applications create

# Sync current state from Cloudflare
swamp model method run my-applications sync
```
