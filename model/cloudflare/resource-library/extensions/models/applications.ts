...
// Auto-generated extension model for @swamp/cloudflare/resource-library/applications
...
const ResourceSchema = z.object({
  application_confidence_score: z.number().optional(),
  application_score_composition: z.record(z.string(), z.unknown()).optional(),
  application_source: z.string().optional(),
  application_type: z.string().optional(),
  application_type_description: z.string().optional(),
  category_id: z.number().optional(),
  created_at: z.string().optional(),
  gen_ai_score: z.number().optional(),
  hostnames: z.array(z.string()).optional(),
  human_id: z.string().optional(),
  id: z.number(),
  ip_subnets: z.array(z.string()).optional(),
  name: z.string().optional(),
  port_protocols: z.array(z.string()).optional(),
  support_domains: z.array(z.string()).optional(),
...
const InputsSchema = z.object({
  ...
  port_protocols: z.array(z.string()).optional(),
  support_domains: z.array(z.string()).optional(),
  category_id: z.number().int().min(1).max(4294967295).optional(),
  human_id: z.string().optional(),
  name: z.string().optional(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.category_id !== undefined) body.category_id = g.category_id;
        if (g.hostnames !== undefined) body.hostnames = g.hostnames;
        if (g.human_id !== undefined) body.human_id = g.human_id;
        if (g.ip_subnets !== undefined) body.ip_subnets = g.ip_subnets;
        if (g.name !== undefined) body.name = g.name;
        if (g.port_protocols !== undefined) {
          body.port_protocols = g.port_protocols;
        }
        if (g.support_domains !== undefined) {
          body.support_domains = g.support_domains;
        }
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.category_id !== undefined) {
          filters.push(["category_id", String(g.category_id)]);
        }
        if (g.human_id !== undefined) {
          filters.push(["human_id", String(g.human_id)]);
        }
