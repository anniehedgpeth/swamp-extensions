...
// Auto-generated extension model for @swamp/cloudflare/ssl/origin-tls-client-auth
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Origin Tls Client Auth.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Origin Tls Client Auth resource state",
  ...
  methods: {
    create: {
      description: "Create a Origin Tls Client Auth",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Origin Tls Client Auth",
      arguments: z.object({
        id: z.string().describe("The ID of the Origin Tls Client Auth"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.certificate !== undefined) {
          filters.push(["certificate", String(g.certificate)]);
        }
        if (g.private_key !== undefined) {
          filters.push(["private_key", String(g.private_key)]);
        }
        if (filters.length === 0) {
          throw new Error(
        ...
        if (matches.length === 0) {
          ...
          throw new Error(
            `No origin tls client auth found matching filters: ${filterDesc}`,
          );
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe(
          "The ID of the Origin Tls Client Auth to import",
        ),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the Origin Tls Client Auth",
      arguments: z.object({
        id: z.string().describe("The ID of the Origin Tls Client Auth"),
      }),
      execute: async (args: { id: string }, context: any) => {
    ...
    sync: {
      description: "Sync Origin Tls Client Auth state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Origin Tls Client Auth by id (e.g. one discovered by list)",
        ).optional(),
      }),
