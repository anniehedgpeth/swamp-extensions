...
Use `swamp model type describe @swamp/cloudflare/flagship/apps` to see the full
...
```bash
# Create a new apps model
swamp model create @swamp/cloudflare/flagship/apps my-apps

# Edit the model to configure its properties
swamp model edit my-apps

# Create the resource in Cloudflare
swamp model method run my-apps create

# Sync current state from Cloudflare
swamp model method run my-apps sync
```
