...
Use `swamp model type describe @swamp/cloudflare/access/portals` to see the full
...
```bash
# Create a new portals model
swamp model create @swamp/cloudflare/access/portals my-portals

# Edit the model to configure its properties
swamp model edit my-portals

# Create the resource in Cloudflare
swamp model method run my-portals create

# Sync current state from Cloudflare
swamp model method run my-portals sync
```
