...
Use `swamp model type describe @swamp/cloudflare/page-rules/pagerules` to see
...
```bash
# Create a new pagerules model
swamp model create @swamp/cloudflare/page-rules/pagerules my-pagerules

# Edit the model to configure its properties
swamp model edit my-pagerules

# Create the resource in Cloudflare
swamp model method run my-pagerules create

# Sync current state from Cloudflare
swamp model method run my-pagerules sync
```
