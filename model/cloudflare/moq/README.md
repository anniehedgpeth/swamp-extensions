...
Use `swamp model type describe @swamp/cloudflare/moq/relays` to see the full
...
```bash
# Create a new relays model
swamp model create @swamp/cloudflare/moq/relays my-relays

# Edit the model to configure its properties
swamp model edit my-relays

# Create the resource in Cloudflare
swamp model method run my-relays create

# Sync current state from Cloudflare
swamp model method run my-relays sync
```
