...
Use `swamp model type describe @swamp/cloudflare/ai-search/instances` to see the
...
swamp model create @swamp/cloudflare/ai-search/instances my-instances
