...
// Auto-generated extension model for @swamp/cloudflare/ai-search/tokens
  ...
  methods: {
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.cf_api_id !== undefined) {
          filters.push(["cf_api_id", String(g.cf_api_id)]);
        }
        if (g.cf_api_key !== undefined) {
          filters.push(["cf_api_key", String(g.cf_api_key)]);
        }
        if (g.legacy !== undefined) filters.push(["legacy", String(g.legacy)]);
