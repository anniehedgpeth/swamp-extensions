...
Use `swamp model type describe @swamp/cloudflare/d1/database` to see the full
...
swamp model create @swamp/cloudflare/d1/database my-database

# Edit the model to configure its properties
swamp model edit my-database

# Create the resource in Cloudflare
swamp model method run my-database create

# Sync current state from Cloudflare
swamp model method run my-database sync
```
