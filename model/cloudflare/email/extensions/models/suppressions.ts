...
// Auto-generated extension model for @swamp/cloudflare/email/suppressions
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Suppressions.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Suppressions resource state",
  ...
  methods: {
    create: {
      description: "Create a Suppressions",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Suppressions",
      arguments: z.object({
        id: z.string().describe("The ID of the Suppressions"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.note !== undefined) filters.push(["note", String(g.note)]);
        ...
        if (matches.length === 0) {
          ...
          throw new Error(
            `No suppressions found matching filters: ${filterDesc}`,
          );
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Suppressions to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
    ...
    update: {
      description: "Update Suppressions attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Suppressions by id (e.g. one discovered by list)",
        ).optional(),
      }),
    ...
    delete: {
      description: "Delete the Suppressions",
      arguments: z.object({
        id: z.string().describe("The ID of the Suppressions"),
      }),
      execute: async (args: { id: string }, context: any) => {
    ...
    sync: {
      description: "Sync Suppressions state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Suppressions by id (e.g. one discovered by list)",
        ).optional(),
