...
// Auto-generated extension model for @swamp/cloudflare/email/addresses
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Addresses.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Addresses resource state",
  ...
  methods: {
    ...
    get: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Addresses"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (matches.length === 0) {
          ...
          throw new Error(`No addresses found matching filters: ${filterDesc}`);
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
            `${k}=${JSON.stringify(v)}`
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Addresses to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
    ...
    sync: {
      description: "Sync Addresses state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Addresses by id (e.g. one discovered by list)",
        ).optional(),
