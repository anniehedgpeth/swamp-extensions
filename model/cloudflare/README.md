...
Use `swamp model type describe @swamp/cloudflare//` to see the full list of
...
```bash
# Create a new  model
swamp model create @swamp/cloudflare// my-

# Edit the model to configure its properties
swamp model edit my-

# Create the resource in Cloudflare
swamp model method run my- create

# Sync current state from Cloudflare
swamp model method run my- sync
```
