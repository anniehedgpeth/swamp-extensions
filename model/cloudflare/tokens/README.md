...
Use `swamp model type describe @swamp/cloudflare/tokens/tokens` to see the full
...
```bash
# Create a new tokens model
swamp model create @swamp/cloudflare/tokens/tokens my-tokens

# Edit the model to configure its properties
swamp model edit my-tokens

# Create the resource in Cloudflare
swamp model method run my-tokens create

# Sync current state from Cloudflare
swamp model method run my-tokens sync
```
