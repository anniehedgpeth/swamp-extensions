...
Use `swamp model type describe @swamp/cloudflare/waiting-rooms/waiting-rooms` to
...
```bash
# Create a new waiting-rooms model
swamp model create @swamp/cloudflare/waiting-rooms/waiting-rooms my-waiting-rooms

# Edit the model to configure its properties
swamp model edit my-waiting-rooms

# Create the resource in Cloudflare
swamp model method run my-waiting-rooms create

# Sync current state from Cloudflare
swamp model method run my-waiting-rooms sync
```
