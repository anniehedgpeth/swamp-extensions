...
Use `swamp model type describe @swamp/cloudflare/iam/resource-groups` to see the
...
```bash
# Create a new resource-groups model
swamp model create @swamp/cloudflare/iam/resource-groups my-resource-groups

# Edit the model to configure its properties
swamp model edit my-resource-groups

# Create the resource in Cloudflare
swamp model method run my-resource-groups create

# Sync current state from Cloudflare
swamp model method run my-resource-groups sync
```
