...
Use
`swamp model type describe @swamp/cloudflare/custom-hostnames/custom-hostnames`
...
```bash
# Create a new custom-hostnames model
swamp model create @swamp/cloudflare/custom-hostnames/custom-hostnames my-custom-hostnames

# Edit the model to configure its properties
swamp model edit my-custom-hostnames

# Create the resource in Cloudflare
swamp model method run my-custom-hostnames create

# Sync current state from Cloudflare
swamp model method run my-custom-hostnames sync
```
