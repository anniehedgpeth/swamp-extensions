...
Use `swamp model type describe @swamp/cloudflare/pipelines/pipelines-v2` to see
...
```bash
# Create a new pipelines-v2 model
swamp model create @swamp/cloudflare/pipelines/pipelines-v2 my-pipelines-v2

# Edit the model to configure its properties
swamp model edit my-pipelines-v2

# Create the resource in Cloudflare
swamp model method run my-pipelines-v2 create

# Sync current state from Cloudflare
swamp model method run my-pipelines-v2 sync
```
