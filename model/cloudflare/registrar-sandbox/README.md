...
Use
`swamp model type describe @swamp/cloudflare/registrar-sandbox/registrations` to
...
```bash
# Create a new registrations model
swamp model create @swamp/cloudflare/registrar-sandbox/registrations my-registrations

# Edit the model to configure its properties
swamp model edit my-registrations

# Create the resource in Cloudflare
swamp model method run my-registrations create

# Sync current state from Cloudflare
swamp model method run my-registrations sync
```
