...
Use `swamp model type describe @swamp/cloudflare/dns/dns-firewall` to see the
...
```bash
# Create a new dns-firewall model
swamp model create @swamp/cloudflare/dns/dns-firewall my-dns-firewall

# Edit the model to configure its properties
swamp model edit my-dns-firewall

# Create the resource in Cloudflare
swamp model method run my-dns-firewall create

# Sync current state from Cloudflare
swamp model method run my-dns-firewall sync
```
