...
// Auto-generated extension model for @swamp/cloudflare/cloudforce-one/priority
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Priority.
 *
...
const GlobalArgsSchema = z.object({
  ...
  labels: z.array(z.string()).describe("List of labels.").optional(),
  priority: z.number().int().describe("Priority.").optional(),
  requirement: z.string().describe("Requirement.").optional(),
...
export const model = {
  ...
  methods: {
    ...
    get: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Priority"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.requirement !== undefined) {
          filters.push(["requirement", String(g.requirement)]);
        }
        ...
        if (matches.length === 0) {
          ...
          throw new Error(`No priority found matching filters: ${filterDesc}`);
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
            `${k}=${JSON.stringify(v)}`
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Priority to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Priority by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        if (g.requirement !== undefined) body.requirement = g.requirement;
    ...
    sync: {
      description: "Sync Priority state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Priority by id (e.g. one discovered by list)",
        ).optional(),
