...
// Auto-generated extension model for @swamp/cloudflare/cloudforce-one/templates
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Templates.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Templates resource state",
  ...
  methods: {
    ...
    get: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Templates"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.body !== undefined) filters.push(["body", String(g.body)]);
        ...
        if (matches.length === 0) {
          ...
          throw new Error(`No templates found matching filters: ${filterDesc}`);
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
            `${k}=${JSON.stringify(v)}`
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Templates to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Templates by id (e.g. one discovered by list)",
        ).optional(),
      }),
    ...
    sync: {
      description: "Sync Templates state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Templates by id (e.g. one discovered by list)",
        ).optional(),
