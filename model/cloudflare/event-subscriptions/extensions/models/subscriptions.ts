...
// Auto-generated extension model for @swamp/cloudflare/event-subscriptions/subscriptions
...
const GlobalArgsSchema = z.object({
  ...
  destination: z.object({
    queue_id: z.string(),
    type: z.enum(["queues.queue"]),
  }).optional(),
  enabled: z.boolean().describe("Whether the subscription is active")
    .optional(),
