# @swamp/cloudflare/event-subscriptions

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Cloudflare event-subscriptions resources.
...
Use
`swamp model type describe @swamp/cloudflare/event-subscriptions/subscriptions`
...
```bash
# Create a new subscriptions model
swamp model create @swamp/cloudflare/event-subscriptions/subscriptions my-subscriptions

# Edit the model to configure its properties
swamp model edit my-subscriptions

# Create the resource in Cloudflare
swamp model method run my-subscriptions create

# Sync current state from Cloudflare
swamp model method run my-subscriptions sync
```
