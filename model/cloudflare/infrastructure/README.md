...
Use `swamp model type describe @swamp/cloudflare/infrastructure/targets` to see
...
```bash
# Create a new targets model
swamp model create @swamp/cloudflare/infrastructure/targets my-targets

# Edit the model to configure its properties
swamp model edit my-targets

# Create the resource in Cloudflare
swamp model method run my-targets create

# Sync current state from Cloudflare
swamp model method run my-targets sync
```
