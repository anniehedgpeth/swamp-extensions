...
Use `swamp model type describe @swamp/cloudflare/dls/prefix-bindings` to see the
...
```bash
# Create a new prefix-bindings model
swamp model create @swamp/cloudflare/dls/prefix-bindings my-prefix-bindings

# Edit the model to configure its properties
swamp model edit my-prefix-bindings

# Create the resource in Cloudflare
swamp model method run my-prefix-bindings create

# Sync current state from Cloudflare
swamp model method run my-prefix-bindings sync
```
