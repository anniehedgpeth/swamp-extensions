...
Use `swamp model type describe @swamp/cloudflare/ai-gateway/custom-providers` to
...
```bash
# Create a new custom-providers model
swamp model create @swamp/cloudflare/ai-gateway/custom-providers my-custom-providers

# Edit the model to configure its properties
swamp model edit my-custom-providers

# Create the resource in Cloudflare
swamp model method run my-custom-providers create

# Sync current state from Cloudflare
swamp model method run my-custom-providers sync
```
