...
Use
`swamp model type describe @swamp/cloudflare/diagnostics/endpoint-healthchecks`
...
```bash
# Create a new endpoint-healthchecks model
swamp model create @swamp/cloudflare/diagnostics/endpoint-healthchecks my-endpoint-healthchecks

# Edit the model to configure its properties
swamp model edit my-endpoint-healthchecks

# Create the resource in Cloudflare
swamp model method run my-endpoint-healthchecks create

# Sync current state from Cloudflare
swamp model method run my-endpoint-healthchecks sync
```
