...
// Auto-generated extension model for @swamp/cloudflare/devices/networks
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Networks.
 *
...
const ResourceSchema = z.object({
  config: z.object({
    sha256: z.string().optional(),
    tls_sockaddr: z.string().optional(),
  }).optional(),
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      description: "Sync Networks state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Networks by id (e.g. one discovered by list)",
        ).optional(),
