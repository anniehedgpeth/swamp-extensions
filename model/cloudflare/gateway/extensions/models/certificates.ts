...
// Auto-generated extension model for @swamp/cloudflare/gateway/certificates
...
const GlobalArgsSchema = z.object({
  ...
  validity_period_days: z.number().int().describe(
...
const InputsSchema = z.object({
  ...
  validity_period_days: z.number().int().optional(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        const endpoint = "/accounts/" + g.account_id + "/gateway/certificates";
        const body: Record<string, unknown> = {};
        if (g.validity_period_days !== undefined) {
          body.validity_period_days = g.validity_period_days;
        }
