...
// Auto-generated extension model for @swamp/cloudflare/gateway/pacfiles
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Pacfiles.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Pacfiles resource state",
  ...
  methods: {
    ...
    get: {
      description: "Get a Pacfiles",
      arguments: z.object({
        id: z.string().describe("The ID of the Pacfiles"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.contents !== undefined) {
          filters.push(["contents", String(g.contents)]);
        }
        ...
        if (matches.length === 0) {
          ...
          throw new Error(`No pacfiles found matching filters: ${filterDesc}`);
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
            `${k}=${JSON.stringify(v)}`
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Pacfiles to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id + "/gateway/pacfiles";
    ...
    update: {
      description: "Update Pacfiles attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Pacfiles by id (e.g. one discovered by list)",
        ).optional(),
      }),
    ...
    delete: {
      description: "Delete the Pacfiles",
      arguments: z.object({
        id: z.string().describe("The ID of the Pacfiles"),
      }),
      execute: async (args: { id: string }, context: any) => {
    ...
    sync: {
      description: "Sync Pacfiles state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Pacfiles by id (e.g. one discovered by list)",
        ).optional(),
