...
Use `swamp model type describe @swamp/cloudflare/gateway/certificates` to see
...
```bash
# Create a new certificates model
swamp model create @swamp/cloudflare/gateway/certificates my-certificates

# Edit the model to configure its properties
swamp model edit my-certificates

# Create the resource in Cloudflare
swamp model method run my-certificates create

# Sync current state from Cloudflare
swamp model method run my-certificates sync
```
