...
Use `swamp model type describe @swamp/cloudflare/containers/applications` to see
...
swamp model create @swamp/cloudflare/containers/applications my-applications
