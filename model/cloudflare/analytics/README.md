...
Use `swamp model type describe @swamp/cloudflare/analytics/graphql-analytics` to
...
```bash
# Create a new graphql-analytics model
swamp model create @swamp/cloudflare/analytics/graphql-analytics my-graphql-analytics

# Edit the model to configure its properties
swamp model edit my-graphql-analytics

# Create the resource in Cloudflare
swamp model method run my-graphql-analytics create

# Sync current state from Cloudflare
swamp model method run my-graphql-analytics sync
```
