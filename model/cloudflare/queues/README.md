...
Use `swamp model type describe @swamp/cloudflare/queues/queues` to see the full
...
```bash
# Create a new queues model
swamp model create @swamp/cloudflare/queues/queues my-queues

# Edit the model to configure its properties
swamp model edit my-queues

# Create the resource in Cloudflare
swamp model method run my-queues create

# Sync current state from Cloudflare
swamp model method run my-queues sync
```
