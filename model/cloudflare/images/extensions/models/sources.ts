...
// Auto-generated extension model for @swamp/cloudflare/images/sources
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Sources.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Sources resource state",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.bucket !== undefined) body.bucket = g.bucket;
    ...
    get: {
      ...
      arguments: z.object({ id: z.string().describe("The ID of the Sources") }),
    ...
    lookup: {
      description:
        "Look up an existing Sources by matching global argument values and import it into state",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
        ...
        if (g.bucket !== undefined) filters.push(["bucket", String(g.bucket)]);
        if (g.vendor !== undefined) filters.push(["vendor", String(g.vendor)]);
        if (filters.length === 0) {
          throw new Error(
        ...
        if (matches.length === 0) {
          ...
          throw new Error(`No sources found matching filters: ${filterDesc}`);
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
            `${k}=${JSON.stringify(v)}`
    ...
    adopt: {
      description: "Import an existing Sources by ID into state for management",
      arguments: z.object({
        id: z.string().describe("The ID of the Sources to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Sources by id (e.g. one discovered by list)",
        ).optional(),
      }),
    ...
    sync: {
      description: "Sync Sources state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Sources by id (e.g. one discovered by list)",
        ).optional(),
