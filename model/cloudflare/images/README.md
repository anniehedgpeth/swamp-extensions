...
Use `swamp model type describe @swamp/cloudflare/images/variants` to see the
...
```bash
# Create a new variants model
swamp model create @swamp/cloudflare/images/variants my-variants

# Edit the model to configure its properties
swamp model edit my-variants

# Create the resource in Cloudflare
swamp model method run my-variants create

# Sync current state from Cloudflare
swamp model method run my-variants sync
```
