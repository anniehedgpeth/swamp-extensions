...
Use `swamp model type describe @swamp/cloudflare/pcaps/pcaps` to see the full
...
```bash
# Create a new pcaps model
swamp model create @swamp/cloudflare/pcaps/pcaps my-pcaps

# Edit the model to configure its properties
swamp model edit my-pcaps

# Create the resource in Cloudflare
swamp model method run my-pcaps create

# Sync current state from Cloudflare
swamp model method run my-pcaps sync
```
