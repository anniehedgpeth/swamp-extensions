...
Use `swamp model type describe @swamp/cloudflare/web3/hostnames` to see the full
...
```bash
# Create a new hostnames model
swamp model create @swamp/cloudflare/web3/hostnames my-hostnames

# Edit the model to configure its properties
swamp model edit my-hostnames

# Create the resource in Cloudflare
swamp model method run my-hostnames create

# Sync current state from Cloudflare
swamp model method run my-hostnames sync
```
