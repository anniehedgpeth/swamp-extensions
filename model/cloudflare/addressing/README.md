...
Use `swamp model type describe @swamp/cloudflare/addressing/address-maps` to see
...
```bash
# Create a new address-maps model
swamp model create @swamp/cloudflare/addressing/address-maps my-address-maps

# Edit the model to configure its properties
swamp model edit my-address-maps

# Create the resource in Cloudflare
swamp model method run my-address-maps create

# Sync current state from Cloudflare
swamp model method run my-address-maps sync
```
