...
Use `swamp model type describe @swamp/cloudflare/teamnet/routes` to see the full
...
```bash
# Create a new routes model
swamp model create @swamp/cloudflare/teamnet/routes my-routes
