...
// Auto-generated extension model for @swamp/cloudflare/load-balancing/monitor-groups
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Monitor Groups.
 *
...
const ResourceSchema = z.object({
  ...
  members: z.array(z.object({
    ...
    monitoring_only: z.boolean().optional(),
    must_be_healthy: z.boolean().optional(),
    updated_at: z.string().optional(),
  })).optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "Monitor Groups resource state",
  ...
  methods: {
    create: {
      description: "Create a Monitor Groups",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Monitor Groups",
      arguments: z.object({
        id: z.string().describe("The ID of the Monitor Groups"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (matches.length === 0) {
          ...
          throw new Error(
            `No monitor groups found matching filters: ${filterDesc}`,
          );
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Monitor Groups to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
    ...
    update: {
      description: "Update Monitor Groups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Monitor Groups by id (e.g. one discovered by list)",
        ).optional(),
      }),
    ...
    delete: {
      description: "Delete the Monitor Groups",
      arguments: z.object({
        id: z.string().describe("The ID of the Monitor Groups"),
      }),
      execute: async (args: { id: string }, context: any) => {
    ...
    sync: {
      description: "Sync Monitor Groups state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Monitor Groups by id (e.g. one discovered by list)",
        ).optional(),
