...
Use `swamp model type describe @swamp/cloudflare/load-balancing/healthchecks` to
...
```bash
# Create a new healthchecks model
swamp model create @swamp/cloudflare/load-balancing/healthchecks my-healthchecks

# Edit the model to configure its properties
swamp model edit my-healthchecks

# Create the resource in Cloudflare
swamp model method run my-healthchecks create

# Sync current state from Cloudflare
swamp model method run my-healthchecks sync
```
