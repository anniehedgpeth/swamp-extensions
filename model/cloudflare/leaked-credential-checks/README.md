# @swamp/cloudflare/leaked-credential-checks

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Cloudflare leaked-credential-checks resources.
...
Use
`swamp model type describe @swamp/cloudflare/leaked-credential-checks/detections`
...
```bash
# Create a new detections model
swamp model create @swamp/cloudflare/leaked-credential-checks/detections my-detections

# Edit the model to configure its properties
swamp model edit my-detections

# Create the resource in Cloudflare
swamp model method run my-detections create

# Sync current state from Cloudflare
swamp model method run my-detections sync
```
