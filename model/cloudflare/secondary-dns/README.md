...
Use `swamp model type describe @swamp/cloudflare/secondary-dns/acls` to see the
...
```bash
# Create a new acls model
swamp model create @swamp/cloudflare/secondary-dns/acls my-acls

# Edit the model to configure its properties
swamp model edit my-acls

# Create the resource in Cloudflare
swamp model method run my-acls create

# Sync current state from Cloudflare
swamp model method run my-acls sync
```
