...
// Auto-generated extension model for @swamp/cloudflare/magic/rules-tcp_flow_protection
  ...
  methods: {
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.rate_sensitivity !== undefined) {
          filters.push(["rate_sensitivity", String(g.rate_sensitivity)]);
        }
        if (g.name !== undefined) filters.push(["name", String(g.name)]);
        if (g.scope !== undefined) filters.push(["scope", String(g.scope)]);
        if (filters.length === 0) {
          throw new Error(
