...
Use `swamp model type describe @swamp/cloudflare/magic/rules` to see the full
...
swamp model create @swamp/cloudflare/magic/rules my-rules

# Edit the model to configure its properties
swamp model edit my-rules

# Create the resource in Cloudflare
swamp model method run my-rules create

# Sync current state from Cloudflare
swamp model method run my-rules sync
```
