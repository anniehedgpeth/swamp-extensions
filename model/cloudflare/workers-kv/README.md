...
Use `swamp model type describe @swamp/cloudflare/workers-kv/namespaces` to see
...
swamp model create @swamp/cloudflare/workers-kv/namespaces my-namespaces
