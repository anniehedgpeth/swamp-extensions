...
Use `swamp model type describe @swamp/cloudflare/smart-shield/healthchecks` to
...
swamp model create @swamp/cloudflare/smart-shield/healthchecks my-healthchecks
