...
Use `swamp model type describe @swamp/cloudflare/oauth-clients/oauth-clients` to
...
```bash
# Create a new oauth-clients model
swamp model create @swamp/cloudflare/oauth-clients/oauth-clients my-oauth-clients

# Edit the model to configure its properties
swamp model edit my-oauth-clients

# Create the resource in Cloudflare
swamp model method run my-oauth-clients create

# Sync current state from Cloudflare
swamp model method run my-oauth-clients sync
```
