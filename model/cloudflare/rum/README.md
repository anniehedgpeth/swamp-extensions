...
Use `swamp model type describe @swamp/cloudflare/rum/site-info` to see the full
...
```bash
# Create a new site-info model
swamp model create @swamp/cloudflare/rum/site-info my-site-info

# Edit the model to configure its properties
swamp model edit my-site-info

# Create the resource in Cloudflare
swamp model method run my-site-info create

# Sync current state from Cloudflare
swamp model method run my-site-info sync
```
