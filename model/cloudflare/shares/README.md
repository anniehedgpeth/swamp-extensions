...
Use `swamp model type describe @swamp/cloudflare/shares/shares` to see the full
...
```bash
# Create a new shares model
swamp model create @swamp/cloudflare/shares/shares my-shares

# Edit the model to configure its properties
swamp model edit my-shares

# Create the resource in Cloudflare
swamp model method run my-shares create

# Sync current state from Cloudflare
swamp model method run my-shares sync
```
