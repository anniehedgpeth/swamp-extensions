...
Use `swamp model type describe @swamp/cloudflare/vectorize/indexes` to see the
...
```bash
# Create a new indexes model
swamp model create @swamp/cloudflare/vectorize/indexes my-indexes

# Edit the model to configure its properties
swamp model edit my-indexes

# Create the resource in Cloudflare
swamp model method run my-indexes create

# Sync current state from Cloudflare
swamp model method run my-indexes sync
```
