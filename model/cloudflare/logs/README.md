...
Use `swamp model type describe @swamp/cloudflare/logs/datasets` to see the full
...
```bash
# Create a new datasets model
swamp model create @swamp/cloudflare/logs/datasets my-datasets

# Edit the model to configure its properties
swamp model edit my-datasets

# Create the resource in Cloudflare
swamp model method run my-datasets create

# Sync current state from Cloudflare
swamp model method run my-datasets sync
```
