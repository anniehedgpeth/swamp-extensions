...
Use
`swamp model type describe @swamp/cloudflare/payment-methods/payment-methods` to
...
```bash
# Create a new payment-methods model
swamp model create @swamp/cloudflare/payment-methods/payment-methods my-payment-methods

# Edit the model to configure its properties
swamp model edit my-payment-methods

# Create the resource in Cloudflare
swamp model method run my-payment-methods create

# Sync current state from Cloudflare
swamp model method run my-payment-methods sync
```
