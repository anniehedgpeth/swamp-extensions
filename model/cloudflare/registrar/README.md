...
Use `swamp model type describe @swamp/cloudflare/registrar/registrations` to see
...
swamp model create @swamp/cloudflare/registrar/registrations my-registrations
