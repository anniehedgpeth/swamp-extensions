...
Use `swamp model type describe @swamp/cloudflare/intel/indicator-feeds` to see
...
```bash
# Create a new indicator-feeds model
swamp model create @swamp/cloudflare/intel/indicator-feeds my-indicator-feeds

# Edit the model to configure its properties
swamp model edit my-indicator-feeds

# Create the resource in Cloudflare
swamp model method run my-indicator-feeds create

# Sync current state from Cloudflare
swamp model method run my-indicator-feeds sync
```
