...
Use `swamp model type describe @swamp/cloudflare/sso-connectors/sso-connectors`
...
```bash
# Create a new sso-connectors model
swamp model create @swamp/cloudflare/sso-connectors/sso-connectors my-sso-connectors

# Edit the model to configure its properties
swamp model edit my-sso-connectors

# Create the resource in Cloudflare
swamp model method run my-sso-connectors create

# Sync current state from Cloudflare
swamp model method run my-sso-connectors sync
```
