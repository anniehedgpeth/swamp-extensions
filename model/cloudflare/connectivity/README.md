...
Use `swamp model type describe @swamp/cloudflare/connectivity/services` to see
...
```bash
# Create a new services model
swamp model create @swamp/cloudflare/connectivity/services my-services

# Edit the model to configure its properties
swamp model edit my-services

# Create the resource in Cloudflare
swamp model method run my-services create

# Sync current state from Cloudflare
swamp model method run my-services sync
```
