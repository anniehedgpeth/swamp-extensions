...
Use `swamp model type describe @swamp/cloudflare/vuln-scanner/credential-sets`
...
```bash
# Create a new credential-sets model
swamp model create @swamp/cloudflare/vuln-scanner/credential-sets my-credential-sets

# Edit the model to configure its properties
swamp model edit my-credential-sets

# Create the resource in Cloudflare
swamp model method run my-credential-sets create

# Sync current state from Cloudflare
swamp model method run my-credential-sets sync
```
