...
Use
`swamp model type describe @swamp/cloudflare/mtls-certificates/mtls-certificates`
...
```bash
# Create a new mtls-certificates model
swamp model create @swamp/cloudflare/mtls-certificates/mtls-certificates my-mtls-certificates

# Edit the model to configure its properties
swamp model edit my-mtls-certificates

# Create the resource in Cloudflare
swamp model method run my-mtls-certificates create

# Sync current state from Cloudflare
swamp model method run my-mtls-certificates sync
```
