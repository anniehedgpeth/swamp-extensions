...
// Auto-generated extension model for @swamp/gcp/bigquerydatatransfer/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud BigQuery Data Transfer Locations.
 *
...
/** Swamp extension model for Google Cloud BigQuery Data Transfer Locations. Registered at `@swamp/gcp/bigquerydatatransfer/locations`. */
export const model = {
  type: "@swamp/gcp/bigquerydatatransfer/locations",
  ...
  methods: {
    ...
    enroll_data_sources: {
      description: "enroll data sources",
      arguments: z.object({
        dataSourceIds: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (args["dataSourceIds"] !== undefined) {
          body["dataSourceIds"] = args["dataSourceIds"];
        }
    ...
    unenroll_data_sources: {
      description: "unenroll data sources",
      arguments: z.object({
        dataSourceIds: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
