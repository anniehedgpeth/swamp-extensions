...
Use `swamp model type describe @swamp/gcp/appsmarket/customerlicense` to see the
...
```bash
# Create a new customerlicense model
swamp model create @swamp/gcp/appsmarket/customerlicense my-customerlicense

# Edit the model to configure its properties
swamp model edit my-customerlicense

# Create the resource in GCP
swamp model method run my-customerlicense create

# Sync current state from GCP
swamp model method run my-customerlicense sync
```
