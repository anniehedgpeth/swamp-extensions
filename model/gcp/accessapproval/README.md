...
Use `swamp model type describe @swamp/gcp/accessapproval/approvalrequests` to
...
```bash
# Create a new approvalrequests model
swamp model create @swamp/gcp/accessapproval/approvalrequests my-approvalrequests

# Edit the model to configure its properties
swamp model edit my-approvalrequests

# Create the resource in GCP
swamp model method run my-approvalrequests create

# Sync current state from GCP
swamp model method run my-approvalrequests sync
```
