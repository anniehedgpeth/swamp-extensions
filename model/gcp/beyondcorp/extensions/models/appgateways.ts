...
/**
 * Swamp extension model for Google Cloud BeyondCorp AppGateways.
 *
...
/** Swamp extension model for Google Cloud BeyondCorp AppGateways. Registered at `@swamp/gcp/beyondcorp/appgateways`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["appGatewayId"] !== undefined) {
          params["appGatewayId"] = String(g["appGatewayId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific appGateways by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List appGateways resources",
      arguments: z.object({
