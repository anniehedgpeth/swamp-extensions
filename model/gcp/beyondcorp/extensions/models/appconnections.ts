...
/**
 * Swamp extension model for Google Cloud BeyondCorp AppConnections.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["appConnectionId"] !== undefined) {
          params["appConnectionId"] = String(g["appConnectionId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific appConnections by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List appConnections resources",
      arguments: z.object({
