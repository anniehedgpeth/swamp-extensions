...
Google Cloud androidpublisher resources.
...
Use
`swamp model type describe @swamp/gcp/androidpublisher/applications_devicetierconfigs`
...
```bash
# Create a new applications_devicetierconfigs model
swamp model create @swamp/gcp/androidpublisher/applications_devicetierconfigs my-applications_devicetierconfigs

# Edit the model to configure its properties
swamp model edit my-applications_devicetierconfigs

# Create the resource in GCP
swamp model method run my-applications_devicetierconfigs create

# Sync current state from GCP
swamp model method run my-applications_devicetierconfigs sync
```
