...
/**
 * Swamp extension model for Google Cloud Google Play Android Developer Edits.Apks.
 *
...
/** Swamp extension model for Google Cloud Google Play Android Developer Edits.Apks. Registered at `@swamp/gcp/androidpublisher/edits-apks`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific apks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List apks resources",
      arguments: z.object({
