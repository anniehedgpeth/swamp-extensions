...
// Auto-generated extension model for @swamp/gcp/androidpublisher/edits-countryavailability
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Android Developer Edits.Countryavailability.
 *
...
const StateSchema = z.object({
  ...
  syncWithProduction: z.boolean().optional(),
}).passthrough();
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a countryavailability",
      arguments: z.object({
        identifier: z.string().describe("The name of the countryavailability"),
      }),
    ...
    sync: {
      description: "Sync countryavailability state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific countryavailability by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
