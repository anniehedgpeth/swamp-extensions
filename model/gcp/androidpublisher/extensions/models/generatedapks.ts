...
const GlobalArgsSchema = z.object({
  ...
  versionCode: z.string().describe("Version code of the app bundle."),
});
...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description: "Added: packageName, versionCode",
      upgradeAttributes: (old: Record<string, unknown>) => old,
    },
    {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific generatedapks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List generatedapks resources",
      arguments: z.object({
