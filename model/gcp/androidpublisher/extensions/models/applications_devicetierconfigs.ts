...
/**
 * Swamp extension model for Google Cloud Google Play Android Developer Applications.DeviceTierConfigs.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific deviceTierConfigs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List deviceTierConfigs resources",
      arguments: z.object({
