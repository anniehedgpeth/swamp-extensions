# @swamp/gcp/businessprofileperformance

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Google Cloud businessprofileperformance resources.
...
Use
`swamp model type describe @swamp/gcp/businessprofileperformance/searchkeywords_impressions_monthly`
...
```bash
# Create a new searchkeywords_impressions_monthly model
swamp model create @swamp/gcp/businessprofileperformance/searchkeywords_impressions_monthly my-searchkeywords_impressions_monthly

# Edit the model to configure its properties
swamp model edit my-searchkeywords_impressions_monthly

# Create the resource in GCP
swamp model method run my-searchkeywords_impressions_monthly create

# Sync current state from GCP
swamp model method run my-searchkeywords_impressions_monthly sync
```
