...
Google Cloud licensing resources.
...
Use `swamp model type describe @swamp/gcp/licensing/licenseassignments` to see
...
```bash
# Create a new licenseassignments model
swamp model create @swamp/gcp/licensing/licenseassignments my-licenseassignments

# Edit the model to configure its properties
swamp model edit my-licenseassignments

# Create the resource in GCP
swamp model method run my-licenseassignments create

# Sync current state from GCP
swamp model method run my-licenseassignments sync
```
