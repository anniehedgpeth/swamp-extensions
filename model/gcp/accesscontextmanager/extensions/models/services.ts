...
// Auto-generated extension model for @swamp/gcp/accesscontextmanager/services
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Access Context Manager Services.
 *
...
const StateSchema = z.object({
  availableOnRestrictedVip: z.boolean().optional(),
  knownLimitations: z.boolean().optional(),
  name: z.string(),
  serviceSupportStage: z.string().optional(),
  supportStage: z.string().optional(),
