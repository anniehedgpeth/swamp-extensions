...
/**
 * Swamp extension model for Google Cloud Access Context Manager AccessPolicies.AuthorizedOrgsDescs.
 *
...
/** Swamp extension model for Google Cloud Access Context Manager AccessPolicies.AuthorizedOrgsDescs. Registered at `@swamp/gcp/accesscontextmanager/accesspolicies-authorizedorgsdescs`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific authorizedOrgsDescs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List authorizedOrgsDescs resources",
      arguments: z.object({
