...
/**
 * Swamp extension model for Google Cloud Access Context Manager AccessPolicies.AccessLevels.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific accessLevels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List accessLevels resources",
      arguments: z.object({
        accessLevelFormat: z.string().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const params: Record<string, string> = { project: projectId };
        if (g["parent"] !== undefined) params["parent"] = String(g["parent"]);
        if (args["accessLevelFormat"] !== undefined) {
          params["accessLevelFormat"] = String(args["accessLevelFormat"]);
        }
