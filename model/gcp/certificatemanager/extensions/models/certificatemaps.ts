...
// Auto-generated extension model for @swamp/gcp/certificatemanager/certificatemaps
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Certificate Manager CertificateMaps.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/certificateMaps/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  gclbTargets: z.array(z.object({
    ipConfigs: z.array(z.object({
      ipAddress: z.string(),
      ports: z.array(z.unknown()),
    })),
    targetHttpsProxy: z.string(),
    targetSslProxy: z.string(),
  })).optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a certificateMaps",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a certificateMaps",
      arguments: z.object({
        identifier: z.string().describe("The name of the certificateMaps"),
      }),
    ...
    update: {
      description: "Update certificateMaps attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific certificateMaps by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the certificateMaps",
      arguments: z.object({
        identifier: z.string().describe("The name of the certificateMaps"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync certificateMaps state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific certificateMaps by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List certificateMaps resources",
      arguments: z.object({
