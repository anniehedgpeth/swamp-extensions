...
// Auto-generated extension model for @swamp/gcp/certificatemanager/certificatemaps-certificatemapentries
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Certificate Manager CertificateMaps.CertificateMapEntries.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/certificateMapEntries/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  certificates: z.array(z.string()).describe(
  ...
  matcher: z.enum(["MATCHER_UNSPECIFIED", "PRIMARY"]).describe(
  ...
  certificateMapEntryId: z.string().describe(
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a certificateMapEntries",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["certificates"] !== undefined) {
          body["certificates"] = g["certificates"];
        }
        ...
        if (g["matcher"] !== undefined) body["matcher"] = g["matcher"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["certificateMapEntryId"] !== undefined) {
          params["certificateMapEntryId"] = String(g["certificateMapEntryId"]);
        }
    ...
    get: {
      description: "Get a certificateMapEntries",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the certificateMapEntries",
        ),
      }),
    ...
    update: {
      description: "Update certificateMapEntries attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific certificateMapEntries by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the certificateMapEntries",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the certificateMapEntries",
        ),
    ...
    sync: {
      description: "Sync certificateMapEntries state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific certificateMapEntries by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List certificateMapEntries resources",
      arguments: z.object({
