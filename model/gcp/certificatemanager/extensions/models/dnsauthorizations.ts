...
// Auto-generated extension model for @swamp/gcp/certificatemanager/dnsauthorizations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Certificate Manager DnsAuthorizations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/dnsAuthorizations/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  dnsAuthorizationId: z.string().describe(
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A DnsAuthorization resource describes a way to perform domain authorization f...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a dnsAuthorizations",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a dnsAuthorizations",
      arguments: z.object({
        identifier: z.string().describe("The name of the dnsAuthorizations"),
      }),
    ...
    delete: {
      description: "Delete the dnsAuthorizations",
      arguments: z.object({
        identifier: z.string().describe("The name of the dnsAuthorizations"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    list: {
      description: "List dnsAuthorizations resources",
      arguments: z.object({
