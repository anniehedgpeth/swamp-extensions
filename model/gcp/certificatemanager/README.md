...
Google Cloud certificatemanager resources.
...
Use
`swamp model type describe @swamp/gcp/certificatemanager/certificateissuanceconfigs`
...
```bash
# Create a new certificateissuanceconfigs model
swamp model create @swamp/gcp/certificatemanager/certificateissuanceconfigs my-certificateissuanceconfigs

# Edit the model to configure its properties
swamp model edit my-certificateissuanceconfigs

# Create the resource in GCP
swamp model method run my-certificateissuanceconfigs create

# Sync current state from GCP
swamp model method run my-certificateissuanceconfigs sync
```
