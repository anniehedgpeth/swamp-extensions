...
// Auto-generated extension model for @swamp/gcp/content/csses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Content for Shopping Csses.
 *
...
const StateSchema = z.object({
  cssDomainId: z.string().optional(),
  cssGroupId: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a csses",
      arguments: z.object({
        identifier: z.string().describe("The name of the csses"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["cssDomainId"] = args.identifier;
    ...
    sync: {
      description: "Sync csses state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific csses by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
        ...
        try {
          ...
          if (g["cssGroupId"] !== undefined) {
            params["cssGroupId"] = String(g["cssGroupId"]);
          } else if (existing["cssGroupId"]) {
            params["cssGroupId"] = String(existing["cssGroupId"]);
          }
    ...
    list: {
      description: "List csses resources",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["cssGroupId", "cssDomainId"],
            "parameters": {
              "cssDomainId": { "location": "path", "required": true },
              "cssGroupId": { "location": "path", "required": true },
            },
          },
          params,
          body,
