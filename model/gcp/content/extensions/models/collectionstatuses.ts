...
// Auto-generated extension model for @swamp/gcp/content/collectionstatuses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Content for Shopping Collectionstatuses.
 *
...
const StateSchema = z.object({
  collectionLevelIssuses: z.array(z.object({
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a collectionstatuses",
      arguments: z.object({
        identifier: z.string().describe("The name of the collectionstatuses"),
      }),
    ...
    sync: {
      description: "Sync collectionstatuses state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific collectionstatuses by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List collectionstatuses resources",
      arguments: z.object({
