...
/**
 * Swamp extension model for Google Cloud Content for Shopping Productstatuses.
 *
...
/** Swamp extension model for Google Cloud Content for Shopping Productstatuses. Registered at `@swamp/gcp/content/productstatuses`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific productstatuses by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List productstatuses resources",
      arguments: z.object({
