...
// Auto-generated extension model for @swamp/gcp/content/freelistingsprogram
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Content for Shopping Freelistingsprogram.
 *
...
/** Swamp extension model for Google Cloud Content for Shopping Freelistingsprogram. Registered at `@swamp/gcp/content/freelistingsprogram`. */
export const model = {
  type: "@swamp/gcp/content/freelistingsprogram",
  ...
  methods: {
    get: {
      description: "Get a freelistingsprogram",
      arguments: z.object({
        identifier: z.string().describe("The name of the freelistingsprogram"),
      }),
    ...
    sync: {
      description: "Sync freelistingsprogram state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific freelistingsprogram by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
