...
/**
 * Swamp extension model for Google Cloud Content for Shopping Accounts.Returncarrier.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific returncarrier by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List returncarrier resources",
      arguments: z.object({
