...
/**
 * Swamp extension model for Google Cloud Content for Shopping Shoppingadsprogram.
 *
...
/** Swamp extension model for Google Cloud Content for Shopping Shoppingadsprogram. Registered at `@swamp/gcp/content/shoppingadsprogram`. */
export const model = {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific shoppingadsprogram by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
