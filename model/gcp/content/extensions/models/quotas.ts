...
// Auto-generated extension model for @swamp/gcp/content/quotas
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Content for Shopping Quotas.
 *
...
/** Swamp extension model for Google Cloud Content for Shopping Quotas. Registered at `@swamp/gcp/content/quotas`. */
export const model = {
  type: "@swamp/gcp/content/quotas",
