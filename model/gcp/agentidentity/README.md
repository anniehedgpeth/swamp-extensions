...
Use `swamp model type describe @swamp/gcp/agentidentity/accesssummaries` to see
...
```bash
# Create a new accesssummaries model
swamp model create @swamp/gcp/agentidentity/accesssummaries my-accesssummaries

# Edit the model to configure its properties
swamp model edit my-accesssummaries

# Create the resource in GCP
swamp model method run my-accesssummaries create

# Sync current state from GCP
swamp model method run my-accesssummaries sync
```
