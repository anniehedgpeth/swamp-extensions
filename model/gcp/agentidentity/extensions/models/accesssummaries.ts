...
// Auto-generated extension model for @swamp/gcp/agentidentity/accesssummaries
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/accessSummaries/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  firstAccessTime: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a accessSummaries",
      arguments: z.object({
        identifier: z.string().describe("The name of the accessSummaries"),
      }),
    ...
    sync: {
      description: "Sync accessSummaries state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific accessSummaries by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List accessSummaries resources",
      arguments: z.object({
