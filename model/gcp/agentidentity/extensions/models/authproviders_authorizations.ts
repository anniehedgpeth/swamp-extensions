...
// Auto-generated extension model for @swamp/gcp/agentidentity/authproviders-authorizations
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/authorizations/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a authorizations",
      arguments: z.object({
        identifier: z.string().describe("The name of the authorizations"),
      }),
    ...
    delete: {
      description: "Delete the authorizations",
      arguments: z.object({
        identifier: z.string().describe("The name of the authorizations"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync authorizations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific authorizations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List authorizations resources",
      arguments: z.object({
