...
/**
 * Swamp extension model for Google Cloud Compute Engine TargetVpnGateways.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific targetVpnGateways by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List targetVpnGateways resources",
      arguments: z.object({
