...
// Auto-generated extension model for @swamp/gcp/compute/regionbackendbuckets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionBackendBuckets.
 *
...
const GET_CONFIG = {
  "id": "compute.regionBackendBuckets.get",
...
const INSERT_CONFIG = {
  "id": "compute.regionBackendBuckets.insert",
...
const PATCH_CONFIG = {
  "id": "compute.regionBackendBuckets.patch",
  "path": "projects/{project}/regions/{region}/backendBuckets/{backendBucket}",
  "httpMethod": "PATCH",
  "parameterOrder": [
    "project",
...
const DELETE_CONFIG = {
  "id": "compute.regionBackendBuckets.delete",
  "path": "projects/{project}/regions/{region}/backendBuckets/{backendBucket}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "project",
...
const LIST_CONFIG = {
  "id": "compute.regionBackendBuckets.list",
  "path": "projects/{project}/regions/{region}/backendBuckets",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionBackendBuckets",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a regionBackendBuckets",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionBackendBuckets"),
      }),
    ...
    update: {
      description: "Update regionBackendBuckets attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionBackendBuckets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the regionBackendBuckets",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionBackendBuckets"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync regionBackendBuckets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionBackendBuckets by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List regionBackendBuckets resources",
      arguments: z.object({
    ...
    get_iam_policy: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.regionBackendBuckets.getIamPolicy",
            "path":
              "projects/{project}/regions/{region}/backendBuckets/{resource}/getIamPolicy",
            "httpMethod": "GET",
    ...
    list_usable: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.regionBackendBuckets.listUsable",
            "path":
              "projects/{project}/regions/{region}/backendBuckets/listUsable",
            "httpMethod": "GET",
    ...
    set_iam_policy: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.regionBackendBuckets.setIamPolicy",
            "path":
              "projects/{project}/regions/{region}/backendBuckets/{resource}/setIamPolicy",
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
    ...
    test_iam_permissions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.regionBackendBuckets.testIamPermissions",
            "path":
              "projects/{project}/regions/{region}/backendBuckets/{resource}/testIamPermissions",
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
