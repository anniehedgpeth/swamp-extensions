...
// Auto-generated extension model for @swamp/gcp/compute/regionsnapshots
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionSnapshots.
 *
...
const GET_CONFIG = {
  "id": "compute.regionSnapshots.get",
...
const INSERT_CONFIG = {
  "id": "compute.regionSnapshots.insert",
...
const DELETE_CONFIG = {
  "id": "compute.regionSnapshots.delete",
  "path": "projects/{project}/regions/{region}/snapshots/{snapshot}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "project",
...
const LIST_CONFIG = {
  "id": "compute.regionSnapshots.list",
  "path": "projects/{project}/regions/{region}/snapshots",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionSnapshots",
      arguments: z.object({
    ...
    get: {
      description: "Get a regionSnapshots",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionSnapshots"),
      }),
    ...
    delete: {
      description: "Delete the regionSnapshots",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionSnapshots"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync regionSnapshots state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionSnapshots by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List regionSnapshots resources",
      arguments: z.object({
    ...
    get_iam_policy: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "compute.regionSnapshots.getIamPolicy",
            "path":
              "projects/{project}/regions/{region}/snapshots/{resource}/getIamPolicy",
            "httpMethod": "GET",
    ...
    set_iam_policy: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "compute.regionSnapshots.setIamPolicy",
            "path":
              "projects/{project}/regions/{region}/snapshots/{resource}/setIamPolicy",
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
    ...
    set_labels: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "compute.regionSnapshots.setLabels",
            "path":
              "projects/{project}/regions/{region}/snapshots/{resource}/setLabels",
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
    ...
    test_iam_permissions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "compute.regionSnapshots.testIamPermissions",
            "path":
              "projects/{project}/regions/{region}/snapshots/{resource}/testIamPermissions",
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
    ...
    update_kms_key: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "compute.regionSnapshots.updateKmsKey",
            "path":
              "projects/{project}/regions/{region}/snapshots/{snapshot}/updateKmsKey",
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "snapshot"],
            "parameters": {
              "project": { "location": "path", "required": true },
              "region": { "location": "path", "required": true },
              "requestId": { "location": "query" },
