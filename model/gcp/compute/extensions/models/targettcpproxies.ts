...
// Auto-generated extension model for @swamp/gcp/compute/targettcpproxies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine TargetTcpProxies.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a targetTcpProxies",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a targetTcpProxies",
      arguments: z.object({
        identifier: z.string().describe("The name of the targetTcpProxies"),
      }),
    ...
    delete: {
      description: "Delete the targetTcpProxies",
      arguments: z.object({
        identifier: z.string().describe("The name of the targetTcpProxies"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync targetTcpProxies state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific targetTcpProxies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List targetTcpProxies resources",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["project", "targetTcpProxy"],
            "parameters": {
              "project": { "location": "path", "required": true },
              "requestId": { "location": "query" },
              "targetTcpProxy": { "location": "path", "required": true },
            },
          },
          params,
          body,
