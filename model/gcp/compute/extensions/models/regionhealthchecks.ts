...
// Auto-generated extension model for @swamp/gcp/compute/regionhealthchecks
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionHealthChecks",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a regionHealthChecks",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionHealthChecks"),
      }),
    ...
    update: {
      description: "Update regionHealthChecks attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionHealthChecks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the regionHealthChecks",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionHealthChecks"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync regionHealthChecks state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionHealthChecks by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List regionHealthChecks resources",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "path":
              "projects/{project}/regions/{region}/healthChecks/{resource}/testIamPermissions",
            "httpMethod": "POST",
