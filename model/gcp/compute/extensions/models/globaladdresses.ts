...
// Auto-generated extension model for @swamp/gcp/compute/globaladdresses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine GlobalAddresses.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a globalAddresses",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a globalAddresses",
      arguments: z.object({
        identifier: z.string().describe("The name of the globalAddresses"),
      }),
    ...
    delete: {
      description: "Delete the globalAddresses",
      arguments: z.object({
        identifier: z.string().describe("The name of the globalAddresses"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync globalAddresses state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific globalAddresses by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List globalAddresses resources",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["project", "address"],
            "parameters": {
