...
// Auto-generated extension model for @swamp/gcp/compute/interconnectattachmentgroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine InterconnectAttachmentGroups.
 *
...
const GET_CONFIG = {
  "id": "compute.interconnectAttachmentGroups.get",
  "path":
    "projects/{project}/global/interconnectAttachmentGroups/{interconnectAttachmentGroup}",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
const INSERT_CONFIG = {
  "id": "compute.interconnectAttachmentGroups.insert",
...
const PATCH_CONFIG = {
  "id": "compute.interconnectAttachmentGroups.patch",
  "path":
    "projects/{project}/global/interconnectAttachmentGroups/{interconnectAttachmentGroup}",
  "httpMethod": "PATCH",
  "parameterOrder": [
...
const DELETE_CONFIG = {
  "id": "compute.interconnectAttachmentGroups.delete",
  "path":
    "projects/{project}/global/interconnectAttachmentGroups/{interconnectAttachmentGroup}",
  "httpMethod": "DELETE",
  "parameterOrder": [
...
const LIST_CONFIG = {
  "id": "compute.interconnectAttachmentGroups.list",
  "path": "projects/{project}/global/interconnectAttachmentGroups",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
const GlobalArgsSchema = z.object({
  ...
  interconnectGroup: z.string().describe(
...
const StateSchema = z.object({
  ...
  interconnectGroup: z.string().optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a interconnectAttachmentGroups",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["interconnectGroup"] !== undefined) {
    ...
    get: {
      description: "Get a interconnectAttachmentGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the interconnectAttachmentGroups",
        ),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        const projectId = await getProjectId(credentials);
        const params: Record<string, string> = { project: projectId };
        params["interconnectAttachmentGroup"] = args.identifier;
    ...
    update: {
      description: "Update interconnectAttachmentGroups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific interconnectAttachmentGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the interconnectAttachmentGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the interconnectAttachmentGroups",
        ),
    ...
    sync: {
      description: "Sync interconnectAttachmentGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific interconnectAttachmentGroups by name (e.g. one discovered by list)",
        ).optional(),
      ...
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        try {
          ...
          params["interconnectAttachmentGroup"] = identifier;
          const result = await readResource(
            BASE_URL,
            GET_CONFIG,
            params,
    ...
    list: {
      description: "List interconnectAttachmentGroups resources",
      arguments: z.object({
    ...
    get_iam_policy: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.interconnectAttachmentGroups.getIamPolicy",
            "path":
              "projects/{project}/global/interconnectAttachmentGroups/{resource}/getIamPolicy",
            "httpMethod": "GET",
    ...
    get_operational_status: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.interconnectAttachmentGroups.getOperationalStatus",
            "path":
              "projects/{project}/global/interconnectAttachmentGroups/{interconnectAttachmentGroup}/getOperationalStatus",
            "httpMethod": "GET",
            "parameterOrder": ["project", "interconnectAttachmentGroup"],
            "parameters": {
              "interconnectAttachmentGroup": {
                "location": "path",
                "required": true,
    ...
    set_iam_policy: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.interconnectAttachmentGroups.setIamPolicy",
            "path":
              "projects/{project}/global/interconnectAttachmentGroups/{resource}/setIamPolicy",
            "httpMethod": "POST",
            "parameterOrder": ["project", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
    ...
    test_iam_permissions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.interconnectAttachmentGroups.testIamPermissions",
            "path":
              "projects/{project}/global/interconnectAttachmentGroups/{resource}/testIamPermissions",
            "httpMethod": "POST",
            "parameterOrder": ["project", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
