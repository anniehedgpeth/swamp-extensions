...
// Auto-generated extension model for @swamp/gcp/compute/regioninstancegroupmanagerresizerequests
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionInstanceGroupManagerResizeRequests.
 *
...
const GET_CONFIG = {
  "id": "compute.regionInstanceGroupManagerResizeRequests.get",
  "path":
    "projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/resizeRequests/{resizeRequest}",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
    "region",
...
const INSERT_CONFIG = {
  "id": "compute.regionInstanceGroupManagerResizeRequests.insert",
  "path":
...
const DELETE_CONFIG = {
  "id": "compute.regionInstanceGroupManagerResizeRequests.delete",
  "path":
    "projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/resizeRequests/{resizeRequest}",
  "httpMethod": "DELETE",
  "parameterOrder": [
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionInstanceGroupManagerResizeRequests",
      arguments: z.object({
    ...
    get: {
      description: "Get a regionInstanceGroupManagerResizeRequests",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionInstanceGroupManagerResizeRequests",
        ),
      }),
    ...
    delete: {
      description: "Delete the regionInstanceGroupManagerResizeRequests",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionInstanceGroupManagerResizeRequests",
        ),
    ...
    sync: {
      description:
        "Sync regionInstanceGroupManagerResizeRequests state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionInstanceGroupManagerResizeRequests by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List regionInstanceGroupManagerResizeRequests resources",
      arguments: z.object({
    ...
    cancel: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.regionInstanceGroupManagerResizeRequests.cancel",
            "path":
              "projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/resizeRequests/{resizeRequest}/cancel",
            "httpMethod": "POST",
            "parameterOrder": [
              "project",
              "region",
