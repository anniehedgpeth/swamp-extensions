...
// Auto-generated extension model for @swamp/gcp/compute/networkedgesecurityservices
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine NetworkEdgeSecurityServices.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a networkEdgeSecurityServices",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["securityPolicy"] !== undefined) {
          body["securityPolicy"] = g["securityPolicy"];
        }
        if (g["requestId"] !== undefined) {
          params["requestId"] = String(g["requestId"]);
        }
        if (g["name"] !== undefined) {
          params["networkEdgeSecurityService"] = String(g["name"]);
        }
    ...
    get: {
      description: "Get a networkEdgeSecurityServices",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the networkEdgeSecurityServices",
        ),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        const params: Record<string, string> = { project: projectId };
        if (g["region"] !== undefined) params["region"] = String(g["region"]);
        params["networkEdgeSecurityService"] = args.identifier;
    ...
    update: {
      description: "Update networkEdgeSecurityServices attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific networkEdgeSecurityServices by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
        ...
        params["networkEdgeSecurityService"] = existing["name"]?.toString() ??
          "";
        const body: Record<string, unknown> = {};
        if (g["description"] !== undefined) {
          body["description"] = g["description"];
    ...
    delete: {
      description: "Delete the networkEdgeSecurityServices",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the networkEdgeSecurityServices",
        ),
    ...
    sync: {
      description: "Sync networkEdgeSecurityServices state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific networkEdgeSecurityServices by name (e.g. one discovered by list)",
        ).optional(),
      ...
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        try {
          ...
          params["networkEdgeSecurityService"] = identifier;
          const result = await readResource(
            BASE_URL,
            GET_CONFIG,
            params,
