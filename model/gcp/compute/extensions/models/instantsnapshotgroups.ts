...
// Auto-generated extension model for @swamp/gcp/compute/instantsnapshotgroups
...
const GET_CONFIG = {
  "id": "compute.instantSnapshotGroups.get",
  "path":
...
const INSERT_CONFIG = {
  "id": "compute.instantSnapshotGroups.insert",
...
const DELETE_CONFIG = {
  "id": "compute.instantSnapshotGroups.delete",
  "path":
    "projects/{project}/zones/{zone}/instantSnapshotGroups/{instantSnapshotGroup}",
  "httpMethod": "DELETE",
  "parameterOrder": [
...
const LIST_CONFIG = {
  "id": "compute.instantSnapshotGroups.list",
  "path": "projects/{project}/zones/{zone}/instantSnapshotGroups",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a instantSnapshotGroups",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["sourceConsistencyGroup"] !== undefined) {
          params["sourceConsistencyGroup"] = String(
            g["sourceConsistencyGroup"],
          );
        }
    ...
    get: {
      description: "Get a instantSnapshotGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the instantSnapshotGroups",
        ),
      }),
    ...
    delete: {
      description: "Delete the instantSnapshotGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the instantSnapshotGroups",
        ),
    ...
    sync: {
      description: "Sync instantSnapshotGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific instantSnapshotGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List instantSnapshotGroups resources",
      arguments: z.object({
    ...
    get_iam_policy: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.instantSnapshotGroups.getIamPolicy",
            "path":
              "projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/getIamPolicy",
            "httpMethod": "GET",
    ...
    set_iam_policy: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.instantSnapshotGroups.setIamPolicy",
            "path":
              "projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/setIamPolicy",
            "httpMethod": "POST",
            "parameterOrder": ["project", "zone", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
    ...
    test_iam_permissions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.instantSnapshotGroups.testIamPermissions",
            "path":
              "projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/testIamPermissions",
            "httpMethod": "POST",
            "parameterOrder": ["project", "zone", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
