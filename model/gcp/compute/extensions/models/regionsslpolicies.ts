...
// Auto-generated extension model for @swamp/gcp/compute/regionsslpolicies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionSslPolicies.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionSslPolicies",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a regionSslPolicies",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionSslPolicies"),
      }),
    ...
    update: {
      description: "Update regionSslPolicies attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionSslPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the regionSslPolicies",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionSslPolicies"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync regionSslPolicies state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionSslPolicies by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List regionSslPolicies resources",
      arguments: z.object({
