...
// Auto-generated extension model for @swamp/gcp/compute/regionzones
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionZones.
 *
...
const GlobalArgsSchema = z.object({
  ...
  region: z.string().describe("Region for this request."),
});

const StateSchema = z.object({
  availableCpuPlatforms: z.array(z.string()).optional(),
...
const InputsSchema = z.object({
  ...
  region: z.string().describe("Region for this request.").optional(),
});
...
/** Swamp extension model for Google Cloud Compute Engine RegionZones. Registered at `@swamp/gcp/compute/regionzones`. */
export const model = {
  type: "@swamp/gcp/compute/regionzones",
  ...
  methods: {
    get: {
      description: "Get a regionZones",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionZones"),
      }),
    ...
    sync: {
      description: "Sync regionZones state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionZones by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List regionZones resources",
      arguments: z.object({
