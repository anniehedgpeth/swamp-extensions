...
/**
 * Swamp extension model for Google Cloud Compute Engine HttpsHealthChecks.
 *
...
/** Swamp extension model for Google Cloud Compute Engine HttpsHealthChecks. Registered at `@swamp/gcp/compute/httpshealthchecks`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific httpsHealthChecks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List httpsHealthChecks resources",
      arguments: z.object({
