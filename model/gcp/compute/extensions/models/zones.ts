...
// Auto-generated extension model for @swamp/gcp/compute/zones
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine Zones.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a zones",
      arguments: z.object({
        identifier: z.string().describe("The name of the zones"),
      }),
    ...
    sync: {
      description: "Sync zones state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific zones by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List zones resources",
      arguments: z.object({
