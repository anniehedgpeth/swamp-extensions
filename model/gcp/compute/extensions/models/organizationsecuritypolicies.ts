...
// Auto-generated extension model for @swamp/gcp/compute/organizationsecuritypolicies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine OrganizationSecurityPolicies.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a organizationSecurityPolicies",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a organizationSecurityPolicies",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the organizationSecurityPolicies",
        ),
      }),
    ...
    update: {
      description: "Update organizationSecurityPolicies attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific organizationSecurityPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the organizationSecurityPolicies",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the organizationSecurityPolicies",
        ),
    ...
    sync: {
      description: "Sync organizationSecurityPolicies state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific organizationSecurityPolicies by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List organizationSecurityPolicies resources",
      arguments: z.object({
    ...
    add_association: {
      ...
      arguments: z.object({
        ...
        excludedFolders: z.any().optional(),
        excludedProjects: z.any().optional(),
        name: z.any().optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["excludedFolders"] !== undefined) {
          body["excludedFolders"] = args["excludedFolders"];
        }
        if (args["excludedProjects"] !== undefined) {
          body["excludedProjects"] = args["excludedProjects"];
        }
        if (args["name"] !== undefined) body["name"] = args["name"];
        if (args["securityPolicyId"] !== undefined) {
          body["securityPolicyId"] = args["securityPolicyId"];
        }
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "parameters": {
              "requestId": { "location": "query" },
              "securityPolicy": { "location": "path", "required": true },
              "sourceSecurityPolicy": { "location": "query" },
            },
          },
          params,
          {},
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "path":
              "locations/global/securityPolicies/listPreconfiguredExpressionSets",
            "httpMethod": "GET",
            "parameterOrder": [],
            "parameters": {
