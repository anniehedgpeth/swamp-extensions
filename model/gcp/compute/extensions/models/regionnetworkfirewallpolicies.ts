...
// Auto-generated extension model for @swamp/gcp/compute/regionnetworkfirewallpolicies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionNetworkFirewallPolicies.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionNetworkFirewallPolicies",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a regionNetworkFirewallPolicies",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionNetworkFirewallPolicies",
        ),
      }),
    ...
    update: {
      description: "Update regionNetworkFirewallPolicies attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionNetworkFirewallPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the regionNetworkFirewallPolicies",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionNetworkFirewallPolicies",
        ),
    ...
    sync: {
      description: "Sync regionNetworkFirewallPolicies state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionNetworkFirewallPolicies by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List regionNetworkFirewallPolicies resources",
      arguments: z.object({
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "GET",
            "parameterOrder": ["project", "region", "network"],
            "parameters": {
              "network": { "location": "query", "required": true },
              "project": { "location": "path", "required": true },
              "region": { "location": "path", "required": true },
            },
          },
