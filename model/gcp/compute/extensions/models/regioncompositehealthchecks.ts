...
const LIST_CONFIG = {
  "id": "compute.regionCompositeHealthChecks.list",
  "path": "projects/{project}/regions/{region}/compositeHealthChecks",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionCompositeHealthChecks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    test_iam_permissions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.regionCompositeHealthChecks.testIamPermissions",
            "path":
              "projects/{project}/regions/{region}/compositeHealthChecks/{resource}/testIamPermissions",
            "httpMethod": "POST",
