...
// Auto-generated extension model for @swamp/gcp/compute/regioninstantsnapshots
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionInstantSnapshots.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionInstantSnapshots",
      arguments: z.object({
    ...
    get: {
      description: "Get a regionInstantSnapshots",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionInstantSnapshots",
        ),
      }),
    ...
    delete: {
      description: "Delete the regionInstantSnapshots",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionInstantSnapshots",
        ),
    ...
    sync: {
      description: "Sync regionInstantSnapshots state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionInstantSnapshots by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List regionInstantSnapshots resources",
      arguments: z.object({
