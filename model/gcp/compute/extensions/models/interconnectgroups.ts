...
/**
 * Swamp extension model for Google Cloud Compute Engine InterconnectGroups.
 *
...
const LIST_CONFIG = {
  "id": "compute.interconnectGroups.list",
  "path": "projects/{project}/global/interconnectGroups",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
/** Swamp extension model for Google Cloud Compute Engine InterconnectGroups. Registered at `@swamp/gcp/compute/interconnectgroups`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific interconnectGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List interconnectGroups resources",
      arguments: z.object({
    ...
    get_iam_policy: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.interconnectGroups.getIamPolicy",
            "path":
              "projects/{project}/global/interconnectGroups/{resource}/getIamPolicy",
            "httpMethod": "GET",
    ...
    set_iam_policy: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.interconnectGroups.setIamPolicy",
            "path":
              "projects/{project}/global/interconnectGroups/{resource}/setIamPolicy",
            "httpMethod": "POST",
            "parameterOrder": ["project", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
    ...
    test_iam_permissions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.interconnectGroups.testIamPermissions",
            "path":
              "projects/{project}/global/interconnectGroups/{resource}/testIamPermissions",
            "httpMethod": "POST",
            "parameterOrder": ["project", "resource"],
            "parameters": {
              "project": { "location": "path", "required": true },
