...
// Auto-generated extension model for @swamp/gcp/compute/acceleratortypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine AcceleratorTypes.
 *
  ...
  methods: {
    get: {
      ...
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["acceleratorType"] = args.identifier;
    ...
    sync: {
      ...
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        try {
          ...
          params["acceleratorType"] = identifier;
          const result = await readResource(
            baseUrl,
            GET_CONFIG,
            params,
