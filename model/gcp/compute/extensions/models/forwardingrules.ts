...
// Auto-generated extension model for @swamp/gcp/compute/forwardingrules
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine ForwardingRules.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a forwardingRules",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a forwardingRules",
      arguments: z.object({
        identifier: z.string().describe("The name of the forwardingRules"),
      }),
    ...
    update: {
      description: "Update forwardingRules attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific forwardingRules by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the forwardingRules",
      arguments: z.object({
        identifier: z.string().describe("The name of the forwardingRules"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync forwardingRules state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific forwardingRules by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List forwardingRules resources",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "forwardingRule"],
            "parameters": {
