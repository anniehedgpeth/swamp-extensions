...
/**
 * Swamp extension model for Google Cloud Compute Engine RegionHealthAggregationPolicies.
 *
...
const LIST_CONFIG = {
  "id": "compute.regionHealthAggregationPolicies.list",
  "path": "projects/{project}/regions/{region}/healthAggregationPolicies",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
/** Swamp extension model for Google Cloud Compute Engine RegionHealthAggregationPolicies. Registered at `@swamp/gcp/compute/regionhealthaggregationpolicies`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionHealthAggregationPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List regionHealthAggregationPolicies resources",
      arguments: z.object({
    ...
    test_iam_permissions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "compute.regionHealthAggregationPolicies.testIamPermissions",
            "path":
              "projects/{project}/regions/{region}/healthAggregationPolicies/{resource}/testIamPermissions",
            "httpMethod": "POST",
