...
/**
 * Swamp extension model for Google Cloud Compute Engine NetworkFirewallPolicies.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific networkFirewallPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List networkFirewallPolicies resources",
      arguments: z.object({
