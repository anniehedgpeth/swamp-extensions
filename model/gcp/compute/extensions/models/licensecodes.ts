...
// Auto-generated extension model for @swamp/gcp/compute/licensecodes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine LicenseCodes.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a licenseCodes",
      arguments: z.object({
        identifier: z.string().describe("The name of the licenseCodes"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["licenseCode"] = args.identifier;
