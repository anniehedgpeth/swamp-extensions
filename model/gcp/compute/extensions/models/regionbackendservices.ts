...
// Auto-generated extension model for @swamp/gcp/compute/regionbackendservices
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionBackendServices.
 *
...
const GlobalArgsSchema = z.object({
  ...
  backends: z.array(z.object({
    balancingMode: z.enum([
      ...
      "Specifies how to determine whether the backend of a load balancer can handle additional traffic or is fully loaded. For usage guidelines, see Connection balancing mode. Backends must use compatible balancing modes. Backends of a backend service may use different balancing modes. For more information, see Supported balancing modes and target capacity settings and Restrictions and guidance for instance groups. Note: Currently, if you use the API to configure incompatible balancing modes, the configuration might be accepted even though it has no impact and is ignored. Specifically, Backend.maxUtilization is ignored when Backend.balancingMode is RATE. In the future, this incompatible combination will be rejected.",
    ).optional(),
    ...
    failover: z.boolean().describe(
      "This field designates whether this is a failover backend. More than one failover backend can be configured for a given BackendService. This field can only be used for a regional external Passthrough Network Load Balancer or a regional internal Passthrough Network Load Balancer.",
    ).optional(),
    ...
    preference: z.enum(["DEFAULT", "PREFERENCE_UNSPECIFIED", "PREFERRED"])
      .describe(
        "This field indicates whether this backend should be fully utilized before sending traffic to backends with default preference. The possible values are: - PREFERRED: Backends with this preference level will be filled up to their capacity limits first, based on RTT. - DEFAULT: If preferred backends don't have enough capacity, backends in this layer would be used and traffic would be assigned based on the load balancing algorithm you use. This is the default For global external Passthrough Network Load Balancers, the following restrictions apply: - At most one backend can be marked as PREFERRED. - PREFERRED and DEFAULT backends cannot reside in the same Cloud region.",
      ).optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionBackendServices",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a regionBackendServices",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionBackendServices",
        ),
      }),
    ...
    update: {
      description: "Update regionBackendServices attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionBackendServices by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the regionBackendServices",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionBackendServices",
        ),
    ...
    sync: {
      description: "Sync regionBackendServices state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionBackendServices by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List regionBackendServices resources",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "backendService"],
            "parameters": {
