...
// Auto-generated extension model for @swamp/gcp/compute/regionhealthsources
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine RegionHealthSources.
 *
...
const GET_CONFIG = {
  "id": "compute.regionHealthSources.get",
...
const INSERT_CONFIG = {
  "id": "compute.regionHealthSources.insert",
...
const PATCH_CONFIG = {
  "id": "compute.regionHealthSources.patch",
  "path": "projects/{project}/regions/{region}/healthSources/{healthSource}",
  "httpMethod": "PATCH",
  "parameterOrder": [
    "project",
...
const DELETE_CONFIG = {
  "id": "compute.regionHealthSources.delete",
  "path": "projects/{project}/regions/{region}/healthSources/{healthSource}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "project",
...
const LIST_CONFIG = {
  "id": "compute.regionHealthSources.list",
  "path": "projects/{project}/regions/{region}/healthSources",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
...
const GlobalArgsSchema = z.object({
  ...
  healthAggregationPolicy: z.string().describe(
  ...
  sourceType: z.enum(["BACKEND_SERVICE"]).describe(
...
const StateSchema = z.object({
  ...
  healthAggregationPolicy: z.string().optional(),
...
/** Swamp extension model for Google Cloud Compute Engine RegionHealthSources. Registered at `@swamp/gcp/compute/regionhealthsources`. */
export const model = {
  ...
  resources: {
    state: {
      description:
        "Represents a health source. A health source resource specifies the source res...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a regionHealthSources",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["healthAggregationPolicy"] !== undefined) {
          body["healthAggregationPolicy"] = g["healthAggregationPolicy"];
        }
        ...
        if (g["name"] !== undefined) params["healthSource"] = String(g["name"]);
    ...
    get: {
      description: "Get a regionHealthSources",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionHealthSources"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        const params: Record<string, string> = { project: projectId };
        if (g["region"] !== undefined) params["region"] = String(g["region"]);
        params["healthSource"] = args.identifier;
    ...
    update: {
      description: "Update regionHealthSources attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionHealthSources by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the regionHealthSources",
      arguments: z.object({
        identifier: z.string().describe("The name of the regionHealthSources"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync regionHealthSources state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionHealthSources by name (e.g. one discovered by list)",
        ).optional(),
      ...
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        try {
          ...
          params["healthSource"] = identifier;
          const result = await readResource(
            BASE_URL,
            GET_CONFIG,
            params,
    ...
    list: {
      description: "List regionHealthSources resources",
      arguments: z.object({
    ...
    test_iam_permissions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            "id": "compute.regionHealthSources.testIamPermissions",
            "path":
              "projects/{project}/regions/{region}/healthSources/{resource}/testIamPermissions",
            "httpMethod": "POST",
