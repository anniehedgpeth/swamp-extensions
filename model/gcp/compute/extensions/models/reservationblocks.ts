...
/**
 * Swamp extension model for Google Cloud Compute Engine ReservationBlocks.
 *
...
const LIST_CONFIG = {
  ...
  "path":
    "projects/{project}/zones/{zone}/reservations/{reservation}/reservationBlocks",
  "httpMethod": "GET",
  "parameterOrder": [
    "project",
    "zone",
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific reservationBlocks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List reservationBlocks resources",
      arguments: z.object({
