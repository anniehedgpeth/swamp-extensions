...
// Auto-generated extension model for @swamp/gcp/compute/regiontargethttpproxies
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a regionTargetHttpProxies",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a regionTargetHttpProxies",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionTargetHttpProxies",
        ),
      }),
    ...
    delete: {
      description: "Delete the regionTargetHttpProxies",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the regionTargetHttpProxies",
        ),
    ...
    sync: {
      description: "Sync regionTargetHttpProxies state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionTargetHttpProxies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List regionTargetHttpProxies resources",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["project", "region", "targetHttpProxy"],
            "parameters": {
