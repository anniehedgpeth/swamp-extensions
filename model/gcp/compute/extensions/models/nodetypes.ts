...
/**
 * Swamp extension model for Google Cloud Compute Engine NodeTypes.
 *
...
/** Swamp extension model for Google Cloud Compute Engine NodeTypes. Registered at `@swamp/gcp/compute/nodetypes`. */
export const model = {
