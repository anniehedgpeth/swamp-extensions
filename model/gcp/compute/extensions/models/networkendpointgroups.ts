...
// Auto-generated extension model for @swamp/gcp/compute/networkendpointgroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Compute Engine NetworkEndpointGroups.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a networkEndpointGroups",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a networkEndpointGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the networkEndpointGroups",
        ),
      }),
    ...
    delete: {
      description: "Delete the networkEndpointGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the networkEndpointGroups",
        ),
    ...
    sync: {
      description: "Sync networkEndpointGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific networkEndpointGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List networkEndpointGroups resources",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["project", "zone", "networkEndpointGroup"],
            "parameters": {
