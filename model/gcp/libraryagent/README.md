...
Use `swamp model type describe @swamp/gcp/libraryagent/shelves_books` to see the
...
```bash
# Create a new shelves_books model
swamp model create @swamp/gcp/libraryagent/shelves_books my-shelves_books

# Edit the model to configure its properties
swamp model edit my-shelves_books

# Create the resource in GCP
swamp model method run my-shelves_books create

# Sync current state from GCP
swamp model method run my-shelves_books sync
```
