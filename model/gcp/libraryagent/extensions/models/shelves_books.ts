...
// Auto-generated extension model for @swamp/gcp/libraryagent/shelves-books
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Library Agent Shelves.Books.
 *
...
export const model = {
  ...
  methods: {
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The name of the books"),
      }),
    ...
    sync: {
      description: "Sync books state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific books by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List books resources",
      arguments: z.object({
