...
// Auto-generated extension model for @swamp/gcp/cloudfunctions/runtimes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Functions Runtimes.
 *
...
/** Swamp extension model for Google Cloud Functions Runtimes. Registered at `@swamp/gcp/cloudfunctions/runtimes`. */
export const model = {
  type: "@swamp/gcp/cloudfunctions/runtimes",
  ...
  resources: {
    state: {
      description:
        "Describes a runtime and any special information (e.g., deprecation status) re...",
      schema: StateSchema,
      lifetime: "infinite",
