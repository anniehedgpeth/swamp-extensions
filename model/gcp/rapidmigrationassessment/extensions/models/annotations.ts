...
// Auto-generated extension model for @swamp/gcp/rapidmigrationassessment/annotations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Rapid Migration Assessment Annotations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/annotations/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  type: z.enum([
    ...
    "TYPE_QWIKLAB",
  ]).describe("Type of an annotation.").optional(),
