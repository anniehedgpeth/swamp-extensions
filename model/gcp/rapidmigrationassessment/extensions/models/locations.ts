...
// Auto-generated extension model for @swamp/gcp/rapidmigrationassessment/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Rapid Migration Assessment Locations.
 *
...
/** Swamp extension model for Google Cloud Rapid Migration Assessment Locations. Registered at `@swamp/gcp/rapidmigrationassessment/locations`. */
export const model = {
  type: "@swamp/gcp/rapidmigrationassessment/locations",
