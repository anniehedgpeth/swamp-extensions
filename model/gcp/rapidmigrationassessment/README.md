...
Google Cloud rapidmigrationassessment resources.
...
Use `swamp model type describe @swamp/gcp/rapidmigrationassessment/annotations`
...
```bash
# Create a new annotations model
swamp model create @swamp/gcp/rapidmigrationassessment/annotations my-annotations

# Edit the model to configure its properties
swamp model edit my-annotations

# Create the resource in GCP
swamp model method run my-annotations create

# Sync current state from GCP
swamp model method run my-annotations sync
```
