...
// Auto-generated extension model for @swamp/gcp/bigtableadmin/instances-clusters-memorylayers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Bigtable Admin Instances.Clusters.MemoryLayers.
 *
...
const LIST_CONFIG = {
  "id": "bigtableadmin.projects.instances.clusters.memoryLayers.list",
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a memoryLayers",
      arguments: z.object({
        identifier: z.string().describe("The name of the memoryLayers"),
      }),
    ...
    sync: {
      description: "Sync memoryLayers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific memoryLayers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List memoryLayers resources",
      arguments: z.object({
