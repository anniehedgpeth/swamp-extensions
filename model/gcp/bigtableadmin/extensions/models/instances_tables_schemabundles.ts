...
// Auto-generated extension model for @swamp/gcp/bigtableadmin/instances-tables-schemabundles
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Bigtable Admin Instances.Tables.SchemaBundles.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/schemaBundles/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  }).describe("Schema for Protobufs.").optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a schemaBundles",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["schemaBundleId"] !== undefined) {
          params["schemaBundleId"] = String(g["schemaBundleId"]);
        }
    ...
    get: {
      description: "Get a schemaBundles",
      arguments: z.object({
        identifier: z.string().describe("The name of the schemaBundles"),
      }),
    ...
    delete: {
      description: "Delete the schemaBundles",
      arguments: z.object({
        identifier: z.string().describe("The name of the schemaBundles"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    list: {
      description: "List schemaBundles resources",
      arguments: z.object({
