...
// Auto-generated extension model for @swamp/gcp/bigtableadmin/instances-materializedviews
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Bigtable Admin Instances.MaterializedViews.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/materializedViews/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a materializedViews",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a materializedViews",
      arguments: z.object({
        identifier: z.string().describe("The name of the materializedViews"),
      }),
    ...
    update: {
      description: "Update materializedViews attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific materializedViews by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the materializedViews",
      arguments: z.object({
        identifier: z.string().describe("The name of the materializedViews"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync materializedViews state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific materializedViews by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List materializedViews resources",
      arguments: z.object({
