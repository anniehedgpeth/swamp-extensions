...
// Auto-generated extension model for @swamp/gcp/bigtableadmin/instances-logicalviews
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Bigtable Admin Instances.LogicalViews.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/logicalViews/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  query: z.string().describe("Required. The logical view's select query.")
    .optional(),
  logicalViewId: z.string().describe(
...
/** Swamp extension model for Google Cloud Bigtable Admin Instances.LogicalViews. Registered at `@swamp/gcp/bigtableadmin/instances-logicalviews`. */
export const model = {
  type: "@swamp/gcp/bigtableadmin/instances-logicalviews",
  ...
  methods: {
    create: {
      description: "Create a logicalViews",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["logicalViewId"] !== undefined) {
          params["logicalViewId"] = String(g["logicalViewId"]);
        }
    ...
    get: {
      description: "Get a logicalViews",
      arguments: z.object({
        identifier: z.string().describe("The name of the logicalViews"),
      }),
    ...
    update: {
      description: "Update logicalViews attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific logicalViews by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the logicalViews",
      arguments: z.object({
        identifier: z.string().describe("The name of the logicalViews"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync logicalViews state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific logicalViews by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List logicalViews resources",
      arguments: z.object({
