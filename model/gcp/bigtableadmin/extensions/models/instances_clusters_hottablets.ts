...
// Auto-generated extension model for @swamp/gcp/bigtableadmin/instances-clusters-hottablets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Bigtable Admin Instances.Clusters.HotTablets.
 *
...
const StateSchema = z.object({
  ...
  name: z.string(),
  nodeCpuUsagePercent: z.number().optional(),
...
/** Swamp extension model for Google Cloud Bigtable Admin Instances.Clusters.HotTablets. Registered at `@swamp/gcp/bigtableadmin/instances-clusters-hottablets`. */
export const model = {
  type: "@swamp/gcp/bigtableadmin/instances-clusters-hottablets",
  ...
  resources: {
    state: {
      description:
        "A tablet is a defined by a start and end key and is explained in https://clou...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a hotTablets",
      arguments: z.object({
        identifier: z.string().describe("The name of the hotTablets"),
      }),
    ...
    sync: {
      description: "Sync hotTablets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific hotTablets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List hotTablets resources",
      arguments: z.object({
        endTime: z.string().describe("The end time to list hot tablets.")
          .optional(),
