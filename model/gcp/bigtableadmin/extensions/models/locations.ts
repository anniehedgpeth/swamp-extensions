...
/**
 * Swamp extension model for Google Cloud Bigtable Admin Locations.
 *
...
/** Swamp extension model for Google Cloud Bigtable Admin Locations. Registered at `@swamp/gcp/bigtableadmin/locations`. */
export const model = {
