...
Google Cloud bigtableadmin resources.
...
Use `swamp model type describe @swamp/gcp/bigtableadmin/instances_appprofiles`
...
```bash
# Create a new instances_appprofiles model
swamp model create @swamp/gcp/bigtableadmin/instances_appprofiles my-instances_appprofiles

# Edit the model to configure its properties
swamp model edit my-instances_appprofiles

# Create the resource in GCP
swamp model method run my-instances_appprofiles create

# Sync current state from GCP
swamp model method run my-instances_appprofiles sync
```
