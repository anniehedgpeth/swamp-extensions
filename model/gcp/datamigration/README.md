...
Google Cloud datamigration resources.
...
Use `swamp model type describe @swamp/gcp/datamigration/connectionprofiles` to
...
```bash
# Create a new connectionprofiles model
swamp model create @swamp/gcp/datamigration/connectionprofiles my-connectionprofiles

# Edit the model to configure its properties
swamp model edit my-connectionprofiles

# Create the resource in GCP
swamp model method run my-connectionprofiles create

# Sync current state from GCP
swamp model method run my-connectionprofiles sync
```
