...
// Auto-generated extension model for @swamp/gcp/datamigration/migrationjobs-objects
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Database Migration MigrationJobs.Objects.
 *
...
const GET_CONFIG = {
  "id": "datamigration.projects.locations.migrationJobs.objects.get",
  "path": "v1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "datamigration.projects.locations.migrationJobs.objects.list",
...
const StateSchema = z.object({
  ...
  heterogeneousMetadata: z.object({
    unsupportedEventsCount: z.string(),
  }).optional(),
  name: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "A specific Migration Job Object (e.g. a specifc DB Table)",
      schema: StateSchema,
      lifetime: "infinite",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific objects by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
