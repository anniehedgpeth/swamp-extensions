...
Google Cloud prod_tt_sasportal resources.
...
Use
`swamp model type describe @swamp/gcp/prod_tt_sasportal/customers_deployments_devices`
...
```bash
# Create a new customers_deployments_devices model
swamp model create @swamp/gcp/prod_tt_sasportal/customers_deployments_devices my-customers_deployments_devices

# Edit the model to configure its properties
swamp model edit my-customers_deployments_devices

# Create the resource in GCP
swamp model method run my-customers_deployments_devices create

# Sync current state from GCP
swamp model method run my-customers_deployments_devices sync
```
