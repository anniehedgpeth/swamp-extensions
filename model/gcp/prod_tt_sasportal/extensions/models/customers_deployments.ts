...
// Auto-generated extension model for @swamp/gcp/prod_tt_sasportal/customers-deployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal (Testing) Customers.Deployments.
 *
 * The Deployment.
 *
...
/** Swamp extension model for Google Cloud SAS Portal (Testing) Customers.Deployments. Registered at `@swamp/gcp/prod_tt_sasportal/customers-deployments`. */
export const model = {
  type: "@swamp/gcp/prod_tt_sasportal/customers-deployments",
