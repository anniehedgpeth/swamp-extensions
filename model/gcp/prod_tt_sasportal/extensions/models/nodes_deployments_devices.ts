...
// Auto-generated extension model for @swamp/gcp/prod_tt_sasportal/nodes-deployments-devices
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal (Testing) Nodes.Deployments.Devices.
 *
...
/** Swamp extension model for Google Cloud SAS Portal (Testing) Nodes.Deployments.Devices. Registered at `@swamp/gcp/prod_tt_sasportal/nodes-deployments-devices`. */
export const model = {
  type: "@swamp/gcp/prod_tt_sasportal/nodes-deployments-devices",
