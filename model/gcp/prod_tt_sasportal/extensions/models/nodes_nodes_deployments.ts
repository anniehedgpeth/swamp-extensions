...
// Auto-generated extension model for @swamp/gcp/prod_tt_sasportal/nodes-nodes-deployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal (Testing) Nodes.Nodes.Deployments.
 *
 * The Deployment.
 *
...
/** Swamp extension model for Google Cloud SAS Portal (Testing) Nodes.Nodes.Deployments. Registered at `@swamp/gcp/prod_tt_sasportal/nodes-nodes-deployments`. */
export const model = {
  type: "@swamp/gcp/prod_tt_sasportal/nodes-nodes-deployments",
