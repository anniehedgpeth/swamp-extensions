...
// Auto-generated extension model for @swamp/gcp/prod_tt_sasportal/nodes-deployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal (Testing) Nodes.Deployments.
 *
 * The Deployment.
 *
...
const GlobalArgsSchema = z.object({
  ...
  displayName: z.string().describe("The deployment's display name.").optional(),
  frns: z.array(z.string()).describe(
    "Output only. The FCC Registration Numbers (FRNs) copied from its direct parent.",
  ).optional(),
  name: z.string().describe("Output only. Resource name.").optional(),
...
const StateSchema = z.object({
  ...
  frns: z.array(z.string()).optional(),
  name: z.string(),
...
/** Swamp extension model for Google Cloud SAS Portal (Testing) Nodes.Deployments. Registered at `@swamp/gcp/prod_tt_sasportal/nodes-deployments`. */
export const model = {
  type: "@swamp/gcp/prod_tt_sasportal/nodes-deployments",
  ...
  methods: {
    ...
    update: {
      ...
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        if (g["frns"] !== undefined) body["frns"] = g["frns"];
