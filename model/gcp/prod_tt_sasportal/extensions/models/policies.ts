...
// Auto-generated extension model for @swamp/gcp/prod_tt_sasportal/policies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal (Testing) Policies.
 *
...
/** Swamp extension model for Google Cloud SAS Portal (Testing) Policies. Registered at `@swamp/gcp/prod_tt_sasportal/policies`. */
export const model = {
  type: "@swamp/gcp/prod_tt_sasportal/policies",
