...
// Auto-generated extension model for @swamp/gcp/prod_tt_sasportal/customers-nodes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal (Testing) Customers.Nodes.
 *
 * The Node.
 *
...
/** Swamp extension model for Google Cloud SAS Portal (Testing) Customers.Nodes. Registered at `@swamp/gcp/prod_tt_sasportal/customers-nodes`. */
export const model = {
  type: "@swamp/gcp/prod_tt_sasportal/customers-nodes",
