...
// Auto-generated extension model for @swamp/gcp/prod_tt_sasportal/deployments-devices
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal (Testing) Deployments.Devices.
 *
...
const GlobalArgsSchema = z.object({
  ...
  grants: z.array(z.object({
    channelType: z.enum([
      ...
      "CHANNEL_TYPE_GAA",
      "CHANNEL_TYPE_PAL",
    ]).describe("Type of channel used.").optional(),
    expireTime: z.string().describe("The expiration time of the grant.")
      .optional(),
    ...
    state: z.enum([
      ...
      "GRANT_STATE_EXPIRED",
    ]).describe("State of the grant.").optional(),
    suspensionReason: z.array(z.string()).describe(
      "If the grant is suspended, the reason(s) for suspension.",
    ).optional(),
  })).describe("Output only. Grants held by the device.").optional(),
  name: z.string().describe("Output only. The resource path name.").optional(),
  ...
  state: z.enum([
    ...
    "REGISTERED",
    "DEREGISTERED",
  ]).describe("Output only. Device state.").optional(),
});
...
/** Swamp extension model for Google Cloud SAS Portal (Testing) Deployments.Devices. Registered at `@swamp/gcp/prod_tt_sasportal/deployments-devices`. */
export const model = {
  type: "@swamp/gcp/prod_tt_sasportal/deployments-devices",
  ...
  methods: {
    ...
    sign_device: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (g["name"] !== undefined) params["name"] = String(g["name"]);
        const body: Record<string, unknown> = {};
        if (args["device"] !== undefined) body["device"] = args["device"];
        const result = await createResource(
          BASE_URL,
          {
