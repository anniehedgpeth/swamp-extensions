...
// Auto-generated extension model for @swamp/gcp/prod_tt_sasportal/customers-nodes-nodes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal (Testing) Customers.Nodes.Nodes.
 *
 * The Node.
 *
...
const GlobalArgsSchema = z.object({
  ...
  displayName: z.string().describe("The node's display name.").optional(),
...
/** Swamp extension model for Google Cloud SAS Portal (Testing) Customers.Nodes.Nodes. Registered at `@swamp/gcp/prod_tt_sasportal/customers-nodes-nodes`. */
export const model = {
  type: "@swamp/gcp/prod_tt_sasportal/customers-nodes-nodes",
