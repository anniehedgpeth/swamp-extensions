...
// Auto-generated extension model for @swamp/gcp/meet/conferencerecords-participants-participantsessions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Meet ConferenceRecords.Participants.ParticipantSessions.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/participantSessions/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Refers to each unique join or leave session when a user joins a conference fr...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a participantSessions",
      arguments: z.object({
        identifier: z.string().describe("The name of the participantSessions"),
      }),
    ...
    sync: {
      description: "Sync participantSessions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific participantSessions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List participantSessions resources",
      arguments: z.object({
