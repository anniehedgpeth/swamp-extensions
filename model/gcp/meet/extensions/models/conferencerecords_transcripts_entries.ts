...
// Auto-generated extension model for @swamp/gcp/meet/conferencerecords-transcripts-entries
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Meet ConferenceRecords.Transcripts.Entries.
 *
...
/** Swamp extension model for Google Cloud Google Meet ConferenceRecords.Transcripts.Entries. Registered at `@swamp/gcp/meet/conferencerecords-transcripts-entries`. */
export const model = {
  type: "@swamp/gcp/meet/conferencerecords-transcripts-entries",
