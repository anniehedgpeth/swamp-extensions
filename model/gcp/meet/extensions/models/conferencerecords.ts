...
// Auto-generated extension model for @swamp/gcp/meet/conferencerecords
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Meet ConferenceRecords.
 *
...
/** Swamp extension model for Google Cloud Google Meet ConferenceRecords. Registered at `@swamp/gcp/meet/conferencerecords`. */
export const model = {
  type: "@swamp/gcp/meet/conferencerecords",
  ...
  methods: {
    get: {
      description: "Get a conferenceRecords",
      arguments: z.object({
        identifier: z.string().describe("The name of the conferenceRecords"),
      }),
    ...
    sync: {
      description: "Sync conferenceRecords state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific conferenceRecords by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List conferenceRecords resources",
      arguments: z.object({
