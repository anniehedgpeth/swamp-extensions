...
// Auto-generated extension model for @swamp/gcp/meet/conferencerecords-participants
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Meet ConferenceRecords.Participants.
 *
...
/** Swamp extension model for Google Cloud Google Meet ConferenceRecords.Participants. Registered at `@swamp/gcp/meet/conferencerecords-participants`. */
export const model = {
  type: "@swamp/gcp/meet/conferencerecords-participants",
