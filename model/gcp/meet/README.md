...
Use
`swamp model type describe @swamp/gcp/meet/conferencerecords_participants_participantsessions`
...
```bash
# Create a new conferencerecords_participants_participantsessions model
swamp model create @swamp/gcp/meet/conferencerecords_participants_participantsessions my-conferencerecords_participants_participantsessions

# Edit the model to configure its properties
swamp model edit my-conferencerecords_participants_participantsessions

# Create the resource in GCP
swamp model method run my-conferencerecords_participants_participantsessions create

# Sync current state from GCP
swamp model method run my-conferencerecords_participants_participantsessions sync
```
