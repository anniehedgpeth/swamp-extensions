...
Google Cloud gkeonprem resources.
...
Use `swamp model type describe @swamp/gcp/gkeonprem/baremetaladminclusters` to
...
```bash
# Create a new baremetaladminclusters model
swamp model create @swamp/gcp/gkeonprem/baremetaladminclusters my-baremetaladminclusters

# Edit the model to configure its properties
swamp model edit my-baremetaladminclusters

# Create the resource in GCP
swamp model method run my-baremetaladminclusters create

# Sync current state from GCP
swamp model method run my-baremetaladminclusters sync
```
