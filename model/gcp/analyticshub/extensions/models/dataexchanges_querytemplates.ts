...
// Auto-generated extension model for @swamp/gcp/analyticshub/dataexchanges-querytemplates
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Analytics Hub DataExchanges.QueryTemplates.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/queryTemplates/${shortName}`;
}

const BASE_URL = "https://analyticshub.googleapis.com/";

const GET_CONFIG = {
  "id": "analyticshub.projects.locations.dataExchanges.queryTemplates.get",
  "path": "v1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const INSERT_CONFIG = {
  "id": "analyticshub.projects.locations.dataExchanges.queryTemplates.create",
...
const PATCH_CONFIG = {
  "id": "analyticshub.projects.locations.dataExchanges.queryTemplates.patch",
  "path": "v1/{+name}",
  "httpMethod": "PATCH",
  "parameterOrder": [
    "name",
...
const DELETE_CONFIG = {
  "id": "analyticshub.projects.locations.dataExchanges.queryTemplates.delete",
  "path": "v1/{+name}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "analyticshub.projects.locations.dataExchanges.queryTemplates.list",
  "path": "v1/{+parent}/queryTemplates",
  "httpMethod": "GET",
  "parameterOrder": [
    "parent",
...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description: "Removed: proposer",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const { proposer: _proposer, ...rest } = old;
        return rest;
      },
    },
    {
  ...
  methods: {
    create: {
      description: "Create a queryTemplates",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a queryTemplates",
      arguments: z.object({
        identifier: z.string().describe("The name of the queryTemplates"),
      }),
    ...
    update: {
      description: "Update queryTemplates attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific queryTemplates by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the queryTemplates",
      arguments: z.object({
        identifier: z.string().describe("The name of the queryTemplates"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync queryTemplates state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific queryTemplates by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List queryTemplates resources",
      arguments: z.object({
