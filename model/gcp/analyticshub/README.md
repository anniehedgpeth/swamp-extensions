...
Google Cloud analyticshub resources.
...
Use `swamp model type describe @swamp/gcp/analyticshub/dataexchanges_listings`
...
```bash
# Create a new dataexchanges_listings model
swamp model create @swamp/gcp/analyticshub/dataexchanges_listings my-dataexchanges_listings

# Edit the model to configure its properties
swamp model edit my-dataexchanges_listings

# Create the resource in GCP
swamp model method run my-dataexchanges_listings create

# Sync current state from GCP
swamp model method run my-dataexchanges_listings sync
```
