...
Use `swamp model type describe @swamp/gcp/networksecurity/addressgroups` to see
...
```bash
# Create a new addressgroups model
swamp model create @swamp/gcp/networksecurity/addressgroups my-addressgroups

# Edit the model to configure its properties
swamp model edit my-addressgroups

# Create the resource in GCP
swamp model method run my-addressgroups create

# Sync current state from GCP
swamp model method run my-addressgroups sync
```
