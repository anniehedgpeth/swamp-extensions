...
// Auto-generated extension model for @swamp/gcp/networksecurity/gatewaysecuritypolicies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Security GatewaySecurityPolicies.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/gatewaySecurityPolicies/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  gatewaySecurityPolicyId: z.string().describe(
...
/** Swamp extension model for Google Cloud Network Security GatewaySecurityPolicies. Registered at `@swamp/gcp/networksecurity/gatewaysecuritypolicies`. */
export const model = {
  type: "@swamp/gcp/networksecurity/gatewaysecuritypolicies",
  ...
  resources: {
    state: {
      description:
        "The GatewaySecurityPolicy resource contains a collection of GatewaySecurityPo...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a gatewaySecurityPolicies",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["gatewaySecurityPolicyId"] !== undefined) {
          params["gatewaySecurityPolicyId"] = String(
            g["gatewaySecurityPolicyId"],
          );
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a gatewaySecurityPolicies",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the gatewaySecurityPolicies",
        ),
      }),
    ...
    update: {
      description: "Update gatewaySecurityPolicies attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific gatewaySecurityPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the gatewaySecurityPolicies",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the gatewaySecurityPolicies",
        ),
    ...
    sync: {
      description: "Sync gatewaySecurityPolicies state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific gatewaySecurityPolicies by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List gatewaySecurityPolicies resources",
      arguments: z.object({
