...
/**
 * Swamp extension model for Google Cloud Network Security AuthorizationPolicies.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["authorizationPolicyId"] !== undefined) {
          params["authorizationPolicyId"] = String(g["authorizationPolicyId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific authorizationPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List authorizationPolicies resources",
      arguments: z.object({
