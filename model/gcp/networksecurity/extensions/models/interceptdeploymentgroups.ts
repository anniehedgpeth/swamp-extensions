...
// Auto-generated extension model for @swamp/gcp/networksecurity/interceptdeploymentgroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Security InterceptDeploymentGroups.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/interceptDeploymentGroups/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  interceptDeploymentGroupId: z.string().describe(
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A deployment group aggregates many zonal intercept backends (deployments) int...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a interceptDeploymentGroups",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["interceptDeploymentGroupId"] !== undefined) {
          params["interceptDeploymentGroupId"] = String(
            g["interceptDeploymentGroupId"],
          );
        }
    ...
    get: {
      description: "Get a interceptDeploymentGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the interceptDeploymentGroups",
        ),
      }),
    ...
    update: {
      description: "Update interceptDeploymentGroups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific interceptDeploymentGroups by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the interceptDeploymentGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the interceptDeploymentGroups",
        ),
    ...
    sync: {
      description: "Sync interceptDeploymentGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific interceptDeploymentGroups by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List interceptDeploymentGroups resources",
      arguments: z.object({
