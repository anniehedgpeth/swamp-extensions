...
/**
 * Swamp extension model for Google Cloud Network Security MirroringDeploymentGroups.
 *
...
/** Swamp extension model for Google Cloud Network Security MirroringDeploymentGroups. Registered at `@swamp/gcp/networksecurity/mirroringdeploymentgroups`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["mirroringDeploymentGroupId"] !== undefined) {
          params["mirroringDeploymentGroupId"] = String(
            g["mirroringDeploymentGroupId"],
          );
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific mirroringDeploymentGroups by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List mirroringDeploymentGroups resources",
      arguments: z.object({
