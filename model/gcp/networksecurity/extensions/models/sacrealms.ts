  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["sacRealmId"] !== undefined) {
          params["sacRealmId"] = String(g["sacRealmId"]);
        }
        if (g["name"] !== undefined) {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sacRealms by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List sacRealms resources",
      arguments: z.object({
