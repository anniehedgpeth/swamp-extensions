...
// Auto-generated extension model for @swamp/gcp/networksecurity/dnsthreatdetectors
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Security DnsThreatDetectors.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/dnsThreatDetectors/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  excludedNetworks: z.array(z.string()).describe(
  ...
  provider: z.enum(["PROVIDER_UNSPECIFIED", "INFOBLOX"]).describe(
    "Required. The provider used for DNS threat analysis.",
  ).optional(),
  dnsThreatDetectorId: z.string().describe(
...
/** Swamp extension model for Google Cloud Network Security DnsThreatDetectors. Registered at `@swamp/gcp/networksecurity/dnsthreatdetectors`. */
export const model = {
  type: "@swamp/gcp/networksecurity/dnsthreatdetectors",
  ...
  methods: {
    create: {
      description: "Create a dnsThreatDetectors",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["excludedNetworks"] !== undefined) {
          body["excludedNetworks"] = g["excludedNetworks"];
        }
        if (g["labels"] !== undefined) body["labels"] = g["labels"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["provider"] !== undefined) body["provider"] = g["provider"];
        if (g["dnsThreatDetectorId"] !== undefined) {
          params["dnsThreatDetectorId"] = String(g["dnsThreatDetectorId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a dnsThreatDetectors",
      arguments: z.object({
        identifier: z.string().describe("The name of the dnsThreatDetectors"),
      }),
    ...
    update: {
      description: "Update dnsThreatDetectors attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dnsThreatDetectors by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the dnsThreatDetectors",
      arguments: z.object({
        identifier: z.string().describe("The name of the dnsThreatDetectors"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync dnsThreatDetectors state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dnsThreatDetectors by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List dnsThreatDetectors resources",
      arguments: z.object({
