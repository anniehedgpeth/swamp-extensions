...
// Auto-generated extension model for @swamp/gcp/networksecurity/mirroringdeployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Security MirroringDeployments.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/mirroringDeployments/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  mirroringDeploymentId: z.string().describe(
...
/** Swamp extension model for Google Cloud Network Security MirroringDeployments. Registered at `@swamp/gcp/networksecurity/mirroringdeployments`. */
export const model = {
  type: "@swamp/gcp/networksecurity/mirroringdeployments",
  ...
  resources: {
    state: {
      description:
        "A deployment represents a zonal mirroring backend ready to accept GENEVE-enca...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a mirroringDeployments",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["mirroringDeploymentId"] !== undefined) {
          params["mirroringDeploymentId"] = String(g["mirroringDeploymentId"]);
        }
    ...
    get: {
      description: "Get a mirroringDeployments",
      arguments: z.object({
        identifier: z.string().describe("The name of the mirroringDeployments"),
      }),
    ...
    update: {
      description: "Update mirroringDeployments attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific mirroringDeployments by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the mirroringDeployments",
      arguments: z.object({
        identifier: z.string().describe("The name of the mirroringDeployments"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync mirroringDeployments state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific mirroringDeployments by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List mirroringDeployments resources",
      arguments: z.object({
