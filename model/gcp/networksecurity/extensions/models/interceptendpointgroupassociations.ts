...
// Auto-generated extension model for @swamp/gcp/networksecurity/interceptendpointgroupassociations
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/interceptEndpointGroupAssociations/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  interceptEndpointGroupAssociationId: z.string().describe(
...
const StateSchema = z.object({
  ...
  interceptEndpointGroup: z.string().optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a interceptEndpointGroupAssociations",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["interceptEndpointGroup"] !== undefined) {
          body["interceptEndpointGroup"] = g["interceptEndpointGroup"];
        }
        if (g["labels"] !== undefined) body["labels"] = g["labels"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["network"] !== undefined) body["network"] = g["network"];
        if (g["interceptEndpointGroupAssociationId"] !== undefined) {
          params["interceptEndpointGroupAssociationId"] = String(
            g["interceptEndpointGroupAssociationId"],
          );
        }
    ...
    get: {
      description: "Get a interceptEndpointGroupAssociations",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the interceptEndpointGroupAssociations",
        ),
      }),
    ...
    update: {
      description: "Update interceptEndpointGroupAssociations attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific interceptEndpointGroupAssociations by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the interceptEndpointGroupAssociations",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the interceptEndpointGroupAssociations",
        ),
    ...
    sync: {
      description: "Sync interceptEndpointGroupAssociations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific interceptEndpointGroupAssociations by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List interceptEndpointGroupAssociations resources",
      arguments: z.object({
