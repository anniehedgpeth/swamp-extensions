...
/**
 * Swamp extension model for Google Cloud Network Security ServerTlsPolicies.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["serverTlsPolicyId"] !== undefined) {
          params["serverTlsPolicyId"] = String(g["serverTlsPolicyId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific serverTlsPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List serverTlsPolicies resources",
      arguments: z.object({
