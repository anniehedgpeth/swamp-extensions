...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["interceptDeploymentId"] !== undefined) {
          params["interceptDeploymentId"] = String(g["interceptDeploymentId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific interceptDeployments by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List interceptDeployments resources",
      arguments: z.object({
