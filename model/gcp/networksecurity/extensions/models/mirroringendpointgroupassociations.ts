...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["mirroringEndpointGroupAssociationId"] !== undefined) {
          params["mirroringEndpointGroupAssociationId"] = String(
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific mirroringEndpointGroupAssociations by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List mirroringEndpointGroupAssociations resources",
      arguments: z.object({
