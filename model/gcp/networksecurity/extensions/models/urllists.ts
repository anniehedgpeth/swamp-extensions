...
// Auto-generated extension model for @swamp/gcp/networksecurity/urllists
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Security UrlLists.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/urlLists/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  values: z.array(z.string()).describe("Required. FQDNs and URLs.").optional(),
  urlListId: z.string().describe(
...
/** Swamp extension model for Google Cloud Network Security UrlLists. Registered at `@swamp/gcp/networksecurity/urllists`. */
export const model = {
  type: "@swamp/gcp/networksecurity/urllists",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["urlListId"] !== undefined) {
          params["urlListId"] = String(g["urlListId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a urlLists",
      arguments: z.object({
        identifier: z.string().describe("The name of the urlLists"),
      }),
    ...
    update: {
      description: "Update urlLists attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific urlLists by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the urlLists",
      arguments: z.object({
        identifier: z.string().describe("The name of the urlLists"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync urlLists state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific urlLists by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List urlLists resources",
      arguments: z.object({
