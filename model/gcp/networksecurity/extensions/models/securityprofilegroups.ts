...
// Auto-generated extension model for @swamp/gcp/networksecurity/securityprofilegroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Security SecurityProfileGroups.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/securityProfileGroups/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  customInterceptProfile: z.string().describe(
    "Optional. Reference to a SecurityProfile with the CustomIntercept configuration.",
  ).optional(),
  customMirroringProfile: z.string().describe(
  ...
  threatPreventionProfile: z.string().describe(
...
const StateSchema = z.object({
  ...
  customInterceptProfile: z.string().optional(),
  customMirroringProfile: z.string().optional(),
  dataPathId: z.string().optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "SecurityProfileGroup is a resource that defines the behavior for various Prof...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a securityProfileGroups",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a securityProfileGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the securityProfileGroups",
        ),
      }),
    ...
    update: {
      description: "Update securityProfileGroups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific securityProfileGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the securityProfileGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the securityProfileGroups",
        ),
    ...
    sync: {
      description: "Sync securityProfileGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific securityProfileGroups by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List securityProfileGroups resources",
      arguments: z.object({
