...
// Auto-generated extension model for @swamp/gcp/container/aggregated-usablesubnetworks
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Kubernetes Engine Aggregated.UsableSubnetworks.
 *
...
/** Swamp extension model for Google Cloud Kubernetes Engine Aggregated.UsableSubnetworks. Registered at `@swamp/gcp/container/aggregated-usablesubnetworks`. */
export const model = {
  type: "@swamp/gcp/container/aggregated-usablesubnetworks",
  ...
  methods: {
    get: {
      description: "Get a usableSubnetworks",
      arguments: z.object({
        identifier: z.string().describe("The name of the usableSubnetworks"),
      }),
    ...
    sync: {
      description: "Sync usableSubnetworks state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific usableSubnetworks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List usableSubnetworks resources",
      arguments: z.object({
