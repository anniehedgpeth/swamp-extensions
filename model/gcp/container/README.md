...
Use
`swamp model type describe @swamp/gcp/container/aggregated_usablesubnetworks` to
...
```bash
# Create a new aggregated_usablesubnetworks model
swamp model create @swamp/gcp/container/aggregated_usablesubnetworks my-aggregated_usablesubnetworks

# Edit the model to configure its properties
swamp model edit my-aggregated_usablesubnetworks

# Create the resource in GCP
swamp model method run my-aggregated_usablesubnetworks create

# Sync current state from GCP
swamp model method run my-aggregated_usablesubnetworks sync
```
