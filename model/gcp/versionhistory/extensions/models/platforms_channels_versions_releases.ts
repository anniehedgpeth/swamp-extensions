...
// Auto-generated extension model for @swamp/gcp/versionhistory/platforms-channels-versions-releases
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud versionhistory.googleapis.com Platforms.Channels.Versions.Releases.
 *
...
const BASE_URL = "https://versionhistory.googleapis.com/";
...
const StateSchema = z.object({
  ...
  fractionGroup: z.string().optional(),
  name: z.string(),
  pinnable: z.boolean().optional(),
  rolloutData: z.array(z.object({
    rolloutName: z.string(),
...
/** Swamp extension model for Google Cloud versionhistory.googleapis.com Platforms.Channels.Versions.Releases. Registered at `@swamp/gcp/versionhistory/platforms-channels-versions-releases`. */
export const model = {
  type: "@swamp/gcp/versionhistory/platforms-channels-versions-releases",
  ...
  resources: {
    state: {
      description:
        "A Release is owned by a Version. A Release contains information about the rel...",
      schema: StateSchema,
      lifetime: "infinite",
