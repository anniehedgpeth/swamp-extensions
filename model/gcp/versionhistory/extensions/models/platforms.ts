...
// Auto-generated extension model for @swamp/gcp/versionhistory/platforms
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud versionhistory.googleapis.com Platforms.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Each Platform is owned by a Product and owns a collection of channels. Availa...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a platforms",
      arguments: z.object({
        identifier: z.string().describe("The name of the platforms"),
      }),
    ...
    sync: {
      description: "Sync platforms state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific platforms by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List platforms resources",
      arguments: z.object({
