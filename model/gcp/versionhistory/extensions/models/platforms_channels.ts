...
// Auto-generated extension model for @swamp/gcp/versionhistory/platforms-channels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud versionhistory.googleapis.com Platforms.Channels.
 *
...
/** Swamp extension model for Google Cloud versionhistory.googleapis.com Platforms.Channels. Registered at `@swamp/gcp/versionhistory/platforms-channels`. */
export const model = {
  type: "@swamp/gcp/versionhistory/platforms-channels",
  ...
  resources: {
    state: {
      description:
        "Each Channel is owned by a Platform and owns a collection of versions. Possib...",
      schema: StateSchema,
      lifetime: "infinite",
