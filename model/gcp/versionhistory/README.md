...
Google Cloud versionhistory resources.
...
Use
`swamp model type describe @swamp/gcp/versionhistory/platforms_channels_versions_releases`
...
```bash
# Create a new platforms_channels_versions_releases model
swamp model create @swamp/gcp/versionhistory/platforms_channels_versions_releases my-platforms_channels_versions_releases

# Edit the model to configure its properties
swamp model edit my-platforms_channels_versions_releases

# Create the resource in GCP
swamp model method run my-platforms_channels_versions_releases create

# Sync current state from GCP
swamp model method run my-platforms_channels_versions_releases sync
```
