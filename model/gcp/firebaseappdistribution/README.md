...
Google Cloud firebaseappdistribution resources.
...
Use
`swamp model type describe @swamp/gcp/firebaseappdistribution/apps_releases_feedbackreports`
...
```bash
# Create a new apps_releases_feedbackreports model
swamp model create @swamp/gcp/firebaseappdistribution/apps_releases_feedbackreports my-apps_releases_feedbackreports

# Edit the model to configure its properties
swamp model edit my-apps_releases_feedbackreports

# Create the resource in GCP
swamp model method run my-apps_releases_feedbackreports create

# Sync current state from GCP
swamp model method run my-apps_releases_feedbackreports sync
```
