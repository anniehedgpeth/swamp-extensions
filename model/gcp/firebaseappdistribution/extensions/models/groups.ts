...
// Auto-generated extension model for @swamp/gcp/firebaseappdistribution/groups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase App Distribution Groups.
 *
...
const GlobalArgsSchema = z.object({
  ...
  displayName: z.string().describe("Required. The display name of the group.")
    .optional(),
...
const StateSchema = z.object({
  ...
  inviteLinkCount: z.number().optional(),
  name: z.string(),
  releaseCount: z.number().optional(),
  testerCount: z.number().optional(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Firebase App Distribution Groups. Registered at `@swamp/gcp/firebaseappdistribution/groups`. */
export const model = {
  type: "@swamp/gcp/firebaseappdistribution/groups",
  ...
  resources: {
    state: {
      description:
        "A group which can contain testers. A group can be invited to test apps in a F...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    batch_join: {
      ...
      arguments: z.object({
        createMissingTesters: z.any().optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        params["group"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const body: Record<string, unknown> = {};
        if (args["createMissingTesters"] !== undefined) {
          body["createMissingTesters"] = args["createMissingTesters"];
        }
