...
Use `swamp model type describe @swamp/gcp/tpu/acceleratortypes` to see the full
...
swamp model create @swamp/gcp/tpu/acceleratortypes my-acceleratortypes
