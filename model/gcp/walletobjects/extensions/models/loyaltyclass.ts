...
// Auto-generated extension model for @swamp/gcp/walletobjects/loyaltyclass
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Wallet Loyaltyclass.
 *
...
const GlobalArgsSchema = z.object({
  ...
  accountNameLabel: z.string().describe(
  ...
  discoverableProgram: z.object({
    merchantSigninInfo: z.object({
      signinWebsite: z.object({
        description: z.string().describe(
          "The URI's title appearing in the app as text. Recommended maximum is 20 characters to ensure full string is displayed on smaller screens. Note that in some contexts this text is not used, such as when `description` is part of an image.",
        ).optional(),
        id: z.string().describe(
    ...
    merchantSignupInfo: z.object({
      signupSharedDatas: z.array(
        z.enum([
    ...
    state: z.enum([
      ...
      "DISABLED",
      "disabled",
    ]).describe("Visibility state of the discoverable program.").optional(),
  }).describe(
  ...
  localizedAccountIdLabel: z.object({
    defaultValue: z.object({
      kind: z.string().describe(
        'Identifies what kind of resource this is. Value: the fixed string `"walletobjects#translatedString"`.',
      ).optional(),
  ...
  localizedAccountNameLabel: z.object({
    defaultValue: z.object({
      kind: z.string().describe(
        'Identifies what kind of resource this is. Value: the fixed string `"walletobjects#translatedString"`.',
      ).optional(),
  ...
  localizedRewardsTierLabel: z.object({
    defaultValue: z.object({
      kind: z.string().describe(
        'Identifies what kind of resource this is. Value: the fixed string `"walletobjects#translatedString"`.',
      ).optional(),
  ...
  localizedSecondaryRewardsTier: z.object({
    defaultValue: z.object({
      kind: z.string().describe(
        'Identifies what kind of resource this is. Value: the fixed string `"walletobjects#translatedString"`.',
      ).optional(),
  ...
  }).describe("Translated strings for the secondary_rewards_tier.").optional(),
  localizedSecondaryRewardsTierLabel: z.object({
    defaultValue: z.object({
      kind: z.string().describe(
        'Identifies what kind of resource this is. Value: the fixed string `"walletobjects#translatedString"`.',
      ).optional(),
  ...
  }).describe("Translated strings for the secondary_rewards_tier_label.")
    .optional(),
  ...
  rewardsTierLabel: z.string().describe(
  ...
  secondaryRewardsTier: z.string().describe(
    'The secondary rewards tier, such as "Gold" or "Platinum."',
  ).optional(),
  secondaryRewardsTierLabel: z.string().describe(
  ...
  ]).describe("View Unlock Requirement options for the loyalty card.")
    .optional(),
...
const StateSchema = z.object({
  accountIdLabel: z.string().optional(),
  accountNameLabel: z.string().optional(),
  ...
  discoverableProgram: z.object({
    ...
    merchantSignupInfo: z.object({
      signupSharedDatas: z.array(z.string()),
      signupWebsite: z.object({
        description: z.string(),
        id: z.string(),
        kind: z.string(),
  ...
  rewardsTier: z.string().optional(),
  rewardsTierLabel: z.string().optional(),
  secondaryRewardsTier: z.string().optional(),
  secondaryRewardsTierLabel: z.string().optional(),
  securityAnimation: z.object({
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a loyaltyclass",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["accountNameLabel"] !== undefined) {
          body["accountNameLabel"] = g["accountNameLabel"];
        }
        ...
        if (g["discoverableProgram"] !== undefined) {
          body["discoverableProgram"] = g["discoverableProgram"];
        }
        ...
        if (g["localizedAccountIdLabel"] !== undefined) {
          body["localizedAccountIdLabel"] = g["localizedAccountIdLabel"];
        }
        if (g["localizedAccountNameLabel"] !== undefined) {
          body["localizedAccountNameLabel"] = g["localizedAccountNameLabel"];
        }
        if (g["localizedIssuerName"] !== undefined) {
          body["localizedIssuerName"] = g["localizedIssuerName"];
        }
        if (g["localizedProgramName"] !== undefined) {
          body["localizedProgramName"] = g["localizedProgramName"];
        }
        if (g["localizedRewardsTier"] !== undefined) {
          body["localizedRewardsTier"] = g["localizedRewardsTier"];
        }
        if (g["localizedRewardsTierLabel"] !== undefined) {
          body["localizedRewardsTierLabel"] = g["localizedRewardsTierLabel"];
        }
        if (g["localizedSecondaryRewardsTier"] !== undefined) {
          body["localizedSecondaryRewardsTier"] =
            g["localizedSecondaryRewardsTier"];
        }
        if (g["localizedSecondaryRewardsTierLabel"] !== undefined) {
          body["localizedSecondaryRewardsTierLabel"] =
            g["localizedSecondaryRewardsTierLabel"];
        }
        ...
        if (g["programName"] !== undefined) {
          body["programName"] = g["programName"];
        }
        ...
        if (g["rewardsTier"] !== undefined) {
          body["rewardsTier"] = g["rewardsTier"];
        }
        if (g["rewardsTierLabel"] !== undefined) {
          body["rewardsTierLabel"] = g["rewardsTierLabel"];
        }
        if (g["secondaryRewardsTier"] !== undefined) {
          body["secondaryRewardsTier"] = g["secondaryRewardsTier"];
        }
        if (g["secondaryRewardsTierLabel"] !== undefined) {
          body["secondaryRewardsTierLabel"] = g["secondaryRewardsTierLabel"];
        }
    ...
    get: {
      description: "Get a loyaltyclass",
      arguments: z.object({
        identifier: z.string().describe("The id of the loyaltyclass"),
      }),
    ...
    update: {
      description: "Update loyaltyclass attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific loyaltyclass by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync loyaltyclass state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific loyaltyclass by id (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List loyaltyclass resources",
      arguments: z.object({
