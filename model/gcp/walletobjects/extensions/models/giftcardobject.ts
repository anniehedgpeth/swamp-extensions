...
// Auto-generated extension model for @swamp/gcp/walletobjects/giftcardobject
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Wallet Giftcardobject.
 *
...
const GlobalArgsSchema = z.object({
  ...
  }).describe("The card's monetary balance.").optional(),
  balanceUpdateTime: z.object({
  ...
  cardNumber: z.string().describe("Required. The card's number.").optional(),
  ...
  classReference: z.object({
    ...
    ]).describe("View Unlock Requirement options for the gift card.")
      .optional(),
  ...
  pin: z.string().describe("The card's PIN.").optional(),
...
const StateSchema = z.object({
  ...
  classReference: z.object({
    allowBarcodeRedemption: z.boolean(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a giftcardobject",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["balance"] !== undefined) body["balance"] = g["balance"];
        if (g["balanceUpdateTime"] !== undefined) {
          body["balanceUpdateTime"] = g["balanceUpdateTime"];
        }
        if (g["barcode"] !== undefined) body["barcode"] = g["barcode"];
        if (g["cardNumber"] !== undefined) body["cardNumber"] = g["cardNumber"];
        ...
        if (g["eventNumber"] !== undefined) {
          body["eventNumber"] = g["eventNumber"];
        }
        ...
        if (g["pin"] !== undefined) body["pin"] = g["pin"];
    ...
    get: {
      description: "Get a giftcardobject",
      arguments: z.object({
        identifier: z.string().describe("The id of the giftcardobject"),
      }),
    ...
    update: {
      description: "Update giftcardobject attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific giftcardobject by id (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    sync: {
      description: "Sync giftcardobject state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific giftcardobject by id (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List giftcardobject resources",
      arguments: z.object({
        classId: z.string().describe(
