...
/**
 * Swamp extension model for Google Cloud Google Wallet Eventticketobject.
 *
...
const GlobalArgsSchema = z.object({
  ...
  classReference: z.object({
    ...
    }).describe("The fine print, terms, or conditions of the ticket.")
      .optional(),
    gateLabel: z.enum([
  ...
  }).describe("Seating details for this ticket.").optional(),
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific eventticketobject by id (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List eventticketobject resources",
      arguments: z.object({
        classId: z.string().describe(
