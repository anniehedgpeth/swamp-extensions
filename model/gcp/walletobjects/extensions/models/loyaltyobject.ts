...
// Auto-generated extension model for @swamp/gcp/walletobjects/loyaltyobject
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Wallet Loyaltyobject.
 *
...
const GlobalArgsSchema = z.object({
  ...
  classReference: z.object({
    ...
    }).describe("Translated strings for the secondary_rewards_tier.")
      .optional(),
  ...
  }).describe("The loyalty reward points label, balance, and type.").optional(),
  merchantLocations: z.array(z.object({
    latitude: z.number().describe(
      "The latitude specified as any value in the range of -90.0 through +90.0, both inclusive. Values outside these bounds will be rejected.",
    ).optional(),
  ...
  secondaryLoyaltyPoints: z.object({
    balance: z.object({
      double: z.number().describe(
        "The double form of a balance. Only one of these subtypes (string, int, double, money) should be populated.",
      ).optional(),
...
const StateSchema = z.object({
  ...
  classReference: z.object({
    ...
    rewardsTier: z.string(),
    rewardsTierLabel: z.string(),
    secondaryRewardsTier: z.string(),
    secondaryRewardsTierLabel: z.string(),
    securityAnimation: z.object({
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a loyaltyobject",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["loyaltyPoints"] !== undefined) {
          body["loyaltyPoints"] = g["loyaltyPoints"];
        }
        ...
        if (g["secondaryLoyaltyPoints"] !== undefined) {
          body["secondaryLoyaltyPoints"] = g["secondaryLoyaltyPoints"];
        }
    ...
    get: {
      description: "Get a loyaltyobject",
      arguments: z.object({
        identifier: z.string().describe("The id of the loyaltyobject"),
      }),
    ...
    update: {
      description: "Update loyaltyobject attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific loyaltyobject by id (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    sync: {
      description: "Sync loyaltyobject state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific loyaltyobject by id (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List loyaltyobject resources",
      arguments: z.object({
        classId: z.string().describe(
