...
// Auto-generated extension model for @swamp/gcp/walletobjects/flightobject
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Wallet Flightobject.
 *
...
const GlobalArgsSchema = z.object({
  ...
  }).describe("The barcode type and value.").optional(),
  boardingAndSeatingInfo: z.object({
    boardingDoor: z.enum([
    ...
    boardingGroup: z.string().describe(
    ...
    boardingPosition: z.string().describe(
      'The value of boarding position. eg: "76"',
    ).optional(),
    boardingPrivilegeImage: z.object({
      contentDescription: z.object({
        defaultValue: z.object({
          kind: z.string().describe(
            'Identifies what kind of resource this is. Value: the fixed string `"walletobjects#translatedString"`.',
    ...
    seatClass: z.string().describe(
      'The value of the seat class. eg: "Economy" or "Economy Plus"',
    ).optional(),
    seatNumber: z.string().describe(
  ...
  }).describe("Passenger specific information about boarding and seating.")
    .optional(),
  ...
  classReference: z.object({
    ...
    appLinkData: z.object({
      androidAppLinkInfo: z.object({
        appLogoImage: z.object({
          ...
          sourceUri: z.object({
            ...
            localizedDescription: z.unknown().describe(
              "Translated strings for the description, which are unused and retained only for backward compatibility.",
            ).optional(),
        ...
        title: z.object({
          ...
          .optional(),
      }).describe("Optional information about the partner app link.")
        .optional(),
      displayText: z.object({
        defaultValue: z.object({
          kind: z.string().describe(
      ...
      webAppLinkInfo: z.object({
        ...
        title: z.object({
          ...
          .optional(),
      }).describe("Optional information about the partner web link.")
        .optional(),
    }).describe(
    ...
    boardingAndSeatingPolicy: z.object({
      boardingPolicy: z.enum([
    ...
    destination: z.object({
      ...
      gate: z.string().describe('A name of the gate. Eg: "B59" or "59"')
        .optional(),
      kind: z.string().describe(
        'Identifies what kind of resource this is. Value: the fixed string `"walletobjects#airportInfo"`.',
      ).optional(),
      terminal: z.string().describe('Terminal name. Eg: "INTL" or "I"')
        .optional(),
    }).describe("Required. Destination airport.").optional(),
    ...
    flightHeader: z.object({
      carrier: z.object({
        airlineAllianceLogo: z.object({
          contentDescription: z.object({
            defaultValue: z.unknown().describe(
              "Contains the string to be displayed if no appropriate translation is available.",
            ).optional(),
        ...
        carrierIataCode: z.string().describe(
        ...
        carrierIcaoCode: z.string().describe(
      ...
      flightNumber: z.string().describe(
      ...
      flightNumberDisplayOverride: z.string().describe(
      ...
      }).describe("Information about operating airline carrier.").optional(),
      operatingFlightNumber: z.string().describe(
        'The flight number used by the operating carrier without IATA carrier code. This field should contain only digits. eg: "234"',
      ).optional(),
    }).describe("Required. Information about the flight carrier and number.")
      .optional(),
    flightStatus: z.enum([
    ...
    localBoardingDateTime: z.string().describe(
    ...
    localEstimatedOrActualArrivalDateTime: z.string().describe(
    ...
    localEstimatedOrActualDepartureDateTime: z.string().describe(
    ...
    localGateClosingDateTime: z.string().describe(
    ...
    localScheduledArrivalDateTime: z.string().describe(
    ...
    localScheduledDepartureDateTime: z.string().describe(
    ...
    origin: z.object({
      ...
      terminal: z.string().describe('Terminal name. Eg: "INTL" or "I"')
        .optional(),
    }).describe("Required. Origin airport.").optional(),
    ...
    ]).describe("View Unlock Requirement options for the boarding pass.")
      .optional(),
    wordMark: z.object({
      contentDescription: z.object({
        defaultValue: z.object({
  ...
  passengerName: z.string().describe(
  ...
  reservationInfo: z.object({
    ...
    eticketNumber: z.string().describe("E-ticket number.").optional(),
    frequentFlyerInfo: z.object({
      frequentFlyerNumber: z.string().describe(
        "Frequent flyer number. Required for each nested object of kind `walletobjects#frequentFlyerInfo`.",
      ).optional(),
      frequentFlyerProgramName: z.object({
        defaultValue: z.object({
          kind: z.string().describe(
            'Identifies what kind of resource this is. Value: the fixed string `"walletobjects#translatedString"`.',
          ).optional(),
  ...
  }).describe("The rotating barcode type and value.").optional(),
...
const StateSchema = z.object({
  ...
  boardingAndSeatingInfo: z.object({
    boardingDoor: z.string(),
    boardingGroup: z.string(),
    boardingPosition: z.string(),
    boardingPrivilegeImage: z.object({
      contentDescription: z.object({
        defaultValue: z.object({
          kind: z.string(),
  ...
  classReference: z.object({
    ...
    boardingAndSeatingPolicy: z.object({
      boardingPolicy: z.string(),
      kind: z.string(),
      seatClassPolicy: z.string(),
    }),
    callbackOptions: z.object({
    ...
    flightHeader: z.object({
      carrier: z.object({
        ...
        carrierIataCode: z.string(),
        carrierIcaoCode: z.string(),
        kind: z.string(),
        wideAirlineLogo: z.object({
          contentDescription: z.object({
            defaultValue: z.unknown(),
      ...
      flightNumberDisplayOverride: z.string(),
      kind: z.string(),
      operatingCarrier: z.object({
        airlineAllianceLogo: z.object({
          contentDescription: z.object({
    ...
    localBoardingDateTime: z.string(),
    localEstimatedOrActualArrivalDateTime: z.string(),
    localEstimatedOrActualDepartureDateTime: z.string(),
    localGateClosingDateTime: z.string(),
    localScheduledArrivalDateTime: z.string(),
    localScheduledDepartureDateTime: z.string(),
    localizedIssuerName: z.object({
      defaultValue: z.object({
        kind: z.string(),
        language: z.string(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a flightobject",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["boardingAndSeatingInfo"] !== undefined) {
          body["boardingAndSeatingInfo"] = g["boardingAndSeatingInfo"];
        }
        ...
        if (g["passengerName"] !== undefined) {
          body["passengerName"] = g["passengerName"];
        }
        ...
        if (g["securityProgramLogo"] !== undefined) {
          body["securityProgramLogo"] = g["securityProgramLogo"];
        }
    ...
    get: {
      description: "Get a flightobject",
      arguments: z.object({
        identifier: z.string().describe("The id of the flightobject"),
      }),
    ...
    update: {
      description: "Update flightobject attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific flightobject by id (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    sync: {
      description: "Sync flightobject state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific flightobject by id (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List flightobject resources",
      arguments: z.object({
        classId: z.string().describe(
