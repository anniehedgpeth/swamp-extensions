...
Google Cloud datapipelines resources.
...
Use `swamp model type describe @swamp/gcp/datapipelines/pipelines_jobs` to see
...
```bash
# Create a new pipelines_jobs model
swamp model create @swamp/gcp/datapipelines/pipelines_jobs my-pipelines_jobs

# Edit the model to configure its properties
swamp model edit my-pipelines_jobs

# Create the resource in GCP
swamp model method run my-pipelines_jobs create

# Sync current state from GCP
swamp model method run my-pipelines_jobs sync
```
