...
// Auto-generated extension model for @swamp/gcp/file/instances-snapshots
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Filestore Instances.Snapshots.
 *
...
const StateSchema = z.object({
  ...
  filesystemUsedBytes: z.string().optional(),
...
/** Swamp extension model for Google Cloud Filestore Instances.Snapshots. Registered at `@swamp/gcp/file/instances-snapshots`. */
export const model = {
  type: "@swamp/gcp/file/instances-snapshots",
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["snapshotId"] !== undefined) {
          params["snapshotId"] = String(g["snapshotId"]);
        }
