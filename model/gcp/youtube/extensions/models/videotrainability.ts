...
// Auto-generated extension model for @swamp/gcp/youtube/videotrainability
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud YouTube Data VideoTrainability.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a videoTrainability",
      arguments: z.object({
        identifier: z.string().describe("The name of the videoTrainability"),
      }),
    ...
    sync: {
      description: "Sync videoTrainability state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific videoTrainability by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
