...
// Auto-generated extension model for @swamp/gcp/youtube/membershipslevels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud YouTube Data MembershipsLevels.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A *membershipsLevel* resource represents an offer made by YouTube creators fo...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a membershipsLevels",
      arguments: z.object({
        identifier: z.string().describe("The name of the membershipsLevels"),
      }),
    ...
    sync: {
      description: "Sync membershipsLevels state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific membershipsLevels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List membershipsLevels resources",
      arguments: z.object({
        part: z.string().describe(
          "The *part* parameter specifies the membershipsLevel resource parts that the API response will include. Supported values are id and snippet.",
        ).optional(),
