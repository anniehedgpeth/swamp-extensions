...
// Auto-generated extension model for @swamp/gcp/youtube/videocategories
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud YouTube Data VideoCategories.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A *videoCategory* resource identifies a category that has been or could be as...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a videoCategories",
      arguments: z.object({
        identifier: z.string().describe("The name of the videoCategories"),
      }),
    ...
    sync: {
      description: "Sync videoCategories state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific videoCategories by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
