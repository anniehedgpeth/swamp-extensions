...
/**
 * Swamp extension model for Google Cloud YouTube Data Playlists.
 *
...
const GlobalArgsSchema = z.object({
  ...
  }).describe("The status object contains status information for the playlist.")
    .optional(),
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific playlists by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List playlists resources",
      arguments: z.object({
        channelId: z.string().describe(
          "Return the playlists owned by the specified channel ID.",
        ).optional(),
        hl: z.string().describe("Return content in specified language")
          .optional(),
        id: z.string().describe(
