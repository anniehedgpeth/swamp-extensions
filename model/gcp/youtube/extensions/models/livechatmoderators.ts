...
/**
 * Swamp extension model for Google Cloud YouTube Data LiveChatModerators.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific liveChatModerators by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List liveChatModerators resources",
      arguments: z.object({
        liveChatId: z.string().describe(
          "The id of the live chat for which moderators should be returned.",
        ).optional(),
