...
/**
 * Swamp extension model for Google Cloud YouTube Data PlaylistItems.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific playlistItems by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List playlistItems resources",
      arguments: z.object({
        id: z.string().optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["playlistId"] !== undefined) {
          params["playlistId"] = String(args["playlistId"]);
        }
