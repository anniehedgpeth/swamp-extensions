...
Google Cloud hypercomputecluster resources.
...
Use `swamp model type describe @swamp/gcp/hypercomputecluster/clusters` to see
...
```bash
# Create a new clusters model
swamp model create @swamp/gcp/hypercomputecluster/clusters my-clusters

# Edit the model to configure its properties
swamp model edit my-clusters

# Create the resource in GCP
swamp model method run my-clusters create

# Sync current state from GCP
swamp model method run my-clusters sync
```
