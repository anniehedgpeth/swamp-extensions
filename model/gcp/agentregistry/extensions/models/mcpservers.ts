...
// Auto-generated extension model for @swamp/gcp/agentregistry/mcpservers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Agent Registry McpServers.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/mcpServers/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a mcpServers",
      arguments: z.object({
        identifier: z.string().describe("The name of the mcpServers"),
      }),
