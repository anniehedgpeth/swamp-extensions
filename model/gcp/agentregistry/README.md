...
Google Cloud agentregistry resources.
...
Use `swamp model type describe @swamp/gcp/agentregistry/agents` to see the full
...
swamp model create @swamp/gcp/agentregistry/agents my-agents
