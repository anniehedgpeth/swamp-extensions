...
// Auto-generated extension model for @swamp/gcp/advisorynotifications/notifications
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Advisory Notifications Notifications.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/notifications/${shortName}`;
}

const BASE_URL = "https://advisorynotifications.googleapis.com/";
...
const StateSchema = z.object({
  ...
  messages: z.array(z.object({
    ...
    body: z.object({
      text: z.object({
        enText: z.string(),
        localizationState: z.string(),
        localizedText: z.string(),
      }),
    }),
    createTime: z.string(),
    localizationTime: z.string(),
  })).optional(),
  name: z.string(),
...
/** Swamp extension model for Google Cloud Advisory Notifications Notifications. Registered at `@swamp/gcp/advisorynotifications/notifications`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific notifications by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List notifications resources",
      arguments: z.object({
