# @swamp/gcp/advisorynotifications

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Google Cloud advisorynotifications resources.
...
Use `swamp model type describe @swamp/gcp/advisorynotifications/notifications`
...
```bash
# Create a new notifications model
swamp model create @swamp/gcp/advisorynotifications/notifications my-notifications

# Edit the model to configure its properties
swamp model edit my-notifications

# Create the resource in GCP
swamp model method run my-notifications create

# Sync current state from GCP
swamp model method run my-notifications sync
```
