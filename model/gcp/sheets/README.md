...
Use `swamp model type describe @swamp/gcp/sheets/spreadsheets_developermetadata`
...
```bash
# Create a new spreadsheets_developermetadata model
swamp model create @swamp/gcp/sheets/spreadsheets_developermetadata my-spreadsheets_developermetadata

# Edit the model to configure its properties
swamp model edit my-spreadsheets_developermetadata

# Create the resource in GCP
swamp model method run my-spreadsheets_developermetadata create

# Sync current state from GCP
swamp model method run my-spreadsheets_developermetadata sync
```
