...
// Auto-generated extension model for @swamp/gcp/merchantapi/accounts-notificationsubscriptions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Merchant Accounts.Notificationsubscriptions.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/notificationsubscriptions/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  allManagedAccounts: z.boolean().describe(
...
const StateSchema = z.object({
  allManagedAccounts: z.boolean().optional(),
  callBackUri: z.string().optional(),
  name: z.string(),
  registeredEvent: z.string().optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Represents a notification subscription owned by a Merchant account. See [Deco...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a notificationsubscriptions",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["allManagedAccounts"] !== undefined) {
          body["allManagedAccounts"] = g["allManagedAccounts"];
        }
        if (g["callBackUri"] !== undefined) {
          body["callBackUri"] = g["callBackUri"];
        }
        if (g["registeredEvent"] !== undefined) {
          body["registeredEvent"] = g["registeredEvent"];
        }
    ...
    get: {
      description: "Get a notificationsubscriptions",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the notificationsubscriptions",
        ),
      }),
    ...
    update: {
      description: "Update notificationsubscriptions attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific notificationsubscriptions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the notificationsubscriptions",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the notificationsubscriptions",
        ),
    ...
    sync: {
      description: "Sync notificationsubscriptions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific notificationsubscriptions by name (e.g. one discovered by list)",
        ).optional(),
