...
// Auto-generated extension model for @swamp/gcp/merchantapi/accounts-aggregateproductstatuses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Merchant Accounts.AggregateProductStatuses.
 *
...
const StateSchema = z.object({
  ...
  stats: z.object({
    activeCount: z.string(),
    disapprovedCount: z.string(),
    expiringCount: z.string(),
...
/** Swamp extension model for Google Cloud Merchant Accounts.AggregateProductStatuses. Registered at `@swamp/gcp/merchantapi/accounts-aggregateproductstatuses`. */
export const model = {
  type: "@swamp/gcp/merchantapi/accounts-aggregateproductstatuses",
  ...
  methods: {
    get: {
      description: "Get a aggregateProductStatuses",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the aggregateProductStatuses",
        ),
      }),
    ...
    sync: {
      description: "Sync aggregateProductStatuses state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific aggregateProductStatuses by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List aggregateProductStatuses resources",
      arguments: z.object({
