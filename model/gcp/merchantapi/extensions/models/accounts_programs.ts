...
// Auto-generated extension model for @swamp/gcp/merchantapi/accounts-programs
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/programs/${shortName}`;
}

const BASE_URL = "https://merchantapi.googleapis.com/";

const GET_CONFIG = {
  "id": "merchantapi.accounts.programs.get",
...
const LIST_CONFIG = {
  "id": "merchantapi.accounts.programs.list",
...
const StateSchema = z.object({
  activeRegionCodes: z.array(z.string()).optional(),
  documentationUri: z.string().optional(),
  name: z.string(),
  state: z.string().optional(),
  unmetRequirements: z.array(z.object({
    affectedRegionCodes: z.array(z.string()),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a programs",
      arguments: z.object({
        identifier: z.string().describe("The name of the programs"),
      }),
    ...
    sync: {
      description: "Sync programs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific programs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List programs resources",
      arguments: z.object({
    ...
    disable: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "merchantapi.accounts.programs.disable",
    ...
    enable: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "merchantapi.accounts.programs.enable",
