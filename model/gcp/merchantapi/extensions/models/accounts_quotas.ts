...
// Auto-generated extension model for @swamp/gcp/merchantapi/accounts-quotas
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Merchant Accounts.Quotas.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "The group information for methods in the Merchant API. The quota is shared be...",
      schema: StateSchema,
      lifetime: "infinite",
