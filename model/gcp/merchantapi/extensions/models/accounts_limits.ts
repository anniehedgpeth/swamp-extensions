...
// Auto-generated extension model for @swamp/gcp/merchantapi/accounts-limits
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Merchant Accounts.Limits.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/limits/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Merchant Accounts.Limits. Registered at `@swamp/gcp/merchantapi/accounts-limits`. */
export const model = {
  type: "@swamp/gcp/merchantapi/accounts-limits",
  ...
  methods: {
    get: {
      description: "Get a limits",
      arguments: z.object({
        identifier: z.string().describe("The name of the limits"),
      }),
    ...
    sync: {
      description: "Sync limits state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific limits by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List limits resources",
      arguments: z.object({
