...
// Auto-generated extension model for @swamp/gcp/merchantapi/accounts-users
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Merchant Accounts.Users.
 *
...
const GET_CONFIG = {
  "id": "merchantapi.accounts.users.get",
...
const INSERT_CONFIG = {
  "id": "merchantapi.accounts.users.create",
...
const PATCH_CONFIG = {
  "id": "merchantapi.accounts.users.patch",
  "path": "accounts/v1/{+name}",
  "httpMethod": "PATCH",
  "parameterOrder": [
    "name",
...
const DELETE_CONFIG = {
  "id": "merchantapi.accounts.users.delete",
  "path": "accounts/v1/{+name}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "merchantapi.accounts.users.list",
  "path": "accounts/v1/{+parent}/users",
  "httpMethod": "GET",
  "parameterOrder": [
    "parent",
...
/** Swamp extension model for Google Cloud Merchant Accounts.Users. Registered at `@swamp/gcp/merchantapi/accounts-users`. */
export const model = {
  type: "@swamp/gcp/merchantapi/accounts-users",
  ...
  resources: {
    state: {
      description:
        "The `User` resource represents a user associated with a Merchant Center accou...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["accessRights"] !== undefined) {
          body["accessRights"] = g["accessRights"];
        }
