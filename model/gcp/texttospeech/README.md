...
Use `swamp model type describe @swamp/gcp/texttospeech/voices` to see the full
...
```bash
# Create a new voices model
swamp model create @swamp/gcp/texttospeech/voices my-voices

# Edit the model to configure its properties
swamp model edit my-voices

# Create the resource in GCP
swamp model method run my-voices create

# Sync current state from GCP
swamp model method run my-voices sync
```
