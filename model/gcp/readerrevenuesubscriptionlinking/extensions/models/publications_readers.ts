...
// Auto-generated extension model for @swamp/gcp/readerrevenuesubscriptionlinking/publications-readers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Reader Revenue Subscription Linking Publications.Readers.
 *
...
const BASE_URL = "https://readerrevenuesubscriptionlinking.googleapis.com/";
...
const StateSchema = z.object({
  ...
  name: z.string(),
  originatingPublicationId: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a readers",
      arguments: z.object({
        identifier: z.string().describe("The name of the readers"),
      }),
    ...
    delete: {
      description: "Delete the readers",
      arguments: z.object({
        identifier: z.string().describe("The name of the readers"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync readers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific readers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
