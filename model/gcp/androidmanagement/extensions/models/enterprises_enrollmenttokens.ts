...
const GlobalArgsSchema = z.object({
  ...
  }).describe("This field is deprecated and the value is ignored.").optional(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["googleAuthenticationOptions"] !== undefined) {
          body["googleAuthenticationOptions"] =
            g["googleAuthenticationOptions"];
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific enrollmentTokens by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
