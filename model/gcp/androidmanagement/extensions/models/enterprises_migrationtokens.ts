...
/**
 * Swamp extension model for Google Cloud Android Management Enterprises.MigrationTokens.
 *
...
/** Swamp extension model for Google Cloud Android Management Enterprises.MigrationTokens. Registered at `@swamp/gcp/androidmanagement/enterprises-migrationtokens`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific migrationTokens by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List migrationTokens resources",
      arguments: z.object({
