...
/**
 * Swamp extension model for Google Cloud Android Management Enterprises.
 *
...
const GlobalArgsSchema = z.object({
  ...
  }).describe("The enterprise contact info of an EMM-managed enterprise.")
    .optional(),
  ...
  }).describe("Settings for Google-provided user authentication.").optional(),
  logo: z.object({
  ...
  signinDetails: z.array(z.object({
    ...
    googleAuthenticationOptions: z.object({
      authenticationRequirement: z.enum([
  ...
  termsAndConditions: z.array(z.object({
    ...
    }).describe("A short header which appears above the HTML content.")
      .optional(),
  })).describe(
...
const StateSchema = z.object({
  ...
  signinDetails: z.array(z.object({
    ...
    googleAuthenticationOptions: z.object({
      authenticationRequirement: z.string(),
    }),
    qrCode: z.string(),
