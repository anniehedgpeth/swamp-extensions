...
Google Cloud androidmanagement resources.
...
Use
`swamp model type describe @swamp/gcp/androidmanagement/enterprises_applications`
...
```bash
# Create a new enterprises_applications model
swamp model create @swamp/gcp/androidmanagement/enterprises_applications my-enterprises_applications

# Edit the model to configure its properties
swamp model edit my-enterprises_applications

# Create the resource in GCP
swamp model method run my-enterprises_applications create

# Sync current state from GCP
swamp model method run my-enterprises_applications sync
```
