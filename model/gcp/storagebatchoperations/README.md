...
Google Cloud storagebatchoperations resources.
...
Use `swamp model type describe @swamp/gcp/storagebatchoperations/jobs` to see
...
swamp model create @swamp/gcp/storagebatchoperations/jobs my-jobs
