...
// Auto-generated extension model for @swamp/gcp/cloudresourcemanager/tagvalues
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Resource Manager TagValues.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A TagValue is a child of a particular TagKey. This is used to group cloud res...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a tagValues",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a tagValues",
      arguments: z.object({
        identifier: z.string().describe("The name of the tagValues"),
      }),
    ...
    update: {
      description: "Update tagValues attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific tagValues by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the tagValues",
      arguments: z.object({
        identifier: z.string().describe("The name of the tagValues"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync tagValues state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific tagValues by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List tagValues resources",
      arguments: z.object({
