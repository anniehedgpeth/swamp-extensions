...
// Auto-generated extension model for @swamp/gcp/cloudresourcemanager/organizations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Resource Manager Organizations.
 *
...
const StateSchema = z.object({
  ...
  directoryCustomerId: z.string().optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "The root node in the resource hierarchy to which a particular entity's (a com...",
      schema: StateSchema,
      lifetime: "infinite",
