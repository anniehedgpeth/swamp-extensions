...
// Auto-generated extension model for @swamp/gcp/cloudresourcemanager/capabilities
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Resource Manager Capabilities.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a capabilities",
      arguments: z.object({
        identifier: z.string().describe("The name of the capabilities"),
      }),
    ...
    update: {
      description: "Update capabilities attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific capabilities by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync capabilities state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific capabilities by name (e.g. one discovered by list)",
        ).optional(),
