...
// Auto-generated extension model for @swamp/gcp/cloudresourcemanager/effectivetags
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Resource Manager EffectiveTags.
 *
...
const StateSchema = z.object({
  ...
  namespacedTagKey: z.string().optional(),
  namespacedTagValue: z.string().optional(),
  tagKey: z.string().optional(),
  tagKeyParentName: z.string().optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "An EffectiveTag represents a tag that applies to a resource during policy eva...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a effectiveTags",
      arguments: z.object({
        identifier: z.string().describe("The name of the effectiveTags"),
      }),
    ...
    sync: {
      description: "Sync effectiveTags state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific effectiveTags by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List effectiveTags resources",
      arguments: z.object({
