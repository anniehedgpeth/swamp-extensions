...
/**
 * Swamp extension model for Google Cloud YouTube Analytics GroupItems.
 *
 * A group item.
 *
...
const GlobalArgsSchema = z.object({
  ...
  }).describe("Apiary error details").optional(),
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        try {
          ...
          const matchValue = String(g["resource"]?.id ?? "");
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific groupItems by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List groupItems resources",
      arguments: z.object({
        groupId: z.string().describe(
