...
// Auto-generated extension model for @swamp/gcp/notebooks/schedules
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Notebooks Schedules.
 *
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["scheduleId"] !== undefined) {
          params["scheduleId"] = String(g["scheduleId"]);
        }
        if (g["name"] !== undefined) {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific schedules by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List schedules resources",
      arguments: z.object({
        filter: z.string().describe("Filter applied to resulting schedules.")
          .optional(),
        orderBy: z.string().describe("Field to order results by.").optional(),
