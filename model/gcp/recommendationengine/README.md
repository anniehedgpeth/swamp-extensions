...
Google Cloud recommendationengine resources.
...
Use
`swamp model type describe @swamp/gcp/recommendationengine/catalogs_catalogitems`
...
```bash
# Create a new catalogs_catalogitems model
swamp model create @swamp/gcp/recommendationengine/catalogs_catalogitems my-catalogs_catalogitems

# Edit the model to configure its properties
swamp model edit my-catalogs_catalogitems

# Create the resource in GCP
swamp model method run my-catalogs_catalogitems create

# Sync current state from GCP
swamp model method run my-catalogs_catalogitems sync
```
