...
// Auto-generated extension model for @swamp/gcp/integrations/integrations-executions-suspensions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Application Integration Integrations.Executions.Suspensions.
 *
...
/** Swamp extension model for Google Cloud Application Integration Integrations.Executions.Suspensions. Registered at `@swamp/gcp/integrations/integrations-executions-suspensions`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific suspensions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List suspensions resources",
      arguments: z.object({
        filter: z.string().describe("Standard filter field.").optional(),
        orderBy: z.string().describe("Field name to order by.").optional(),
