...
// Auto-generated extension model for @swamp/gcp/integrations/sfdcinstances-sfdcchannels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Application Integration SfdcInstances.SfdcChannels.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/sfdcChannels/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Optional. The description for this channel")
    .optional(),
...
const StateSchema = z.object({
  ...
  lastReplayId: z.string().optional(),
  name: z.string(),
...
/** Swamp extension model for Google Cloud Application Integration SfdcInstances.SfdcChannels. Registered at `@swamp/gcp/integrations/sfdcinstances-sfdcchannels`. */
export const model = {
  type: "@swamp/gcp/integrations/sfdcinstances-sfdcchannels",
  ...
  methods: {
    create: {
      description: "Create a sfdcChannels",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["channelTopic"] !== undefined) {
          body["channelTopic"] = g["channelTopic"];
        }
    ...
    get: {
      description: "Get a sfdcChannels",
      arguments: z.object({
        identifier: z.string().describe("The name of the sfdcChannels"),
      }),
    ...
    update: {
      description: "Update sfdcChannels attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sfdcChannels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the sfdcChannels",
      arguments: z.object({
        identifier: z.string().describe("The name of the sfdcChannels"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync sfdcChannels state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sfdcChannels by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List sfdcChannels resources",
      arguments: z.object({
