...
// Auto-generated extension model for @swamp/gcp/integrations/connections-runtimeentityschemas
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Application Integration Connections.RuntimeEntitySchemas.
 *
...
const StateSchema = z.object({
  arrayFieldSchema: z.string().optional(),
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific runtimeEntitySchemas by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
