...
/**
 * Swamp extension model for Google Cloud Application Integration Certificates.
 *
...
/** Swamp extension model for Google Cloud Application Integration Certificates. Registered at `@swamp/gcp/integrations/certificates`. */
export const model = {
