...
// Auto-generated extension model for @swamp/gcp/integrations/sfdcinstances
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Application Integration SfdcInstances.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/sfdcInstances/${shortName}`;
}
...
const StateSchema = z.object({
  authConfigId: z.array(z.string()).optional(),
  createTime: z.string().optional(),
  deleteTime: z.string().optional(),
  description: z.string().optional(),
  displayName: z.string().optional(),
  name: z.string(),
  serviceAuthority: z.string().optional(),
...
/** Swamp extension model for Google Cloud Application Integration SfdcInstances. Registered at `@swamp/gcp/integrations/sfdcinstances`. */
export const model = {
  type: "@swamp/gcp/integrations/sfdcinstances",
  ...
  methods: {
    create: {
      description: "Create a sfdcInstances",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["authConfigId"] !== undefined) {
          body["authConfigId"] = g["authConfigId"];
        }
        ...
        if (g["serviceAuthority"] !== undefined) {
          body["serviceAuthority"] = g["serviceAuthority"];
        }
        if (g["sfdcOrgId"] !== undefined) body["sfdcOrgId"] = g["sfdcOrgId"];
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a sfdcInstances",
      arguments: z.object({
        identifier: z.string().describe("The name of the sfdcInstances"),
      }),
    ...
    update: {
      description: "Update sfdcInstances attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sfdcInstances by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the sfdcInstances",
      arguments: z.object({
        identifier: z.string().describe("The name of the sfdcInstances"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync sfdcInstances state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sfdcInstances by name (e.g. one discovered by list)",
        ).optional(),
