...
Google Cloud integrations resources.
...
Use `swamp model type describe @swamp/gcp/integrations/authconfigs` to see the
...
```bash
# Create a new authconfigs model
swamp model create @swamp/gcp/integrations/authconfigs my-authconfigs

# Edit the model to configure its properties
swamp model edit my-authconfigs

# Create the resource in GCP
swamp model method run my-authconfigs create

# Sync current state from GCP
swamp model method run my-authconfigs sync
```
