...
Google Cloud workflows resources.
...
Use `swamp model type describe @swamp/gcp/workflows/locations` to see the full
...
swamp model create @swamp/gcp/workflows/locations my-locations
