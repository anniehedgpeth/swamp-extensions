...
Use `swamp model type describe @swamp/gcp/kmsinventory/cryptokeys` to see the
...
```bash
# Create a new cryptokeys model
swamp model create @swamp/gcp/kmsinventory/cryptokeys my-cryptokeys

# Edit the model to configure its properties
swamp model edit my-cryptokeys

# Create the resource in GCP
swamp model method run my-cryptokeys create

# Sync current state from GCP
swamp model method run my-cryptokeys sync
```
