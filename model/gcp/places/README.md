...
Use `swamp model type describe @swamp/gcp/places/places` to see the full list of
...
```bash
# Create a new places model
swamp model create @swamp/gcp/places/places my-places

# Edit the model to configure its properties
swamp model edit my-places

# Create the resource in GCP
swamp model method run my-places create

# Sync current state from GCP
swamp model method run my-places sync
```
