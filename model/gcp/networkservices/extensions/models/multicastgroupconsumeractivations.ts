...
// Auto-generated extension model for @swamp/gcp/networkservices/multicastgroupconsumeractivations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Services MulticastGroupConsumerActivations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/multicastGroupConsumerActivations/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  multicastConsumerAssociation: z.string().optional(),
  multicastGroup: z.string().optional(),
  multicastGroupRangeActivation: z.string().optional(),
  name: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "Multicast group consumer activation resource.",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a multicastGroupConsumerActivations",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["multicastConsumerAssociation"] !== undefined) {
          body["multicastConsumerAssociation"] =
            g["multicastConsumerAssociation"];
        }
        if (g["multicastGroupRangeActivation"] !== undefined) {
    ...
    get: {
      description: "Get a multicastGroupConsumerActivations",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the multicastGroupConsumerActivations",
        ),
      }),
    ...
    update: {
      description: "Update multicastGroupConsumerActivations attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific multicastGroupConsumerActivations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the multicastGroupConsumerActivations",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the multicastGroupConsumerActivations",
        ),
    ...
    sync: {
      description: "Sync multicastGroupConsumerActivations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific multicastGroupConsumerActivations by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List multicastGroupConsumerActivations resources",
      arguments: z.object({
