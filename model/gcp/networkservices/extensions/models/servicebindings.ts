...
// Auto-generated extension model for @swamp/gcp/networkservices/servicebindings
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Services ServiceBindings.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/serviceBindings/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a serviceBindings",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a serviceBindings",
      arguments: z.object({
        identifier: z.string().describe("The name of the serviceBindings"),
      }),
    ...
    update: {
      description: "Update serviceBindings attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific serviceBindings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the serviceBindings",
      arguments: z.object({
        identifier: z.string().describe("The name of the serviceBindings"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync serviceBindings state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific serviceBindings by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List serviceBindings resources",
      arguments: z.object({
