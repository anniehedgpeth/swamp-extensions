...
// Auto-generated extension model for @swamp/gcp/networkservices/multicastconsumerassociations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Services MulticastConsumerAssociations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/multicastConsumerAssociations/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  multicastDomainActivation: z.string().optional(),
  name: z.string(),
  network: z.string().optional(),
  placementPolicy: z.string().optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "Multicast consumer association resource.",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a multicastConsumerAssociations",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["multicastDomainActivation"] !== undefined) {
    ...
    get: {
      description: "Get a multicastConsumerAssociations",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the multicastConsumerAssociations",
        ),
      }),
    ...
    update: {
      description: "Update multicastConsumerAssociations attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific multicastConsumerAssociations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the multicastConsumerAssociations",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the multicastConsumerAssociations",
        ),
    ...
    sync: {
      description: "Sync multicastConsumerAssociations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific multicastConsumerAssociations by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List multicastConsumerAssociations resources",
      arguments: z.object({
