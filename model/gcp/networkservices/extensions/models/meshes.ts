...
// Auto-generated extension model for @swamp/gcp/networkservices/meshes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Services Meshes.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/meshes/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  interceptionPort: z.number().int().describe(
...
const StateSchema = z.object({
  ...
  interceptionPort: z.number().optional(),
...
/** Swamp extension model for Google Cloud Network Services Meshes. Registered at `@swamp/gcp/networkservices/meshes`. */
export const model = {
  type: "@swamp/gcp/networkservices/meshes",
  ...
  resources: {
    state: {
      description:
        "Mesh represents a logical configuration grouping for workload to workload com...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["interceptionPort"] !== undefined) {
          body["interceptionPort"] = g["interceptionPort"];
        }
        if (g["labels"] !== undefined) body["labels"] = g["labels"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["meshId"] !== undefined) params["meshId"] = String(g["meshId"]);
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a meshes",
      arguments: z.object({
        identifier: z.string().describe("The name of the meshes"),
      }),
    ...
    update: {
      description: "Update meshes attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific meshes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync meshes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific meshes by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List meshes resources",
      arguments: z.object({
