...
/**
 * Swamp extension model for Google Cloud Network Services ServiceLbPolicies.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["serviceLbPolicyId"] !== undefined) {
          params["serviceLbPolicyId"] = String(g["serviceLbPolicyId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific serviceLbPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List serviceLbPolicies resources",
      arguments: z.object({
