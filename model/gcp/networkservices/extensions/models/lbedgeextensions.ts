...
// Auto-generated extension model for @swamp/gcp/networkservices/lbedgeextensions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Services LbEdgeExtensions.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/lbEdgeExtensions/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  lbEdgeExtensionId: z.string().describe(
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a lbEdgeExtensions",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["lbEdgeExtensionId"] !== undefined) {
          params["lbEdgeExtensionId"] = String(g["lbEdgeExtensionId"]);
        }
    ...
    get: {
      description: "Get a lbEdgeExtensions",
      arguments: z.object({
        identifier: z.string().describe("The name of the lbEdgeExtensions"),
      }),
    ...
    update: {
      description: "Update lbEdgeExtensions attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific lbEdgeExtensions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the lbEdgeExtensions",
      arguments: z.object({
        identifier: z.string().describe("The name of the lbEdgeExtensions"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync lbEdgeExtensions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific lbEdgeExtensions by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List lbEdgeExtensions resources",
      arguments: z.object({
