...
Google Cloud networkservices resources.
...
Use
`swamp model type describe @swamp/gcp/networkservices/agentconnectivitytemplates`
...
```bash
# Create a new agentconnectivitytemplates model
swamp model create @swamp/gcp/networkservices/agentconnectivitytemplates my-agentconnectivitytemplates

# Edit the model to configure its properties
swamp model edit my-agentconnectivitytemplates

# Create the resource in GCP
swamp model method run my-agentconnectivitytemplates create

# Sync current state from GCP
swamp model method run my-agentconnectivitytemplates sync
```
