...
Use `swamp model type describe @swamp/gcp/admob/accounts_adunits` to see the
...
```bash
# Create a new accounts_adunits model
swamp model create @swamp/gcp/admob/accounts_adunits my-accounts_adunits

# Edit the model to configure its properties
swamp model edit my-accounts_adunits

# Create the resource in GCP
swamp model method run my-accounts_adunits create

# Sync current state from GCP
swamp model method run my-accounts_adunits sync
```
