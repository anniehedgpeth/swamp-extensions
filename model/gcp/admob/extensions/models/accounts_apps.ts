...
// Auto-generated extension model for @swamp/gcp/admob/accounts-apps
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud AdMob Accounts.Apps.
 *
...
const StateSchema = z.object({
  appApprovalState: z.string().optional(),
  appId: z.string().optional(),
  linkedAppInfo: z.object({
    appStoreId: z.string(),
    displayName: z.string(),
  }).optional(),
  manualAppInfo: z.object({
    displayName: z.string(),
  }).optional(),
  name: z.string(),
...
/** Swamp extension model for Google Cloud AdMob Accounts.Apps. Registered at `@swamp/gcp/admob/accounts-apps`. */
export const model = {
  type: "@swamp/gcp/admob/accounts-apps",
