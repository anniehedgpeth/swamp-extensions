...
Google Cloud discoveryengine resources.
...
Use `swamp model type describe @swamp/gcp/discoveryengine/cmekconfigs` to see
...
```bash
# Create a new cmekconfigs model
swamp model create @swamp/gcp/discoveryengine/cmekconfigs my-cmekconfigs

# Edit the model to configure its properties
swamp model edit my-cmekconfigs

# Create the resource in GCP
swamp model method run my-cmekconfigs create

# Sync current state from GCP
swamp model method run my-cmekconfigs sync
```
