...
// Auto-generated extension model for @swamp/gcp/discoveryengine/collections-datastores-schemas
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.Schemas.
 *
...
const StateSchema = z.object({
  ...
  name: z.string(),
  structSchema: z.record(z.string(), z.unknown()).optional(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.Schemas. Registered at `@swamp/gcp/discoveryengine/collections-datastores-schemas`. */
export const model = {
  type: "@swamp/gcp/discoveryengine/collections-datastores-schemas",
