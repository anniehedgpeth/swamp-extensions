...
// Auto-generated extension model for @swamp/gcp/discoveryengine/collections-datastores-custommodels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.CustomModels.
 *
...
const StateSchema = z.object({
  ...
  name: z.string(),
  trainingStartTime: z.string().optional(),
}).passthrough();
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a customModels",
      arguments: z.object({
        identifier: z.string().describe("The name of the customModels"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        if (g["dataStore"] !== undefined) {
          params["dataStore"] = String(g["dataStore"]);
        }
    ...
    sync: {
      description: "Sync customModels state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific customModels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
        ...
        try {
          ...
          if (g["dataStore"] !== undefined) {
            params["dataStore"] = String(g["dataStore"]);
          } else if (existing["dataStore"]) {
            params["dataStore"] = String(existing["dataStore"]);
          }
    ...
    list: {
      description: "List customModels resources",
      arguments: z.object({
