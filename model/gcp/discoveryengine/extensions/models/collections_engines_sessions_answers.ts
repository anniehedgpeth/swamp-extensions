...
// Auto-generated extension model for @swamp/gcp/discoveryengine/collections-engines-sessions-answers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Discovery Engine Collections.Engines.Sessions.Answers.
 *
 * Defines an answer.
 *
...
/** Swamp extension model for Google Cloud Discovery Engine Collections.Engines.Sessions.Answers. Registered at `@swamp/gcp/discoveryengine/collections-engines-sessions-answers`. */
export const model = {
  type: "@swamp/gcp/discoveryengine/collections-engines-sessions-answers",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific answers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
