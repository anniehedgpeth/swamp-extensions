...
// Auto-generated extension model for @swamp/gcp/discoveryengine/datastores-sessions-answers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Discovery Engine DataStores.Sessions.Answers.
 *
 * Defines an answer.
 *
...
/** Swamp extension model for Google Cloud Discovery Engine DataStores.Sessions.Answers. Registered at `@swamp/gcp/discoveryengine/datastores-sessions-answers`. */
export const model = {
