...
/**
 * Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.SiteSearchEngine.TargetSites.
 *
...
/** Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.SiteSearchEngine.TargetSites. Registered at `@swamp/gcp/discoveryengine/collections-datastores-sitesearchengine-targetsites`. */
export const model = {
  type:
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific targetSites by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List targetSites resources",
      arguments: z.object({
