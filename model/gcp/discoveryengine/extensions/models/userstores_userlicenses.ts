...
// Auto-generated extension model for @swamp/gcp/discoveryengine/userstores-userlicenses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Discovery Engine UserStores.UserLicenses.
 *
...
const StateSchema = z.object({
  ...
  licenseAssignmentState: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a userLicenses",
      arguments: z.object({
        identifier: z.string().describe("The name of the userLicenses"),
      }),
