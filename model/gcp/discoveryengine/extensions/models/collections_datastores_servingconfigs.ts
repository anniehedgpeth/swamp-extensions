...
/**
 * Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.ServingConfigs.
 *
...
/** Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.ServingConfigs. Registered at `@swamp/gcp/discoveryengine/collections-datastores-servingconfigs`. */
export const model = {
    ...
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["servingConfigId"] !== undefined) {
          params["servingConfigId"] = String(g["servingConfigId"]);
        }
