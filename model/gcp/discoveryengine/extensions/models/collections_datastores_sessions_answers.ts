...
/**
 * Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.Sessions.Answers.
 *
 * Defines an answer.
 *
...
/** Swamp extension model for Google Cloud Discovery Engine Collections.DataStores.Sessions.Answers. Registered at `@swamp/gcp/discoveryengine/collections-datastores-sessions-answers`. */
export const model = {
