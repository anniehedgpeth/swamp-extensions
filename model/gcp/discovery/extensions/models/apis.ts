...
/**
 * Swamp extension model for Google Cloud API Discovery Service Apis.
 *
...
export const model = {
  ...
  methods: {
    ...
    list: {
      ...
      arguments: z.object({
        name: z.string().describe("Only include APIs with the given name.")
          .optional(),
        preferred: z.boolean().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["preferred"] !== undefined) {
          params["preferred"] = String(args["preferred"]);
        }
