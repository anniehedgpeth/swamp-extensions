...
Google Cloud discovery resources.
...
Use `swamp model type describe @swamp/gcp/discovery/apis` to see the full list
...
```bash
# Create a new apis model
swamp model create @swamp/gcp/discovery/apis my-apis

# Edit the model to configure its properties
swamp model edit my-apis

# Create the resource in GCP
swamp model method run my-apis create

# Sync current state from GCP
swamp model method run my-apis sync
```
