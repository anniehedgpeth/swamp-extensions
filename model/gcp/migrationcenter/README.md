...
Google Cloud migrationcenter resources.
...
Use `swamp model type describe @swamp/gcp/migrationcenter/assets` to see the
...
swamp model create @swamp/gcp/migrationcenter/assets my-assets
