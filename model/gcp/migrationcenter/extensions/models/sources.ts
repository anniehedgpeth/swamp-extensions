...
/**
 * Swamp extension model for Google Cloud Migration Center Sources.
 *
...
/** Swamp extension model for Google Cloud Migration Center Sources. Registered at `@swamp/gcp/migrationcenter/sources`. */
export const model = {
