...
/**
 * Swamp extension model for Google Cloud Migration Center DiscoveryClients.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["discoveryClientId"] !== undefined) {
          params["discoveryClientId"] = String(g["discoveryClientId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific discoveryClients by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List discoveryClients resources",
      arguments: z.object({
        filter: z.string().describe(
          "Optional. Filter expression to filter results by.",
        ).optional(),
        orderBy: z.string().describe("Optional. Field to sort by.").optional(),
