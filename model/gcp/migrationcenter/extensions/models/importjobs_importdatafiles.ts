...
// Auto-generated extension model for @swamp/gcp/migrationcenter/importjobs-importdatafiles
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Migration Center ImportJobs.ImportDataFiles.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/importDataFiles/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  ]).describe("Required. The payload format.").optional(),
  uploadFileInfo: z.object({
    headers: z.record(z.string(), z.string()).describe(
      "Output only. The headers that were used to sign the URI.",
    ).optional(),
    signedUri: z.string().describe("Output only. Upload URI for the file.")
      .optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a importDataFiles",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["uploadFileInfo"] !== undefined) {
          body["uploadFileInfo"] = g["uploadFileInfo"];
        }
        if (g["importDataFileId"] !== undefined) {
          params["importDataFileId"] = String(g["importDataFileId"]);
        }
    ...
    get: {
      description: "Get a importDataFiles",
      arguments: z.object({
        identifier: z.string().describe("The name of the importDataFiles"),
      }),
    ...
    delete: {
      description: "Delete the importDataFiles",
      arguments: z.object({
        identifier: z.string().describe("The name of the importDataFiles"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync importDataFiles state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific importDataFiles by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List importDataFiles resources",
      arguments: z.object({
