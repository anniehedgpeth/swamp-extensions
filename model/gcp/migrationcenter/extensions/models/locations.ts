...
// Auto-generated extension model for @swamp/gcp/migrationcenter/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Migration Center Locations.
 *
...
/** Swamp extension model for Google Cloud Migration Center Locations. Registered at `@swamp/gcp/migrationcenter/locations`. */
export const model = {
  type: "@swamp/gcp/migrationcenter/locations",
  ...
  methods: {
    ...
    update_settings: {
      ...
      arguments: z.object({
        disableCloudLogging: z.any().optional(),
        name: z.any().optional(),
        preferenceSet: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (args["disableCloudLogging"] !== undefined) {
          body["disableCloudLogging"] = args["disableCloudLogging"];
        }
        if (args["name"] !== undefined) body["name"] = args["name"];
        if (args["preferenceSet"] !== undefined) {
          body["preferenceSet"] = args["preferenceSet"];
        }
        const result = await createResource(
          BASE_URL,
          {
