...
/**
 * Swamp extension model for Google Cloud Migration Center AssetsExportJobs.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["assetsExportJobId"] !== undefined) {
          params["assetsExportJobId"] = String(g["assetsExportJobId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific assetsExportJobs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List assetsExportJobs resources",
      arguments: z.object({
