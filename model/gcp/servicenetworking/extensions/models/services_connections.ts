...
// Auto-generated extension model for @swamp/gcp/servicenetworking/services-connections
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Service Networking Services.Connections.
 *
...
const StateSchema = z.object({
  ...
  reservedPeeringRanges: z.array(z.string()).optional(),
    ...
    list: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["network"] !== undefined) {
          params["network"] = String(args["network"]);
        }
