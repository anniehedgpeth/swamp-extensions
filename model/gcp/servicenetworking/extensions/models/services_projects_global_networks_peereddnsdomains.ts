...
// Auto-generated extension model for @swamp/gcp/servicenetworking/services-projects-global-networks-peereddnsdomains
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Service Networking Services.Projects.Global.Networks.PeeredDnsDomains.
 *
...
/** Swamp extension model for Google Cloud Service Networking Services.Projects.Global.Networks.PeeredDnsDomains. Registered at `@swamp/gcp/servicenetworking/services-projects-global-networks-peereddnsdomains`. */
export const model = {
  type:
    "@swamp/gcp/servicenetworking/services-projects-global-networks-peereddnsdomains",
  ...
  methods: {
    create: {
      description: "Create a peeredDnsDomains",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a peeredDnsDomains",
      arguments: z.object({
        identifier: z.string().describe("The name of the peeredDnsDomains"),
      }),
    ...
    delete: {
      description: "Delete the peeredDnsDomains",
      arguments: z.object({
        identifier: z.string().describe("The name of the peeredDnsDomains"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync peeredDnsDomains state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific peeredDnsDomains by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List peeredDnsDomains resources",
      arguments: z.object({
