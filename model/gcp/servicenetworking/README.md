...
Google Cloud servicenetworking resources.
...
Use
`swamp model type describe @swamp/gcp/servicenetworking/services_connections` to
...
```bash
# Create a new services_connections model
swamp model create @swamp/gcp/servicenetworking/services_connections my-services_connections

# Edit the model to configure its properties
swamp model edit my-services_connections

# Create the resource in GCP
swamp model method run my-services_connections create

# Sync current state from GCP
swamp model method run my-services_connections sync
```
