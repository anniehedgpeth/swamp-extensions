...
Google Cloud blockchainnodeengine resources.
...
Use `swamp model type describe @swamp/gcp/blockchainnodeengine/blockchainnodes`
...
```bash
# Create a new blockchainnodes model
swamp model create @swamp/gcp/blockchainnodeengine/blockchainnodes my-blockchainnodes

# Edit the model to configure its properties
swamp model edit my-blockchainnodes

# Create the resource in GCP
swamp model method run my-blockchainnodes create

# Sync current state from GCP
swamp model method run my-blockchainnodes sync
```
