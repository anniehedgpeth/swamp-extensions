...
// Auto-generated extension model for @swamp/gcp/firestore/databases-backupschedules
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firestore Databases.BackupSchedules.
 *
...
const StateSchema = z.object({
  ...
  dailyRecurrence: z.object({}).optional(),
  name: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A backup schedule for a Cloud Firestore Database. This resource is owned by t...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["dailyRecurrence"] !== undefined) {
          body["dailyRecurrence"] = g["dailyRecurrence"];
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific backupSchedules by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List backupSchedules resources",
      arguments: z.object({
