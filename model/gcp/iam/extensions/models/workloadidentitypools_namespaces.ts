...
// Auto-generated extension model for @swamp/gcp/iam/workloadidentitypools-namespaces
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Identity and Access Management (IAM) WorkloadIdentityPools.Namespaces.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Represents a namespace for a workload identity pool. Namespaces are used to s...",
      schema: StateSchema,
      lifetime: "infinite",
