...
// Auto-generated extension model for @swamp/gcp/iam/workforcepools-providers-scimtenants-tokens
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Identity and Access Management (IAM) WorkforcePools.Providers.ScimTenants.Tokens.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/tokens/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  workforcePoolProviderScimTokenId: z.string().describe(
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Gemini Enterprise only. Represents a token for the WorkforcePoolProviderScimT...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["workforcePoolProviderScimTokenId"] !== undefined) {
          params["workforcePoolProviderScimTokenId"] = String(
            g["workforcePoolProviderScimTokenId"],
          );
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific tokens by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
