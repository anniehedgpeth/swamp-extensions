...
// Auto-generated extension model for @swamp/gcp/iam/roles
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Identity and Access Management (IAM) Roles.
 *
...
const GlobalArgsSchema = z.object({
  ...
  role: z.object({
    ...
    etag: z.string().describe("Used to perform a consistent read-modify-write.")
      .optional(),
    includedPermissions: z.array(z.string()).describe(
  ...
  methods: {
    ...
    update: {
      ...
      execute: async (args: { identifier?: string }, context: any) => {
        ...
        if (g["includedPermissions"] !== undefined) {
          body["includedPermissions"] = g["includedPermissions"];
        }
        if (g["stage"] !== undefined) body["stage"] = g["stage"];
