...
// Auto-generated extension model for @swamp/gcp/iam/workloadidentitypools-namespaces-managedidentities
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Identity and Access Management (IAM) WorkloadIdentityPools.Namespaces.ManagedIdentities.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/managedIdentities/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a managedIdentities",
      arguments: z.object({
    ...
    get: {
      description: "Get a managedIdentities",
      arguments: z.object({
        identifier: z.string().describe("The name of the managedIdentities"),
      }),
    ...
    update: {
      description: "Update managedIdentities attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific managedIdentities by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the managedIdentities",
      arguments: z.object({
        identifier: z.string().describe("The name of the managedIdentities"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync managedIdentities state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific managedIdentities by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List managedIdentities resources",
      arguments: z.object({
