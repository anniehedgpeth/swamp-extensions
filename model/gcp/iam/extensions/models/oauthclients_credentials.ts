...
// Auto-generated extension model for @swamp/gcp/iam/oauthclients-credentials
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Identity and Access Management (IAM) OauthClients.Credentials.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/credentials/${shortName}`;
}

const BASE_URL = "https://iam.googleapis.com/";

const GET_CONFIG = {
  "id": "iam.projects.locations.oauthClients.credentials.get",
  "path": "v1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const INSERT_CONFIG = {
  "id": "iam.projects.locations.oauthClients.credentials.create",
...
const PATCH_CONFIG = {
  "id": "iam.projects.locations.oauthClients.credentials.patch",
  "path": "v1/{+name}",
  "httpMethod": "PATCH",
  "parameterOrder": [
    "name",
...
const DELETE_CONFIG = {
  "id": "iam.projects.locations.oauthClients.credentials.delete",
  "path": "v1/{+name}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "iam.projects.locations.oauthClients.credentials.list",
  "path": "v1/{+parent}/credentials",
  "httpMethod": "GET",
  "parameterOrder": [
    "parent",
...
const GlobalArgsSchema = z.object({
  ...
  oauthClientCredentialId: z.string().describe(
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Represents an OauthClientCredential. Used to authenticate an OauthClient whil...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a credentials",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["oauthClientCredentialId"] !== undefined) {
          params["oauthClientCredentialId"] = String(
            g["oauthClientCredentialId"],
          );
        }
    ...
    get: {
      description: "Get a credentials",
      arguments: z.object({
        identifier: z.string().describe("The name of the credentials"),
      }),
    ...
    update: {
      description: "Update credentials attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific credentials by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync credentials state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific credentials by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List credentials resources",
      arguments: z.object({
