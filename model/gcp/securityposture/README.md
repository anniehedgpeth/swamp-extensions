...
Google Cloud securityposture resources.
...
Use `swamp model type describe @swamp/gcp/securityposture/locations` to see the
...
swamp model create @swamp/gcp/securityposture/locations my-locations
