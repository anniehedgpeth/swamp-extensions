...
/**
 * Swamp extension model for Google Cloud Security Posture PostureDeployments.
 *
...
/** Swamp extension model for Google Cloud Security Posture PostureDeployments. Registered at `@swamp/gcp/securityposture/posturedeployments`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["postureDeploymentId"] !== undefined) {
          params["postureDeploymentId"] = String(g["postureDeploymentId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific postureDeployments by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List postureDeployments resources",
      arguments: z.object({
