...
/**
 * Swamp extension model for Google Cloud Security Posture PostureTemplates.
 *
...
/** Swamp extension model for Google Cloud Security Posture PostureTemplates. Registered at `@swamp/gcp/securityposture/posturetemplates`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific postureTemplates by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List postureTemplates resources",
      arguments: z.object({
