...
/**
 * Swamp extension model for Google Cloud Security Posture Postures.
 *
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["postureId"] !== undefined) {
          params["postureId"] = String(g["postureId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific postures by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List postures resources",
      arguments: z.object({
