...
// Auto-generated extension model for @swamp/gcp/securityposture/reports
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Security Posture Reports.
 *
 * Details of a report.
 *
...
const StateSchema = z.object({
  ...
  iacValidationReport: z.object({
    ...
    violations: z.array(z.object({
      ...
      violatedPosture: z.object({
        policySet: z.string(),
        posture: z.string(),
        postureDeployment: z.string(),
        postureDeploymentTargetResource: z.string(),
        postureRevisionId: z.string(),
      }),
    })),
  }).optional(),
  name: z.string(),
...
/** Swamp extension model for Google Cloud Security Posture Reports. Registered at `@swamp/gcp/securityposture/reports`. */
export const model = {
  ...
  methods: {
    ...
    create_ia_cvalidation_report: {
      description: "create ia cvalidation report",
      arguments: z.object({
        iac: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["iac"] !== undefined) body["iac"] = args["iac"];
