...
Use
`swamp model type describe @swamp/gcp/tagmanager/accounts_containers_destinations`
...
```bash
# Create a new accounts_containers_destinations model
swamp model create @swamp/gcp/tagmanager/accounts_containers_destinations my-accounts_containers_destinations

# Edit the model to configure its properties
swamp model edit my-accounts_containers_destinations

# Create the resource in GCP
swamp model method run my-accounts_containers_destinations create

# Sync current state from GCP
swamp model method run my-accounts_containers_destinations sync
```
