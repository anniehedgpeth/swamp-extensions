...
/**
 * Swamp extension model for Google Cloud Tag Manager Accounts.Containers.Workspaces.Gtag_config.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific gtag_config by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List gtag_config resources",
      arguments: z.object({
