...
/**
 * Swamp extension model for Google Cloud Service Consumer Management Services.TenancyUnits.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific tenancyUnits by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List tenancyUnits resources",
      arguments: z.object({
