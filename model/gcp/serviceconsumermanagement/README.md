...
Google Cloud serviceconsumermanagement resources.
...
Use
`swamp model type describe @swamp/gcp/serviceconsumermanagement/services_tenancyunits`
...
```bash
# Create a new services_tenancyunits model
swamp model create @swamp/gcp/serviceconsumermanagement/services_tenancyunits my-services_tenancyunits

# Edit the model to configure its properties
swamp model edit my-services_tenancyunits

# Create the resource in GCP
swamp model method run my-services_tenancyunits create

# Sync current state from GCP
swamp model method run my-services_tenancyunits sync
```
