...
Use `swamp model type describe @swamp/gcp/retail/catalogs_branches_products` to
...
```bash
# Create a new catalogs_branches_products model
swamp model create @swamp/gcp/retail/catalogs_branches_products my-catalogs_branches_products

# Edit the model to configure its properties
swamp model edit my-catalogs_branches_products

# Create the resource in GCP
swamp model method run my-catalogs_branches_products create

# Sync current state from GCP
swamp model method run my-catalogs_branches_products sync
```
