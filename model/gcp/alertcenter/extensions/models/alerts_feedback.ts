...
/**
 * Swamp extension model for Google Cloud Google Workspace Alert Center Alerts.Feedback.
 *
...
/** Swamp extension model for Google Cloud Google Workspace Alert Center Alerts.Feedback. Registered at `@swamp/gcp/alertcenter/alerts-feedback`. */
export const model = {
  ...
  methods: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        const result = await createResource(
          ...
          undefined,
          {
            ...
            listParams: { "alertId": String(g["alertId"] ?? "") },
            matchField: "name",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific feedback by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List feedback resources",
      arguments: z.object({
