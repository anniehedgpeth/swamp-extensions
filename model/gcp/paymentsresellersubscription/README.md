...
Google Cloud paymentsresellersubscription resources.
...
Use
`swamp model type describe @swamp/gcp/paymentsresellersubscription/partners_products`
...
```bash
# Create a new partners_products model
swamp model create @swamp/gcp/paymentsresellersubscription/partners_products my-partners_products

# Edit the model to configure its properties
swamp model edit my-partners_products

# Create the resource in GCP
swamp model method run my-partners_products create

# Sync current state from GCP
swamp model method run my-partners_products sync
```
