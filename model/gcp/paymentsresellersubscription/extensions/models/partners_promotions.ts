...
// Auto-generated extension model for @swamp/gcp/paymentsresellersubscription/partners-promotions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Payments Reseller Subscription Partners.Promotions.
 *
...
/** Swamp extension model for Google Cloud Payments Reseller Subscription Partners.Promotions. Registered at `@swamp/gcp/paymentsresellersubscription/partners-promotions`. */
export const model = {
  type: "@swamp/gcp/paymentsresellersubscription/partners-promotions",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific promotions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
