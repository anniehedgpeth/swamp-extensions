...
Use `swamp model type describe @swamp/gcp/agenciesandbrands/agencies_reports` to
...
```bash
# Create a new agencies_reports model
swamp model create @swamp/gcp/agenciesandbrands/agencies_reports my-agencies_reports

# Edit the model to configure its properties
swamp model edit my-agencies_reports

# Create the resource in GCP
swamp model method run my-agencies_reports create

# Sync current state from GCP
swamp model method run my-agencies_reports sync
```
