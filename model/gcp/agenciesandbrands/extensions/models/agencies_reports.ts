...
// Auto-generated extension model for @swamp/gcp/agenciesandbrands/agencies-reports
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Agencies and Brands Agencies.Reports.
 *
 * The `Report` resource.
 *
...
const BASE_URL = "https://agenciesandbrands.googleapis.com/";
...
/** Swamp extension model for Google Cloud Agencies and Brands Agencies.Reports. Registered at `@swamp/gcp/agenciesandbrands/agencies-reports`. */
export const model = {
  type: "@swamp/gcp/agenciesandbrands/agencies-reports",
