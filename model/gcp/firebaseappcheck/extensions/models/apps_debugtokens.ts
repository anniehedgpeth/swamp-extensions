...
// Auto-generated extension model for @swamp/gcp/firebaseappcheck/apps-debugtokens
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase App Check Apps.DebugTokens.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/debugTokens/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A *debug token* is a secret used during the development or integration testin...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a debugTokens",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a debugTokens",
      arguments: z.object({
        identifier: z.string().describe("The name of the debugTokens"),
      }),
    ...
    update: {
      description: "Update debugTokens attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific debugTokens by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the debugTokens",
      arguments: z.object({
        identifier: z.string().describe("The name of the debugTokens"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync debugTokens state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific debugTokens by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List debugTokens resources",
      arguments: z.object({
