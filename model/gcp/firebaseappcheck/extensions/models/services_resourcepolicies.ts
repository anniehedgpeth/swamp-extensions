...
// Auto-generated extension model for @swamp/gcp/firebaseappcheck/services-resourcepolicies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase App Check Services.ResourcePolicies.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/resourcePolicies/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "App Check enforcement policy for a specific resource of a Google service supp...",
      schema: StateSchema,
      lifetime: "infinite",
