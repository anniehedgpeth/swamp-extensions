...
// Auto-generated extension model for @swamp/gcp/firebaseappcheck/apps-appattestconfig
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase App Check Apps.AppAttestConfig.
 *
...
/** Swamp extension model for Google Cloud Firebase App Check Apps.AppAttestConfig. Registered at `@swamp/gcp/firebaseappcheck/apps-appattestconfig`. */
export const model = {
  type: "@swamp/gcp/firebaseappcheck/apps-appattestconfig",
  ...
  methods: {
    get: {
      description: "Get a appAttestConfig",
      arguments: z.object({
        identifier: z.string().describe("The name of the appAttestConfig"),
      }),
    ...
    update: {
      description: "Update appAttestConfig attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific appAttestConfig by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync appAttestConfig state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific appAttestConfig by name (e.g. one discovered by list)",
        ).optional(),
