...
Use `swamp model type describe @swamp/gcp/firebaseappcheck/apps_appattestconfig`
...
```bash
# Create a new apps_appattestconfig model
swamp model create @swamp/gcp/firebaseappcheck/apps_appattestconfig my-apps_appattestconfig

# Edit the model to configure its properties
swamp model edit my-apps_appattestconfig

# Create the resource in GCP
swamp model method run my-apps_appattestconfig create

# Sync current state from GCP
swamp model method run my-apps_appattestconfig sync
```
