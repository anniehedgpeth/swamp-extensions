...
// Auto-generated extension model for @swamp/gcp/batch/jobs-taskgroups-tasks
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Batch Jobs.TaskGroups.Tasks.
 *
 * A Cloud Batch task.
 *
...
/** Swamp extension model for Google Cloud Batch Jobs.TaskGroups.Tasks. Registered at `@swamp/gcp/batch/jobs-taskgroups-tasks`. */
export const model = {
  type: "@swamp/gcp/batch/jobs-taskgroups-tasks",
