...
Use `swamp model type describe @swamp/gcp/batch/jobs_taskgroups_tasks` to see
...
```bash
# Create a new jobs_taskgroups_tasks model
swamp model create @swamp/gcp/batch/jobs_taskgroups_tasks my-jobs_taskgroups_tasks

# Edit the model to configure its properties
swamp model edit my-jobs_taskgroups_tasks

# Create the resource in GCP
swamp model method run my-jobs_taskgroups_tasks create

# Sync current state from GCP
swamp model method run my-jobs_taskgroups_tasks sync
```
