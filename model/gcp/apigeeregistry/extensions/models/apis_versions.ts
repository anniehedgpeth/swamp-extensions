...
/**
 * Swamp extension model for Google Cloud Apigee Registry Apis.Versions.
 *
...
/** Swamp extension model for Google Cloud Apigee Registry Apis.Versions. Registered at `@swamp/gcp/apigeeregistry/apis-versions`. */
export const model = {
    ...
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["apiVersionId"] !== undefined) {
          params["apiVersionId"] = String(g["apiVersionId"]);
        }
