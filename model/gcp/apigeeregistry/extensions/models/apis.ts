...
// Auto-generated extension model for @swamp/gcp/apigeeregistry/apis
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Registry Apis.
 *
...
const StateSchema = z.object({
  ...
  name: z.string(),
  recommendedDeployment: z.string().optional(),
...
/** Swamp extension model for Google Cloud Apigee Registry Apis. Registered at `@swamp/gcp/apigeeregistry/apis`. */
export const model = {
  type: "@swamp/gcp/apigeeregistry/apis",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["recommendedDeployment"] !== undefined) {
          body["recommendedDeployment"] = g["recommendedDeployment"];
        }
        if (g["recommendedVersion"] !== undefined) {
          body["recommendedVersion"] = g["recommendedVersion"];
        }
        if (g["apiId"] !== undefined) params["apiId"] = String(g["apiId"]);
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific apis by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
