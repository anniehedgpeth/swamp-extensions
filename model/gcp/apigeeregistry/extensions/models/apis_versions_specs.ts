...
// Auto-generated extension model for @swamp/gcp/apigeeregistry/apis-versions-specs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Registry Apis.Versions.Specs.
 *
...
/** Swamp extension model for Google Cloud Apigee Registry Apis.Versions.Specs. Registered at `@swamp/gcp/apigeeregistry/apis-versions-specs`. */
export const model = {
  type: "@swamp/gcp/apigeeregistry/apis-versions-specs",
  ...
  resources: {
    state: {
      description:
        "Describes a version of an API in a structured way. ApiSpecs provide formal de...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["apiSpecId"] !== undefined) {
          params["apiSpecId"] = String(g["apiSpecId"]);
        }
