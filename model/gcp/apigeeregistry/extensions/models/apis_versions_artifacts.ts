...
// Auto-generated extension model for @swamp/gcp/apigeeregistry/apis-versions-artifacts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Registry Apis.Versions.Artifacts.
 *
...
/** Swamp extension model for Google Cloud Apigee Registry Apis.Versions.Artifacts. Registered at `@swamp/gcp/apigeeregistry/apis-versions-artifacts`. */
export const model = {
  type: "@swamp/gcp/apigeeregistry/apis-versions-artifacts",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["artifactId"] !== undefined) {
          params["artifactId"] = String(g["artifactId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific artifacts by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
