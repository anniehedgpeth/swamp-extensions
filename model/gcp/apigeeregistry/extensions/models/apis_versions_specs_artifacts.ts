...
/**
 * Swamp extension model for Google Cloud Apigee Registry Apis.Versions.Specs.Artifacts.
 *
...
/** Swamp extension model for Google Cloud Apigee Registry Apis.Versions.Specs.Artifacts. Registered at `@swamp/gcp/apigeeregistry/apis-versions-specs-artifacts`. */
export const model = {
