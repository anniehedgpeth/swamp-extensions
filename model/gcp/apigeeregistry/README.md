...
Google Cloud apigeeregistry resources.
...
Use `swamp model type describe @swamp/gcp/apigeeregistry/apis_artifacts` to see
...
```bash
# Create a new apis_artifacts model
swamp model create @swamp/gcp/apigeeregistry/apis_artifacts my-apis_artifacts

# Edit the model to configure its properties
swamp model edit my-apis_artifacts

# Create the resource in GCP
swamp model method run my-apis_artifacts create

# Sync current state from GCP
swamp model method run my-apis_artifacts sync
```
