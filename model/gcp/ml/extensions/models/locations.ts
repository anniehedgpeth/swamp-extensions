...
// Auto-generated extension model for @swamp/gcp/ml/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud AI Platform Training & Prediction Locations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/locations/${shortName}`;
}
...
const StateSchema = z.object({
  capabilities: z.array(z.object({
    availableAccelerators: z.array(z.string()),
    type: z.string(),
  })).optional(),
  name: z.string(),
}).passthrough();
...
/** Swamp extension model for Google Cloud AI Platform Training & Prediction Locations. Registered at `@swamp/gcp/ml/locations`. */
export const model = {
  type: "@swamp/gcp/ml/locations",
  ...
  resources: {
    state: {
      description:
        "Get the complete list of CMLE capabilities in a location, along with their lo...",
      schema: StateSchema,
      lifetime: "infinite",
