...
Use `swamp model type describe @swamp/gcp/keep/notes` to see the full list of
...
```bash
# Create a new notes model
swamp model create @swamp/gcp/keep/notes my-notes

# Edit the model to configure its properties
swamp model edit my-notes

# Create the resource in GCP
swamp model method run my-notes create

# Sync current state from GCP
swamp model method run my-notes sync
```
