...
Use `swamp model type describe @swamp/gcp/oauth2/userinfo_v2_me` to see the full
...
```bash
# Create a new userinfo_v2_me model
swamp model create @swamp/gcp/oauth2/userinfo_v2_me my-userinfo_v2_me

# Edit the model to configure its properties
swamp model edit my-userinfo_v2_me

# Create the resource in GCP
swamp model method run my-userinfo_v2_me create

# Sync current state from GCP
swamp model method run my-userinfo_v2_me sync
```
