...
// Auto-generated extension model for @swamp/gcp/securitycenter/simulations-attackexposureresults-valuedresources
...
/** Swamp extension model for Google Cloud Security Command Center Simulations.AttackExposureResults.ValuedResources. Registered at `@swamp/gcp/securitycenter/simulations-attackexposureresults-valuedresources`. */
export const model = {
  type:
