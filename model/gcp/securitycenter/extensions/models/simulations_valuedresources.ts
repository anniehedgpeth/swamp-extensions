...
// Auto-generated extension model for @swamp/gcp/securitycenter/simulations-valuedresources
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Security Command Center Simulations.ValuedResources.
 *
 * GCP securitycenter Simulations.ValuedResources resource
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/valuedResources/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description: "GCP securitycenter Simulations.ValuedResources resource",
      schema: StateSchema,
      lifetime: "infinite",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific valuedResources by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
