...
// Auto-generated extension model for @swamp/gcp/securitycenter/eventthreatdetectionsettings-effectivecustommodules
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/effectiveCustomModules/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Security Command Center EventThreatDetectionSettings.EffectiveCustomModules. Registered at `@swamp/gcp/securitycenter/eventthreatdetectionsettings-effectivecustommodules`. */
export const model = {
  type:
  ...
  methods: {
    get: {
      description: "Get a effectiveCustomModules",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the effectiveCustomModules",
        ),
      }),
