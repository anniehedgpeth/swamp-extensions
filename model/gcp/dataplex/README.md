...
Google Cloud dataplex resources.
...
Use `swamp model type describe @swamp/gcp/dataplex/aspecttypes` to see the full
...
```bash
# Create a new aspecttypes model
swamp model create @swamp/gcp/dataplex/aspecttypes my-aspecttypes

# Edit the model to configure its properties
swamp model edit my-aspecttypes

# Create the resource in GCP
swamp model method run my-aspecttypes create

# Sync current state from GCP
swamp model method run my-aspecttypes sync
```
