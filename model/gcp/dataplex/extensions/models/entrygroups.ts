...
// Auto-generated extension model for @swamp/gcp/dataplex/entrygroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataplex EntryGroups.
 *
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Optional. Description of the EntryGroup.")
    .optional(),
  ...
  entryGroupId: z.string().describe("Required. EntryGroup identifier.")
    .optional(),
...
/** Swamp extension model for Google Cloud Dataplex EntryGroups. Registered at `@swamp/gcp/dataplex/entrygroups`. */
export const model = {
  type: "@swamp/gcp/dataplex/entrygroups",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["entryGroupId"] !== undefined) {
          params["entryGroupId"] = String(g["entryGroupId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific entryGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List entryGroups resources",
      arguments: z.object({
