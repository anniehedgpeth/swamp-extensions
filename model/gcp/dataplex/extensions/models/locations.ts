...
// Auto-generated extension model for @swamp/gcp/dataplex/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataplex Locations.
 *
...
export const model = {
  ...
  methods: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "parameterOrder": ["name"],
            "parameters": {
              "aspectTypes": { "location": "query" },
              "entry": { "location": "query" },
              "name": { "location": "path", "required": true },
              "paths": { "location": "query" },
              "view": { "location": "query" },
            },
          },
          params,
    ...
    lookup_entry_links: {
      description: "lookup entry links",
      arguments: z.object({}),
      execute: async (_args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const baseUrl = g["apiEndpoint"]?.toString() ??
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "parameters": {
              "entry": { "location": "query" },
              "entryLinkTypes": { "location": "query" },
              "entryMode": { "location": "query" },
              "name": { "location": "path", "required": true },
