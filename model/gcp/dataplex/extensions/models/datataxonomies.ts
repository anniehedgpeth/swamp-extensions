...
// Auto-generated extension model for @swamp/gcp/dataplex/datataxonomies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataplex DataTaxonomies.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/dataTaxonomies/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Optional. Description of the DataTaxonomy.")
    .optional(),
  ...
  dataTaxonomyId: z.string().describe(
...
/** Swamp extension model for Google Cloud Dataplex DataTaxonomies. Registered at `@swamp/gcp/dataplex/datataxonomies`. */
export const model = {
  type: "@swamp/gcp/dataplex/datataxonomies",
  ...
  resources: {
    state: {
      description:
        "DataTaxonomy represents a set of hierarchical DataAttributes resources, group...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a dataTaxonomies",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["dataTaxonomyId"] !== undefined) {
          params["dataTaxonomyId"] = String(g["dataTaxonomyId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a dataTaxonomies",
      arguments: z.object({
        identifier: z.string().describe("The name of the dataTaxonomies"),
      }),
    ...
    update: {
      description: "Update dataTaxonomies attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataTaxonomies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the dataTaxonomies",
      arguments: z.object({
        identifier: z.string().describe("The name of the dataTaxonomies"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync dataTaxonomies state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataTaxonomies by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List dataTaxonomies resources",
      arguments: z.object({
