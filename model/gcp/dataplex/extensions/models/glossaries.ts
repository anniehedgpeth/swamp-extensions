...
// Auto-generated extension model for @swamp/gcp/dataplex/glossaries
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataplex Glossaries.
 *
...
const GlobalArgsSchema = z.object({
  ...
  glossaryId: z.string().describe("Required. Glossary ID: Glossary identifier.")
    .optional(),
...
/** Swamp extension model for Google Cloud Dataplex Glossaries. Registered at `@swamp/gcp/dataplex/glossaries`. */
export const model = {
  type: "@swamp/gcp/dataplex/glossaries",
  ...
  resources: {
    state: {
      description:
        "A Glossary represents a collection of GlossaryCategories and GlossaryTerms de...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["glossaryId"] !== undefined) {
          params["glossaryId"] = String(g["glossaryId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific glossaries by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
