...
// Auto-generated extension model for @swamp/gcp/dataplex/datadomains
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataplex DataDomains.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/dataDomains/${shortName}`;
}

const BASE_URL = "https://dataplex.googleapis.com/";

const GET_CONFIG = {
  "id": "dataplex.projects.locations.dataDomains.get",
  "path": "v1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const INSERT_CONFIG = {
  "id": "dataplex.projects.locations.dataDomains.create",
...
const PATCH_CONFIG = {
  "id": "dataplex.projects.locations.dataDomains.patch",
  "path": "v1/{+name}",
  "httpMethod": "PATCH",
  "parameterOrder": [
    "name",
...
const DELETE_CONFIG = {
  "id": "dataplex.projects.locations.dataDomains.delete",
  "path": "v1/{+name}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "dataplex.projects.locations.dataDomains.list",
  "path": "v1/{+parent}/dataDomains",
  "httpMethod": "GET",
  "parameterOrder": [
    "parent",
...
const GlobalArgsSchema = z.object({
  ...
  displayName: z.string().describe("Required. User-friendly display name.")
    .optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A DataDomain is a logical grouping of data resources for governance, discover...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a dataDomains",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a dataDomains",
      arguments: z.object({
        identifier: z.string().describe("The name of the dataDomains"),
      }),
    ...
    update: {
      description: "Update dataDomains attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataDomains by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the dataDomains",
      arguments: z.object({
        identifier: z.string().describe("The name of the dataDomains"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync dataDomains state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataDomains by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List dataDomains resources",
      arguments: z.object({
