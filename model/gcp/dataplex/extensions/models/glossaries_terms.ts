...
// Auto-generated extension model for @swamp/gcp/dataplex/glossaries-terms
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataplex Glossaries.Terms.
 *
...
const GlobalArgsSchema = z.object({
  ...
  termId: z.string().describe("Required. GlossaryTerm identifier.").optional(),
});
...
/** Swamp extension model for Google Cloud Dataplex Glossaries.Terms. Registered at `@swamp/gcp/dataplex/glossaries-terms`. */
export const model = {
  type: "@swamp/gcp/dataplex/glossaries-terms",
  ...
  resources: {
    state: {
      description:
        "GlossaryTerms are the core of Glossary. A GlossaryTerm holds a rich text desc...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["termId"] !== undefined) params["termId"] = String(g["termId"]);
    ...
    get: {
      description: "Get a terms",
      arguments: z.object({
        identifier: z.string().describe("The name of the terms"),
      }),
    ...
    update: {
      description: "Update terms attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific terms by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync terms state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific terms by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List terms resources",
      arguments: z.object({
