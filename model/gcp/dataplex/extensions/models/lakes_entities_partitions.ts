...
// Auto-generated extension model for @swamp/gcp/dataplex/lakes-entities-partitions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataplex Lakes.Entities.Partitions.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/partitions/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a partitions",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a partitions",
      arguments: z.object({
        identifier: z.string().describe("The name of the partitions"),
      }),
    ...
    delete: {
      description: "Delete the partitions",
      arguments: z.object({
        identifier: z.string().describe("The name of the partitions"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync partitions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific partitions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List partitions resources",
      arguments: z.object({
