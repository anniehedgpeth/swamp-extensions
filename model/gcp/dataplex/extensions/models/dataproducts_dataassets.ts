...
/**
 * Swamp extension model for Google Cloud Dataplex DataProducts.DataAssets.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["dataAssetId"] !== undefined) {
          params["dataAssetId"] = String(g["dataAssetId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataAssets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List dataAssets resources",
      arguments: z.object({
