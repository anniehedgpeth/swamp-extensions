...
// Auto-generated extension model for @swamp/gcp/dataplex/datataxonomies-attributes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataplex DataTaxonomies.Attributes.
 *
...
const GlobalArgsSchema = z.object({
  ...
  dataAccessSpec: z.object({
    readers: z.array(z.string()).describe(
  ...
  resourceAccessSpec: z.object({
    ...
    writers: z.array(z.string()).describe(
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["dataAccessSpec"] !== undefined) {
          body["dataAccessSpec"] = g["dataAccessSpec"];
        }
        ...
        if (g["resourceAccessSpec"] !== undefined) {
          body["resourceAccessSpec"] = g["resourceAccessSpec"];
        }
        if (g["dataAttributeId"] !== undefined) {
          params["dataAttributeId"] = String(g["dataAttributeId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific attributes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
