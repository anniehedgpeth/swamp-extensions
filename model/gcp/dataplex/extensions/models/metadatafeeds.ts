...
/**
 * Swamp extension model for Google Cloud Dataplex MetadataFeeds.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["metadataFeedId"] !== undefined) {
          params["metadataFeedId"] = String(g["metadataFeedId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific metadataFeeds by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List metadataFeeds resources",
      arguments: z.object({
