...
Google Cloud fitness resources.
...
Use
`swamp model type describe @swamp/gcp/fitness/users_datasources_datapointchanges`
...
```bash
# Create a new users_datasources_datapointchanges model
swamp model create @swamp/gcp/fitness/users_datasources_datapointchanges my-users_datasources_datapointchanges

# Edit the model to configure its properties
swamp model edit my-users_datasources_datapointchanges

# Create the resource in GCP
swamp model method run my-users_datasources_datapointchanges create

# Sync current state from GCP
swamp model method run my-users_datasources_datapointchanges sync
```
