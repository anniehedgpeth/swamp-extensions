...
// Auto-generated extension model for @swamp/gcp/fitness/users-datasources-datapointchanges
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Fitness Users.DataSources.DataPointChanges.
 *
...
const StateSchema = z.object({
  computationTimeMillis: z.string().optional(),
  dataTypeName: z.string().optional(),
  endTimeNanos: z.string().optional(),
  modifiedTimeMillis: z.string().optional(),
  originDataSourceId: z.string().optional(),
  rawTimestampNanos: z.string().optional(),
  startTimeNanos: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a dataPointChanges",
      arguments: z.object({
        identifier: z.string().describe("The name of the dataPointChanges"),
      }),
    ...
    sync: {
      description: "Sync dataPointChanges state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataPointChanges by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List dataPointChanges resources",
      arguments: z.object({
