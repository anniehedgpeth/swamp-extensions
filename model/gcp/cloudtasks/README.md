...
Google Cloud cloudtasks resources.
...
Use `swamp model type describe @swamp/gcp/cloudtasks/locations` to see the full
...
swamp model create @swamp/gcp/cloudtasks/locations my-locations
