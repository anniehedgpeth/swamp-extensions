...
Google Cloud mybusinessaccountmanagement resources.
...
Use
`swamp model type describe @swamp/gcp/mybusinessaccountmanagement/accounts_admins`
...
```bash
# Create a new accounts_admins model
swamp model create @swamp/gcp/mybusinessaccountmanagement/accounts_admins my-accounts_admins

# Edit the model to configure its properties
swamp model edit my-accounts_admins

# Create the resource in GCP
swamp model method run my-accounts_admins create

# Sync current state from GCP
swamp model method run my-accounts_admins sync
```
