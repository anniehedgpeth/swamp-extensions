...
/**
 * Swamp extension model for Google Cloud My Business Account Management Accounts.Admins.
 *
...
/** Swamp extension model for Google Cloud My Business Account Management Accounts.Admins. Registered at `@swamp/gcp/mybusinessaccountmanagement/accounts-admins`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific admins by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List admins resources",
      arguments: z.object({
