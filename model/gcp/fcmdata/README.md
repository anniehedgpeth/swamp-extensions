...
Google Cloud fcmdata resources.
...
Use `swamp model type describe @swamp/gcp/fcmdata/androidapps_deliverydata` to
...
```bash
# Create a new androidapps_deliverydata model
swamp model create @swamp/gcp/fcmdata/androidapps_deliverydata my-androidapps_deliverydata

# Edit the model to configure its properties
swamp model edit my-androidapps_deliverydata

# Create the resource in GCP
swamp model method run my-androidapps_deliverydata create

# Sync current state from GCP
swamp model method run my-androidapps_deliverydata sync
```
