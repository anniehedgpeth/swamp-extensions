...
Use `swamp model type describe @swamp/gcp/css/accounts_cssproducts` to see the
...
```bash
# Create a new accounts_cssproducts model
swamp model create @swamp/gcp/css/accounts_cssproducts my-accounts_cssproducts

# Edit the model to configure its properties
swamp model edit my-accounts_cssproducts

# Create the resource in GCP
swamp model method run my-accounts_cssproducts create

# Sync current state from GCP
swamp model method run my-accounts_cssproducts sync
```
