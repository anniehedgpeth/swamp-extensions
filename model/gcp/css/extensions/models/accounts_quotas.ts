...
// Auto-generated extension model for @swamp/gcp/css/accounts-quotas
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud CSS Accounts.Quotas.
 *
...
const StateSchema = z.object({
  methodDetails: z.array(z.object({
    method: z.string(),
    path: z.string(),
    subapi: z.string(),
    version: z.string(),
  ...
  quotaMinuteLimit: z.string().optional(),
...
/** Swamp extension model for Google Cloud CSS Accounts.Quotas. Registered at `@swamp/gcp/css/accounts-quotas`. */
export const model = {
  type: "@swamp/gcp/css/accounts-quotas",
  ...
  methods: {
    get: {
      description: "Get a quotas",
      arguments: z.object({
        identifier: z.string().describe("The name of the quotas"),
      }),
    ...
    sync: {
      description: "Sync quotas state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific quotas by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List quotas resources",
      arguments: z.object({
