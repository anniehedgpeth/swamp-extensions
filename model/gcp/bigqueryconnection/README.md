...
Google Cloud bigqueryconnection resources.
...
Use `swamp model type describe @swamp/gcp/bigqueryconnection/connections` to see
...
swamp model create @swamp/gcp/bigqueryconnection/connections my-connections

# Edit the model to configure its properties
swamp model edit my-connections

# Create the resource in GCP
swamp model method run my-connections create

# Sync current state from GCP
swamp model method run my-connections sync
```
