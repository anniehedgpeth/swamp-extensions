...
Google Cloud groupssettings resources.
...
Use `swamp model type describe @swamp/gcp/groupssettings/groups` to see the full
...
swamp model create @swamp/gcp/groupssettings/groups my-groups
