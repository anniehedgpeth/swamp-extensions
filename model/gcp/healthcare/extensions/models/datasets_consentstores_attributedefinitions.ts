...
/**
 * Swamp extension model for Google Cloud Healthcare Datasets.ConsentStores.AttributeDefinitions.
 *
...
/** Swamp extension model for Google Cloud Healthcare Datasets.ConsentStores.AttributeDefinitions. Registered at `@swamp/gcp/healthcare/datasets-consentstores-attributedefinitions`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["attributeDefinitionId"] !== undefined) {
          params["attributeDefinitionId"] = String(g["attributeDefinitionId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific attributeDefinitions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List attributeDefinitions resources",
      arguments: z.object({
