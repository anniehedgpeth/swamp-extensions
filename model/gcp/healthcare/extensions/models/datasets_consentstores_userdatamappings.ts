...
// Auto-generated extension model for @swamp/gcp/healthcare/datasets-consentstores-userdatamappings
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Healthcare Datasets.ConsentStores.UserDataMappings.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/userDataMappings/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Healthcare Datasets.ConsentStores.UserDataMappings. Registered at `@swamp/gcp/healthcare/datasets-consentstores-userdatamappings`. */
export const model = {
  type: "@swamp/gcp/healthcare/datasets-consentstores-userdatamappings",
  ...
  methods: {
    create: {
      description: "Create a userDataMappings",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["dataId"] !== undefined) body["dataId"] = g["dataId"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["resourceAttributes"] !== undefined) {
          body["resourceAttributes"] = g["resourceAttributes"];
        }
    ...
    get: {
      description: "Get a userDataMappings",
      arguments: z.object({
        identifier: z.string().describe("The name of the userDataMappings"),
      }),
    ...
    update: {
      description: "Update userDataMappings attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userDataMappings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the userDataMappings",
      arguments: z.object({
        identifier: z.string().describe("The name of the userDataMappings"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync userDataMappings state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userDataMappings by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List userDataMappings resources",
      arguments: z.object({
