...
/**
 * Swamp extension model for Google Cloud Healthcare Datasets.ConsentStores.
 *
...
/** Swamp extension model for Google Cloud Healthcare Datasets.ConsentStores. Registered at `@swamp/gcp/healthcare/datasets-consentstores`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["consentStoreId"] !== undefined) {
          params["consentStoreId"] = String(g["consentStoreId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific consentStores by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List consentStores resources",
      arguments: z.object({
