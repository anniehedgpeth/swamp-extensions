...
/**
 * Swamp extension model for Google Cloud Healthcare Datasets.Hl7V2Stores.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["hl7V2StoreId"] !== undefined) {
          params["hl7V2StoreId"] = String(g["hl7V2StoreId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific hl7V2Stores by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List hl7V2Stores resources",
      arguments: z.object({
        filter: z.string().describe(
