...
Google Cloud healthcare resources.
...
Use
`swamp model type describe @swamp/gcp/healthcare/datasets_consentstores_attributedefinitions`
...
```bash
# Create a new datasets_consentstores_attributedefinitions model
swamp model create @swamp/gcp/healthcare/datasets_consentstores_attributedefinitions my-datasets_consentstores_attributedefinitions

# Edit the model to configure its properties
swamp model edit my-datasets_consentstores_attributedefinitions

# Create the resource in GCP
swamp model method run my-datasets_consentstores_attributedefinitions create

# Sync current state from GCP
swamp model method run my-datasets_consentstores_attributedefinitions sync
```
