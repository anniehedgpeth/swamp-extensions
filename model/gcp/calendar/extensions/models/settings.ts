...
/**
 * Swamp extension model for Google Cloud Calendar Settings.
 *
...
/** Swamp extension model for Google Cloud Calendar Settings. Registered at `@swamp/gcp/calendar/settings`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific settings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List settings resources",
      arguments: z.object({
