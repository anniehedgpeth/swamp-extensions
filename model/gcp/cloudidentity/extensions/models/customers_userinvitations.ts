...
// Auto-generated extension model for @swamp/gcp/cloudidentity/customers-userinvitations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Identity Customers.Userinvitations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/userinvitations/${shortName}`;
}
...
const StateSchema = z.object({
  mailsSentCount: z.string().optional(),
  name: z.string(),
...
/** Swamp extension model for Google Cloud Identity Customers.Userinvitations. Registered at `@swamp/gcp/cloudidentity/customers-userinvitations`. */
export const model = {
  type: "@swamp/gcp/cloudidentity/customers-userinvitations",
  ...
  resources: {
    state: {
      description:
        "The `UserInvitation` resource represents an email that can be sent to an unma...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a userinvitations",
      arguments: z.object({
        identifier: z.string().describe("The name of the userinvitations"),
      }),
    ...
    sync: {
      description: "Sync userinvitations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userinvitations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List userinvitations resources",
      arguments: z.object({
