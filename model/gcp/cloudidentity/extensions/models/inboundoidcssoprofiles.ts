...
/**
 * Swamp extension model for Google Cloud Identity InboundOidcSsoProfiles.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific inboundOidcSsoProfiles by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List inboundOidcSsoProfiles resources",
      arguments: z.object({
