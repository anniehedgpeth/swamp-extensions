...
Use `swamp model type describe @swamp/gcp/spanner/instanceconfigs` to see the
...
```bash
# Create a new instanceconfigs model
swamp model create @swamp/gcp/spanner/instanceconfigs my-instanceconfigs

# Edit the model to configure its properties
swamp model edit my-instanceconfigs

# Create the resource in GCP
swamp model method run my-instanceconfigs create

# Sync current state from GCP
swamp model method run my-instanceconfigs sync
```
