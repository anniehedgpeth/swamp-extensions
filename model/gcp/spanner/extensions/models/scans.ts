...
// Auto-generated extension model for @swamp/gcp/spanner/scans
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Spanner Scans.
 *
...
const StateSchema = z.object({
  ...
  scanData: z.object({
    data: z.object({
      ...
      prefixNodes: z.array(z.object({
        dataSourceNode: z.boolean(),
        depth: z.number(),
        endIndex: z.number(),
        startIndex: z.number(),
        word: z.string(),
...
/** Swamp extension model for Google Cloud Spanner Scans. Registered at `@swamp/gcp/spanner/scans`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific scans by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List scans resources",
      arguments: z.object({
