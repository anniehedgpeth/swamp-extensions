...
/**
 * Swamp extension model for Google Cloud API Gateway Apis.
 *
...
/** Swamp extension model for Google Cloud API Gateway Apis. Registered at `@swamp/gcp/apigateway/apis`. */
export const model = {
