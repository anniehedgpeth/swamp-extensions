...
// Auto-generated extension model for @swamp/gcp/apigateway/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud API Gateway Locations.
 *
...
/** Swamp extension model for Google Cloud API Gateway Locations. Registered at `@swamp/gcp/apigateway/locations`. */
export const model = {
  type: "@swamp/gcp/apigateway/locations",
