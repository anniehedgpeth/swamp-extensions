...
const GlobalArgsSchema = z.object({
  ...
  openapiDocuments: z.array(z.object({
    ...
    }).describe("The OpenAPI Specification document file.").optional(),
  })).describe(
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["apiConfigId"] !== undefined) {
          params["apiConfigId"] = String(g["apiConfigId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific configs by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List configs resources",
      arguments: z.object({
