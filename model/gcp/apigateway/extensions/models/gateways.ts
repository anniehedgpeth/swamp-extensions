...
// Auto-generated extension model for @swamp/gcp/apigateway/gateways
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud API Gateway Gateways.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A Gateway is an API-aware HTTP proxy. It performs API-Method and/or API-Consu...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    list: {
      description: "List gateways resources",
      arguments: z.object({
