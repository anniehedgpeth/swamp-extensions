...
Use `swamp model type describe @swamp/gcp/monitoring/alertpolicies` to see the
...
```bash
# Create a new alertpolicies model
swamp model create @swamp/gcp/monitoring/alertpolicies my-alertpolicies

# Edit the model to configure its properties
swamp model edit my-alertpolicies

# Create the resource in GCP
swamp model method run my-alertpolicies create

# Sync current state from GCP
swamp model method run my-alertpolicies sync
```
