...
// Auto-generated extension model for @swamp/gcp/monitoring/groups-members
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Monitoring Groups.Members.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "An object representing a resource that can be used for monitoring, logging, b...",
      schema: StateSchema,
      lifetime: "infinite",
