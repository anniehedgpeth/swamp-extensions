...
// Auto-generated extension model for @swamp/gcp/monitoring/location-prometheus-api-v1-metadata
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Monitoring Location.Prometheus.Api.V1.Metadata.
 *
...
export const model = {
  ...
  methods: {
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The name of the metadata"),
      }),
    ...
    sync: {
      description: "Sync metadata state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific metadata by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List metadata resources",
      arguments: z.object({
        limit: z.string().describe("Maximum number of metrics to return.")
          .optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["metric"] !== undefined) {
          params["metric"] = String(args["metric"]);
        }
