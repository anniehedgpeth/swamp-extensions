...
// Auto-generated extension model for @swamp/gcp/monitoring/groups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Monitoring Groups.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "The description of a dynamic collection of monitored resources. Each group ha...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["isCluster"] !== undefined) body["isCluster"] = g["isCluster"];
        if (g["parentName"] !== undefined) body["parentName"] = g["parentName"];
