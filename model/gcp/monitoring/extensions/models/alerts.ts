...
// Auto-generated extension model for @swamp/gcp/monitoring/alerts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Monitoring Alerts.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/alerts/${shortName}`;
}

const BASE_URL = "https://monitoring.googleapis.com/";

const GET_CONFIG = {
  "id": "monitoring.projects.alerts.get",
  "path": "v3/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "monitoring.projects.alerts.list",
...
const StateSchema = z.object({
  ...
  log: z.object({
    extractedLabels: z.record(z.string(), z.unknown()),
  }).optional(),
  metadata: z.object({
...
/** Swamp extension model for Google Cloud Monitoring Alerts. Registered at `@swamp/gcp/monitoring/alerts`. */
export const model = {
  type: "@swamp/gcp/monitoring/alerts",
  ...
  resources: {
    state: {
      description:
        "An alert is the representation of a violation of an alert policy. It is a rea...",
      schema: StateSchema,
      lifetime: "infinite",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific alerts by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
