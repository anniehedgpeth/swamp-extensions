...
Google Cloud dataproc resources.
...
Use `swamp model type describe @swamp/gcp/dataproc/autoscalingpolicies` to see
...
```bash
# Create a new autoscalingpolicies model
swamp model create @swamp/gcp/dataproc/autoscalingpolicies my-autoscalingpolicies

# Edit the model to configure its properties
swamp model edit my-autoscalingpolicies

# Create the resource in GCP
swamp model method run my-autoscalingpolicies create

# Sync current state from GCP
swamp model method run my-autoscalingpolicies sync
```
