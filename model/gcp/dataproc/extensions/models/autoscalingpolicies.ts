...
/**
 * Swamp extension model for Google Cloud Dataproc AutoscalingPolicies.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific autoscalingPolicies by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List autoscalingPolicies resources",
      arguments: z.object({
