...
Google Cloud searchads360 resources.
...
Use `swamp model type describe @swamp/gcp/searchads360/customers_customcolumns`
...
```bash
# Create a new customers_customcolumns model
swamp model create @swamp/gcp/searchads360/customers_customcolumns my-customers_customcolumns

# Edit the model to configure its properties
swamp model edit my-customers_customcolumns

# Create the resource in GCP
swamp model method run my-customers_customcolumns create

# Sync current state from GCP
swamp model method run my-customers_customcolumns sync
```
