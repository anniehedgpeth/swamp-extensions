...
Google Cloud pubsublite resources.
...
Use
`swamp model type describe @swamp/gcp/pubsublite/admin_projects_reservations_topics`
...
```bash
# Create a new admin_projects_reservations_topics model
swamp model create @swamp/gcp/pubsublite/admin_projects_reservations_topics my-admin_projects_reservations_topics

# Edit the model to configure its properties
swamp model edit my-admin_projects_reservations_topics

# Create the resource in GCP
swamp model method run my-admin_projects_reservations_topics create

# Sync current state from GCP
swamp model method run my-admin_projects_reservations_topics sync
```
