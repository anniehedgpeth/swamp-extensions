...
// Auto-generated extension model for @swamp/gcp/pubsublite/admin-projects-reservations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Pub/Sub Lite Admin.Projects.Reservations.
 *
...
const GlobalArgsSchema = z.object({
  ...
  throughputCapacity: z.string().describe(
...
const StateSchema = z.object({
  name: z.string(),
  throughputCapacity: z.string().optional(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Pub/Sub Lite Admin.Projects.Reservations. Registered at `@swamp/gcp/pubsublite/admin-projects-reservations`. */
export const model = {
  type: "@swamp/gcp/pubsublite/admin-projects-reservations",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["throughputCapacity"] !== undefined) {
          body["throughputCapacity"] = g["throughputCapacity"];
        }
        if (g["reservationId"] !== undefined) {
          params["reservationId"] = String(g["reservationId"]);
        }
