...
// Auto-generated extension model for @swamp/gcp/pubsublite/admin-projects-reservations-topics
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Pub/Sub Lite Admin.Projects.Reservations.Topics.
 *
...
/** Swamp extension model for Google Cloud Pub/Sub Lite Admin.Projects.Reservations.Topics. Registered at `@swamp/gcp/pubsublite/admin-projects-reservations-topics`. */
export const model = {
  type: "@swamp/gcp/pubsublite/admin-projects-reservations-topics",
