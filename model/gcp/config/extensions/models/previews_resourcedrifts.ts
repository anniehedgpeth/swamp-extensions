...
// Auto-generated extension model for @swamp/gcp/config/previews-resourcedrifts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Infrastructure Manager Previews.ResourceDrifts.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/resourceDrifts/${shortName}`;
}
...
const StateSchema = z.object({
  name: z.string(),
  propertyDrifts: z.array(z.object({
    after: z.string(),
...
/** Swamp extension model for Google Cloud Infrastructure Manager Previews.ResourceDrifts. Registered at `@swamp/gcp/config/previews-resourcedrifts`. */
export const model = {
  type: "@swamp/gcp/config/previews-resourcedrifts",
  ...
  methods: {
    get: {
      description: "Get a resourceDrifts",
      arguments: z.object({
        identifier: z.string().describe("The name of the resourceDrifts"),
      }),
    ...
    sync: {
      description: "Sync resourceDrifts state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific resourceDrifts by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List resourceDrifts resources",
      arguments: z.object({
