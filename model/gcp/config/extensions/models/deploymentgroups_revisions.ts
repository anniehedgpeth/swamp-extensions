...
// Auto-generated extension model for @swamp/gcp/config/deploymentgroups-revisions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Infrastructure Manager DeploymentGroups.Revisions.
 *
...
const StateSchema = z.object({
  ...
  snapshot: z.object({
    ...
    provisioningStateDescription: z.string(),
    state: z.string(),
...
/** Swamp extension model for Google Cloud Infrastructure Manager DeploymentGroups.Revisions. Registered at `@swamp/gcp/config/deploymentgroups-revisions`. */
export const model = {
  type: "@swamp/gcp/config/deploymentgroups-revisions",
  ...
  resources: {
    state: {
      description:
        "A DeploymentGroupRevision represents a snapshot of a DeploymentGroup at a giv...",
      schema: StateSchema,
      lifetime: "infinite",
