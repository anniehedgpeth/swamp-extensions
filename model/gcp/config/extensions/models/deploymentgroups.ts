...
// Auto-generated extension model for @swamp/gcp/config/deploymentgroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Infrastructure Manager DeploymentGroups.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/deploymentGroups/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  provisioningStateDescription: z.string().optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A DeploymentGroup is a collection of DeploymentUnits that in a DAG-like struc...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a deploymentGroups",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["deploymentUnits"] !== undefined) {
    ...
    get: {
      description: "Get a deploymentGroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the deploymentGroups"),
      }),
    ...
    update: {
      description: "Update deploymentGroups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific deploymentGroups by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the deploymentGroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the deploymentGroups"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync deploymentGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific deploymentGroups by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List deploymentGroups resources",
      arguments: z.object({
    ...
    deprovision: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const body: Record<string, unknown> = {};
        if (args["deletePolicy"] !== undefined) {
          body["deletePolicy"] = args["deletePolicy"];
        }
    ...
    provision: {
      ...
      arguments: z.object({
        deploymentSpecs: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        const body: Record<string, unknown> = {};
        if (args["deploymentSpecs"] !== undefined) {
          body["deploymentSpecs"] = args["deploymentSpecs"];
        }
        const result = await createResource(
          BASE_URL,
          {
