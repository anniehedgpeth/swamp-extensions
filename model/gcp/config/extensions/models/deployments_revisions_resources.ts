...
// Auto-generated extension model for @swamp/gcp/config/deployments-revisions-resources
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Infrastructure Manager Deployments.Revisions.Resources.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/resources/${shortName}`;
}
...
const StateSchema = z.object({
  caiAssets: z.record(z.string(), z.unknown()).optional(),
...
/** Swamp extension model for Google Cloud Infrastructure Manager Deployments.Revisions.Resources. Registered at `@swamp/gcp/config/deployments-revisions-resources`. */
export const model = {
  type: "@swamp/gcp/config/deployments-revisions-resources",
  ...
  resources: {
    state: {
      description:
        "Resource represents a Google Cloud Platform resource actuated by IM. Resource...",
      schema: StateSchema,
      lifetime: "infinite",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific resources by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
