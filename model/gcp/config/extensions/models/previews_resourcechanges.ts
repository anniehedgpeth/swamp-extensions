...
// Auto-generated extension model for @swamp/gcp/config/previews-resourcechanges
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Infrastructure Manager Previews.ResourceChanges.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/resourceChanges/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  name: z.string(),
  propertyChanges: z.array(z.object({
    after: z.string(),
    afterSensitivePaths: z.array(z.string()),
    before: z.string(),
    beforeSensitivePaths: z.array(z.string()),
    path: z.string(),
  })).optional(),
  terraformInfo: z.object({
...
/** Swamp extension model for Google Cloud Infrastructure Manager Previews.ResourceChanges. Registered at `@swamp/gcp/config/previews-resourcechanges`. */
export const model = {
  type: "@swamp/gcp/config/previews-resourcechanges",
  ...
  methods: {
    get: {
      description: "Get a resourceChanges",
      arguments: z.object({
        identifier: z.string().describe("The name of the resourceChanges"),
      }),
    ...
    sync: {
      description: "Sync resourceChanges state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific resourceChanges by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List resourceChanges resources",
      arguments: z.object({
