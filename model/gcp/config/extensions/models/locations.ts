...
// Auto-generated extension model for @swamp/gcp/config/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Infrastructure Manager Locations.
 *
...
/** Swamp extension model for Google Cloud Infrastructure Manager Locations. Registered at `@swamp/gcp/config/locations`. */
export const model = {
  type: "@swamp/gcp/config/locations",
  ...
  methods: {
    ...
    get_auto_migration_config: {
      description: "get auto migration config",
      arguments: z.object({}),
    ...
    update_auto_migration_config: {
      description: "update auto migration config",
      arguments: z.object({
        autoMigrationEnabled: z.any().optional(),
        name: z.any().optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["autoMigrationEnabled"] !== undefined) {
          body["autoMigrationEnabled"] = args["autoMigrationEnabled"];
        }
