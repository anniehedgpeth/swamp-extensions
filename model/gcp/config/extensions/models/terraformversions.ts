...
// Auto-generated extension model for @swamp/gcp/config/terraformversions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Infrastructure Manager TerraformVersions.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/terraformVersions/${shortName}`;
}
...
const StateSchema = z.object({
  deprecateTime: z.string().optional(),
  name: z.string(),
  obsoleteTime: z.string().optional(),
  state: z.string().optional(),
  supportTime: z.string().optional(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Infrastructure Manager TerraformVersions. Registered at `@swamp/gcp/config/terraformversions`. */
export const model = {
  type: "@swamp/gcp/config/terraformversions",
  ...
  resources: {
    state: {
      description:
        "A TerraformVersion represents the support state the corresponding Terraform v...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a terraformVersions",
      arguments: z.object({
        identifier: z.string().describe("The name of the terraformVersions"),
      }),
    ...
    sync: {
      description: "Sync terraformVersions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific terraformVersions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List terraformVersions resources",
      arguments: z.object({
