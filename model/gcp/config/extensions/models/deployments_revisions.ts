...
// Auto-generated extension model for @swamp/gcp/config/deployments-revisions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Infrastructure Manager Deployments.Revisions.
 *
...
const StateSchema = z.object({
  ...
  quotaValidationResults: z.string().optional(),
...
/** Swamp extension model for Google Cloud Infrastructure Manager Deployments.Revisions. Registered at `@swamp/gcp/config/deployments-revisions`. */
export const model = {
  type: "@swamp/gcp/config/deployments-revisions",
  ...
  resources: {
    state: {
      description:
        "A child resource of a Deployment generated by a 'CreateDeployment' or 'Update...",
      schema: StateSchema,
      lifetime: "infinite",
