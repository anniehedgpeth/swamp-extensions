...
Use `swamp model type describe @swamp/gcp/config/deploymentgroups_revisions` to
...
```bash
# Create a new deploymentgroups_revisions model
swamp model create @swamp/gcp/config/deploymentgroups_revisions my-deploymentgroups_revisions

# Edit the model to configure its properties
swamp model edit my-deploymentgroups_revisions

# Create the resource in GCP
swamp model method run my-deploymentgroups_revisions create

# Sync current state from GCP
swamp model method run my-deploymentgroups_revisions sync
```
