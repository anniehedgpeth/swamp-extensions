...
/**
 * Swamp extension model for Google Cloud Display & Video 360 InventorySourceGroups.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific inventorySourceGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List inventorySourceGroups resources",
      arguments: z.object({
        advertiserId: z.string().describe(
