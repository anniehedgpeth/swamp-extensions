...
// Auto-generated extension model for @swamp/gcp/displayvideo/googleaudiences
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Display & Video 360 GoogleAudiences.
 *
...
const StateSchema = z.object({
  ...
  googleAudienceId: z.string().optional(),
  googleAudienceType: z.string().optional(),
  name: z.string(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Display & Video 360 GoogleAudiences. Registered at `@swamp/gcp/displayvideo/googleaudiences`. */
export const model = {
  type: "@swamp/gcp/displayvideo/googleaudiences",
  ...
  methods: {
    get: {
      description: "Get a googleAudiences",
      arguments: z.object({
        identifier: z.string().describe("The name of the googleAudiences"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["googleAudienceId"] = args.identifier;
    ...
    sync: {
      description: "Sync googleAudiences state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific googleAudiences by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
        ...
        try {
          ...
          params["googleAudienceId"] = identifier;
          const result = await readResource(
            BASE_URL,
            GET_CONFIG,
            params,
    ...
    list: {
      description: "List googleAudiences resources",
      arguments: z.object({
