...
/**
 * Swamp extension model for Google Cloud Display & Video 360 Advertisers.Invoices.
 *
 * A single invoice.
 *
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific invoices by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      ...
      arguments: z.object({
        ...
        loiSapinInvoiceType: z.string().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["loiSapinInvoiceType"] !== undefined) {
          params["loiSapinInvoiceType"] = String(args["loiSapinInvoiceType"]);
        }
