...
/**
 * Swamp extension model for Google Cloud Display & Video 360 Advertisers.NegativeKeywordLists.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific negativeKeywordLists by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List negativeKeywordLists resources",
      arguments: z.object({
