...
/**
 * Swamp extension model for Google Cloud Display & Video 360 FloodlightGroups.FloodlightActivities.
 *
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific floodlightActivities by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
