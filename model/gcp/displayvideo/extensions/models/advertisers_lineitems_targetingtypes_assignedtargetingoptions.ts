...
// Auto-generated extension model for @swamp/gcp/displayvideo/advertisers-lineitems-targetingtypes-assignedtargetingoptions
...
const GET_CONFIG = {
  ...
  "path":
    "v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}",
  "httpMethod": "GET",
  "parameterOrder": [
    "advertiserId",
    "lineItemId",
...
const INSERT_CONFIG = {
  ...
  "path":
    "v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions",
  "httpMethod": "POST",
  "parameterOrder": [
    "advertiserId",
    "lineItemId",
