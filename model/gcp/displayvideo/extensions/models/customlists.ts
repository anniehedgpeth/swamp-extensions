...
// Auto-generated extension model for @swamp/gcp/displayvideo/customlists
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Display & Video 360 CustomLists.
 *
...
/** Swamp extension model for Google Cloud Display & Video 360 CustomLists. Registered at `@swamp/gcp/displayvideo/customlists`. */
export const model = {
  type: "@swamp/gcp/displayvideo/customlists",
  ...
  resources: {
    state: {
      description:
        "Describes a custom list entity, such as a custom affinity or custom intent au...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a customLists",
      arguments: z.object({
        identifier: z.string().describe("The name of the customLists"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["customListId"] = args.identifier;
    ...
    sync: {
      description: "Sync customLists state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific customLists by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
        ...
        try {
          ...
          params["customListId"] = identifier;
          const result = await readResource(
            baseUrl,
            GET_CONFIG,
            params,
    ...
    list: {
      description: "List customLists resources",
      arguments: z.object({
