...
// Auto-generated extension model for @swamp/gcp/displayvideo/combinedaudiences
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Display & Video 360 CombinedAudiences.
 *
...
const StateSchema = z.object({
  combinedAudienceId: z.string().optional(),
...
/** Swamp extension model for Google Cloud Display & Video 360 CombinedAudiences. Registered at `@swamp/gcp/displayvideo/combinedaudiences`. */
export const model = {
  type: "@swamp/gcp/displayvideo/combinedaudiences",
  ...
  methods: {
    get: {
      description: "Get a combinedAudiences",
      arguments: z.object({
        identifier: z.string().describe("The name of the combinedAudiences"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["combinedAudienceId"] = args.identifier;
    ...
    sync: {
      description: "Sync combinedAudiences state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific combinedAudiences by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
        ...
        try {
          ...
          params["combinedAudienceId"] = identifier;
          const result = await readResource(
            BASE_URL,
            GET_CONFIG,
            params,
    ...
    list: {
      description: "List combinedAudiences resources",
      arguments: z.object({
