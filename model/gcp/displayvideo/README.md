...
Google Cloud displayvideo resources.
...
Use `swamp model type describe @swamp/gcp/displayvideo/advertisers_adassets` to
...
```bash
# Create a new advertisers_adassets model
swamp model create @swamp/gcp/displayvideo/advertisers_adassets my-advertisers_adassets

# Edit the model to configure its properties
swamp model edit my-advertisers_adassets

# Create the resource in GCP
swamp model method run my-advertisers_adassets create

# Sync current state from GCP
swamp model method run my-advertisers_adassets sync
```
