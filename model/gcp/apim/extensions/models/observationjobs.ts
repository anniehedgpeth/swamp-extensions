...
// Auto-generated extension model for @swamp/gcp/apim/observationjobs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud API Management ObservationJobs.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/observationJobs/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  observationJobId: z.string().describe(
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a observationJobs",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["observationJobId"] !== undefined) {
          params["observationJobId"] = String(g["observationJobId"]);
        }
    ...
    get: {
      description: "Get a observationJobs",
      arguments: z.object({
        identifier: z.string().describe("The name of the observationJobs"),
      }),
    ...
    delete: {
      description: "Delete the observationJobs",
      arguments: z.object({
        identifier: z.string().describe("The name of the observationJobs"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync observationJobs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific observationJobs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List observationJobs resources",
      arguments: z.object({
