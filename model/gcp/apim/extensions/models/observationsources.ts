...
/**
 * Swamp extension model for Google Cloud API Management ObservationSources.
 *
...
/** Swamp extension model for Google Cloud API Management ObservationSources. Registered at `@swamp/gcp/apim/observationsources`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["observationSourceId"] !== undefined) {
          params["observationSourceId"] = String(g["observationSourceId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific observationSources by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List observationSources resources",
      arguments: z.object({
