...
// Auto-generated extension model for @swamp/gcp/sasportal/customers-nodes-nodes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal Customers.Nodes.Nodes.
 *
 * The Node.
 *
...
/** Swamp extension model for Google Cloud SAS Portal Customers.Nodes.Nodes. Registered at `@swamp/gcp/sasportal/customers-nodes-nodes`. */
export const model = {
  type: "@swamp/gcp/sasportal/customers-nodes-nodes",
