...
/**
 * Swamp extension model for Google Cloud SAS Portal Nodes.Deployments.Devices.
 *
...
/** Swamp extension model for Google Cloud SAS Portal Nodes.Deployments.Devices. Registered at `@swamp/gcp/sasportal/nodes-deployments-devices`. */
export const model = {
