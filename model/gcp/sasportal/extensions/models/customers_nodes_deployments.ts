...
// Auto-generated extension model for @swamp/gcp/sasportal/customers-nodes-deployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud SAS Portal Customers.Nodes.Deployments.
 *
 * The Deployment.
 *
...
/** Swamp extension model for Google Cloud SAS Portal Customers.Nodes.Deployments. Registered at `@swamp/gcp/sasportal/customers-nodes-deployments`. */
export const model = {
  type: "@swamp/gcp/sasportal/customers-nodes-deployments",
