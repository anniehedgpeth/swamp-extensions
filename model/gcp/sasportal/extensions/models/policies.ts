...
/**
 * Swamp extension model for Google Cloud SAS Portal Policies.
 *
...
/** Swamp extension model for Google Cloud SAS Portal Policies. Registered at `@swamp/gcp/sasportal/policies`. */
export const model = {
