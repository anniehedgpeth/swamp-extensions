...
Google Cloud sasportal resources.
...
Use
`swamp model type describe @swamp/gcp/sasportal/customers_deployments_devices`
...
swamp model create @swamp/gcp/sasportal/customers_deployments_devices my-customers_deployments_devices
