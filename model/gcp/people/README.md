...
Use `swamp model type describe @swamp/gcp/people/contactgroups` to see the full
...
```bash
# Create a new contactgroups model
swamp model create @swamp/gcp/people/contactgroups my-contactgroups

# Edit the model to configure its properties
swamp model edit my-contactgroups

# Create the resource in GCP
swamp model method run my-contactgroups create

# Sync current state from GCP
swamp model method run my-contactgroups sync
```
