...
// Auto-generated extension model for @swamp/gcp/cloudbuild/connections-repositories
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Build Connections.Repositories.
 *
...
const GlobalArgsSchema = z.object({
  ...
  remoteUri: z.string().describe("Required. Git Clone HTTPS URI.").optional(),
...
/** Swamp extension model for Google Cloud Build Connections.Repositories. Registered at `@swamp/gcp/cloudbuild/connections-repositories`. */
export const model = {
  type: "@swamp/gcp/cloudbuild/connections-repositories",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["remoteUri"] !== undefined) body["remoteUri"] = g["remoteUri"];
    ...
    access_read_write_token: {
      description: "access read write token",
      arguments: z.object({}),
      execute: async (_args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const baseUrl = g["apiEndpoint"]?.toString() ??
