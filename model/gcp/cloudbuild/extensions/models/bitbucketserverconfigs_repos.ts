...
// Auto-generated extension model for @swamp/gcp/cloudbuild/bitbucketserverconfigs-repos
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Build BitbucketServerConfigs.Repos.
 *
...
/** Swamp extension model for Google Cloud Build BitbucketServerConfigs.Repos. Registered at `@swamp/gcp/cloudbuild/bitbucketserverconfigs-repos`. */
export const model = {
  type: "@swamp/gcp/cloudbuild/bitbucketserverconfigs-repos",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific repos by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
