...
// Auto-generated extension model for @swamp/gcp/ftp/servers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud FTP Servers.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/servers/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  accessType: z.enum(["ACCESS_TYPE_UNSPECIFIED", "EXTERNAL", "INTERNAL"])
    .describe("Required. The access type of the Server.").optional(),
  displayName: z.string().describe("Optional. Display name of the Server")
    .optional(),
  externalConfig: z.object({
    allowedCidrBlocks: z.array(z.string()).describe(
  ...
  }).describe("Configuration for external access.").optional(),
  internalConfig: z.object({
    consumerAcceptList: z.array(z.object({
      connectionLimit: z.string().describe(
    ...
    consumerRejectList: z.array(z.object({
      project: z.string().describe(
        "The project ID or number of the consumer project. Must be in the format: `projects/{project}`.",
      ).optional(),
    })).describe(
    ...
    })).describe("Output only. Details of endpoints created by the customer.")
      .optional(),
  ...
  }).describe("Configuration for internal access.").optional(),
  labels: z.record(z.string(), z.string()).describe(
    "Optional. Labels as key value pairs",
  ).optional(),
  name: z.string().describe("Identifier. name of resource").optional(),
...
const StateSchema = z.object({
  ...
  externalConfig: z.object({
    allowedCidrBlocks: z.array(z.string()),
    ipAddress: z.string(),
  }).optional(),
  googleManagedServerCredential: z.object({
    asymmetricAlgorithm: z.string(),
    fingerprint: z.string(),
  }).optional(),
  internalConfig: z.object({
    consumerAcceptList: z.array(z.object({
      connectionLimit: z.string(),
      project: z.string(),
    })),
    consumerRejectList: z.array(z.object({
      project: z.string(),
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["externalConfig"] !== undefined) {
          body["externalConfig"] = g["externalConfig"];
        }
        if (g["internalConfig"] !== undefined) {
          body["internalConfig"] = g["internalConfig"];
        }
    ...
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The name of the servers"),
      }),
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific servers by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    sync: {
      description: "Sync servers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific servers by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List servers resources",
      arguments: z.object({
