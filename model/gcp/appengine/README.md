...
Google Cloud appengine resources.
...
Use
`swamp model type describe @swamp/gcp/appengine/applications_authorizedcertificates`
...
```bash
# Create a new applications_authorizedcertificates model
swamp model create @swamp/gcp/appengine/applications_authorizedcertificates my-applications_authorizedcertificates

# Edit the model to configure its properties
swamp model edit my-applications_authorizedcertificates

# Create the resource in GCP
swamp model method run my-applications_authorizedcertificates create

# Sync current state from GCP
swamp model method run my-applications_authorizedcertificates sync
```
