...
// Auto-generated extension model for @swamp/gcp/appengine/apps-authorizeddomains
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud App Engine Admin Apps.AuthorizedDomains.
 *
...
/** Swamp extension model for Google Cloud App Engine Admin Apps.AuthorizedDomains. Registered at `@swamp/gcp/appengine/apps-authorizeddomains`. */
export const model = {
  type: "@swamp/gcp/appengine/apps-authorizeddomains",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific authorizedDomains by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List authorizedDomains resources",
      arguments: z.object({
