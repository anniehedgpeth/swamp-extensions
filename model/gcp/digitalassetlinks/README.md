...
Google Cloud digitalassetlinks resources.
...
Use `swamp model type describe @swamp/gcp/digitalassetlinks/statements` to see
...
```bash
# Create a new statements model
swamp model create @swamp/gcp/digitalassetlinks/statements my-statements

# Edit the model to configure its properties
swamp model edit my-statements

# Create the resource in GCP
swamp model method run my-statements create

# Sync current state from GCP
swamp model method run my-statements sync
```
