...
Google Cloud mybusinessqanda resources.
...
Use `swamp model type describe @swamp/gcp/mybusinessqanda/questions_answers` to
...
```bash
# Create a new questions_answers model
swamp model create @swamp/gcp/mybusinessqanda/questions_answers my-questions_answers

# Edit the model to configure its properties
swamp model edit my-questions_answers

# Create the resource in GCP
swamp model method run my-questions_answers create

# Sync current state from GCP
swamp model method run my-questions_answers sync
```
