...
Use `swamp model type describe @swamp/gcp/storage/anywherecaches` to see the
...
```bash
# Create a new anywherecaches model
swamp model create @swamp/gcp/storage/anywherecaches my-anywherecaches

# Edit the model to configure its properties
swamp model edit my-anywherecaches

# Create the resource in GCP
swamp model method run my-anywherecaches create

# Sync current state from GCP
swamp model method run my-anywherecaches sync
```
