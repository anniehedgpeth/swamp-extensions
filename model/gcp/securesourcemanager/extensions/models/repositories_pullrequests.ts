...
// Auto-generated extension model for @swamp/gcp/securesourcemanager/repositories-pullrequests
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Secure Source Manager Repositories.PullRequests.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/pullRequests/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  base: z.object({
    ref: z.string().describe("Required. Name of the branch.").optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a pullRequests",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a pullRequests",
      arguments: z.object({
        identifier: z.string().describe("The name of the pullRequests"),
      }),
    ...
    update: {
      description: "Update pullRequests attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific pullRequests by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync pullRequests state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific pullRequests by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List pullRequests resources",
      arguments: z.object({
