...
/**
 * Swamp extension model for Google Cloud Secure Source Manager Repositories.Issues.IssueComments.
 *
...
/** Swamp extension model for Google Cloud Secure Source Manager Repositories.Issues.IssueComments. Registered at `@swamp/gcp/securesourcemanager/repositories-issues-issuecomments`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific issueComments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List issueComments resources",
      arguments: z.object({
