...
/**
 * Swamp extension model for Google Cloud Secure Source Manager Repositories.PullRequests.PullRequestComments.
 *
...
const GlobalArgsSchema = z.object({
  ...
  code: z.object({
    ...
    }).describe("Optional. The position of the comment.").optional(),
  ...
  }).describe("Optional. The comment on a code line.").optional(),
  comment: z.object({
    body: z.string().describe("Required. The comment body.").optional(),
  }).describe("Optional. The general pull request comment.").optional(),
  ...
  }).describe("Optional. The review summary comment.").optional(),
...
/** Swamp extension model for Google Cloud Secure Source Manager Repositories.PullRequests.PullRequestComments. Registered at `@swamp/gcp/securesourcemanager/repositories-pullrequests-pullrequestcomments`. */
export const model = {
  type:
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific pullRequestComments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List pullRequestComments resources",
      arguments: z.object({
