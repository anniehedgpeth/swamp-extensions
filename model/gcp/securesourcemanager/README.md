...
Google Cloud securesourcemanager resources.
...
Use `swamp model type describe @swamp/gcp/securesourcemanager/instances` to see
...
swamp model create @swamp/gcp/securesourcemanager/instances my-instances
