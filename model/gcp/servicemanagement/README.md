...
Google Cloud servicemanagement resources.
...
Use `swamp model type describe @swamp/gcp/servicemanagement/services_configs` to
...
```bash
# Create a new services_configs model
swamp model create @swamp/gcp/servicemanagement/services_configs my-services_configs

# Edit the model to configure its properties
swamp model edit my-services_configs

# Create the resource in GCP
swamp model method run my-services_configs create

# Sync current state from GCP
swamp model method run my-services_configs sync
```
