...
Google Cloud billingbudgets resources.
...
Use `swamp model type describe @swamp/gcp/billingbudgets/budgets` to see the
...
```bash
# Create a new budgets model
swamp model create @swamp/gcp/billingbudgets/budgets my-budgets

# Edit the model to configure its properties
swamp model edit my-budgets

# Create the resource in GCP
swamp model method run my-budgets create

# Sync current state from GCP
swamp model method run my-budgets sync
```
