...
// Auto-generated extension model for @swamp/gcp/cloudnumberregistry/ipamadminscopes
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/ipamAdminScopes/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  enabledAddonPlatforms: z.array(z.string()).optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a ipamAdminScopes",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["enabledAddonPlatforms"] !== undefined) {
          body["enabledAddonPlatforms"] = g["enabledAddonPlatforms"];
        }
        if (g["labels"] !== undefined) body["labels"] = g["labels"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["scopes"] !== undefined) body["scopes"] = g["scopes"];
        if (g["ipamAdminScopeId"] !== undefined) {
          params["ipamAdminScopeId"] = String(g["ipamAdminScopeId"]);
        }
    ...
    get: {
      description: "Get a ipamAdminScopes",
      arguments: z.object({
        identifier: z.string().describe("The name of the ipamAdminScopes"),
      }),
    ...
    update: {
      description: "Update ipamAdminScopes attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific ipamAdminScopes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the ipamAdminScopes",
      arguments: z.object({
        identifier: z.string().describe("The name of the ipamAdminScopes"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync ipamAdminScopes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific ipamAdminScopes by name (e.g. one discovered by list)",
        ).optional(),
