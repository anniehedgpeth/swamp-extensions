...
Use `swamp model type describe @swamp/gcp/cloudnumberregistry/customranges` to
...
```bash
# Create a new customranges model
swamp model create @swamp/gcp/cloudnumberregistry/customranges my-customranges

# Edit the model to configure its properties
swamp model edit my-customranges

# Create the resource in GCP
swamp model method run my-customranges create

# Sync current state from GCP
swamp model method run my-customranges sync
```
