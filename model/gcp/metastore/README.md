...
Google Cloud metastore resources.
...
Use `swamp model type describe @swamp/gcp/metastore/federations` to see the full
...
```bash
# Create a new federations model
swamp model create @swamp/gcp/metastore/federations my-federations

# Edit the model to configure its properties
swamp model edit my-federations

# Create the resource in GCP
swamp model method run my-federations create

# Sync current state from GCP
swamp model method run my-federations sync
```
