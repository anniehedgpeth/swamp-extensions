...
/**
 * Swamp extension model for Google Cloud Dataproc Metastore Services.Backups.
 *
...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description: "Removed: serviceRevision",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const { serviceRevision: _serviceRevision, ...rest } = old;
        return rest;
      },
    },
    {
