...
// Auto-generated extension model for @swamp/gcp/metastore/services-metadataimports
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataproc Metastore Services.MetadataImports.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/metadataImports/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  databaseDump: z.object({
    databaseType: z.enum(["DATABASE_TYPE_UNSPECIFIED", "MYSQL"]).describe(
    ...
    type: z.enum(["TYPE_UNSPECIFIED", "MYSQL", "AVRO"]).describe(
  ...
  metadataImportId: z.string().describe(
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a metadataImports",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["metadataImportId"] !== undefined) {
          params["metadataImportId"] = String(g["metadataImportId"]);
        }
    ...
    get: {
      description: "Get a metadataImports",
      arguments: z.object({
        identifier: z.string().describe("The name of the metadataImports"),
      }),
    ...
    update: {
      description: "Update metadataImports attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific metadataImports by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    sync: {
      description: "Sync metadataImports state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific metadataImports by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List metadataImports resources",
      arguments: z.object({
