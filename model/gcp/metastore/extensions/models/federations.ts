...
// Auto-generated extension model for @swamp/gcp/metastore/federations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataproc Metastore Federations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/federations/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  backendMetastores: z.record(
    z.string(),
    z.object({
      metastoreType: z.enum([
        "METASTORE_TYPE_UNSPECIFIED",
        "BIGQUERY",
        "DATAPROC_METASTORE",
      ]).describe("The type of the backend metastore.").optional(),
  ...
  federationId: z.string().describe(
...
const StateSchema = z.object({
  backendMetastores: z.record(z.string(), z.unknown()).optional(),
...
/** Swamp extension model for Google Cloud Dataproc Metastore Federations. Registered at `@swamp/gcp/metastore/federations`. */
export const model = {
  type: "@swamp/gcp/metastore/federations",
  ...
  methods: {
    create: {
      description: "Create a federations",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["backendMetastores"] !== undefined) {
          body["backendMetastores"] = g["backendMetastores"];
        }
        if (g["labels"] !== undefined) body["labels"] = g["labels"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["tags"] !== undefined) body["tags"] = g["tags"];
        if (g["version"] !== undefined) body["version"] = g["version"];
        if (g["federationId"] !== undefined) {
          params["federationId"] = String(g["federationId"]);
        }
    ...
    get: {
      description: "Get a federations",
      arguments: z.object({
        identifier: z.string().describe("The name of the federations"),
      }),
    ...
    update: {
      description: "Update federations attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific federations by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the federations",
      arguments: z.object({
        identifier: z.string().describe("The name of the federations"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync federations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific federations by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List federations resources",
      arguments: z.object({
