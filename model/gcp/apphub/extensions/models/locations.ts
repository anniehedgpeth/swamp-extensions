...
// Auto-generated extension model for @swamp/gcp/apphub/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud App Hub Locations.
 *
...
/** Swamp extension model for Google Cloud App Hub Locations. Registered at `@swamp/gcp/apphub/locations`. */
export const model = {
  type: "@swamp/gcp/apphub/locations",
  ...
  methods: {
    ...
    detach_service_project_attachment: {
      description: "detach service project attachment",
      arguments: z.object({}),
    ...
    lookup_service_project_attachment: {
      description: "lookup service project attachment",
      arguments: z.object({}),
      execute: async (_args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const baseUrl = g["apiEndpoint"]?.toString() ??
    ...
    update_boundary: {
      description: "update boundary",
      arguments: z.object({
        createTime: z.any().optional(),
        crmNode: z.any().optional(),
        name: z.any().optional(),
        type: z.any().optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["crmNode"] !== undefined) body["crmNode"] = args["crmNode"];
