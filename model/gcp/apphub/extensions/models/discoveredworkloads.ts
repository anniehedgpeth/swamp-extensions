...
// Auto-generated extension model for @swamp/gcp/apphub/discoveredworkloads
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud App Hub DiscoveredWorkloads.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/discoveredWorkloads/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "DiscoveredWorkload is a binary deployment (such as managed instance groups (M...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a discoveredWorkloads",
      arguments: z.object({
        identifier: z.string().describe("The name of the discoveredWorkloads"),
      }),
    ...
    sync: {
      description: "Sync discoveredWorkloads state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific discoveredWorkloads by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List discoveredWorkloads resources",
      arguments: z.object({
