...
Use `swamp model type describe @swamp/gcp/apphub/applications_services` to see
...
```bash
# Create a new applications_services model
swamp model create @swamp/gcp/apphub/applications_services my-applications_services

# Edit the model to configure its properties
swamp model edit my-applications_services

# Create the resource in GCP
swamp model method run my-applications_services create

# Sync current state from GCP
swamp model method run my-applications_services sync
```
