...
Google Cloud networkconnectivity resources.
...
Use
`swamp model type describe @swamp/gcp/networkconnectivity/automateddnsrecords`
...
```bash
# Create a new automateddnsrecords model
swamp model create @swamp/gcp/networkconnectivity/automateddnsrecords my-automateddnsrecords

# Edit the model to configure its properties
swamp model edit my-automateddnsrecords

# Create the resource in GCP
swamp model method run my-automateddnsrecords create

# Sync current state from GCP
swamp model method run my-automateddnsrecords sync
```
