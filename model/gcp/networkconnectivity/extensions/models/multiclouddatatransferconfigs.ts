...
/**
 * Swamp extension model for Google Cloud Network Connectivity MulticloudDataTransferConfigs.
 *
...
/** Swamp extension model for Google Cloud Network Connectivity MulticloudDataTransferConfigs. Registered at `@swamp/gcp/networkconnectivity/multiclouddatatransferconfigs`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["multicloudDataTransferConfigId"] !== undefined) {
          params["multicloudDataTransferConfigId"] = String(
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific multicloudDataTransferConfigs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List multicloudDataTransferConfigs resources",
      arguments: z.object({
        filter: z.string().describe(
          "Optional. An expression that filters the results listed in the response.",
        ).optional(),
        orderBy: z.string().describe("Optional. The sort order of the results.")
          .optional(),
