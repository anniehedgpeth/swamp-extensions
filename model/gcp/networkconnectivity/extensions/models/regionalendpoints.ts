...
/**
 * Swamp extension model for Google Cloud Network Connectivity RegionalEndpoints.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["regionalEndpointId"] !== undefined) {
          params["regionalEndpointId"] = String(g["regionalEndpointId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific regionalEndpoints by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List regionalEndpoints resources",
      arguments: z.object({
