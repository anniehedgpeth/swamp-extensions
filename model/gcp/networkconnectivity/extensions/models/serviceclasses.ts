...
// Auto-generated extension model for @swamp/gcp/networkconnectivity/serviceclasses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Connectivity ServiceClasses.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/serviceClasses/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Network Connectivity ServiceClasses. Registered at `@swamp/gcp/networkconnectivity/serviceclasses`. */
export const model = {
  type: "@swamp/gcp/networkconnectivity/serviceclasses",
  ...
  methods: {
    get: {
      description: "Get a serviceClasses",
      arguments: z.object({
        identifier: z.string().describe("The name of the serviceClasses"),
      }),
    ...
    update: {
      description: "Update serviceClasses attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific serviceClasses by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the serviceClasses",
      arguments: z.object({
        identifier: z.string().describe("The name of the serviceClasses"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync serviceClasses state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific serviceClasses by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List serviceClasses resources",
      arguments: z.object({
