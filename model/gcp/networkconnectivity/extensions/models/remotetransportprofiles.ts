...
// Auto-generated extension model for @swamp/gcp/networkconnectivity/remotetransportprofiles
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Connectivity RemoteTransportProfiles.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/remoteTransportProfiles/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  providerSite: z.string().optional(),
  sla: z.string().optional(),
  supportedBandwidths: z.array(z.string()).optional(),
}).passthrough();
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a remoteTransportProfiles",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the remoteTransportProfiles",
        ),
      }),
    ...
    sync: {
      description: "Sync remoteTransportProfiles state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific remoteTransportProfiles by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List remoteTransportProfiles resources",
      arguments: z.object({
