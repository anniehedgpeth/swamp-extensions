...
// Auto-generated extension model for @swamp/gcp/networkconnectivity/serviceconnectiontokens
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Connectivity ServiceConnectionTokens.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/serviceConnectionTokens/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  serviceConnectionTokenId: z.string().describe(
...
/** Swamp extension model for Google Cloud Network Connectivity ServiceConnectionTokens. Registered at `@swamp/gcp/networkconnectivity/serviceconnectiontokens`. */
export const model = {
  type: "@swamp/gcp/networkconnectivity/serviceconnectiontokens",
  ...
  methods: {
    create: {
      description: "Create a serviceConnectionTokens",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["serviceConnectionTokenId"] !== undefined) {
          params["serviceConnectionTokenId"] = String(
            g["serviceConnectionTokenId"],
          );
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a serviceConnectionTokens",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the serviceConnectionTokens",
        ),
      }),
    ...
    delete: {
      description: "Delete the serviceConnectionTokens",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the serviceConnectionTokens",
        ),
    ...
    sync: {
      description: "Sync serviceConnectionTokens state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific serviceConnectionTokens by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List serviceConnectionTokens resources",
      arguments: z.object({
