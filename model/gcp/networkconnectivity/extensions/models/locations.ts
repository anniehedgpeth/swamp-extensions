...
// Auto-generated extension model for @swamp/gcp/networkconnectivity/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Connectivity Locations.
 *
...
/** Swamp extension model for Google Cloud Network Connectivity Locations. Registered at `@swamp/gcp/networkconnectivity/locations`. */
export const model = {
  type: "@swamp/gcp/networkconnectivity/locations",
  ...
  methods: {
    ...
    check_consumer_config: {
      description: "check consumer config",
      arguments: z.object({
        consumerNetwork: z.any().optional(),
        endpointProject: z.any().optional(),
        requestedIpVersion: z.any().optional(),
        serviceClass: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (args["endpointProject"] !== undefined) {
          body["endpointProject"] = args["endpointProject"];
        }
        if (args["requestedIpVersion"] !== undefined) {
          body["requestedIpVersion"] = args["requestedIpVersion"];
        }
        if (args["serviceClass"] !== undefined) {
          body["serviceClass"] = args["serviceClass"];
        }
