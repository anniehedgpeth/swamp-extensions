...
/**
 * Swamp extension model for Google Cloud Network Connectivity Global.PolicyBasedRoutes.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["policyBasedRouteId"] !== undefined) {
          params["policyBasedRouteId"] = String(g["policyBasedRouteId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific policyBasedRoutes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List policyBasedRoutes resources",
      arguments: z.object({
