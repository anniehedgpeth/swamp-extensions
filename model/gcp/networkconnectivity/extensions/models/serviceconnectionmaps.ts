...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["serviceConnectionMapId"] !== undefined) {
          params["serviceConnectionMapId"] = String(
            g["serviceConnectionMapId"],
          );
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific serviceConnectionMaps by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List serviceConnectionMaps resources",
      arguments: z.object({
