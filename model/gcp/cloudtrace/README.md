...
Use `swamp model type describe @swamp/gcp/cloudtrace/traces` to see the full
...
```bash
# Create a new traces model
swamp model create @swamp/gcp/cloudtrace/traces my-traces

# Edit the model to configure its properties
swamp model edit my-traces

# Create the resource in GCP
swamp model method run my-traces create

# Sync current state from GCP
swamp model method run my-traces sync
```
