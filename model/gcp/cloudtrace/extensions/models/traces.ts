...
// Auto-generated extension model for @swamp/gcp/cloudtrace/traces
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Trace Traces.
 *
...
const BASE_URL = "https://cloudtrace.googleapis.com/";
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A trace describes how long it takes for an application to perform an operatio...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a traces",
      arguments: z.object({
        identifier: z.string().describe("The name of the traces"),
      }),
    ...
    sync: {
      description: "Sync traces state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific traces by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
