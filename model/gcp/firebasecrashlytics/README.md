...
Use `swamp model type describe @swamp/gcp/firebasecrashlytics/apps_events` to
...
```bash
# Create a new apps_events model
swamp model create @swamp/gcp/firebasecrashlytics/apps_events my-apps_events

# Edit the model to configure its properties
swamp model edit my-apps_events

# Create the resource in GCP
swamp model method run my-apps_events create

# Sync current state from GCP
swamp model method run my-apps_events sync
```
