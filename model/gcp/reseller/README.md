...
Google Cloud reseller resources.
...
Use `swamp model type describe @swamp/gcp/reseller/customers` to see the full
...
```bash
# Create a new customers model
swamp model create @swamp/gcp/reseller/customers my-customers

# Edit the model to configure its properties
swamp model edit my-customers

# Create the resource in GCP
swamp model method run my-customers create

# Sync current state from GCP
swamp model method run my-customers sync
```
