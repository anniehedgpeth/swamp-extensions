...
// Auto-generated extension model for @swamp/gcp/assuredworkloads/workloads-violations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Assured Workloads Workloads.Violations.
 *
...
const StateSchema = z.object({
  ...
  exceptionContexts: z.array(z.object({
    acknowledgementTime: z.string(),
    comment: z.string(),
    userName: z.string(),
  })).optional(),
  name: z.string(),
  nonCompliantOrgPolicy: z.string().optional(),
  orgPolicyConstraint: z.string().optional(),
  parentProjectNumber: z.string().optional(),
  ...
  methods: {
    ...
    list: {
      ...
      arguments: z.object({
        ...
        interval_endTime: z.string().describe("The end of the time window.")
          .optional(),
