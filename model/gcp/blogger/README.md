...
Google Cloud blogger resources.
...
Use `swamp model type describe @swamp/gcp/blogger/blogs` to see the full list of
...
```bash
# Create a new blogs model
swamp model create @swamp/gcp/blogger/blogs my-blogs

# Edit the model to configure its properties
swamp model edit my-blogs

# Create the resource in GCP
swamp model method run my-blogs create

# Sync current state from GCP
swamp model method run my-blogs sync
```
