...
// Auto-generated extension model for @swamp/gcp/cloudscheduler/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Scheduler Locations.
 *
...
/** Swamp extension model for Google Cloud Scheduler Locations. Registered at `@swamp/gcp/cloudscheduler/locations`. */
export const model = {
  type: "@swamp/gcp/cloudscheduler/locations",
  ...
  methods: {
    ...
    update_cmek_config: {
      description: "update cmek config",
      arguments: z.object({
