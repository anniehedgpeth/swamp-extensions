...
Google Cloud cloudscheduler resources.
...
Use `swamp model type describe @swamp/gcp/cloudscheduler/jobs` to see the full
...
swamp model create @swamp/gcp/cloudscheduler/jobs my-jobs
