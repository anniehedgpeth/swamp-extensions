...
// Auto-generated extension model for @swamp/gcp/eventarc/messagebuses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Eventarc MessageBuses.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/messageBuses/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  messageBusId: z.string().describe(
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "MessageBus for the messages flowing through the system. The admin has visibil...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a messageBuses",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["messageBusId"] !== undefined) {
          params["messageBusId"] = String(g["messageBusId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a messageBuses",
      arguments: z.object({
        identifier: z.string().describe("The name of the messageBuses"),
      }),
    ...
    update: {
      description: "Update messageBuses attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific messageBuses by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the messageBuses",
      arguments: z.object({
        identifier: z.string().describe("The name of the messageBuses"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync messageBuses state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific messageBuses by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List messageBuses resources",
      arguments: z.object({
