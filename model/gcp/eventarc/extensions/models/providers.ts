...
// Auto-generated extension model for @swamp/gcp/eventarc/providers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Eventarc Providers.
 *
...
const StateSchema = z.object({
  ...
  eventTypes: z.array(z.object({
    ...
    eventSchemaUri: z.string(),
    filteringAttributes: z.array(z.object({
      attribute: z.string(),
      description: z.string(),
      pathPatternSupported: z.boolean(),
      required: z.boolean(),
    })),
    type: z.string(),
  })).optional(),
...
/** Swamp extension model for Google Cloud Eventarc Providers. Registered at `@swamp/gcp/eventarc/providers`. */
export const model = {
  type: "@swamp/gcp/eventarc/providers",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific providers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
