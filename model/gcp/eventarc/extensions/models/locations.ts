...
// Auto-generated extension model for @swamp/gcp/eventarc/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Eventarc Locations.
 *
...
/** Swamp extension model for Google Cloud Eventarc Locations. Registered at `@swamp/gcp/eventarc/locations`. */
export const model = {
  type: "@swamp/gcp/eventarc/locations",
  ...
  methods: {
    ...
    get_google_channel_config: {
      description: "get google channel config",
      arguments: z.object({}),
    ...
    update_google_channel_config: {
      description: "update google channel config",
      arguments: z.object({
        cryptoKeyName: z.any().optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["cryptoKeyName"] !== undefined) {
          body["cryptoKeyName"] = args["cryptoKeyName"];
        }
