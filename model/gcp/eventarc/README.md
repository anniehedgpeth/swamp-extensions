...
Google Cloud eventarc resources.
...
Use `swamp model type describe @swamp/gcp/eventarc/channelconnections` to see
...
```bash
# Create a new channelconnections model
swamp model create @swamp/gcp/eventarc/channelconnections my-channelconnections

# Edit the model to configure its properties
swamp model edit my-channelconnections

# Create the resource in GCP
swamp model method run my-channelconnections create

# Sync current state from GCP
swamp model method run my-channelconnections sync
```
