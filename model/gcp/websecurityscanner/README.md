...
Google Cloud websecurityscanner resources.
...
Use
`swamp model type describe @swamp/gcp/websecurityscanner/scanconfigs_scanruns_crawledurls`
...
```bash
# Create a new scanconfigs_scanruns_crawledurls model
swamp model create @swamp/gcp/websecurityscanner/scanconfigs_scanruns_crawledurls my-scanconfigs_scanruns_crawledurls

# Edit the model to configure its properties
swamp model edit my-scanconfigs_scanruns_crawledurls

# Create the resource in GCP
swamp model method run my-scanconfigs_scanruns_crawledurls create

# Sync current state from GCP
swamp model method run my-scanconfigs_scanruns_crawledurls sync
```
