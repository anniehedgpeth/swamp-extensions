...
// Auto-generated extension model for @swamp/gcp/websecurityscanner/scanconfigs-scanruns-findingtypestats
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Web Security Scanner ScanConfigs.ScanRuns.FindingTypeStats.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a findingTypeStats",
      arguments: z.object({
        identifier: z.string().describe("The name of the findingTypeStats"),
      }),
    ...
    sync: {
      description: "Sync findingTypeStats state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific findingTypeStats by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List findingTypeStats resources",
      arguments: z.object({
