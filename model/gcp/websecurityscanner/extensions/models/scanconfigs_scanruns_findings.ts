...
// Auto-generated extension model for @swamp/gcp/websecurityscanner/scanconfigs-scanruns-findings
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Web Security Scanner ScanConfigs.ScanRuns.Findings.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/findings/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  fuzzedUrl: z.string().optional(),
  httpMethod: z.string().optional(),
  name: z.string(),
  outdatedLibrary: z.object({
    learnMoreUrls: z.array(z.string()),
    libraryName: z.string(),
    version: z.string(),
  }).optional(),
  reproductionUrl: z.string().optional(),
  severity: z.string().optional(),
  trackingId: z.string().optional(),
  violatingResource: z.object({
    contentType: z.string(),
    resourceUrl: z.string(),
  }).optional(),
  vulnerableHeaders: z.object({
  ...
  xss: z.object({
    ...
    storedXssSeedingUrl: z.string(),
  }).optional(),
  xxe: z.object({
    payloadLocation: z.string(),
...
/** Swamp extension model for Google Cloud Web Security Scanner ScanConfigs.ScanRuns.Findings. Registered at `@swamp/gcp/websecurityscanner/scanconfigs-scanruns-findings`. */
export const model = {
  type: "@swamp/gcp/websecurityscanner/scanconfigs-scanruns-findings",
  ...
  resources: {
    state: {
      description:
        "A Finding resource represents a vulnerability instance identified during a Sc...",
      schema: StateSchema,
      lifetime: "infinite",
