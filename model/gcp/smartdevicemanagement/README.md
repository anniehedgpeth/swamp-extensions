# @swamp/gcp/smartdevicemanagement

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Google Cloud smartdevicemanagement resources.
...
Use
`swamp model type describe @swamp/gcp/smartdevicemanagement/enterprises_devices`
...
```bash
# Create a new enterprises_devices model
swamp model create @swamp/gcp/smartdevicemanagement/enterprises_devices my-enterprises_devices

# Edit the model to configure its properties
swamp model edit my-enterprises_devices

# Create the resource in GCP
swamp model method run my-enterprises_devices create

# Sync current state from GCP
swamp model method run my-enterprises_devices sync
```
