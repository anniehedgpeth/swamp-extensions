...
// Auto-generated extension model for @swamp/gcp/smartdevicemanagement/enterprises-structures-rooms
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Smart Device Management Enterprises.Structures.Rooms.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/rooms/${shortName}`;
}

const BASE_URL = "https://smartdevicemanagement.googleapis.com/";
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a rooms",
      arguments: z.object({
        identifier: z.string().describe("The name of the rooms"),
      }),
    ...
    sync: {
      description: "Sync rooms state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific rooms by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List rooms resources",
      arguments: z.object({
