...
// Auto-generated extension model for @swamp/gcp/smartdevicemanagement/enterprises-structures
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Smart Device Management Enterprises.Structures.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/structures/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a structures",
      arguments: z.object({
        identifier: z.string().describe("The name of the structures"),
      }),
    ...
    sync: {
      description: "Sync structures state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific structures by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
