...
Google Cloud adexchangebuyer2 resources.
...
Use
`swamp model type describe @swamp/gcp/adexchangebuyer2/accounts_clients_invitations`
...
```bash
# Create a new accounts_clients_invitations model
swamp model create @swamp/gcp/adexchangebuyer2/accounts_clients_invitations my-accounts_clients_invitations

# Edit the model to configure its properties
swamp model edit my-accounts_clients_invitations

# Create the resource in GCP
swamp model method run my-accounts_clients_invitations create

# Sync current state from GCP
swamp model method run my-accounts_clients_invitations sync
```
