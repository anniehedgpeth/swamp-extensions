...
/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Accounts.Creatives.DealAssociations.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dealAssociations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List dealAssociations resources",
      arguments: z.object({
