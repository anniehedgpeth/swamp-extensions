...
// Auto-generated extension model for @swamp/gcp/adexchangebuyer2/bidders-filtersets-bidresponseswithoutbids
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.FilterSets.BidResponsesWithoutBids.
 *
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.FilterSets.BidResponsesWithoutBids. Registered at `@swamp/gcp/adexchangebuyer2/bidders-filtersets-bidresponseswithoutbids`. */
export const model = {
  type:
    "@swamp/gcp/adexchangebuyer2/bidders-filtersets-bidresponseswithoutbids",
