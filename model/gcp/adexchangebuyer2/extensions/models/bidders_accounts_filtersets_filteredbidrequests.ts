...
// Auto-generated extension model for @swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbidrequests
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.FilteredBidRequests.
 *
...
const StateSchema = z.object({
  calloutStatusId: z.number().optional(),
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.FilteredBidRequests. Registered at `@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbidrequests`. */
export const model = {
  type:
    "@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbidrequests",
  ...
  resources: {
    state: {
      description:
        "The number of impressions with the specified dimension values where the corre...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a filteredBidRequests",
      arguments: z.object({
        identifier: z.string().describe("The name of the filteredBidRequests"),
      }),
    ...
    sync: {
      description: "Sync filteredBidRequests state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific filteredBidRequests by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List filteredBidRequests resources",
      arguments: z.object({
