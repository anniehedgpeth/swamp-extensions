...
// Auto-generated extension model for @swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-bidresponseerrors
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.BidResponseErrors.
 *
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.BidResponseErrors. Registered at `@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-bidresponseerrors`. */
export const model = {
  type:
    "@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-bidresponseerrors",
  ...
  methods: {
    get: {
      description: "Get a bidResponseErrors",
      arguments: z.object({
        identifier: z.string().describe("The name of the bidResponseErrors"),
      }),
    ...
    sync: {
      description: "Sync bidResponseErrors state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific bidResponseErrors by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List bidResponseErrors resources",
      arguments: z.object({
