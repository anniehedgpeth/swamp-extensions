...
/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.FilterSets.NonBillableWinningBids.
 *
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.FilterSets.NonBillableWinningBids. Registered at `@swamp/gcp/adexchangebuyer2/bidders-filtersets-nonbillablewinningbids`. */
export const model = {
