...
// Auto-generated extension model for @swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-bidresponseswithoutbids
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.BidResponsesWithoutBids.
 *
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.BidResponsesWithoutBids. Registered at `@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-bidresponseswithoutbids`. */
export const model = {
  type:
    "@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-bidresponseswithoutbids",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific bidResponsesWithoutBids by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List bidResponsesWithoutBids resources",
      arguments: z.object({
