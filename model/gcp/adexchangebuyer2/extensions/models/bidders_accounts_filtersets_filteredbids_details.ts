...
// Auto-generated extension model for @swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbids-details
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.FilteredBids.Details.
 *
...
const GlobalArgsSchema = z.object({
  ...
  creativeStatusId: z.string().describe(
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.FilteredBids.Details. Registered at `@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbids-details`. */
export const model = {
  type:
    "@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbids-details",
  ...
  upgrades: [
    ...
    },
    {
      ...
      description: "Added: filterSetName, creativeStatusId",
      upgradeAttributes: (old: Record<string, unknown>) => old,
    },
    {
  ...
  methods: {
    get: {
      ...
      execute: async (args: { identifier: string }, context: any) => {
        ...
        if (g["creativeStatusId"] !== undefined) {
          params["creativeStatusId"] = String(g["creativeStatusId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific details by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
        ...
        try {
          ...
          if (g["creativeStatusId"] !== undefined) {
            params["creativeStatusId"] = String(g["creativeStatusId"]);
          } else if (existing["creativeStatusId"]) {
            params["creativeStatusId"] = String(existing["creativeStatusId"]);
          }
    ...
    list: {
      description: "List details resources",
      arguments: z.object({
