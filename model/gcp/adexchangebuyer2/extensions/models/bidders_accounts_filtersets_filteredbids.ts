...
// Auto-generated extension model for @swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbids
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.FilteredBids.
 *
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.FilteredBids. Registered at `@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbids`. */
export const model = {
  type: "@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-filteredbids",
  ...
  methods: {
    get: {
      description: "Get a filteredBids",
      arguments: z.object({
        identifier: z.string().describe("The name of the filteredBids"),
      }),
    ...
    sync: {
      description: "Sync filteredBids state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific filteredBids by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List filteredBids resources",
      arguments: z.object({
