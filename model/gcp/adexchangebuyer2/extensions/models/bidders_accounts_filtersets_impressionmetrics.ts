...
// Auto-generated extension model for @swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-impressionmetrics
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.ImpressionMetrics.
 *
...
const StateSchema = z.object({
  availableImpressions: z.object({
    value: z.string(),
    variance: z.string(),
  }).optional(),
  bidRequests: z.object({
    value: z.string(),
    variance: z.string(),
  }).optional(),
  inventoryMatches: z.object({
    value: z.string(),
    variance: z.string(),
  }).optional(),
  responsesWithBids: z.object({
    value: z.string(),
    variance: z.string(),
  }).optional(),
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.Accounts.FilterSets.ImpressionMetrics. Registered at `@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-impressionmetrics`. */
export const model = {
  type:
    "@swamp/gcp/adexchangebuyer2/bidders-accounts-filtersets-impressionmetrics",
  ...
  methods: {
    get: {
      description: "Get a impressionMetrics",
      arguments: z.object({
        identifier: z.string().describe("The name of the impressionMetrics"),
      }),
    ...
    sync: {
      description: "Sync impressionMetrics state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific impressionMetrics by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List impressionMetrics resources",
      arguments: z.object({
