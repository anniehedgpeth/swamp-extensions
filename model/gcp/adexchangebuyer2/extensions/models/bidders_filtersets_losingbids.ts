...
// Auto-generated extension model for @swamp/gcp/adexchangebuyer2/bidders-filtersets-losingbids
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.FilterSets.LosingBids.
 *
...
/** Swamp extension model for Google Cloud Ad Exchange Buyer Bidders.FilterSets.LosingBids. Registered at `@swamp/gcp/adexchangebuyer2/bidders-filtersets-losingbids`. */
export const model = {
  type: "@swamp/gcp/adexchangebuyer2/bidders-filtersets-losingbids",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific losingBids by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List losingBids resources",
      arguments: z.object({
