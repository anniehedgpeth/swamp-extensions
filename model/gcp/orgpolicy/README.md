...
Google Cloud orgpolicy resources.
...
Use `swamp model type describe @swamp/gcp/orgpolicy/constraints` to see the full
...
```bash
# Create a new constraints model
swamp model create @swamp/gcp/orgpolicy/constraints my-constraints

# Edit the model to configure its properties
swamp model edit my-constraints

# Create the resource in GCP
swamp model method run my-constraints create

# Sync current state from GCP
swamp model method run my-constraints sync
```
