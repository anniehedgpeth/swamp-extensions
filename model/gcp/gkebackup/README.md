...
Google Cloud gkebackup resources.
...
Use
`swamp model type describe @swamp/gcp/gkebackup/backupchannels_backupplanbindings`
...
```bash
# Create a new backupchannels_backupplanbindings model
swamp model create @swamp/gcp/gkebackup/backupchannels_backupplanbindings my-backupchannels_backupplanbindings

# Edit the model to configure its properties
swamp model edit my-backupchannels_backupplanbindings

# Create the resource in GCP
swamp model method run my-backupchannels_backupplanbindings create

# Sync current state from GCP
swamp model method run my-backupchannels_backupplanbindings sync
```
