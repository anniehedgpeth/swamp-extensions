...
/**
 * Swamp extension model for Google Cloud Backup for GKE RestoreChannels.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["restoreChannelId"] !== undefined) {
          params["restoreChannelId"] = String(g["restoreChannelId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific restoreChannels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List restoreChannels resources",
      arguments: z.object({
