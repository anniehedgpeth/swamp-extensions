...
/**
 * Swamp extension model for Google Cloud Backup for GKE BackupChannels.BackupPlanBindings.
 *
...
/** Swamp extension model for Google Cloud Backup for GKE BackupChannels.BackupPlanBindings. Registered at `@swamp/gcp/gkebackup/backupchannels-backupplanbindings`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific backupPlanBindings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List backupPlanBindings resources",
      arguments: z.object({
