...
// Auto-generated extension model for @swamp/gcp/gkebackup/backupchannels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Backup for GKE BackupChannels.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/backupChannels/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  backupChannelId: z.string().describe(
...
/** Swamp extension model for Google Cloud Backup for GKE BackupChannels. Registered at `@swamp/gcp/gkebackup/backupchannels`. */
export const model = {
  type: "@swamp/gcp/gkebackup/backupchannels",
  ...
  resources: {
    state: {
      description:
        "A BackupChannel imposes constraints on where clusters can be backed up. The B...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a backupChannels",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["backupChannelId"] !== undefined) {
          params["backupChannelId"] = String(g["backupChannelId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a backupChannels",
      arguments: z.object({
        identifier: z.string().describe("The name of the backupChannels"),
      }),
    ...
    update: {
      description: "Update backupChannels attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific backupChannels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the backupChannels",
      arguments: z.object({
        identifier: z.string().describe("The name of the backupChannels"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync backupChannels state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific backupChannels by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List backupChannels resources",
      arguments: z.object({
