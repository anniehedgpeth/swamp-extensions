...
// Auto-generated extension model for @swamp/gcp/gkebackup/restorechannels-restoreplanbindings
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Backup for GKE RestoreChannels.RestorePlanBindings.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/restorePlanBindings/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a restorePlanBindings",
      arguments: z.object({
        identifier: z.string().describe("The name of the restorePlanBindings"),
      }),
    ...
    sync: {
      description: "Sync restorePlanBindings state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific restorePlanBindings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List restorePlanBindings resources",
      arguments: z.object({
