...
// Auto-generated extension model for @swamp/gcp/gkebackup/backupplans-backups-volumebackups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Backup for GKE BackupPlans.Backups.VolumeBackups.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/volumeBackups/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  volumeBackupHandle: z.string().optional(),
}).passthrough();
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Represents the backup of a specific persistent volume as a component of a Bac...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a volumeBackups",
      arguments: z.object({
        identifier: z.string().describe("The name of the volumeBackups"),
      }),
    ...
    sync: {
      description: "Sync volumeBackups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific volumeBackups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List volumeBackups resources",
      arguments: z.object({
