...
Use `swamp model type describe @swamp/gcp/apigee/analytics_datastores` to see
...
```bash
# Create a new analytics_datastores model
swamp model create @swamp/gcp/apigee/analytics_datastores my-analytics_datastores

# Edit the model to configure its properties
swamp model edit my-analytics_datastores

# Create the resource in GCP
swamp model method run my-analytics_datastores create

# Sync current state from GCP
swamp model method run my-analytics_datastores sync
```
