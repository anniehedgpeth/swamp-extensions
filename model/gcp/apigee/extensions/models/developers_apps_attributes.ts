...
// Auto-generated extension model for @swamp/gcp/apigee/developers-apps-attributes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Developers.Apps.Attributes.
 *
...
/** Swamp extension model for Google Cloud Apigee Developers.Apps.Attributes. Registered at `@swamp/gcp/apigee/developers-apps-attributes`. */
export const model = {
  type: "@swamp/gcp/apigee/developers-apps-attributes",
  ...
  methods: {
    ...
    update_developer_app_attribute: {
      description: "update developer app attribute",
      arguments: z.object({
        name: z.any().optional(),
