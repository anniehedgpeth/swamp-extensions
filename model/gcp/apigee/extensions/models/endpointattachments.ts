...
/**
 * Swamp extension model for Google Cloud Apigee EndpointAttachments.
 *
...
/** Swamp extension model for Google Cloud Apigee EndpointAttachments. Registered at `@swamp/gcp/apigee/endpointattachments`. */
export const model = {
