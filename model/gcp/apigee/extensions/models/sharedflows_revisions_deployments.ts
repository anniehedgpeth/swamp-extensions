...
// Auto-generated extension model for @swamp/gcp/apigee/sharedflows-revisions-deployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Sharedflows.Revisions.Deployments.
 *
...
/** Swamp extension model for Google Cloud Apigee Sharedflows.Revisions.Deployments. Registered at `@swamp/gcp/apigee/sharedflows-revisions-deployments`. */
export const model = {
  type: "@swamp/gcp/apigee/sharedflows-revisions-deployments",
