...
/**
 * Swamp extension model for Google Cloud Apigee Environments.OptimizedStats.
 *
...
/** Swamp extension model for Google Cloud Apigee Environments.OptimizedStats. Registered at `@swamp/gcp/apigee/environments-optimizedstats`. */
export const model = {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific optimizedStats by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
