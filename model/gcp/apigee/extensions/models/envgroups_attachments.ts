...
// Auto-generated extension model for @swamp/gcp/apigee/envgroups-attachments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Envgroups.Attachments.
 *
...
const GlobalArgsSchema = z.object({
  ...
  environment: z.string().describe("Required. ID of the attached environment.")
    .optional(),
  name: z.string().describe("ID of the environment group attachment.")
    .optional(),
...
const StateSchema = z.object({
  ...
  environmentGroupId: z.string().optional(),
  name: z.string(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Apigee Envgroups.Attachments. Registered at `@swamp/gcp/apigee/envgroups-attachments`. */
export const model = {
  type: "@swamp/gcp/apigee/envgroups-attachments",
  ...
  resources: {
    state: {
      description:
        "EnvironmentGroupAttachment is a resource which defines an attachment of an en...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific attachments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List attachments resources",
      arguments: z.object({
