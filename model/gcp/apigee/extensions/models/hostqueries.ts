...
// Auto-generated extension model for @swamp/gcp/apigee/hostqueries
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee HostQueries.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/hostQueries/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Get status of a query submitted at host level. If the query is still in progr...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a hostQueries",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a hostQueries",
      arguments: z.object({
        identifier: z.string().describe("The name of the hostQueries"),
      }),
    ...
    sync: {
      description: "Sync hostQueries state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific hostQueries by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
