...
// Auto-generated extension model for @swamp/gcp/apigee/instances-attachments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Instances.Attachments.
 *
...
const GlobalArgsSchema = z.object({
  ...
  environment: z.string().describe("ID of the attached environment.")
    .optional(),
...
/** Swamp extension model for Google Cloud Apigee Instances.Attachments. Registered at `@swamp/gcp/apigee/instances-attachments`. */
export const model = {
  type: "@swamp/gcp/apigee/instances-attachments",
  ...
  resources: {
    state: {
      description:
        "InstanceAttachment represents the installation of an environment onto an inst...",
      schema: StateSchema,
      lifetime: "infinite",
