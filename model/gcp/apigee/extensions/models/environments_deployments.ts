...
// Auto-generated extension model for @swamp/gcp/apigee/environments-deployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Environments.Deployments.
 *
...
/** Swamp extension model for Google Cloud Apigee Environments.Deployments. Registered at `@swamp/gcp/apigee/environments-deployments`. */
export const model = {
  type: "@swamp/gcp/apigee/environments-deployments",
  ...
  methods: {
    ...
    list: {
      ...
      arguments: z.object({
        sharedFlows: z.boolean().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["sharedFlows"] !== undefined) {
          params["sharedFlows"] = String(args["sharedFlows"]);
        }
