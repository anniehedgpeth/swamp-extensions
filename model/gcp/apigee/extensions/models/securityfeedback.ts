...
/**
 * Swamp extension model for Google Cloud Apigee SecurityFeedback.
 *
...
/** Swamp extension model for Google Cloud Apigee SecurityFeedback. Registered at `@swamp/gcp/apigee/securityfeedback`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["securityFeedbackId"] !== undefined) {
          params["securityFeedbackId"] = String(g["securityFeedbackId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific securityFeedback by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List securityFeedback resources",
      arguments: z.object({
