...
/**
 * Swamp extension model for Google Cloud Apigee Sites.Apidocs.
 *
...
/** Swamp extension model for Google Cloud Apigee Sites.Apidocs. Registered at `@swamp/gcp/apigee/sites-apidocs`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific apidocs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List apidocs resources",
      arguments: z.object({
