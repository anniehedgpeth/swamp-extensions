...
/**
 * Swamp extension model for Google Cloud Apigee Apis.Revisions.Deployments.
 *
...
/** Swamp extension model for Google Cloud Apigee Apis.Revisions.Deployments. Registered at `@swamp/gcp/apigee/apis-revisions-deployments`. */
export const model = {
