...
// Auto-generated extension model for @swamp/gcp/apigee/environments-securityreports
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Environments.SecurityReports.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/securityReports/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Apigee Environments.SecurityReports. Registered at `@swamp/gcp/apigee/environments-securityreports`. */
export const model = {
  type: "@swamp/gcp/apigee/environments-securityreports",
  ...
  methods: {
    create: {
      description: "Create a securityReports",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a securityReports",
      arguments: z.object({
        identifier: z.string().describe("The name of the securityReports"),
      }),
    ...
    sync: {
      description: "Sync securityReports state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific securityReports by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List securityReports resources",
      arguments: z.object({
