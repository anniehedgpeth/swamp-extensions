...
// Auto-generated extension model for @swamp/gcp/apigee/apiproducts-attributes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Apiproducts.Attributes.
 *
...
/** Swamp extension model for Google Cloud Apigee Apiproducts.Attributes. Registered at `@swamp/gcp/apigee/apiproducts-attributes`. */
export const model = {
  type: "@swamp/gcp/apigee/apiproducts-attributes",
  ...
  methods: {
    ...
    update_api_product_attribute: {
      description: "update api product attribute",
      arguments: z.object({
        name: z.any().optional(),
