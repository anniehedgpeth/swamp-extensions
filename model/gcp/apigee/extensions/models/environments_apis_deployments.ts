...
// Auto-generated extension model for @swamp/gcp/apigee/environments-apis-deployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Environments.Apis.Deployments.
 *
...
/** Swamp extension model for Google Cloud Apigee Environments.Apis.Deployments. Registered at `@swamp/gcp/apigee/environments-apis-deployments`. */
export const model = {
  type: "@swamp/gcp/apigee/environments-apis-deployments",
