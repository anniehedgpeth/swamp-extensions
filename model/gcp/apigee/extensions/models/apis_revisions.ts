...
// Auto-generated extension model for @swamp/gcp/apigee/apis-revisions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Apis.Revisions.
 *
...
/** Swamp extension model for Google Cloud Apigee Apis.Revisions. Registered at `@swamp/gcp/apigee/apis-revisions`. */
export const model = {
  type: "@swamp/gcp/apigee/apis-revisions",
  ...
  methods: {
    ...
    update_api_proxy_revision: {
      description: "update api proxy revision",
      arguments: z.object({
