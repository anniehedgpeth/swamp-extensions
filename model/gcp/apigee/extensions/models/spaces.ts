...
// Auto-generated extension model for @swamp/gcp/apigee/spaces
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Spaces.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/spaces/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  displayName: z.string().describe("Optional. Display name of the space.")
    .optional(),
  spaceId: z.string().describe("Required. Resource ID of the space.")
    .optional(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["spaceId"] !== undefined) {
          params["spaceId"] = String(g["spaceId"]);
        }
