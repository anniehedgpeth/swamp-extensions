...
/**
 * Swamp extension model for Google Cloud Apigee Environments.Apis.Revisions.Debugsessions.
 *
...
/** Swamp extension model for Google Cloud Apigee Environments.Apis.Revisions.Debugsessions. Registered at `@swamp/gcp/apigee/environments-apis-revisions-debugsessions`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["timeout"] !== undefined) {
          params["timeout"] = String(g["timeout"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific debugsessions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List debugsessions resources",
      arguments: z.object({
