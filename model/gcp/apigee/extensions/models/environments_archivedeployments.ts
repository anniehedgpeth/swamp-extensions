...
/**
 * Swamp extension model for Google Cloud Apigee Environments.ArchiveDeployments.
 *
...
/** Swamp extension model for Google Cloud Apigee Environments.ArchiveDeployments. Registered at `@swamp/gcp/apigee/environments-archivedeployments`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific archiveDeployments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List archiveDeployments resources",
      arguments: z.object({
