...
// Auto-generated extension model for @swamp/gcp/apigee/envgroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Envgroups.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/envgroups/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Apigee Envgroups. Registered at `@swamp/gcp/apigee/envgroups`. */
export const model = {
  type: "@swamp/gcp/apigee/envgroups",
  ...
  methods: {
    create: {
      description: "Create a envgroups",
      arguments: z.object({
    ...
    get: {
      description: "Get a envgroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the envgroups"),
      }),
    ...
    update: {
      description: "Update envgroups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific envgroups by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the envgroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the envgroups"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync envgroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific envgroups by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List envgroups resources",
      arguments: z.object({
