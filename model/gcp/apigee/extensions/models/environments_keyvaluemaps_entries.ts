...
// Auto-generated extension model for @swamp/gcp/apigee/environments-keyvaluemaps-entries
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Environments.Keyvaluemaps.Entries.
 *
...
/** Swamp extension model for Google Cloud Apigee Environments.Keyvaluemaps.Entries. Registered at `@swamp/gcp/apigee/environments-keyvaluemaps-entries`. */
export const model = {
  type: "@swamp/gcp/apigee/environments-keyvaluemaps-entries",
  ...
  resources: {
    state: {
      description:
        "Key value map pair where the value represents the data associated with the co...",
      schema: StateSchema,
      lifetime: "infinite",
