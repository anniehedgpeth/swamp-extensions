...
/**
 * Swamp extension model for Google Cloud Apigee SecurityProfilesV2.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific securityProfilesV2 by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List securityProfilesV2 resources",
      arguments: z.object({
