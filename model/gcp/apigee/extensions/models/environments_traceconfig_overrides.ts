...
// Auto-generated extension model for @swamp/gcp/apigee/environments-traceconfig-overrides
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Environments.TraceConfig.Overrides.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/overrides/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  samplingConfig: z.object({
    sampler: z.enum(["SAMPLER_UNSPECIFIED", "OFF", "PROBABILITY"]).describe(
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["apiProxy"] !== undefined) body["apiProxy"] = g["apiProxy"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["samplingConfig"] !== undefined) {
          body["samplingConfig"] = g["samplingConfig"];
        }
    ...
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The name of the overrides"),
      }),
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific overrides by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync overrides state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific overrides by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List overrides resources",
      arguments: z.object({
