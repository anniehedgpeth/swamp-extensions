...
// Auto-generated extension model for @swamp/gcp/apigee/environments-sharedflows-deployments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Apigee Environments.Sharedflows.Deployments.
 *
...
/** Swamp extension model for Google Cloud Apigee Environments.Sharedflows.Deployments. Registered at `@swamp/gcp/apigee/environments-sharedflows-deployments`. */
export const model = {
  type: "@swamp/gcp/apigee/environments-sharedflows-deployments",
