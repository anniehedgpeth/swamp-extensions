...
/**
 * Swamp extension model for Google Cloud Apigee OptimizedHostStats.
 *
...
/** Swamp extension model for Google Cloud Apigee OptimizedHostStats. Registered at `@swamp/gcp/apigee/optimizedhoststats`. */
export const model = {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific optimizedHostStats by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
