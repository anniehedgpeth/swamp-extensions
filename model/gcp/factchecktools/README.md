...
Google Cloud factchecktools resources.
...
Use `swamp model type describe @swamp/gcp/factchecktools/pages` to see the full
...
```bash
# Create a new pages model
swamp model create @swamp/gcp/factchecktools/pages my-pages

# Edit the model to configure its properties
swamp model edit my-pages

# Create the resource in GCP
swamp model method run my-pages create

# Sync current state from GCP
swamp model method run my-pages sync
```
