...
Use `swamp model type describe @swamp/gcp/searchconsole/sitemaps` to see the
...
```bash
# Create a new sitemaps model
swamp model create @swamp/gcp/searchconsole/sitemaps my-sitemaps

# Edit the model to configure its properties
swamp model edit my-sitemaps

# Create the resource in GCP
swamp model method run my-sitemaps create

# Sync current state from GCP
swamp model method run my-sitemaps sync
```
