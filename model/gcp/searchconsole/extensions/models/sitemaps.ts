...
/**
 * Swamp extension model for Google Cloud Google Search Console Sitemaps.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sitemaps by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List sitemaps resources",
      arguments: z.object({
        sitemapIndex: z.string().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["sitemapIndex"] !== undefined) {
          params["sitemapIndex"] = String(args["sitemapIndex"]);
        }
