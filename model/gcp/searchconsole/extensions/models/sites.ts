...
// Auto-generated extension model for @swamp/gcp/searchconsole/sites
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Search Console Sites.
 *
...
/** Swamp extension model for Google Cloud Google Search Console Sites. Registered at `@swamp/gcp/searchconsole/sites`. */
export const model = {
  type: "@swamp/gcp/searchconsole/sites",
  ...
  resources: {
    state: {
      description:
        "Contains permission level information about a Search Console site. For more i...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      ...
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["siteUrl"] = args.identifier;
    ...
    add: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["siteUrl"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
