...
// Auto-generated extension model for @swamp/gcp/forms/forms-responses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Forms Forms.Responses.
 *
 * A form response.
 *
...
const GlobalArgsSchema = z.object({
  ...
  formId: z.string().describe("Required. The form ID."),
});
...
const InputsSchema = z.object({
  ...
  formId: z.string().describe("Required. The form ID.").optional(),
});
  ...
  methods: {
    get: {
      ...
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["responseId"] = args.identifier;
    ...
    list: {
      description: "List responses resources",
      arguments: z.object({
