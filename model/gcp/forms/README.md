...
Use `swamp model type describe @swamp/gcp/forms/forms_responses` to see the full
...
```bash
# Create a new forms_responses model
swamp model create @swamp/gcp/forms/forms_responses my-forms_responses

# Edit the model to configure its properties
swamp model edit my-forms_responses

# Create the resource in GCP
swamp model method run my-forms_responses create

# Sync current state from GCP
swamp model method run my-forms_responses sync
```
