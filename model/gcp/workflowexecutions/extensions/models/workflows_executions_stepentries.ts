...
// Auto-generated extension model for @swamp/gcp/workflowexecutions/workflows-executions-stepentries
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Workflow Executions Workflows.Executions.StepEntries.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/stepEntries/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  stepEntryMetadata: z.object({
    expectedIteration: z.string(),
    progressNumber: z.string(),
...
/** Swamp extension model for Google Cloud Workflow Executions Workflows.Executions.StepEntries. Registered at `@swamp/gcp/workflowexecutions/workflows-executions-stepentries`. */
export const model = {
  type: "@swamp/gcp/workflowexecutions/workflows-executions-stepentries",
  ...
  resources: {
    state: {
      description:
        "An StepEntry contains debugging information for a step transition in a workfl...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a stepEntries",
      arguments: z.object({
        identifier: z.string().describe("The name of the stepEntries"),
      }),
    ...
    sync: {
      description: "Sync stepEntries state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific stepEntries by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List stepEntries resources",
      arguments: z.object({
