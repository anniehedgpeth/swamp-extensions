...
Google Cloud workflowexecutions resources.
...
Use
`swamp model type describe @swamp/gcp/workflowexecutions/workflows_executions_callbacks`
...
```bash
# Create a new workflows_executions_callbacks model
swamp model create @swamp/gcp/workflowexecutions/workflows_executions_callbacks my-workflows_executions_callbacks

# Edit the model to configure its properties
swamp model edit my-workflows_executions_callbacks

# Create the resource in GCP
swamp model method run my-workflows_executions_callbacks create

# Sync current state from GCP
swamp model method run my-workflows_executions_callbacks sync
```
