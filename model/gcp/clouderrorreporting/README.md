...
Google Cloud clouderrorreporting resources.
...
Use `swamp model type describe @swamp/gcp/clouderrorreporting/events` to see the
...
swamp model create @swamp/gcp/clouderrorreporting/events my-events
