...
/**
 * Swamp extension model for Google Cloud Error Reporting Groups.
 *
...
/** Swamp extension model for Google Cloud Error Reporting Groups. Registered at `@swamp/gcp/clouderrorreporting/groups`. */
export const model = {
