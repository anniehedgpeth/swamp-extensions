...
Google Cloud firebasestorage resources.
...
Use `swamp model type describe @swamp/gcp/firebasestorage/buckets` to see the
...
```bash
# Create a new buckets model
swamp model create @swamp/gcp/firebasestorage/buckets my-buckets

# Edit the model to configure its properties
swamp model edit my-buckets

# Create the resource in GCP
swamp model method run my-buckets create

# Sync current state from GCP
swamp model method run my-buckets sync
```
