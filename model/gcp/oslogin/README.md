...
Google Cloud oslogin resources.
...
Use `swamp model type describe @swamp/gcp/oslogin/users_sshpublickeys` to see
...
```bash
# Create a new users_sshpublickeys model
swamp model create @swamp/gcp/oslogin/users_sshpublickeys my-users_sshpublickeys

# Edit the model to configure its properties
swamp model edit my-users_sshpublickeys

# Create the resource in GCP
swamp model method run my-users_sshpublickeys create

# Sync current state from GCP
swamp model method run my-users_sshpublickeys sync
```
