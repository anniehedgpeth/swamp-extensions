...
/**
 * Swamp extension model for Google Cloud Tool Results Histories.Executions.Steps.Thumbnails.
 *
...
const GlobalArgsSchema = z.object({
  ...
  executionId: z.string().describe("An Execution id. Required."),
  stepId: z.string().describe("A Step id. Required."),
});
...
const InputsSchema = z.object({
  ...
  executionId: z.string().describe("An Execution id. Required.").optional(),
  stepId: z.string().describe("A Step id. Required.").optional(),
});
...
/** Swamp extension model for Google Cloud Tool Results Histories.Executions.Steps.Thumbnails. Registered at `@swamp/gcp/toolresults/histories-executions-steps-thumbnails`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific thumbnails by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List thumbnails resources",
      arguments: z.object({
