...
Google Cloud toolresults resources.
...
Use
`swamp model type describe @swamp/gcp/toolresults/histories_executions_clusters`
...
```bash
# Create a new histories_executions_clusters model
swamp model create @swamp/gcp/toolresults/histories_executions_clusters my-histories_executions_clusters

# Edit the model to configure its properties
swamp model edit my-histories_executions_clusters

# Create the resource in GCP
swamp model method run my-histories_executions_clusters create

# Sync current state from GCP
swamp model method run my-histories_executions_clusters sync
```
