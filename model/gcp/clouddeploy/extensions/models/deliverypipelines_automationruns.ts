...
/**
 * Swamp extension model for Google Cloud Deploy DeliveryPipelines.AutomationRuns.
 *
...
/** Swamp extension model for Google Cloud Deploy DeliveryPipelines.AutomationRuns. Registered at `@swamp/gcp/clouddeploy/deliverypipelines-automationruns`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific automationRuns by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List automationRuns resources",
      arguments: z.object({
        filter: z.string().describe(
          "Filter automationRuns to be returned. All fields can be used in the filter.",
        ).optional(),
        orderBy: z.string().describe("Field to sort by.").optional(),
