...
Google Cloud clouddeploy resources.
...
Use `swamp model type describe @swamp/gcp/clouddeploy/customtargettypes` to see
...
```bash
# Create a new customtargettypes model
swamp model create @swamp/gcp/clouddeploy/customtargettypes my-customtargettypes

# Edit the model to configure its properties
swamp model edit my-customtargettypes

# Create the resource in GCP
swamp model method run my-customtargettypes create

# Sync current state from GCP
swamp model method run my-customtargettypes sync
```
