...
// Auto-generated extension model for @swamp/gcp/essentialcontacts/contacts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Essential Contacts Contacts.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/contacts/${shortName}`;
}

const BASE_URL = "https://essentialcontacts.googleapis.com/";
...
const GlobalArgsSchema = z.object({
  ...
  notificationCategorySubscriptions: z.array(
    z.enum([
...
const StateSchema = z.object({
  ...
  name: z.string(),
  notificationCategorySubscriptions: z.array(z.string()).optional(),
  validateTime: z.string().optional(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["languageTag"] !== undefined) {
          body["languageTag"] = g["languageTag"];
        }
    ...
    get: {
      description: "Get a contacts",
      arguments: z.object({
        identifier: z.string().describe("The name of the contacts"),
      }),
    ...
    update: {
      description: "Update contacts attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific contacts by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync contacts state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific contacts by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List contacts resources",
      arguments: z.object({
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "parameters": {
              "notificationCategories": { "location": "query" },
    ...
    send_test_message: {
      ...
      arguments: z.object({
        ...
        notificationCategory: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const baseUrl = g["apiEndpoint"]?.toString() ??
        ...
        if (args["notificationCategory"] !== undefined) {
          body["notificationCategory"] = args["notificationCategory"];
        }
        const result = await createResource(
          baseUrl,
          {
