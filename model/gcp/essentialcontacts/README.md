...
Google Cloud essentialcontacts resources.
...
Use `swamp model type describe @swamp/gcp/essentialcontacts/contacts` to see the
...
swamp model create @swamp/gcp/essentialcontacts/contacts my-contacts

# Edit the model to configure its properties
swamp model edit my-contacts

# Create the resource in GCP
swamp model method run my-contacts create

# Sync current state from GCP
swamp model method run my-contacts sync
```
