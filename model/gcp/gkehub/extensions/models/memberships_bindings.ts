...
// Auto-generated extension model for @swamp/gcp/gkehub/memberships-bindings
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud GKE Hub Memberships.Bindings.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "MembershipBinding is a subresource of a Membership, representing what Fleet S...",
      schema: StateSchema,
      lifetime: "infinite",
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific bindings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
