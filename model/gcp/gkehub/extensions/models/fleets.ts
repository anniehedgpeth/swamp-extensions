...
// Auto-generated extension model for @swamp/gcp/gkehub/fleets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud GKE Hub Fleets.
 *
...
const StateSchema = z.object({
  ...
  defaultClusterConfig: z.object({
    binaryAuthorizationConfig: z.object({
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a fleets",
      arguments: z.object({
        identifier: z.string().describe("The name of the fleets"),
      }),
    ...
    sync: {
      description: "Sync fleets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific fleets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List fleets resources",
      arguments: z.object({
