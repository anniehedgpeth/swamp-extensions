...
// Auto-generated extension model for @swamp/gcp/gkehub/scopes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud GKE Hub Scopes.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/scopes/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  name: z.string(),
  namespaceLabels: z.record(z.string(), z.unknown()).optional(),
  state: z.object({
    code: z.string(),
  }).optional(),
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific scopes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List scopes resources",
      arguments: z.object({
    ...
    list_memberships: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["scopeName"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "GET",
            "parameterOrder": ["scopeName"],
            "parameters": {
              "filter": { "location": "query" },
              "pageSize": { "location": "query" },
              "pageToken": { "location": "query" },
              "scopeName": { "location": "path", "required": true },
            },
          },
          params,
          undefined,
