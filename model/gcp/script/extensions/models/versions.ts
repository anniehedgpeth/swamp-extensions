...
/**
 * Swamp extension model for Google Cloud Apps Script Versions.
 *
...
/** Swamp extension model for Google Cloud Apps Script Versions. Registered at `@swamp/gcp/script/versions`. */
export const model = {
