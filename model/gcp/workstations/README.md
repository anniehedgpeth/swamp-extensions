...
Google Cloud workstations resources.
...
Use `swamp model type describe @swamp/gcp/workstations/locations` to see the
...
swamp model create @swamp/gcp/workstations/locations my-locations
