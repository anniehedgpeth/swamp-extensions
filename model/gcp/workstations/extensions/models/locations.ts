...
// Auto-generated extension model for @swamp/gcp/workstations/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Workstations Locations.
 *
...
const GET_CONFIG = {
  "id": "workstations.projects.locations.get",
  "path": "v1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
/** Swamp extension model for Google Cloud Workstations Locations. Registered at `@swamp/gcp/workstations/locations`. */
export const model = {
  type: "@swamp/gcp/workstations/locations",
