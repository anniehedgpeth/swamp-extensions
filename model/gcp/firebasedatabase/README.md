...
Google Cloud firebasedatabase resources.
...
Use `swamp model type describe @swamp/gcp/firebasedatabase/instances` to see the
...
swamp model create @swamp/gcp/firebasedatabase/instances my-instances
