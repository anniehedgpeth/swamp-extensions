...
// Auto-generated extension model for @swamp/gcp/firebasedatabase/instances
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase Realtime Database Management Instances.
 *
...
const BASE_URL = "https://firebasedatabase.googleapis.com/";
...
/** Swamp extension model for Google Cloud Firebase Realtime Database Management Instances. Registered at `@swamp/gcp/firebasedatabase/instances`. */
export const model = {
  type: "@swamp/gcp/firebasedatabase/instances",
  ...
  resources: {
    state: {
      description:
        "Representation of a Realtime Database instance. Details on interacting with c...",
      schema: StateSchema,
      lifetime: "infinite",
    ...
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["databaseId"] !== undefined) {
          params["databaseId"] = String(g["databaseId"]);
        }
        if (g["name"] !== undefined) {
