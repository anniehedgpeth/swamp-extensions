...
Google Cloud saasservicemgmt resources.
...
Use `swamp model type describe @swamp/gcp/saasservicemgmt/locations` to see the
...
swamp model create @swamp/gcp/saasservicemgmt/locations my-locations
