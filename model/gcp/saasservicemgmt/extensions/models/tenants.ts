...
// Auto-generated extension model for @swamp/gcp/saasservicemgmt/tenants
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud App Lifecycle Manager Tenants.
 *
...
const GlobalArgsSchema = z.object({
  ...
  tenantId: z.string().describe("Required. The ID value for the new tenant.")
    .optional(),
...
const StateSchema = z.object({
  ...
  consumerResource: z.string().optional(),
...
/** Swamp extension model for Google Cloud App Lifecycle Manager Tenants. Registered at `@swamp/gcp/saasservicemgmt/tenants`. */
export const model = {
  ...
  resources: {
    state: {
      description:
        "Tenant represents the service producer side of an instance of the service cre...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["consumerResource"] !== undefined) {
          body["consumerResource"] = g["consumerResource"];
        }
        ...
        if (g["tenantId"] !== undefined) {
          params["tenantId"] = String(g["tenantId"]);
        }
        if (g["name"] !== undefined) {
