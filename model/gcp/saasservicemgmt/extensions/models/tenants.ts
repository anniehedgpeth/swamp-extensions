...
/**
 * Swamp extension model for Google Cloud SaaS Runtime Tenants.
 *
...
/** Swamp extension model for Google Cloud SaaS Runtime Tenants. Registered at `@swamp/gcp/saasservicemgmt/tenants`. */
export const model = {
