...
Google Cloud alloydb resources.
...
Use `swamp model type describe @swamp/gcp/alloydb/backups` to see the full list
...
swamp model create @swamp/gcp/alloydb/backups my-backups
