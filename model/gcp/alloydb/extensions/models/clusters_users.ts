...
// Auto-generated extension model for @swamp/gcp/alloydb/clusters-users
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud AlloyDB Clusters.Users.
 *
...
const GlobalArgsSchema = z.object({
  ...
  keepExtraRoles: z.boolean().describe(
    "Input only. If the user already exists and it has additional roles, keep them granted.",
  ).optional(),
  password: z.string().describe("Input only. Password for the user.")
    .optional(),
  userType: z.enum([
...
const StateSchema = z.object({
  ...
  keepExtraRoles: z.boolean().optional(),
  name: z.string(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["keepExtraRoles"] !== undefined) {
          body["keepExtraRoles"] = g["keepExtraRoles"];
        }
