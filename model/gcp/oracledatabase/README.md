...
Use
`swamp model type describe @swamp/gcp/oracledatabase/autonomousdatabasebackups`
...
```bash
# Create a new autonomousdatabasebackups model
swamp model create @swamp/gcp/oracledatabase/autonomousdatabasebackups my-autonomousdatabasebackups

# Edit the model to configure its properties
swamp model edit my-autonomousdatabasebackups

# Create the resource in GCP
swamp model method run my-autonomousdatabasebackups create

# Sync current state from GCP
swamp model method run my-autonomousdatabasebackups sync
```
