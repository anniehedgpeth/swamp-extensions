...
// Auto-generated extension model for @swamp/gcp/oracledatabase/dbsystemshapes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Oracle Database@Google Cloud DbSystemShapes.
 *
...
const StateSchema = z.object({
  ...
  minDbNodeStoragePerNodeGb: z.number().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a dbSystemShapes",
      arguments: z.object({
        identifier: z.string().describe("The name of the dbSystemShapes"),
      }),
    ...
    sync: {
      description: "Sync dbSystemShapes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dbSystemShapes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
