...
// Auto-generated extension model for @swamp/gcp/oracledatabase/giversions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Oracle Database@Google Cloud GiVersions.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a giVersions",
      arguments: z.object({
        identifier: z.string().describe("The name of the giVersions"),
      }),
    ...
    sync: {
      description: "Sync giVersions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific giVersions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
