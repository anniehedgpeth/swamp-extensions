...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["goldengateConnectionAssignmentId"] !== undefined) {
          params["goldengateConnectionAssignmentId"] = String(
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific goldengateConnectionAssignments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List goldengateConnectionAssignments resources",
      arguments: z.object({
