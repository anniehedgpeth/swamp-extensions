...
// Auto-generated extension model for @swamp/gcp/oracledatabase/cloudexadatainfrastructures-dbservers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Oracle Database@Google Cloud CloudExadataInfrastructures.DbServers.
 *
...
const StateSchema = z.object({
  ...
  name: z.string(),
  properties: z.object({
    dbNodeIds: z.array(z.string()),
    dbNodeStorageSizeGb: z.number(),
    maxDbNodeStorageSizeGb: z.number(),
    maxMemorySizeGb: z.number(),
    maxOcpuCount: z.number(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Details of the database server resource. https://docs.oracle.com/en-us/iaas/a...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a dbServers",
      arguments: z.object({
        identifier: z.string().describe("The name of the dbServers"),
      }),
    ...
    sync: {
      description: "Sync dbServers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dbServers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List dbServers resources",
      arguments: z.object({
