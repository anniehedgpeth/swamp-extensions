...
// Auto-generated extension model for @swamp/gcp/oracledatabase/databasecharactersets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Oracle Database@Google Cloud DatabaseCharacterSets.
 *
...
/** Swamp extension model for Google Cloud Oracle Database@Google Cloud DatabaseCharacterSets. Registered at `@swamp/gcp/oracledatabase/databasecharactersets`. */
export const model = {
  type: "@swamp/gcp/oracledatabase/databasecharactersets",
  ...
  methods: {
    get: {
      description: "Get a databaseCharacterSets",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the databaseCharacterSets",
        ),
      }),
    ...
    sync: {
      description: "Sync databaseCharacterSets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific databaseCharacterSets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List databaseCharacterSets resources",
      arguments: z.object({
