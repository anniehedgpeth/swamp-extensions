...
// Auto-generated extension model for @swamp/gcp/oracledatabase/goldengateconnectiontypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Oracle Database@Google Cloud GoldengateConnectionTypes.
 *
...
const StateSchema = z.object({
  ...
  name: z.string(),
  technologyTypes: z.array(z.string()).optional(),
}).passthrough();
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a goldengateConnectionTypes",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the goldengateConnectionTypes",
        ),
      }),
    ...
    sync: {
      description: "Sync goldengateConnectionTypes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific goldengateConnectionTypes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List goldengateConnectionTypes resources",
      arguments: z.object({
