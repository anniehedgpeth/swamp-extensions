...
/**
 * Swamp extension model for Google Cloud Oracle Database@Google Cloud OdbNetworks.OdbSubnets.
 *
...
/** Swamp extension model for Google Cloud Oracle Database@Google Cloud OdbNetworks.OdbSubnets. Registered at `@swamp/gcp/oracledatabase/odbnetworks-odbsubnets`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["odbSubnetId"] !== undefined) {
          params["odbSubnetId"] = String(g["odbSubnetId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific odbSubnets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List odbSubnets resources",
      arguments: z.object({
