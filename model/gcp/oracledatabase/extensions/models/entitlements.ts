...
// Auto-generated extension model for @swamp/gcp/oracledatabase/entitlements
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Oracle Database@Google Cloud Entitlements.
 *
...
const StateSchema = z.object({
  cloudAccountDetails: z.object({
    accountCreationUri: z.string(),
    cloudAccount: z.string(),
    cloudAccountHomeRegion: z.string(),
    linkExistingAccountUri: z.string(),
  }).optional(),
...
/** Swamp extension model for Google Cloud Oracle Database@Google Cloud Entitlements. Registered at `@swamp/gcp/oracledatabase/entitlements`. */
export const model = {
  type: "@swamp/gcp/oracledatabase/entitlements",
