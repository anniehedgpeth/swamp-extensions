...
// Auto-generated extension model for @swamp/gcp/oracledatabase/databases
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Oracle Database@Google Cloud Databases.
 *
...
const StateSchema = z.object({
  ...
  dbHomeName: z.string().optional(),
  dbName: z.string().optional(),
  dbUniqueName: z.string().optional(),
  gcpOracleZone: z.string().optional(),
  name: z.string(),
  ncharacterSet: z.string().optional(),
  ociUrl: z.string().optional(),
  opsInsightsStatus: z.string().optional(),
  pluggableDatabaseId: z.string().optional(),
  pluggableDatabaseName: z.string().optional(),
  properties: z.object({
