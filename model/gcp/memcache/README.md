...
Google Cloud memcache resources.
...
Use `swamp model type describe @swamp/gcp/memcache/instances` to see the full
...
swamp model create @swamp/gcp/memcache/instances my-instances
