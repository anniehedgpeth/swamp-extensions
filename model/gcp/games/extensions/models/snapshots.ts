...
// Auto-generated extension model for @swamp/gcp/games/snapshots
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Games Services Snapshots.
 *
 * An snapshot object.
 *
...
const StateSchema = z.object({
  ...
  lastModifiedMillis: z.string().optional(),
...
/** Swamp extension model for Google Cloud Google Play Games Services Snapshots. Registered at `@swamp/gcp/games/snapshots`. */
export const model = {
  type: "@swamp/gcp/games/snapshots",
