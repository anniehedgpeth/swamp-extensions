...
// Auto-generated extension model for @swamp/gcp/games/achievementdefinitions
...
const StateSchema = z.object({
  ...
  formattedTotalSteps: z.string().optional(),
  id: z.string().optional(),
  initialState: z.string().optional(),
  isRevealedIconUrlDefault: z.boolean().optional(),
  isUnlockedIconUrlDefault: z.boolean().optional(),
  kind: z.string().optional(),
  name: z.string(),
  revealedIconUrl: z.string().optional(),
  totalSteps: z.number().optional(),
  unlockedIconUrl: z.string().optional(),
}).passthrough();
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a achievementDefinitions",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the achievementDefinitions",
        ),
      }),
    ...
    sync: {
      description: "Sync achievementDefinitions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific achievementDefinitions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List achievementDefinitions resources",
      arguments: z.object({
