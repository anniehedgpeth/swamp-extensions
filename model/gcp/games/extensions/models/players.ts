...
// Auto-generated extension model for @swamp/gcp/games/players
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Games Services Players.
 *
 * A Player resource.
 *
...
const StateSchema = z.object({
  ...
  bannerUrlLandscape: z.string().optional(),
  bannerUrlPortrait: z.string().optional(),
  ...
  friendStatus: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a players",
      arguments: z.object({
        identifier: z.string().describe("The name of the players"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["playerId"] = args.identifier;
    ...
    sync: {
      description: "Sync players state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific players by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List players resources",
      arguments: z.object({
    ...
    get_multiple_application_player_ids: {
      description: "get multiple application player ids",
      arguments: z.object({}),
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "GET",
            "parameterOrder": [],
            "parameters": { "applicationIds": { "location": "query" } },
          },
          params,
          undefined,
          undefined,
    ...
    get_scoped_player_ids: {
      description: "get scoped player ids",
      arguments: z.object({}),
      execute: async (_args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
