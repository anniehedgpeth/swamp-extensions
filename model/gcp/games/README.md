...
Use `swamp model type describe @swamp/gcp/games/achievementdefinitions` to see
...
```bash
# Create a new achievementdefinitions model
swamp model create @swamp/gcp/games/achievementdefinitions my-achievementdefinitions

# Edit the model to configure its properties
swamp model edit my-achievementdefinitions

# Create the resource in GCP
swamp model method run my-achievementdefinitions create

# Sync current state from GCP
swamp model method run my-achievementdefinitions sync
```
