...
Use `swamp model type describe @swamp/gcp/doubleclicksearch/conversion` to see
...
```bash
# Create a new conversion model
swamp model create @swamp/gcp/doubleclicksearch/conversion my-conversion

# Edit the model to configure its properties
swamp model edit my-conversion

# Create the resource in GCP
swamp model method run my-conversion create

# Sync current state from GCP
swamp model method run my-conversion sync
```
