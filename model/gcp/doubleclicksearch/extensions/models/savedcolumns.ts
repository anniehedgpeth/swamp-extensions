...
// Auto-generated extension model for @swamp/gcp/doubleclicksearch/savedcolumns
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Search Ads 360 SavedColumns.
 *
 * A saved column
 *
...
const StateSchema = z.object({
  ...
  savedColumnName: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a savedColumns",
      arguments: z.object({
        identifier: z.string().describe("The name of the savedColumns"),
      }),
    ...
    sync: {
      description: "Sync savedColumns state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific savedColumns by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List savedColumns resources",
      arguments: z.object({
