...
/**
 * Swamp extension model for Google Cloud Developer Connect InsightsConfigs.DeploymentEvents.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific deploymentEvents by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List deploymentEvents resources",
      arguments: z.object({
