...
/**
 * Swamp extension model for Google Cloud Developer Connect InsightsConfigs.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["insightsConfigId"] !== undefined) {
          params["insightsConfigId"] = String(g["insightsConfigId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific insightsConfigs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List insightsConfigs resources",
      arguments: z.object({
