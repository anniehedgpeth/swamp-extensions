...
Google Cloud workloadmanager resources.
...
Use
`swamp model type describe @swamp/gcp/workloadmanager/deployments_actuations` to
...
```bash
# Create a new deployments_actuations model
swamp model create @swamp/gcp/workloadmanager/deployments_actuations my-deployments_actuations

# Edit the model to configure its properties
swamp model edit my-deployments_actuations

# Create the resource in GCP
swamp model method run my-deployments_actuations create

# Sync current state from GCP
swamp model method run my-deployments_actuations sync
```
