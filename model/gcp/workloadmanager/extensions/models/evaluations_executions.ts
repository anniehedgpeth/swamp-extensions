...
// Auto-generated extension model for @swamp/gcp/workloadmanager/evaluations-executions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Workload Manager Evaluations.Executions.
 *
...
const StateSchema = z.object({
  ...
  externalDataSources: z.array(z.object({
    assetType: z.string(),
    name: z.string(),
    type: z.string(),
    uri: z.string(),
  })).optional(),
  inventoryTime: z.string().optional(),
...
/** Swamp extension model for Google Cloud Workload Manager Evaluations.Executions. Registered at `@swamp/gcp/workloadmanager/evaluations-executions`. */
export const model = {
  type: "@swamp/gcp/workloadmanager/evaluations-executions",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific executions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
