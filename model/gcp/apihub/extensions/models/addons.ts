...
// Auto-generated extension model for @swamp/gcp/apihub/addons
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud API hub Addons.
 *
 * Addon resource.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/addons/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a addons",
      arguments: z.object({
        identifier: z.string().describe("The name of the addons"),
      }),
    ...
    sync: {
      description: "Sync addons state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific addons by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List addons resources",
      arguments: z.object({
