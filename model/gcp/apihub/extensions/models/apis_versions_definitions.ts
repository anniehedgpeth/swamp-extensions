...
// Auto-generated extension model for @swamp/gcp/apihub/apis-versions-definitions
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Represents a definition for example schema, request, response definitions con...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a definitions",
      arguments: z.object({
        identifier: z.string().describe("The name of the definitions"),
      }),
    ...
    sync: {
      description: "Sync definitions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific definitions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
