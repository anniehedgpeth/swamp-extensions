...
/**
 * Swamp extension model for Google Cloud API hub ApiHubInstances.
 *
    ...
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["apiHubInstanceId"] !== undefined) {
          params["apiHubInstanceId"] = String(g["apiHubInstanceId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific apiHubInstances by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
