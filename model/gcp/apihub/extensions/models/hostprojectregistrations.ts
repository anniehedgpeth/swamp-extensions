...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["hostProjectRegistrationId"] !== undefined) {
          params["hostProjectRegistrationId"] = String(
            g["hostProjectRegistrationId"],
          );
        }
        if (g["name"] !== undefined) {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific hostProjectRegistrations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List hostProjectRegistrations resources",
      arguments: z.object({
