...
/**
 * Swamp extension model for Google Cloud API hub RuntimeProjectAttachments.
 *
...
/** Swamp extension model for Google Cloud API hub RuntimeProjectAttachments. Registered at `@swamp/gcp/apihub/runtimeprojectattachments`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["runtimeProjectAttachmentId"] !== undefined) {
          params["runtimeProjectAttachmentId"] = String(
            g["runtimeProjectAttachmentId"],
          );
        }
        if (g["name"] !== undefined) {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific runtimeProjectAttachments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List runtimeProjectAttachments resources",
      arguments: z.object({
