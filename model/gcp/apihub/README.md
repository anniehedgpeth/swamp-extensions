...
Use `swamp model type describe @swamp/gcp/apihub/addons` to see the full list of
...
```bash
# Create a new addons model
swamp model create @swamp/gcp/apihub/addons my-addons

# Edit the model to configure its properties
swamp model edit my-addons

# Create the resource in GCP
swamp model method run my-addons create

# Sync current state from GCP
swamp model method run my-addons sync
```
