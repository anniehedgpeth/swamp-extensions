...
Google Cloud playdeveloperreporting resources.
...
Use `swamp model type describe @swamp/gcp/playdeveloperreporting/anomalies` to
...
```bash
# Create a new anomalies model
swamp model create @swamp/gcp/playdeveloperreporting/anomalies my-anomalies

# Edit the model to configure its properties
swamp model edit my-anomalies

# Create the resource in GCP
swamp model method run my-anomalies create

# Sync current state from GCP
swamp model method run my-anomalies sync
```
