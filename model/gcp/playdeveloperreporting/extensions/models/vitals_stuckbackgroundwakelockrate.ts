...
// Auto-generated extension model for @swamp/gcp/playdeveloperreporting/vitals-stuckbackgroundwakelockrate
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Stuckbackgroundwakelockrate.
 *
...
/** Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Stuckbackgroundwakelockrate. Registered at `@swamp/gcp/playdeveloperreporting/vitals-stuckbackgroundwakelockrate`. */
export const model = {
  type: "@swamp/gcp/playdeveloperreporting/vitals-stuckbackgroundwakelockrate",
  ...
  methods: {
    get: {
      description: "Get a stuckbackgroundwakelockrate",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the stuckbackgroundwakelockrate",
        ),
      }),
    ...
    sync: {
      description: "Sync stuckbackgroundwakelockrate state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific stuckbackgroundwakelockrate by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
