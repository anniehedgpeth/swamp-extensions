...
// Auto-generated extension model for @swamp/gcp/playdeveloperreporting/vitals-slowrenderingrate
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Slowrenderingrate.
 *
...
/** Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Slowrenderingrate. Registered at `@swamp/gcp/playdeveloperreporting/vitals-slowrenderingrate`. */
export const model = {
  type: "@swamp/gcp/playdeveloperreporting/vitals-slowrenderingrate",
  ...
  resources: {
    state: {
      description:
        "Singleton resource representing the set of Slow Rendering metrics. This metri...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a slowrenderingrate",
      arguments: z.object({
        identifier: z.string().describe("The name of the slowrenderingrate"),
      }),
    ...
    sync: {
      description: "Sync slowrenderingrate state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific slowrenderingrate by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
