...
// Auto-generated extension model for @swamp/gcp/playdeveloperreporting/vitals-anrrate
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Anrrate.
 *
...
/** Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Anrrate. Registered at `@swamp/gcp/playdeveloperreporting/vitals-anrrate`. */
export const model = {
  ...
  resources: {
    state: {
      description:
        "Singleton resource representing the set of ANR (Application not responding) m...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a anrrate",
      arguments: z.object({
        identifier: z.string().describe("The name of the anrrate"),
      }),
    ...
    sync: {
      description: "Sync anrrate state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific anrrate by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
