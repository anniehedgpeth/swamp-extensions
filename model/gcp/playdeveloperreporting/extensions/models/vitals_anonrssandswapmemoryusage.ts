...
// Auto-generated extension model for @swamp/gcp/playdeveloperreporting/vitals-anonrssandswapmemoryusage
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Anonrssandswapmemoryusage.
 *
...
const GET_CONFIG = {
  "id": "playdeveloperreporting.vitals.anonrssandswapmemoryusage.get",
  "path": "v1beta1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
/** Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Anonrssandswapmemoryusage. Registered at `@swamp/gcp/playdeveloperreporting/vitals-anonrssandswapmemoryusage`. */
export const model = {
  type: "@swamp/gcp/playdeveloperreporting/vitals-anonrssandswapmemoryusage",
  ...
  resources: {
    state: {
      description:
        "Singleton resource representing the set of Anon RSS and Swap Memory Usage met...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a anonrssandswapmemoryusage",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the anonrssandswapmemoryusage",
        ),
      }),
    ...
    sync: {
      description: "Sync anonrssandswapmemoryusage state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific anonrssandswapmemoryusage by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    query: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          ...
          {
            "id":
              "playdeveloperreporting.vitals.anonrssandswapmemoryusage.query",
