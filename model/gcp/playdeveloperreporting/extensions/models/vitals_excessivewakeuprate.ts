...
// Auto-generated extension model for @swamp/gcp/playdeveloperreporting/vitals-excessivewakeuprate
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Excessivewakeuprate.
 *
...
/** Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Excessivewakeuprate. Registered at `@swamp/gcp/playdeveloperreporting/vitals-excessivewakeuprate`. */
export const model = {
  type: "@swamp/gcp/playdeveloperreporting/vitals-excessivewakeuprate",
  ...
  resources: {
    state: {
      description:
        "Singleton resource representing the set of Excessive Weakeups metrics. This m...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a excessivewakeuprate",
      arguments: z.object({
        identifier: z.string().describe("The name of the excessivewakeuprate"),
      }),
    ...
    sync: {
      description: "Sync excessivewakeuprate state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific excessivewakeuprate by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
