...
// Auto-generated extension model for @swamp/gcp/playdeveloperreporting/vitals-slowstartrate
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Slowstartrate.
 *
...
/** Swamp extension model for Google Cloud Google Play Developer Reporting Vitals.Slowstartrate. Registered at `@swamp/gcp/playdeveloperreporting/vitals-slowstartrate`. */
export const model = {
  type: "@swamp/gcp/playdeveloperreporting/vitals-slowstartrate",
  ...
  resources: {
    state: {
      description:
        "Singleton resource representing the set of Slow Start metrics. This metric se...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a slowstartrate",
      arguments: z.object({
        identifier: z.string().describe("The name of the slowstartrate"),
      }),
    ...
    sync: {
      description: "Sync slowstartrate state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific slowstartrate by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
