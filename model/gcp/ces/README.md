...
Use `swamp model type describe @swamp/gcp/ces/apps_agents` to see the full list
...
```bash
# Create a new apps_agents model
swamp model create @swamp/gcp/ces/apps_agents my-apps_agents

# Edit the model to configure its properties
swamp model edit my-apps_agents

# Create the resource in GCP
swamp model method run my-apps_agents create

# Sync current state from GCP
swamp model method run my-apps_agents sync
```
