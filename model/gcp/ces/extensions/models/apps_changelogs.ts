...
// Auto-generated extension model for @swamp/gcp/ces/apps-changelogs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Gemini Enterprise for Customer Experience Apps.Changelogs.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/changelogs/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  dependentResources: z.array(z.record(z.string(), z.unknown())).optional(),
  description: z.string().optional(),
  displayName: z.string().optional(),
  name: z.string(),
  newResource: z.record(z.string(), z.unknown()).optional(),
  originalResource: z.record(z.string(), z.unknown()).optional(),
...
/** Swamp extension model for Google Cloud Gemini Enterprise for Customer Experience Apps.Changelogs. Registered at `@swamp/gcp/ces/apps-changelogs`. */
export const model = {
  type: "@swamp/gcp/ces/apps-changelogs",
  ...
  methods: {
    get: {
      description: "Get a changelogs",
      arguments: z.object({
        identifier: z.string().describe("The name of the changelogs"),
      }),
    ...
    sync: {
      description: "Sync changelogs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific changelogs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
