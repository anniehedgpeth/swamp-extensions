...
// Auto-generated extension model for @swamp/gcp/ces/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Gemini Enterprise for Customer Experience Locations.
 *
...
/** Swamp extension model for Google Cloud Gemini Enterprise for Customer Experience Locations. Registered at `@swamp/gcp/ces/locations`. */
export const model = {
  type: "@swamp/gcp/ces/locations",
