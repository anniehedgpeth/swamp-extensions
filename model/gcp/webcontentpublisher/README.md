...
Use `swamp model type describe @swamp/gcp/webcontentpublisher/publications_ctas`
...
```bash
# Create a new publications_ctas model
swamp model create @swamp/gcp/webcontentpublisher/publications_ctas my-publications_ctas

# Edit the model to configure its properties
swamp model edit my-publications_ctas

# Create the resource in GCP
swamp model method run my-publications_ctas create

# Sync current state from GCP
swamp model method run my-publications_ctas sync
```
