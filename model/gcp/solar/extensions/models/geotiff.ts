...
// Auto-generated extension model for @swamp/gcp/solar/geotiff
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Solar GeoTiff.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a geoTiff",
      arguments: z.object({
        identifier: z.string().describe("The name of the geoTiff"),
      }),
    ...
    sync: {
      description: "Sync geoTiff state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific geoTiff by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
