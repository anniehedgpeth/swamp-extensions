...
Use `swamp model type describe @swamp/gcp/solar/datalayers` to see the full list
...
```bash
# Create a new datalayers model
swamp model create @swamp/gcp/solar/datalayers my-datalayers

# Edit the model to configure its properties
swamp model edit my-datalayers

# Create the resource in GCP
swamp model method run my-datalayers create

# Sync current state from GCP
swamp model method run my-datalayers sync
```
