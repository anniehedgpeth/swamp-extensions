...
// Auto-generated extension model for @swamp/gcp/managedkafka/schemaregistries-schemas-versions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Schemas.Versions.
 *
...
/** Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Schemas.Versions. Registered at `@swamp/gcp/managedkafka/schemaregistries-schemas-versions`. */
export const model = {
  type: "@swamp/gcp/managedkafka/schemaregistries-schemas-versions",
