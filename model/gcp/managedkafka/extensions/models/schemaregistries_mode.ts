...
// Auto-generated extension model for @swamp/gcp/managedkafka/schemaregistries-mode
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Mode.
 *
...
const GlobalArgsSchema = z.object({
  ...
  mode: z.enum(["NONE", "READONLY", "READWRITE", "IMPORT"]).describe(
...
/** Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Mode. Registered at `@swamp/gcp/managedkafka/schemaregistries-mode`. */
export const model = {
  type: "@swamp/gcp/managedkafka/schemaregistries-mode",
  ...
  resources: {
    state: {
      description:
        "SchemaMode represents the mode of a schema registry or a specific subject. Fo...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The name of the mode"),
      }),
    ...
    update: {
      description: "Update mode attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific mode by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync mode state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific mode by name (e.g. one discovered by list)",
        ).optional(),
