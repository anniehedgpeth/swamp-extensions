...
// Auto-generated extension model for @swamp/gcp/managedkafka/schemaregistries-contexts-subjects
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Contexts.Subjects.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "List subjects in the schema registry. The response will be an array of subjec...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    lookup_version: {
      ...
      arguments: z.object({
        ...
        normalize: z.any().optional(),
        references: z.any().optional(),
        schema: z.any().optional(),
        schemaType: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
