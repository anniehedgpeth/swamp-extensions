...
/**
 * Swamp extension model for Google Cloud Managed Service for Apache Kafka Clusters.Topics.
 *
...
/** Swamp extension model for Google Cloud Managed Service for Apache Kafka Clusters.Topics. Registered at `@swamp/gcp/managedkafka/clusters-topics`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["topicId"] !== undefined) {
          params["topicId"] = String(g["topicId"]);
        }
