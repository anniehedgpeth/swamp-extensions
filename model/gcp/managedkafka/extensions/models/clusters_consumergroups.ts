...
// Auto-generated extension model for @swamp/gcp/managedkafka/clusters-consumergroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Apache Kafka Clusters.ConsumerGroups.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/consumerGroups/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Managed Service for Apache Kafka Clusters.ConsumerGroups. Registered at `@swamp/gcp/managedkafka/clusters-consumergroups`. */
export const model = {
  type: "@swamp/gcp/managedkafka/clusters-consumergroups",
  ...
  methods: {
    get: {
      description: "Get a consumerGroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the consumerGroups"),
      }),
    ...
    update: {
      description: "Update consumerGroups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific consumerGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the consumerGroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the consumerGroups"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync consumerGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific consumerGroups by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List consumerGroups resources",
      arguments: z.object({
