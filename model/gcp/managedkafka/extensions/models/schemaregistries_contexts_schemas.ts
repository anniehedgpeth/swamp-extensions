...
// Auto-generated extension model for @swamp/gcp/managedkafka/schemaregistries-contexts-schemas
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Contexts.Schemas.
 *
...
/** Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Contexts.Schemas. Registered at `@swamp/gcp/managedkafka/schemaregistries-contexts-schemas`. */
export const model = {
  type: "@swamp/gcp/managedkafka/schemaregistries-contexts-schemas",
