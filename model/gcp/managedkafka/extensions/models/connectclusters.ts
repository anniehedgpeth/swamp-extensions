...
/**
 * Swamp extension model for Google Cloud Managed Service for Apache Kafka ConnectClusters.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["connectClusterId"] !== undefined) {
          params["connectClusterId"] = String(g["connectClusterId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific connectClusters by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List connectClusters resources",
      arguments: z.object({
