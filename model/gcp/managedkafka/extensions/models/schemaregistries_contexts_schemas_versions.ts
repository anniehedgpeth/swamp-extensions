...
// Auto-generated extension model for @swamp/gcp/managedkafka/schemaregistries-contexts-schemas-versions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Contexts.Schemas.Versions.
 *
...
/** Swamp extension model for Google Cloud Managed Service for Apache Kafka SchemaRegistries.Contexts.Schemas.Versions. Registered at `@swamp/gcp/managedkafka/schemaregistries-contexts-schemas-versions`. */
export const model = {
  type: "@swamp/gcp/managedkafka/schemaregistries-contexts-schemas-versions",
  ...
  resources: {
    state: {
      description:
        "List the schema versions for the given schema id. The response will be an arr...",
      schema: StateSchema,
      lifetime: "infinite",
