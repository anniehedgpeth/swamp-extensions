...
Google Cloud managedkafka resources.
...
Use `swamp model type describe @swamp/gcp/managedkafka/clusters_acls` to see the
...
```bash
# Create a new clusters_acls model
swamp model create @swamp/gcp/managedkafka/clusters_acls my-clusters_acls

# Edit the model to configure its properties
swamp model edit my-clusters_acls

# Create the resource in GCP
swamp model method run my-clusters_acls create

# Sync current state from GCP
swamp model method run my-clusters_acls sync
```
