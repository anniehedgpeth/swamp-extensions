...
Google Cloud datastream resources.
...
Use `swamp model type describe @swamp/gcp/datastream/connectionprofiles` to see
...
swamp model create @swamp/gcp/datastream/connectionprofiles my-connectionprofiles
