...
// Auto-generated extension model for @swamp/gcp/datastream/privateconnections-routes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Datastream PrivateConnections.Routes.
 *
...
const GlobalArgsSchema = z.object({
  ...
  destinationPort: z.number().int().describe("Destination port for connection")
    .optional(),
  ...
  routeId: z.string().describe("Required. The Route identifier.").optional(),
...
/** Swamp extension model for Google Cloud Datastream PrivateConnections.Routes. Registered at `@swamp/gcp/datastream/privateconnections-routes`. */
export const model = {
  type: "@swamp/gcp/datastream/privateconnections-routes",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["destinationAddress"] !== undefined) {
          body["destinationAddress"] = g["destinationAddress"];
        }
        if (g["destinationPort"] !== undefined) {
          body["destinationPort"] = g["destinationPort"];
        }
        ...
        if (g["routeId"] !== undefined) {
          params["routeId"] = String(g["routeId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific routes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
