...
// Auto-generated extension model for @swamp/gcp/streetviewpublish/photosequences
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Street View Publish PhotoSequences.
 *
...
/** Swamp extension model for Google Cloud Street View Publish PhotoSequences. Registered at `@swamp/gcp/streetviewpublish/photosequences`. */
export const model = {
  type: "@swamp/gcp/streetviewpublish/photosequences",
  ...
  methods: {
    get: {
      description: "Get a photoSequences",
      arguments: z.object({
        identifier: z.string().describe("The name of the photoSequences"),
      }),
    ...
    sync: {
      description: "Sync photoSequences state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific photoSequences by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List photoSequences resources",
      arguments: z.object({
