...
Google Cloud streetviewpublish resources.
...
Use `swamp model type describe @swamp/gcp/streetviewpublish/photo` to see the
...
swamp model create @swamp/gcp/streetviewpublish/photo my-photo

# Edit the model to configure its properties
swamp model edit my-photo

# Create the resource in GCP
swamp model method run my-photo create

# Sync current state from GCP
swamp model method run my-photo sync
```
