...
Use
`swamp model type describe @swamp/gcp/identitytoolkit/defaultsupportedidpconfigs`
...
```bash
# Create a new defaultsupportedidpconfigs model
swamp model create @swamp/gcp/identitytoolkit/defaultsupportedidpconfigs my-defaultsupportedidpconfigs

# Edit the model to configure its properties
swamp model edit my-defaultsupportedidpconfigs

# Create the resource in GCP
swamp model method run my-defaultsupportedidpconfigs create

# Sync current state from GCP
swamp model method run my-defaultsupportedidpconfigs sync
```
