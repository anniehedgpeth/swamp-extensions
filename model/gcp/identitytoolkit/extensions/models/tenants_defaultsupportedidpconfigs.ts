...
// Auto-generated extension model for @swamp/gcp/identitytoolkit/tenants-defaultsupportedidpconfigs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Identity Toolkit Tenants.DefaultSupportedIdpConfigs.
 *
...
/** Swamp extension model for Google Cloud Identity Toolkit Tenants.DefaultSupportedIdpConfigs. Registered at `@swamp/gcp/identitytoolkit/tenants-defaultsupportedidpconfigs`. */
export const model = {
  type: "@swamp/gcp/identitytoolkit/tenants-defaultsupportedidpconfigs",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["idpId"] !== undefined) params["idpId"] = String(g["idpId"]);
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific defaultSupportedIdpConfigs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
