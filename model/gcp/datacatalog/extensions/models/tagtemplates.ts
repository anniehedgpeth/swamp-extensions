...
/**
 * Swamp extension model for Google Cloud Google Cloud Data Catalog TagTemplates.
 *
    ...
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["tagTemplateId"] !== undefined) {
          params["tagTemplateId"] = String(g["tagTemplateId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific tagTemplates by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
