...
// Auto-generated extension model for @swamp/gcp/datacatalog/taxonomies-policytags
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Cloud Data Catalog Taxonomies.PolicyTags.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/policyTags/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  parentPolicyTag: z.string().describe(
...
const StateSchema = z.object({
  childPolicyTags: z.array(z.string()).optional(),
  description: z.string().optional(),
  displayName: z.string().optional(),
  name: z.string(),
  parentPolicyTag: z.string().optional(),
}).passthrough();
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Denotes one policy tag in a taxonomy, for example, SSN. Policy tags can be de...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a policyTags",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["parentPolicyTag"] !== undefined) {
          body["parentPolicyTag"] = g["parentPolicyTag"];
        }
    ...
    get: {
      description: "Get a policyTags",
      arguments: z.object({
        identifier: z.string().describe("The name of the policyTags"),
      }),
    ...
    update: {
      description: "Update policyTags attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific policyTags by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the policyTags",
      arguments: z.object({
        identifier: z.string().describe("The name of the policyTags"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync policyTags state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific policyTags by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List policyTags resources",
      arguments: z.object({
