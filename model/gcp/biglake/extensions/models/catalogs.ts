...
/**
 * Swamp extension model for Google Cloud BigLake Catalogs.
 *
...
/** Swamp extension model for Google Cloud BigLake Catalogs. Registered at `@swamp/gcp/biglake/catalogs`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["catalogId"] !== undefined) {
          params["catalogId"] = String(g["catalogId"]);
        }
        if (g["name"] !== undefined) {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific catalogs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
