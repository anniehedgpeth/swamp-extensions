...
Google Cloud biglake resources.
...
Use `swamp model type describe @swamp/gcp/biglake/catalogs_databases_tables` to
...
```bash
# Create a new catalogs_databases_tables model
swamp model create @swamp/gcp/biglake/catalogs_databases_tables my-catalogs_databases_tables

# Edit the model to configure its properties
swamp model edit my-catalogs_databases_tables

# Create the resource in GCP
swamp model method run my-catalogs_databases_tables create

# Sync current state from GCP
swamp model method run my-catalogs_databases_tables sync
```
