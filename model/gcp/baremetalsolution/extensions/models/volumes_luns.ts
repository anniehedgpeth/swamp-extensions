...
// Auto-generated extension model for @swamp/gcp/baremetalsolution/volumes-luns
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Bare Metal Solution Volumes.Luns.
 *
...
const StateSchema = z.object({
  bootLun: z.boolean().optional(),
  expireTime: z.string().optional(),
  id: z.string().optional(),
  instances: z.array(z.string()).optional(),
  multiprotocolType: z.string().optional(),
  name: z.string(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a luns",
      arguments: z.object({
        identifier: z.string().describe("The name of the luns"),
      }),
    ...
    sync: {
      description: "Sync luns state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific luns by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List luns resources",
      arguments: z.object({
