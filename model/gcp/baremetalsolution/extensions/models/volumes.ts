...
/**
 * Swamp extension model for Google Cloud Bare Metal Solution Volumes.
 *
 * A storage volume.
 *
...
/** Swamp extension model for Google Cloud Bare Metal Solution Volumes. Registered at `@swamp/gcp/baremetalsolution/volumes`. */
export const model = {
