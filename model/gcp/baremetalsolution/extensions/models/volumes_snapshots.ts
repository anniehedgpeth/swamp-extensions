...
// Auto-generated extension model for @swamp/gcp/baremetalsolution/volumes-snapshots
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Bare Metal Solution Volumes.Snapshots.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/snapshots/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("The description of the snapshot.")
    .optional(),
  name: z.string().describe("The name of the snapshot.").optional(),
...
const StateSchema = z.object({
  ...
  name: z.string(),
  storageVolume: z.string().optional(),
...
/** Swamp extension model for Google Cloud Bare Metal Solution Volumes.Snapshots. Registered at `@swamp/gcp/baremetalsolution/volumes-snapshots`. */
export const model = {
  type: "@swamp/gcp/baremetalsolution/volumes-snapshots",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific snapshots by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    restore_volume_snapshot: {
      description: "restore volume snapshot",
      arguments: z.object({}),
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["volumeSnapshot"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["volumeSnapshot"],
            "parameters": {
              "volumeSnapshot": { "location": "path", "required": true },
            },
          },
          params,
          {},
