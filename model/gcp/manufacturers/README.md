...
Google Cloud manufacturers resources.
...
Use
`swamp model type describe @swamp/gcp/manufacturers/accounts_languages_productcertifications`
...
```bash
# Create a new accounts_languages_productcertifications model
swamp model create @swamp/gcp/manufacturers/accounts_languages_productcertifications my-accounts_languages_productcertifications

# Edit the model to configure its properties
swamp model edit my-accounts_languages_productcertifications

# Create the resource in GCP
swamp model method run my-accounts_languages_productcertifications create

# Sync current state from GCP
swamp model method run my-accounts_languages_productcertifications sync
```
