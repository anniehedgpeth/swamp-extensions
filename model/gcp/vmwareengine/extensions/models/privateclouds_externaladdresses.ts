...
// Auto-generated extension model for @swamp/gcp/vmwareengine/privateclouds-externaladdresses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VMware Engine PrivateClouds.ExternalAddresses.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/externalAddresses/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  internalIp: z.string().describe("The internal IP address of a workload VM.")
    .optional(),
  externalAddressId: z.string().describe(
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a externalAddresses",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["externalAddressId"] !== undefined) {
          params["externalAddressId"] = String(g["externalAddressId"]);
        }
    ...
    get: {
      description: "Get a externalAddresses",
      arguments: z.object({
        identifier: z.string().describe("The name of the externalAddresses"),
      }),
    ...
    update: {
      description: "Update externalAddresses attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific externalAddresses by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the externalAddresses",
      arguments: z.object({
        identifier: z.string().describe("The name of the externalAddresses"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync externalAddresses state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific externalAddresses by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List externalAddresses resources",
      arguments: z.object({
