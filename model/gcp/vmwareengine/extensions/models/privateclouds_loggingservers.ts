...
// Auto-generated extension model for @swamp/gcp/vmwareengine/privateclouds-loggingservers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VMware Engine PrivateClouds.LoggingServers.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/loggingServers/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  protocol: z.enum(["PROTOCOL_UNSPECIFIED", "UDP", "TCP", "TLS", "SSL", "RELP"])
    .describe(
      "Required. Protocol used by vCenter to send logs to a logging server.",
    ).optional(),
  sourceType: z.enum(["SOURCE_TYPE_UNSPECIFIED", "ESXI", "VCSA"]).describe(
    "Required. The type of component that produces logs that will be forwarded to this logging server.",
  ).optional(),
  loggingServerId: z.string().describe(
...
/** Swamp extension model for Google Cloud VMware Engine PrivateClouds.LoggingServers. Registered at `@swamp/gcp/vmwareengine/privateclouds-loggingservers`. */
export const model = {
  type: "@swamp/gcp/vmwareengine/privateclouds-loggingservers",
  ...
  methods: {
    create: {
      description: "Create a loggingServers",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["loggingServerId"] !== undefined) {
          params["loggingServerId"] = String(g["loggingServerId"]);
        }
    ...
    get: {
      description: "Get a loggingServers",
      arguments: z.object({
        identifier: z.string().describe("The name of the loggingServers"),
      }),
    ...
    update: {
      description: "Update loggingServers attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific loggingServers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the loggingServers",
      arguments: z.object({
        identifier: z.string().describe("The name of the loggingServers"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync loggingServers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific loggingServers by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List loggingServers resources",
      arguments: z.object({
