...
// Auto-generated extension model for @swamp/gcp/vmwareengine/privateclouds-subnets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VMware Engine PrivateClouds.Subnets.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/subnets/${shortName}`;
}
...
/** Swamp extension model for Google Cloud VMware Engine PrivateClouds.Subnets. Registered at `@swamp/gcp/vmwareengine/privateclouds-subnets`. */
export const model = {
  type: "@swamp/gcp/vmwareengine/privateclouds-subnets",
  ...
  methods: {
    get: {
      description: "Get a subnets",
      arguments: z.object({
        identifier: z.string().describe("The name of the subnets"),
      }),
    ...
    update: {
      description: "Update subnets attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific subnets by name (e.g. one discovered by list)",
        ).optional(),
      ...
      execute: async (
        ...
        const result = await updateResource(
          ...
          (args.waitForReady ?? true)
            ? {
              "statusField": "state",
              "readyValues": ["ACTIVE", "RECONCILING"],
              "failedValues": ["FAILED"],
            }
            : undefined,
          credentials,
    ...
    sync: {
      description: "Sync subnets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific subnets by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List subnets resources",
      arguments: z.object({
