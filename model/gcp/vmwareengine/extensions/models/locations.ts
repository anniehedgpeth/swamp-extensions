...
// Auto-generated extension model for @swamp/gcp/vmwareengine/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VMware Engine Locations.
 *
...
/** Swamp extension model for Google Cloud VMware Engine Locations. Registered at `@swamp/gcp/vmwareengine/locations`. */
export const model = {
  type: "@swamp/gcp/vmwareengine/locations",
  ...
  methods: {
    ...
    get_dns_bind_permission: {
      description: "get dns bind permission",
      arguments: z.object({}),
