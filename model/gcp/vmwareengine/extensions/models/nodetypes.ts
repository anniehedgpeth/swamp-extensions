...
// Auto-generated extension model for @swamp/gcp/vmwareengine/nodetypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VMware Engine NodeTypes.
 *
 * Describes node type.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/nodeTypes/${shortName}`;
}
...
const StateSchema = z.object({
  availableCustomCoreCounts: z.array(z.number()).optional(),
  ...
  totalCoreCount: z.number().optional(),
  virtualCpuCount: z.number().optional(),
}).passthrough();
...
/** Swamp extension model for Google Cloud VMware Engine NodeTypes. Registered at `@swamp/gcp/vmwareengine/nodetypes`. */
export const model = {
  type: "@swamp/gcp/vmwareengine/nodetypes",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific nodeTypes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List nodeTypes resources",
      arguments: z.object({
