...
// Auto-generated extension model for @swamp/gcp/vmwareengine/vmwareenginenetworks
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VMware Engine VmwareEngineNetworks.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/vmwareEngineNetworks/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  type: z.enum(["TYPE_UNSPECIFIED", "LEGACY", "STANDARD"]).describe(
  ...
  vmwareEngineNetworkId: z.string().describe(
...
/** Swamp extension model for Google Cloud VMware Engine VmwareEngineNetworks. Registered at `@swamp/gcp/vmwareengine/vmwareenginenetworks`. */
export const model = {
  type: "@swamp/gcp/vmwareengine/vmwareenginenetworks",
  ...
  resources: {
    state: {
      description:
        "VMware Engine network resource that provides connectivity for VMware Engine p...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a vmwareEngineNetworks",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["vmwareEngineNetworkId"] !== undefined) {
          params["vmwareEngineNetworkId"] = String(g["vmwareEngineNetworkId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a vmwareEngineNetworks",
      arguments: z.object({
        identifier: z.string().describe("The name of the vmwareEngineNetworks"),
      }),
    ...
    update: {
      description: "Update vmwareEngineNetworks attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific vmwareEngineNetworks by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the vmwareEngineNetworks",
      arguments: z.object({
        identifier: z.string().describe("The name of the vmwareEngineNetworks"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync vmwareEngineNetworks state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific vmwareEngineNetworks by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List vmwareEngineNetworks resources",
      arguments: z.object({
