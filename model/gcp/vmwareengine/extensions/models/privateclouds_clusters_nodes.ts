...
// Auto-generated extension model for @swamp/gcp/vmwareengine/privateclouds-clusters-nodes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VMware Engine PrivateClouds.Clusters.Nodes.
 *
 * Node in a cluster.
 *
...
const StateSchema = z.object({
  customCoreCount: z.string().optional(),
...
/** Swamp extension model for Google Cloud VMware Engine PrivateClouds.Clusters.Nodes. Registered at `@swamp/gcp/vmwareengine/privateclouds-clusters-nodes`. */
export const model = {
  type: "@swamp/gcp/vmwareengine/privateclouds-clusters-nodes",
