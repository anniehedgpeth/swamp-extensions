...
/**
 * Swamp extension model for Google Cloud VMware Engine NetworkPolicies.ExternalAccessRules.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["externalAccessRuleId"] !== undefined) {
          params["externalAccessRuleId"] = String(g["externalAccessRuleId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific externalAccessRules by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List externalAccessRules resources",
      arguments: z.object({
