...
// Auto-generated extension model for @swamp/gcp/vmwareengine/announcements
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VMware Engine Announcements.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/announcements/${shortName}`;
}

const BASE_URL = "https://vmwareengine.googleapis.com/";

const GET_CONFIG = {
  "id": "vmwareengine.projects.locations.announcements.get",
  "path": "v1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "vmwareengine.projects.locations.announcements.list",
...
const StateSchema = z.object({
  ...
  name: z.string(),
  privateCloud: z.string().optional(),
...
/** Swamp extension model for Google Cloud VMware Engine Announcements. Registered at `@swamp/gcp/vmwareengine/announcements`. */
export const model = {
  type: "@swamp/gcp/vmwareengine/announcements",
  ...
  methods: {
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The name of the announcements"),
      }),
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific announcements by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
