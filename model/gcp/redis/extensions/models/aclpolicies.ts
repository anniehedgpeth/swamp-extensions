...
// Auto-generated extension model for @swamp/gcp/redis/aclpolicies
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Cloud Memorystore for Redis AclPolicies.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/aclPolicies/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  name: z.string().describe("Identifier. Full resource path of the ACL policy.")
    .optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a aclPolicies",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["aclPolicyId"] !== undefined) {
          params["aclPolicyId"] = String(g["aclPolicyId"]);
        }
    ...
    get: {
      description: "Get a aclPolicies",
      arguments: z.object({
        identifier: z.string().describe("The name of the aclPolicies"),
      }),
    ...
    update: {
      description: "Update aclPolicies attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific aclPolicies by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the aclPolicies",
      arguments: z.object({
        identifier: z.string().describe("The name of the aclPolicies"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync aclPolicies state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific aclPolicies by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List aclPolicies resources",
      arguments: z.object({
