...
// Auto-generated extension model for @swamp/gcp/redis/clusters-tokenauthusers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Cloud Memorystore for Redis Clusters.TokenAuthUsers.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/tokenAuthUsers/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a tokenAuthUsers",
      arguments: z.object({
        identifier: z.string().describe("The name of the tokenAuthUsers"),
      }),
    ...
    delete: {
      description: "Delete the tokenAuthUsers",
      arguments: z.object({
        identifier: z.string().describe("The name of the tokenAuthUsers"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync tokenAuthUsers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific tokenAuthUsers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List tokenAuthUsers resources",
      arguments: z.object({
    ...
    add_auth_token: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["tokenAuthUser"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["tokenAuthUser"],
            "parameters": {
              "tokenAuthUser": { "location": "path", "required": true },
            },
          },
          params,
          body,
