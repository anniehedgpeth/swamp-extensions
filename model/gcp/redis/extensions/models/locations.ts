...
// Auto-generated extension model for @swamp/gcp/redis/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Cloud Memorystore for Redis Locations.
 *
...
/** Swamp extension model for Google Cloud Google Cloud Memorystore for Redis Locations. Registered at `@swamp/gcp/redis/locations`. */
export const model = {
  type: "@swamp/gcp/redis/locations",
  ...
  methods: {
    ...
    get_shared_regional_certificate_authority: {
      description: "get shared regional certificate authority",
      arguments: z.object({}),
