...
// Auto-generated extension model for @swamp/gcp/redis/backupcollections-backups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Cloud Memorystore for Redis BackupCollections.Backups.
 *
 * Backup of a cluster.
 *
...
/** Swamp extension model for Google Cloud Google Cloud Memorystore for Redis BackupCollections.Backups. Registered at `@swamp/gcp/redis/backupcollections-backups`. */
export const model = {
  type: "@swamp/gcp/redis/backupcollections-backups",
  ...
  methods: {
    ...
    export: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["gcsBucket"] !== undefined) {
          body["gcsBucket"] = args["gcsBucket"];
        }
