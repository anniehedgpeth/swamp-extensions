...
// Auto-generated extension model for @swamp/gcp/redis/clusters-tokenauthusers-authtokens
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Cloud Memorystore for Redis Clusters.TokenAuthUsers.AuthTokens.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/authTokens/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a authTokens",
      arguments: z.object({
        identifier: z.string().describe("The name of the authTokens"),
      }),
    ...
    delete: {
      description: "Delete the authTokens",
      arguments: z.object({
        identifier: z.string().describe("The name of the authTokens"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync authTokens state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific authTokens by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List authTokens resources",
      arguments: z.object({
