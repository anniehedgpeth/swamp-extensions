...
Use `swamp model type describe @swamp/gcp/customsearch/cse_siterestrict` to see
...
```bash
# Create a new cse_siterestrict model
swamp model create @swamp/gcp/customsearch/cse_siterestrict my-cse_siterestrict

# Edit the model to configure its properties
swamp model edit my-cse_siterestrict

# Create the resource in GCP
swamp model method run my-cse_siterestrict create

# Sync current state from GCP
swamp model method run my-cse_siterestrict sync
```
