...
Google Cloud youtubereporting resources.
...
Use `swamp model type describe @swamp/gcp/youtubereporting/jobs_reports` to see
...
```bash
# Create a new jobs_reports model
swamp model create @swamp/gcp/youtubereporting/jobs_reports my-jobs_reports

# Edit the model to configure its properties
swamp model edit my-jobs_reports

# Create the resource in GCP
swamp model method run my-jobs_reports create

# Sync current state from GCP
swamp model method run my-jobs_reports sync
```
