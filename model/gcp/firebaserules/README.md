...
Google Cloud firebaserules resources.
...
Use `swamp model type describe @swamp/gcp/firebaserules/releases` to see the
...
```bash
# Create a new releases model
swamp model create @swamp/gcp/firebaserules/releases my-releases

# Edit the model to configure its properties
swamp model edit my-releases

# Create the resource in GCP
swamp model method run my-releases create

# Sync current state from GCP
swamp model method run my-releases sync
```
