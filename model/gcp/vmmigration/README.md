...
Google Cloud vmmigration resources.
...
Use `swamp model type describe @swamp/gcp/vmmigration/groups` to see the full
...
swamp model create @swamp/gcp/vmmigration/groups my-groups
