...
// Auto-generated extension model for @swamp/gcp/vmmigration/groups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VM Migration Groups.
 *
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("User-provided description of the group.")
    .optional(),
  displayName: z.string().describe(
    "Display name is a user defined name for this group which can be updated.",
  ).optional(),
  migrationTargetType: z.enum([
    "MIGRATION_TARGET_TYPE_UNSPECIFIED",
    "MIGRATION_TARGET_TYPE_GCE",
    "MIGRATION_TARGET_TYPE_DISKS",
  ]).describe("Immutable. The target type of this group.").optional(),
  groupId: z.string().describe("Required. The group identifier.").optional(),
...
const StateSchema = z.object({
  ...
  migrationTargetType: z.string().optional(),
  name: z.string(),
...
/** Swamp extension model for Google Cloud VM Migration Groups. Registered at `@swamp/gcp/vmmigration/groups`. */
export const model = {
  type: "@swamp/gcp/vmmigration/groups",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["migrationTargetType"] !== undefined) {
          body["migrationTargetType"] = g["migrationTargetType"];
        }
        if (g["groupId"] !== undefined) {
          params["groupId"] = String(g["groupId"]);
        }
    ...
    add_group_migration: {
      description: "add group migration",
      arguments: z.object({
        migratingVm: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["group"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const body: Record<string, unknown> = {};
        if (args["migratingVm"] !== undefined) {
          body["migratingVm"] = args["migratingVm"];
        }
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["group"],
            "parameters": { "group": { "location": "path", "required": true } },
          },
          params,
          body,
          undefined,
