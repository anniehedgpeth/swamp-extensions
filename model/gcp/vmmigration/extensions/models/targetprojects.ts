...
// Auto-generated extension model for @swamp/gcp/vmmigration/targetprojects
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud VM Migration TargetProjects.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/targetProjects/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "TargetProject message represents a target Compute Engine project for a migrat...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a targetProjects",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["targetProjectId"] !== undefined) {
          params["targetProjectId"] = String(g["targetProjectId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a targetProjects",
      arguments: z.object({
        identifier: z.string().describe("The name of the targetProjects"),
      }),
    ...
    update: {
      description: "Update targetProjects attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific targetProjects by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the targetProjects",
      arguments: z.object({
        identifier: z.string().describe("The name of the targetProjects"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync targetProjects state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific targetProjects by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List targetProjects resources",
      arguments: z.object({
