...
/**
 * Swamp extension model for Google Cloud VM Migration Sources.MigratingVms.CloneJobs.
 *
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["cloneJobId"] !== undefined) {
          params["cloneJobId"] = String(g["cloneJobId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific cloneJobs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List cloneJobs resources",
      arguments: z.object({
