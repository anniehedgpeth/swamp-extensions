...
/**
 * Swamp extension model for Google Cloud VM Migration Sources.DatacenterConnectors.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["datacenterConnectorId"] !== undefined) {
          params["datacenterConnectorId"] = String(g["datacenterConnectorId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific datacenterConnectors by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List datacenterConnectors resources",
      arguments: z.object({
