...
Use
`swamp model type describe @swamp/gcp/curationpartners/curators_curatedpackages`
...
```bash
# Create a new curators_curatedpackages model
swamp model create @swamp/gcp/curationpartners/curators_curatedpackages my-curators_curatedpackages

# Edit the model to configure its properties
swamp model edit my-curators_curatedpackages

# Create the resource in GCP
swamp model method run my-curators_curatedpackages create

# Sync current state from GCP
swamp model method run my-curators_curatedpackages sync
```
