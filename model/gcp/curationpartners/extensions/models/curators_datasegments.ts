...
// Auto-generated extension model for @swamp/gcp/curationpartners/curators-datasegments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Curation Partners Curators.DataSegments.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/dataSegments/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Curation Partners Curators.DataSegments. Registered at `@swamp/gcp/curationpartners/curators-datasegments`. */
export const model = {
  type: "@swamp/gcp/curationpartners/curators-datasegments",
  ...
  resources: {
    state: {
      description:
        "Defines an identifier for a segment of inventory that can be targeted by cura...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a dataSegments",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["cpmFee"] !== undefined) body["cpmFee"] = g["cpmFee"];
    ...
    get: {
      description: "Get a dataSegments",
      arguments: z.object({
        identifier: z.string().describe("The name of the dataSegments"),
      }),
    ...
    update: {
      description: "Update dataSegments attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataSegments by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    sync: {
      description: "Sync dataSegments state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataSegments by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List dataSegments resources",
      arguments: z.object({
