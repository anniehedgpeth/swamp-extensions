...
// Auto-generated extension model for @swamp/gcp/firebasedataconnect/services
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase SQL Connect Services.
 *
...
export const model = {
  ...
  methods: {
    ...
    execute_graphql_read: {
      description: "execute graphql read",
      arguments: z.object({
        extensions: z.any().optional(),
        operationName: z.any().optional(),
        query: z.any().optional(),
