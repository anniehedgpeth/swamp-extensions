...
Google Cloud firebasedataconnect resources.
...
Use `swamp model type describe @swamp/gcp/firebasedataconnect/locations` to see
...
swamp model create @swamp/gcp/firebasedataconnect/locations my-locations
