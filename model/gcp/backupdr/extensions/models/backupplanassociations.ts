...
/**
 * Swamp extension model for Google Cloud Backup and DR Service BackupPlanAssociations.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["backupPlanAssociationId"] !== undefined) {
          params["backupPlanAssociationId"] = String(
            g["backupPlanAssociationId"],
          );
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific backupPlanAssociations by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List backupPlanAssociations resources",
      arguments: z.object({
