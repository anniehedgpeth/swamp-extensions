...
// Auto-generated extension model for @swamp/gcp/backupdr/datasourcereferences
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Backup and DR Service DataSourceReferences.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/dataSourceReferences/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  dataSourceBackupConfigInfo: z.object({
    lastBackupState: z.string(),
    lastSuccessfulBackupConsistencyTime: z.string(),
  }).optional(),
  dataSourceBackupConfigState: z.string().optional(),
  dataSourceBackupCount: z.string().optional(),
  dataSourceGcpResourceInfo: z.object({
    alloyDbClusterProperties: z.object({
      name: z.string(),
    }),
    cloudSqlInstanceProperties: z.object({
      databaseInstalledVersion: z.string(),
      instanceCreateTime: z.string(),
      instanceTier: z.string(),
      name: z.string(),
    }),
    filestoreInstanceProperties: z.object({
      instanceCreateTime: z.string(),
      name: z.string(),
    }),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a dataSourceReferences",
      arguments: z.object({
        identifier: z.string().describe("The name of the dataSourceReferences"),
      }),
    ...
    sync: {
      description: "Sync dataSourceReferences state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dataSourceReferences by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List dataSourceReferences resources",
      arguments: z.object({
