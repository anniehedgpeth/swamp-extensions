...
/**
 * Swamp extension model for Google Cloud Backup and DR Service Locations.
 *
...
/** Swamp extension model for Google Cloud Backup and DR Service Locations. Registered at `@swamp/gcp/backupdr/locations`. */
export const model = {
