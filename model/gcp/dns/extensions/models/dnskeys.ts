...
/**
 * Swamp extension model for Google Cloud DNS DnsKeys.
 *
 * A DNSSEC key pair.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dnsKeys by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List dnsKeys resources",
      arguments: z.object({
        digestType: z.string().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["digestType"] !== undefined) {
          params["digestType"] = String(args["digestType"]);
        }
