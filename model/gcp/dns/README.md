...
Use `swamp model type describe @swamp/gcp/dns/changes` to see the full list of
...
```bash
# Create a new changes model
swamp model create @swamp/gcp/dns/changes my-changes

# Edit the model to configure its properties
swamp model edit my-changes

# Create the resource in GCP
swamp model method run my-changes create

# Sync current state from GCP
swamp model method run my-changes sync
```
