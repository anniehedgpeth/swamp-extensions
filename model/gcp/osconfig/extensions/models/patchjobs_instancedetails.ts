...
// Auto-generated extension model for @swamp/gcp/osconfig/patchjobs-instancedetails
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud OS Config PatchJobs.InstanceDetails.
 *
...
const StateSchema = z.object({
  attemptCount: z.string().optional(),
  failureReason: z.string().optional(),
  instanceSystemId: z.string().optional(),
  name: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Patch details for a VM instance. For more information about reviewing VM inst...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a instanceDetails",
      arguments: z.object({
        identifier: z.string().describe("The name of the instanceDetails"),
      }),
    ...
    sync: {
      description: "Sync instanceDetails state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific instanceDetails by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List instanceDetails resources",
      arguments: z.object({
