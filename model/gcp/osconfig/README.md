...
Google Cloud osconfig resources.
...
Use `swamp model type describe @swamp/gcp/osconfig/global_policyorchestrators`
...
```bash
# Create a new global_policyorchestrators model
swamp model create @swamp/gcp/osconfig/global_policyorchestrators my-global_policyorchestrators

# Edit the model to configure its properties
swamp model edit my-global_policyorchestrators

# Create the resource in GCP
swamp model method run my-global_policyorchestrators create

# Sync current state from GCP
swamp model method run my-global_policyorchestrators sync
```
