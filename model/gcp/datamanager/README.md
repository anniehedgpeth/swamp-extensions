...
Google Cloud datamanager resources.
...
Use
`swamp model type describe @swamp/gcp/datamanager/accounttypes_accounts_userlistdirectlicenses`
...
```bash
# Create a new accounttypes_accounts_userlistdirectlicenses model
swamp model create @swamp/gcp/datamanager/accounttypes_accounts_userlistdirectlicenses my-accounttypes_accounts_userlistdirectlicenses

# Edit the model to configure its properties
swamp model edit my-accounttypes_accounts_userlistdirectlicenses

# Create the resource in GCP
swamp model method run my-accounttypes_accounts_userlistdirectlicenses create

# Sync current state from GCP
swamp model method run my-accounttypes_accounts_userlistdirectlicenses sync
```
