...
Use
`swamp model type describe @swamp/gcp/analyticsdata/properties_audienceexports`
...
```bash
# Create a new properties_audienceexports model
swamp model create @swamp/gcp/analyticsdata/properties_audienceexports my-properties_audienceexports

# Edit the model to configure its properties
swamp model edit my-properties_audienceexports

# Create the resource in GCP
swamp model method run my-properties_audienceexports create

# Sync current state from GCP
swamp model method run my-properties_audienceexports sync
```
