...
// Auto-generated extension model for @swamp/gcp/realtimebidding/bidders-publisherconnections
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Real-time Bidding Bidders.PublisherConnections.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/publisherConnections/${shortName}`;
}
...
const StateSchema = z.object({
  biddingState: z.string().optional(),
  createTime: z.string().optional(),
  displayName: z.string().optional(),
  name: z.string(),
  publisherPlatform: z.string().optional(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Real-time Bidding Bidders.PublisherConnections. Registered at `@swamp/gcp/realtimebidding/bidders-publisherconnections`. */
export const model = {
  type: "@swamp/gcp/realtimebidding/bidders-publisherconnections",
  ...
  resources: {
    state: {
      description:
        "An Open Bidding exchange's connection to a publisher. This is initiated by th...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a publisherConnections",
      arguments: z.object({
        identifier: z.string().describe("The name of the publisherConnections"),
      }),
    ...
    sync: {
      description: "Sync publisherConnections state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific publisherConnections by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List publisherConnections resources",
      arguments: z.object({
