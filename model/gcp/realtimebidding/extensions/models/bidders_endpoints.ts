...
/**
 * Swamp extension model for Google Cloud Real-time Bidding Bidders.Endpoints.
 *
...
/** Swamp extension model for Google Cloud Real-time Bidding Bidders.Endpoints. Registered at `@swamp/gcp/realtimebidding/bidders-endpoints`. */
export const model = {
