...
Google Cloud realtimebidding resources.
...
Use `swamp model type describe @swamp/gcp/realtimebidding/bidders_creatives` to
...
```bash
# Create a new bidders_creatives model
swamp model create @swamp/gcp/realtimebidding/bidders_creatives my-bidders_creatives

# Edit the model to configure its properties
swamp model edit my-bidders_creatives

# Create the resource in GCP
swamp model method run my-bidders_creatives create

# Sync current state from GCP
swamp model method run my-bidders_creatives sync
```
