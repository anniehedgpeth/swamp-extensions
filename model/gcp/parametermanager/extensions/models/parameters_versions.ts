...
// Auto-generated extension model for @swamp/gcp/parametermanager/parameters-versions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Parameter Manager Parameters.Versions.
 *
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["parameterVersionId"] !== undefined) {
          params["parameterVersionId"] = String(g["parameterVersionId"]);
        }
