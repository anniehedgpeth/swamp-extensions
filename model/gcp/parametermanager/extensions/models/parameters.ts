...
// Auto-generated extension model for @swamp/gcp/parametermanager/parameters
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Parameter Manager Parameters.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/parameters/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  format: z.enum([
    ...
    "YAML",
    "JSON",
  ]).describe("Optional. Specifies the format of a Parameter.").optional(),
...
export const model = {
  ...
  methods: {
    ...
    get: {
      description: "Get a parameters",
      arguments: z.object({
        identifier: z.string().describe("The name of the parameters"),
      }),
    ...
    update: {
      description: "Update parameters attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific parameters by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the parameters",
      arguments: z.object({
        identifier: z.string().describe("The name of the parameters"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync parameters state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific parameters by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List parameters resources",
      arguments: z.object({
