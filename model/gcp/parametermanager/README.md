...
Google Cloud parametermanager resources.
...
Use `swamp model type describe @swamp/gcp/parametermanager/locations` to see the
...
swamp model create @swamp/gcp/parametermanager/locations my-locations
