...
// Auto-generated extension model for @swamp/gcp/authorizedbuyersmarketplace/buyers-clients
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Authorized Buyers Marketplace Buyers.Clients.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/clients/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  sellerVisible: z.boolean().describe(
...
const StateSchema = z.object({
  ...
  sellerVisible: z.boolean().optional(),
...
/** Swamp extension model for Google Cloud Authorized Buyers Marketplace Buyers.Clients. Registered at `@swamp/gcp/authorizedbuyersmarketplace/buyers-clients`. */
export const model = {
  type: "@swamp/gcp/authorizedbuyersmarketplace/buyers-clients",
  ...
  resources: {
    state: {
      description:
        "A client represents an agency, a brand, or an advertiser customer of the buye...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["sellerVisible"] !== undefined) {
          body["sellerVisible"] = g["sellerVisible"];
        }
