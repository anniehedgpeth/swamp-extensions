...
// Auto-generated extension model for @swamp/gcp/authorizedbuyersmarketplace/buyers-clients-users
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Authorized Buyers Marketplace Buyers.Clients.Users.
 *
...
/** Swamp extension model for Google Cloud Authorized Buyers Marketplace Buyers.Clients.Users. Registered at `@swamp/gcp/authorizedbuyersmarketplace/buyers-clients-users`. */
export const model = {
  type: "@swamp/gcp/authorizedbuyersmarketplace/buyers-clients-users",
  ...
  resources: {
    state: {
      description:
        "A user of a client who has restricted access to the Marketplace and certain o...",
      schema: StateSchema,
      lifetime: "infinite",
