...
// Auto-generated extension model for @swamp/gcp/authorizedbuyersmarketplace/buyers-publisherprofiles
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Authorized Buyers Marketplace Buyers.PublisherProfiles.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/publisherProfiles/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  pitchStatement: z.string().optional(),
...
/** Swamp extension model for Google Cloud Authorized Buyers Marketplace Buyers.PublisherProfiles. Registered at `@swamp/gcp/authorizedbuyersmarketplace/buyers-publisherprofiles`. */
export const model = {
  type: "@swamp/gcp/authorizedbuyersmarketplace/buyers-publisherprofiles",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific publisherProfiles by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List publisherProfiles resources",
      arguments: z.object({
