...
// Auto-generated extension model for @swamp/gcp/authorizedbuyersmarketplace/bidders-auctionpackages
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Authorized Buyers Marketplace Bidders.AuctionPackages.
 *
...
const StateSchema = z.object({
  ...
  dealOwnerSeatId: z.string().optional(),
  ...
  name: z.string(),
  subscribedBuyers: z.array(z.string()).optional(),
  subscribedClients: z.array(z.string()).optional(),
  subscribedMediaPlanners: z.array(z.object({
    accountId: z.string(),
...
/** Swamp extension model for Google Cloud Authorized Buyers Marketplace Bidders.AuctionPackages. Registered at `@swamp/gcp/authorizedbuyersmarketplace/bidders-auctionpackages`. */
export const model = {
  type: "@swamp/gcp/authorizedbuyersmarketplace/bidders-auctionpackages",
  ...
  methods: {
    get: {
      description: "Get a auctionPackages",
      arguments: z.object({
        identifier: z.string().describe("The name of the auctionPackages"),
      }),
    ...
    sync: {
      description: "Sync auctionPackages state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific auctionPackages by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List auctionPackages resources",
      arguments: z.object({
