# @swamp/gcp/authorizedbuyersmarketplace

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Google Cloud authorizedbuyersmarketplace resources.
...
Use
`swamp model type describe @swamp/gcp/authorizedbuyersmarketplace/bidders_auctionpackages`
...
```bash
# Create a new bidders_auctionpackages model
swamp model create @swamp/gcp/authorizedbuyersmarketplace/bidders_auctionpackages my-bidders_auctionpackages

# Edit the model to configure its properties
swamp model edit my-bidders_auctionpackages

# Create the resource in GCP
swamp model method run my-bidders_auctionpackages create

# Sync current state from GCP
swamp model method run my-bidders_auctionpackages sync
```
