...
Use `swamp model type describe @swamp/gcp/vision/products_referenceimages` to
...
```bash
# Create a new products_referenceimages model
swamp model create @swamp/gcp/vision/products_referenceimages my-products_referenceimages

# Edit the model to configure its properties
swamp model edit my-products_referenceimages

# Create the resource in GCP
swamp model method run my-products_referenceimages create

# Sync current state from GCP
swamp model method run my-products_referenceimages sync
```
