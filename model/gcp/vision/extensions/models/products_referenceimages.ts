...
/**
 * Swamp extension model for Google Cloud Vision Products.ReferenceImages.
 *
...
/** Swamp extension model for Google Cloud Vision Products.ReferenceImages. Registered at `@swamp/gcp/vision/products-referenceimages`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["referenceImageId"] !== undefined) {
          params["referenceImageId"] = String(g["referenceImageId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific referenceImages by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List referenceImages resources",
      arguments: z.object({
