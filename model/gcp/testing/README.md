...
Google Cloud testing resources.
...
Use `swamp model type describe @swamp/gcp/testing/devicesessions` to see the
...
```bash
# Create a new devicesessions model
swamp model create @swamp/gcp/testing/devicesessions my-devicesessions

# Edit the model to configure its properties
swamp model edit my-devicesessions

# Create the resource in GCP
swamp model method run my-devicesessions create

# Sync current state from GCP
swamp model method run my-devicesessions sync
```
