...
/**
 * Swamp extension model for Google Cloud Testing TestMatrices.
 *
...
const GlobalArgsSchema = z.object({
  ...
  environmentMatrix: z.object({
    ...
    }).describe("A matrix of Android devices.").optional(),
    ...
    }).describe("A list of iOS devices.").optional(),
  }).describe("Required. The devices the tests are being executed on.")
    .optional(),
  ...
  }).describe("Required. Where the results for the matrix are written.")
    .optional(),
  testSpecification: z.object({
    androidInstrumentationTest: z.object({
      ...
      }).describe("The APK for the application under test.").optional(),
      appBundle: z.object({
        apks: z.object({
          bundleSplits: z.array(z.unknown()).describe(
        ...
        }).describe(".aab file representing the app bundle under test.")
          .optional(),
      }).describe("A multi-apk app bundle for the application under test.")
        .optional(),
      ...
      shardingOption: z.object({
        manualSharding: z.object({
          testTargetsForShard: z.array(z.unknown()).describe(
      ...
      }).describe("The option to run tests in multiple shards in parallel.")
        .optional(),
      testApk: z.object({
        gcsPath: z.string().describe(
          "A path to a file in Google Cloud Storage. Example: gs://build-app-1414623860166/app%40debug-unaligned.apk These paths are expected to be url encoded (percent encoding)",
        ).optional(),
      }).describe("Required. The APK containing the test code to be executed.")
        .optional(),
    ...
    androidRoboTest: z.object({
      ...
      startingIntents: z.array(z.object({
        ...
        startActivity: z.object({
          ...
          uri: z.unknown().describe("URI for the action.").optional(),
        }).describe("An intent that starts an activity with specific details.")
          .optional(),
    ...
    }).describe("An Android Application with a Test Loop.").optional(),
    ...
    }).describe("An iOS Robo test.").optional(),
    iosTestLoop: z.object({
      ...
      }).describe("Required. The.ipa of the application to test.").optional(),
      scenarios: z.array(z.number().int()).describe(
        "The list of scenarios that should be run during the test. Defaults to the single scenario 0 if unspecified.",
      ).optional(),
    }).describe("An iOS application with a test loop.").optional(),
    iosTestSetup: z.object({
      ...
      pullDirectories: z.array(z.object({
        ...
        content: z.object({
          gcsPath: z.unknown().describe(
            "A path to a file in Google Cloud Storage. Example: gs://build-app-1414623860166/app%40debug-unaligned.apk These paths are expected to be url encoded (percent encoding)",
          ).optional(),
        }).describe("The source file").optional(),
    ...
    }).describe("Test setup requirements for iOS.").optional(),
    iosXcTest: z.object({
      appBundleId: z.string().describe(
        "Output only. The bundle id for the application under test.",
      ).optional(),
    ...
    }).describe("An iOS XCTest, via an.xctestrun file.").optional(),
    testSetup: z.object({
      account: z.object({
        googleAuto: z.object({}).describe("An automatic google login account.")
          .optional(),
      }).describe(
      ...
      filesToPush: z.array(z.object({
        obbFile: z.object({
          obb: z.unknown().describe(
            "Required. Opaque Binary Blob (OBB) file(s) to install on the device.",
          ).optional(),
          obbFileName: z.unknown().describe(
        ...
        }).describe("A reference to an opaque binary blob file.").optional(),
        regularFile: z.object({
          content: z.unknown().describe("Required. The source file.")
            .optional(),
          devicePath: z.unknown().describe(
        ...
        }).describe("A reference to a regular file.").optional(),
      })).describe(
        "List of files to push to the device before starting the test.",
      ).optional(),
  ...
  }).describe("Required. How to run the test.").optional(),
...
const StateSchema = z.object({
  ...
  testExecutions: z.array(z.object({
    ...
    testSpecification: z.object({
      androidInstrumentationTest: z.object({
        ...
        appBundle: z.object({
          apks: z.unknown(),
          bundleLocation: z.unknown(),
        }),
        appPackageId: z.string(),
        orchestratorOption: z.string(),
        shardingOption: z.object({
          manualSharding: z.unknown(),
      ...
      androidRoboTest: z.object({
        ...
        maxDepth: z.number(),
        maxSteps: z.number(),
        roboDirectives: z.array(z.unknown()),
        roboMode: z.string(),
        roboScript: z.object({
          gcsPath: z.unknown(),
        }),
        startingIntents: z.array(z.unknown()),
      }),
      androidTestLoop: z.object({
        appApk: z.object({
          gcsPath: z.unknown(),
        ...
        appPackageId: z.string(),
        scenarioLabels: z.array(z.unknown()),
      ...
      iosTestSetup: z.object({
        additionalIpas: z.array(z.unknown()),
        networkProfile: z.string(),
        pullDirectories: z.array(z.unknown()),
        pushFiles: z.array(z.unknown()),
      }),
      iosXcTest: z.object({
        appBundleId: z.string(),
      ...
      testSetup: z.object({
        account: z.object({
          googleAuto: z.unknown(),
        }),
        additionalApks: z.array(z.unknown()),
        directoriesToPull: z.array(z.unknown()),
        dontAutograntPermissions: z.boolean(),
        environmentVariables: z.array(z.unknown()),
        filesToPush: z.array(z.unknown()),
        initialSetupApks: z.array(z.unknown()),
        networkProfile: z.string(),
        systrace: z.object({
  ...
  testSpecification: z.object({
    androidInstrumentationTest: z.object({
      ...
      appBundle: z.object({
        apks: z.object({
          bundleSplits: z.array(z.unknown()),
        }),
        bundleLocation: z.object({
          gcsPath: z.string(),
        }),
      ...
      shardingOption: z.object({
        manualSharding: z.object({
          testTargetsForShard: z.array(z.unknown()),
        }),
        smartSharding: z.object({
    ...
    testSetup: z.object({
      ...
      filesToPush: z.array(z.object({
        obbFile: z.object({
          obb: z.unknown(),
          obbFileName: z.unknown(),
        }),
        regularFile: z.object({
          content: z.unknown(),
          devicePath: z.unknown(),
        }),
      })),
      initialSetupApks: z.array(z.object({
        location: z.object({
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific testMatrices by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
