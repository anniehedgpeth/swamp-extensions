...
Use `swamp model type describe @swamp/gcp/docs/documents` to see the full list
...
swamp model create @swamp/gcp/docs/documents my-documents

# Edit the model to configure its properties
swamp model edit my-documents

# Create the resource in GCP
swamp model method run my-documents create

# Sync current state from GCP
swamp model method run my-documents sync
```
