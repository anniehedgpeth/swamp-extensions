...
// Auto-generated extension model for @swamp/gcp/storagetransfer/agentpools
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Storage Transfer AgentPools.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "Represents an agent pool.",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a agentPools",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["bandwidthLimit"] !== undefined) {
          body["bandwidthLimit"] = g["bandwidthLimit"];
        }
    ...
    get: {
      description: "Get a agentPools",
      arguments: z.object({
        identifier: z.string().describe("The name of the agentPools"),
      }),
    ...
    update: {
      description: "Update agentPools attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific agentPools by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the agentPools",
      arguments: z.object({
        identifier: z.string().describe("The name of the agentPools"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync agentPools state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific agentPools by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List agentPools resources",
      arguments: z.object({
