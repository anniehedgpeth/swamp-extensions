...
Google Cloud storagetransfer resources.
...
Use `swamp model type describe @swamp/gcp/storagetransfer/agentpools` to see the
...
```bash
# Create a new agentpools model
swamp model create @swamp/gcp/storagetransfer/agentpools my-agentpools

# Edit the model to configure its properties
swamp model edit my-agentpools

# Create the resource in GCP
swamp model method run my-agentpools create

# Sync current state from GCP
swamp model method run my-agentpools sync
```
