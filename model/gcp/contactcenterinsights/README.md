...
Google Cloud contactcenterinsights resources.
...
Use `swamp model type describe @swamp/gcp/contactcenterinsights/analysisrules`
...
```bash
# Create a new analysisrules model
swamp model create @swamp/gcp/contactcenterinsights/analysisrules my-analysisrules

# Edit the model to configure its properties
swamp model edit my-analysisrules

# Create the resource in GCP
swamp model method run my-analysisrules create

# Sync current state from GCP
swamp model method run my-analysisrules sync
```
