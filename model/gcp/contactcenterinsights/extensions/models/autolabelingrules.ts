...
/**
 * Swamp extension model for Google Cloud Contact Center AI Insights AutoLabelingRules.
 *
...
/** Swamp extension model for Google Cloud Contact Center AI Insights AutoLabelingRules. Registered at `@swamp/gcp/contactcenterinsights/autolabelingrules`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["autoLabelingRuleId"] !== undefined) {
          params["autoLabelingRuleId"] = String(g["autoLabelingRuleId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific autoLabelingRules by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List autoLabelingRules resources",
      arguments: z.object({
