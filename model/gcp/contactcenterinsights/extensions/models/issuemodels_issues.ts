...
// Auto-generated extension model for @swamp/gcp/contactcenterinsights/issuemodels-issues
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Contact Center AI Insights IssueModels.Issues.
 *
 * The issue resource.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/issues/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  displayDescription: z.string().describe(
    "Representative description of the issue.",
  ).optional(),
  displayName: z.string().describe("The representative name for the issue.")
    .optional(),
...
const StateSchema = z.object({
  ...
  name: z.string(),
  sampleUtterances: z.array(z.string()).optional(),
...
/** Swamp extension model for Google Cloud Contact Center AI Insights IssueModels.Issues. Registered at `@swamp/gcp/contactcenterinsights/issuemodels-issues`. */
export const model = {
  type: "@swamp/gcp/contactcenterinsights/issuemodels-issues",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["displayDescription"] !== undefined) {
          body["displayDescription"] = g["displayDescription"];
        }
