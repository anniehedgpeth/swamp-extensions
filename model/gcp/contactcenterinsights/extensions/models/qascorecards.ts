...
// Auto-generated extension model for @swamp/gcp/contactcenterinsights/qascorecards
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Contact Center AI Insights QaScorecards.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/qaScorecards/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  qaScorecardId: z.string().describe(
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a qaScorecards",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["qaScorecardId"] !== undefined) {
          params["qaScorecardId"] = String(g["qaScorecardId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a qaScorecards",
      arguments: z.object({
        identifier: z.string().describe("The name of the qaScorecards"),
      }),
    ...
    update: {
      description: "Update qaScorecards attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific qaScorecards by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the qaScorecards",
      arguments: z.object({
        identifier: z.string().describe("The name of the qaScorecards"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync qaScorecards state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific qaScorecards by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List qaScorecards resources",
      arguments: z.object({
        ...
        qaScorecardSources: z.string().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["qaScorecardSources"] !== undefined) {
          params["qaScorecardSources"] = String(args["qaScorecardSources"]);
        }
