...
/**
 * Swamp extension model for Google Cloud Contact Center AI Insights AuthorizedViewSets.AuthorizedViews.Conversations.Assessments.Notes.
 *
...
/** Swamp extension model for Google Cloud Contact Center AI Insights AuthorizedViewSets.AuthorizedViews.Conversations.Assessments.Notes. Registered at `@swamp/gcp/contactcenterinsights/authorizedviewsets-authorizedviews-conversations-assessments-notes`. */
export const model = {
  type:
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific notes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
