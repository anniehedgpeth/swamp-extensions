...
// Auto-generated extension model for @swamp/gcp/contactcenterinsights/views
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Contact Center AI Insights Views.
 *
 * The View resource.
 *
...
/** Swamp extension model for Google Cloud Contact Center AI Insights Views. Registered at `@swamp/gcp/contactcenterinsights/views`. */
export const model = {
  type: "@swamp/gcp/contactcenterinsights/views",
