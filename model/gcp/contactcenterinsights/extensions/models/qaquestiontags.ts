...
// Auto-generated extension model for @swamp/gcp/contactcenterinsights/qaquestiontags
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Contact Center AI Insights QaQuestionTags.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/qaQuestionTags/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  qaQuestionIds: z.array(z.string()).describe(
  ...
  qaQuestionTagId: z.string().describe(
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A tag is a resource which aims to categorize a set of questions across multip...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a qaQuestionTags",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["qaQuestionIds"] !== undefined) {
          body["qaQuestionIds"] = g["qaQuestionIds"];
        }
        if (g["qaQuestionTagId"] !== undefined) {
          params["qaQuestionTagId"] = String(g["qaQuestionTagId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a qaQuestionTags",
      arguments: z.object({
        identifier: z.string().describe("The name of the qaQuestionTags"),
      }),
    ...
    update: {
      description: "Update qaQuestionTags attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific qaQuestionTags by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the qaQuestionTags",
      arguments: z.object({
        identifier: z.string().describe("The name of the qaQuestionTags"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync qaQuestionTags state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific qaQuestionTags by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List qaQuestionTags resources",
      arguments: z.object({
