...
// Auto-generated extension model for @swamp/gcp/contactcenterinsights/conversations-feedbacklabels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Contact Center AI Insights Conversations.FeedbackLabels.
 *
...
/** Swamp extension model for Google Cloud Contact Center AI Insights Conversations.FeedbackLabels. Registered at `@swamp/gcp/contactcenterinsights/conversations-feedbacklabels`. */
export const model = {
  type: "@swamp/gcp/contactcenterinsights/conversations-feedbacklabels",
    ...
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["feedbackLabelId"] !== undefined) {
          params["feedbackLabelId"] = String(g["feedbackLabelId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific feedbackLabels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
