...
// Auto-generated extension model for @swamp/gcp/contactcenterinsights/datasets-conversations-feedbacklabels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Contact Center AI Insights Datasets.Conversations.FeedbackLabels.
 *
...
/** Swamp extension model for Google Cloud Contact Center AI Insights Datasets.Conversations.FeedbackLabels. Registered at `@swamp/gcp/contactcenterinsights/datasets-conversations-feedbacklabels`. */
export const model = {
  type:
