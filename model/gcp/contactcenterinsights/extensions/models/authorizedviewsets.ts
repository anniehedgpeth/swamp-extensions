...
// Auto-generated extension model for @swamp/gcp/contactcenterinsights/authorizedviewsets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Contact Center AI Insights AuthorizedViewSets.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/authorizedViewSets/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  authorizedViewSetId: z.string().describe(
...
/** Swamp extension model for Google Cloud Contact Center AI Insights AuthorizedViewSets. Registered at `@swamp/gcp/contactcenterinsights/authorizedviewsets`. */
export const model = {
  type: "@swamp/gcp/contactcenterinsights/authorizedviewsets",
  ...
  methods: {
    create: {
      description: "Create a authorizedViewSets",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["authorizedViewSetId"] !== undefined) {
          params["authorizedViewSetId"] = String(g["authorizedViewSetId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a authorizedViewSets",
      arguments: z.object({
        identifier: z.string().describe("The name of the authorizedViewSets"),
      }),
    ...
    update: {
      description: "Update authorizedViewSets attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific authorizedViewSets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the authorizedViewSets",
      arguments: z.object({
        identifier: z.string().describe("The name of the authorizedViewSets"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync authorizedViewSets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific authorizedViewSets by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List authorizedViewSets resources",
      arguments: z.object({
