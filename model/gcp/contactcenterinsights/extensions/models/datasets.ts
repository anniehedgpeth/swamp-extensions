...
// Auto-generated extension model for @swamp/gcp/contactcenterinsights/datasets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Contact Center AI Insights Datasets.
 *
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Dataset description.").optional(),
  displayName: z.string().describe("Display name for the dataaset").optional(),
  name: z.string().describe(
    "Immutable. Identifier. Resource name of the dataset. Format: projects/{project}/locations/{location}/datasets/{dataset}",
  ).optional(),
  ttl: z.string().describe("Optional. Option TTL for the dataset.").optional(),
  type: z.enum(["TYPE_UNSPECIFIED", "EVAL", "LIVE"]).describe(
    "Dataset usage type.",
  ).optional(),
  datasetId: z.string().describe("Optional. The ID to use for the dataset.")
    .optional(),
...
export const model = {
  ...
  methods: {
    ...
    bulk_delete_feedback_labels: {
      description: "bulk delete feedback labels",
      arguments: z.object({
    ...
    bulk_download_feedback_labels: {
      description: "bulk download feedback labels",
      arguments: z.object({
        conversationFilter: z.any().optional(),
        feedbackLabelType: z.any().optional(),
        filter: z.any().optional(),
        gcsDestination: z.any().optional(),
        maxDownloadCount: z.any().optional(),
        parent: z.any().optional(),
        sheetsDestination: z.any().optional(),
        templateQaScorecardId: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (args["conversationFilter"] !== undefined) {
          body["conversationFilter"] = args["conversationFilter"];
        }
        if (args["feedbackLabelType"] !== undefined) {
          body["feedbackLabelType"] = args["feedbackLabelType"];
        }
        if (args["filter"] !== undefined) body["filter"] = args["filter"];
        if (args["gcsDestination"] !== undefined) {
          body["gcsDestination"] = args["gcsDestination"];
        }
        if (args["maxDownloadCount"] !== undefined) {
          body["maxDownloadCount"] = args["maxDownloadCount"];
        }
        if (args["parent"] !== undefined) body["parent"] = args["parent"];
        if (args["sheetsDestination"] !== undefined) {
          body["sheetsDestination"] = args["sheetsDestination"];
        }
        if (args["templateQaScorecardId"] !== undefined) {
          body["templateQaScorecardId"] = args["templateQaScorecardId"];
        }
        const result = await createResource(
          BASE_URL,
          {
    ...
    bulk_upload_feedback_labels: {
      description: "bulk upload feedback labels",
      arguments: z.object({
        gcsSource: z.any().optional(),
        sheetsSource: z.any().optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["sheetsSource"] !== undefined) {
          body["sheetsSource"] = args["sheetsSource"];
        }
    ...
    list_all_feedback_labels: {
      description: "list all feedback labels",
      arguments: z.object({}),
