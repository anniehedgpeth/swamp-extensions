...
Google Cloud threatintelligence resources.
...
Use `swamp model type describe @swamp/gcp/threatintelligence/alerts_documents`
...
```bash
# Create a new alerts_documents model
swamp model create @swamp/gcp/threatintelligence/alerts_documents my-alerts_documents

# Edit the model to configure its properties
swamp model edit my-alerts_documents

# Create the resource in GCP
swamp model method run my-alerts_documents create

# Sync current state from GCP
swamp model method run my-alerts_documents sync
```
