...
// Auto-generated extension model for @swamp/gcp/threatintelligence/alerts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Threat Intelligence Alerts.
 *
...
const StateSchema = z.object({
  ...
  duplicatedBy: z.array(z.string()).optional(),
  etag: z.string().optional(),
  externalId: z.string().optional(),
  findingCount: z.string().optional(),
  findings: z.array(z.string()).optional(),
  name: z.string(),
  priorityAnalysis: z.object({
    confidence: z.string(),
    priorityLevel: z.string(),
    reasoning: z.string(),
  }).optional(),
  relevanceAnalysis: z.object({
    confidence: z.string(),
    evidence: z.object({
      commonThemes: z.array(z.string()),
      distinctThemes: z.array(z.string()),
    }),
    reasoning: z.string(),
    relevanceLevel: z.string(),
    relevant: z.boolean(),
  }).optional(),
  severityAnalysis: z.object({
    confidence: z.string(),
    reasoning: z.string(),
    ...
    duplicate: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["duplicateOf"] !== undefined) {
          body["duplicateOf"] = args["duplicateOf"];
        }
        const result = await createResource(
          baseUrl,
          {
