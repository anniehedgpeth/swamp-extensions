...
// Auto-generated extension model for @swamp/gcp/threatintelligence/alerts-documents
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Threat Intelligence Alerts.Documents.
 *
...
const StateSchema = z.object({
  ...
  ingestTime: z.string().optional(),
  languageCode: z.string().optional(),
  name: z.string(),
  source: z.string().optional(),
  sourceUpdateTime: z.string().optional(),
...
/** Swamp extension model for Google Cloud Threat Intelligence Alerts.Documents. Registered at `@swamp/gcp/threatintelligence/alerts-documents`. */
export const model = {
  type: "@swamp/gcp/threatintelligence/alerts-documents",
