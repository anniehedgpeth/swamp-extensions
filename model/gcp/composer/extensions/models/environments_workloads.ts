...
// Auto-generated extension model for @swamp/gcp/composer/environments-workloads
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Composer Environments.Workloads.
 *
...
const StateSchema = z.object({
  name: z.string(),
  status: z.object({
    detailedStatusMessage: z.string(),
    state: z.string(),
...
/** Swamp extension model for Google Cloud Composer Environments.Workloads. Registered at `@swamp/gcp/composer/environments-workloads`. */
export const model = {
  type: "@swamp/gcp/composer/environments-workloads",
