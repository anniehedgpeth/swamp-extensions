...
// Auto-generated extension model for @swamp/gcp/composer/environments-userworkloadssecrets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Composer Environments.UserWorkloadsSecrets.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/userWorkloadsSecrets/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a userWorkloadsSecrets",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a userWorkloadsSecrets",
      arguments: z.object({
        identifier: z.string().describe("The name of the userWorkloadsSecrets"),
      }),
    ...
    update: {
      description: "Update userWorkloadsSecrets attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userWorkloadsSecrets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the userWorkloadsSecrets",
      arguments: z.object({
        identifier: z.string().describe("The name of the userWorkloadsSecrets"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync userWorkloadsSecrets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userWorkloadsSecrets by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List userWorkloadsSecrets resources",
      arguments: z.object({
