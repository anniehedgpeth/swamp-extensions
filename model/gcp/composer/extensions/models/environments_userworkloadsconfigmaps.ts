...
// Auto-generated extension model for @swamp/gcp/composer/environments-userworkloadsconfigmaps
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Composer Environments.UserWorkloadsConfigMaps.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/userWorkloadsConfigMaps/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Composer Environments.UserWorkloadsConfigMaps. Registered at `@swamp/gcp/composer/environments-userworkloadsconfigmaps`. */
export const model = {
  type: "@swamp/gcp/composer/environments-userworkloadsconfigmaps",
  ...
  resources: {
    state: {
      description:
        "User workloads ConfigMap used by Airflow tasks that run with Kubernetes execu...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a userWorkloadsConfigMaps",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a userWorkloadsConfigMaps",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the userWorkloadsConfigMaps",
        ),
      }),
    ...
    update: {
      description: "Update userWorkloadsConfigMaps attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userWorkloadsConfigMaps by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the userWorkloadsConfigMaps",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the userWorkloadsConfigMaps",
        ),
    ...
    sync: {
      description: "Sync userWorkloadsConfigMaps state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userWorkloadsConfigMaps by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List userWorkloadsConfigMaps resources",
      arguments: z.object({
