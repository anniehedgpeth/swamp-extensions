...
Google Cloud datalabeling resources.
...
Use `swamp model type describe @swamp/gcp/datalabeling/annotationspecsets` to
...
```bash
# Create a new annotationspecsets model
swamp model create @swamp/gcp/datalabeling/annotationspecsets my-annotationspecsets

# Edit the model to configure its properties
swamp model edit my-annotationspecsets

# Create the resource in GCP
swamp model method run my-annotationspecsets create

# Sync current state from GCP
swamp model method run my-annotationspecsets sync
```
