...
// Auto-generated extension model for @swamp/gcp/datalabeling/datasets-evaluations
...
const StateSchema = z.object({
  ...
  evaluatedItemCount: z.string().optional(),
  evaluationJobRunTime: z.string().optional(),
  evaluationMetrics: z.object({
    ...
    objectDetectionMetrics: z.object({
      prCurve: z.object({
        annotationSpec: z.object({
          description: z.string(),
          displayName: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Describes an evaluation between a machine learning model's predictions and gr...",
      schema: StateSchema,
      lifetime: "infinite",
