...
Google Cloud webfonts resources.
...
Use `swamp model type describe @swamp/gcp/webfonts/webfonts` to see the full
...
```bash
# Create a new webfonts model
swamp model create @swamp/gcp/webfonts/webfonts my-webfonts

# Edit the model to configure its properties
swamp model edit my-webfonts

# Create the resource in GCP
swamp model method run my-webfonts create

# Sync current state from GCP
swamp model method run my-webfonts sync
```
