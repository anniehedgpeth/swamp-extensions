...
Use `swamp model type describe @swamp/gcp/chromepolicy/customers_policyschemas`
...
```bash
# Create a new customers_policyschemas model
swamp model create @swamp/gcp/chromepolicy/customers_policyschemas my-customers_policyschemas

# Edit the model to configure its properties
swamp model edit my-customers_policyschemas

# Create the resource in GCP
swamp model method run my-customers_policyschemas create

# Sync current state from GCP
swamp model method run my-customers_policyschemas sync
```
