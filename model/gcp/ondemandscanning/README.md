...
Google Cloud ondemandscanning resources.
...
Use
`swamp model type describe @swamp/gcp/ondemandscanning/scans_vulnerabilities` to
...
```bash
# Create a new scans_vulnerabilities model
swamp model create @swamp/gcp/ondemandscanning/scans_vulnerabilities my-scans_vulnerabilities

# Edit the model to configure its properties
swamp model edit my-scans_vulnerabilities

# Create the resource in GCP
swamp model method run my-scans_vulnerabilities create

# Sync current state from GCP
swamp model method run my-scans_vulnerabilities sync
```
