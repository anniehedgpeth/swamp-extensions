...
Use `swamp model type describe @swamp/gcp/slides/presentations_pages` to see the
...
```bash
# Create a new presentations_pages model
swamp model create @swamp/gcp/slides/presentations_pages my-presentations_pages

# Edit the model to configure its properties
swamp model edit my-presentations_pages

# Create the resource in GCP
swamp model method run my-presentations_pages create

# Sync current state from GCP
swamp model method run my-presentations_pages sync
```
