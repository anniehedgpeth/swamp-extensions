...
Google Cloud recaptchaenterprise resources.
...
Use `swamp model type describe @swamp/gcp/recaptchaenterprise/firewallpolicies`
...
```bash
# Create a new firewallpolicies model
swamp model create @swamp/gcp/recaptchaenterprise/firewallpolicies my-firewallpolicies

# Edit the model to configure its properties
swamp model edit my-firewallpolicies

# Create the resource in GCP
swamp model method run my-firewallpolicies create

# Sync current state from GCP
swamp model method run my-firewallpolicies sync
```
