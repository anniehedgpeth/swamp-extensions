...
// Auto-generated extension model for @swamp/gcp/recaptchaenterprise/relatedaccountgroups-memberships
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud reCAPTCHA Enterprise Relatedaccountgroups.Memberships.
 *
...
const StateSchema = z.object({
  ...
  hashedAccountId: z.string().optional(),
  name: z.string(),
}).passthrough();
...
/** Swamp extension model for Google Cloud reCAPTCHA Enterprise Relatedaccountgroups.Memberships. Registered at `@swamp/gcp/recaptchaenterprise/relatedaccountgroups-memberships`. */
export const model = {
  type: "@swamp/gcp/recaptchaenterprise/relatedaccountgroups-memberships",
