...
Google Cloud firebaseapphosting resources.
...
Use `swamp model type describe @swamp/gcp/firebaseapphosting/backends_builds` to
...
```bash
# Create a new backends_builds model
swamp model create @swamp/gcp/firebaseapphosting/backends_builds my-backends_builds

# Edit the model to configure its properties
swamp model edit my-backends_builds

# Create the resource in GCP
swamp model method run my-backends_builds create

# Sync current state from GCP
swamp model method run my-backends_builds sync
```
