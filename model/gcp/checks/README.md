...
Use `swamp model type describe @swamp/gcp/checks/accounts_apps_reports` to see
...
```bash
# Create a new accounts_apps_reports model
swamp model create @swamp/gcp/checks/accounts_apps_reports my-accounts_apps_reports

# Edit the model to configure its properties
swamp model edit my-accounts_apps_reports

# Create the resource in GCP
swamp model method run my-accounts_apps_reports create

# Sync current state from GCP
swamp model method run my-accounts_apps_reports sync
```
