...
// Auto-generated extension model for @swamp/gcp/checks/accounts-apps
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Checks Accounts.Apps.
 *
...
/** Swamp extension model for Google Cloud Checks Accounts.Apps. Registered at `@swamp/gcp/checks/accounts-apps`. */
export const model = {
  type: "@swamp/gcp/checks/accounts-apps",
