...
// Auto-generated extension model for @swamp/gcp/datalineage/processes-runs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Data Lineage Processes.Runs.
 *
...
const GlobalArgsSchema = z.object({
  ...
  state: z.enum(["UNKNOWN", "STARTED", "COMPLETED", "FAILED", "ABORTED"])
    .describe("Required. The state of the run.").optional(),
