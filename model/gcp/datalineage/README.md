...
Google Cloud datalineage resources.
...
Use `swamp model type describe @swamp/gcp/datalineage/config` to see the full
...
swamp model create @swamp/gcp/datalineage/config my-config

# Edit the model to configure its properties
swamp model edit my-config

# Create the resource in GCP
swamp model method run my-config create

# Sync current state from GCP
swamp model method run my-config sync
```
