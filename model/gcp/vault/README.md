...
Use `swamp model type describe @swamp/gcp/vault/matters_exports` to see the full
...
```bash
# Create a new matters_exports model
swamp model create @swamp/gcp/vault/matters_exports my-matters_exports

# Edit the model to configure its properties
swamp model edit my-matters_exports

# Create the resource in GCP
swamp model method run my-matters_exports create

# Sync current state from GCP
swamp model method run my-matters_exports sync
```
