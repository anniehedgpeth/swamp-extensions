...
/**
 * Swamp extension model for Google Cloud BigQuery Reservation CapacityCommitments.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["capacityCommitmentId"] !== undefined) {
          params["capacityCommitmentId"] = String(g["capacityCommitmentId"]);
        }
        if (g["enforceSingleAdminProjectPerOrg"] !== undefined) {
          params["enforceSingleAdminProjectPerOrg"] = String(
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific capacityCommitments by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List capacityCommitments resources",
      arguments: z.object({
