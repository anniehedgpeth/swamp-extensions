...
// Auto-generated extension model for @swamp/gcp/bigqueryreservation/reservationgroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud BigQuery Reservation ReservationGroups.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/reservationGroups/${shortName}`;
}
...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description: "Removed: parentGroup",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const { parentGroup: _parentGroup, ...rest } = old;
        return rest;
      },
    },
    {
  ...
  methods: {
    create: {
      description: "Create a reservationGroups",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a reservationGroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the reservationGroups"),
      }),
    ...
    delete: {
      description: "Delete the reservationGroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the reservationGroups"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync reservationGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific reservationGroups by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List reservationGroups resources",
      arguments: z.object({
