...
Google Cloud bigqueryreservation resources.
...
Use
`swamp model type describe @swamp/gcp/bigqueryreservation/capacitycommitments`
...
```bash
# Create a new capacitycommitments model
swamp model create @swamp/gcp/bigqueryreservation/capacitycommitments my-capacitycommitments

# Edit the model to configure its properties
swamp model edit my-capacitycommitments

# Create the resource in GCP
swamp model method run my-capacitycommitments create

# Sync current state from GCP
swamp model method run my-capacitycommitments sync
```
