...
// Auto-generated extension model for @swamp/gcp/cloudcommerceprocurement/providers-accounts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Commerce Partner Procurement Providers.Accounts.
 *
...
const StateSchema = z.object({
  ...
  resellerParentBillingAccount: z.string().optional(),
...
/** Swamp extension model for Google Cloud Commerce Partner Procurement Providers.Accounts. Registered at `@swamp/gcp/cloudcommerceprocurement/providers-accounts`. */
export const model = {
  type: "@swamp/gcp/cloudcommerceprocurement/providers-accounts",
  ...
  resources: {
    state: {
      description:
        "Represents an account that was established by the customer on the service pro...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    approve: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["approvalName"] !== undefined) {
          body["approvalName"] = args["approvalName"];
        }
