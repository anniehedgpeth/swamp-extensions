...
Google Cloud cloudcommerceprocurement resources.
...
Use
`swamp model type describe @swamp/gcp/cloudcommerceprocurement/providers_accounts`
...
```bash
# Create a new providers_accounts model
swamp model create @swamp/gcp/cloudcommerceprocurement/providers_accounts my-providers_accounts

# Edit the model to configure its properties
swamp model edit my-providers_accounts

# Create the resource in GCP
swamp model method run my-providers_accounts create

# Sync current state from GCP
swamp model method run my-providers_accounts sync
```
