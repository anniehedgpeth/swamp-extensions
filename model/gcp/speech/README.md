...
Use `swamp model type describe @swamp/gcp/speech/customclasses` to see the full
...
```bash
# Create a new customclasses model
swamp model create @swamp/gcp/speech/customclasses my-customclasses

# Edit the model to configure its properties
swamp model edit my-customclasses

# Create the resource in GCP
swamp model method run my-customclasses create

# Sync current state from GCP
swamp model method run my-customclasses sync
```
