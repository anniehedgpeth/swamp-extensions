...
// Auto-generated extension model for @swamp/gcp/chat/users-sections-items
...
const LIST_CONFIG = {
  "id": "chat.users.sections.items.list",
  ...
  methods: {
    ...
    move: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["targetSection"] !== undefined) {
          body["targetSection"] = args["targetSection"];
        }
        const result = await createResource(
          BASE_URL,
          {
            "id": "chat.users.sections.items.move",
            "path": "v1/{+name}:move",
            "httpMethod": "POST",
            "parameterOrder": ["name"],
