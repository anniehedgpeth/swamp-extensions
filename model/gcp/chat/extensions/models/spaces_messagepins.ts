...
// Auto-generated extension model for @swamp/gcp/chat/spaces-messagepins
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Chat Spaces.MessagePins.
 *
...
const INSERT_CONFIG = {
  "id": "chat.spaces.messagePins.create",
...
const DELETE_CONFIG = {
  "id": "chat.spaces.messagePins.delete",
  "path": "v1/{+name}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "chat.spaces.messagePins.list",
  "path": "v1/{+parent}/messagePins",
  "httpMethod": "GET",
  "parameterOrder": [
    "parent",
...
/** Swamp extension model for Google Cloud Google Chat Spaces.MessagePins. Registered at `@swamp/gcp/chat/spaces-messagepins`. */
export const model = {
  type: "@swamp/gcp/chat/spaces-messagepins",
  ...
  resources: {
    state: {
      description:
        "A pin on a Chat message. For more information see [Pin a message](https://sup...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a messagePins",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a messagePins",
      arguments: z.object({
        identifier: z.string().describe("The name of the messagePins"),
      }),
    ...
    delete: {
      description: "Delete the messagePins",
      arguments: z.object({
        identifier: z.string().describe("The name of the messagePins"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync messagePins state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific messagePins by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List messagePins resources",
      arguments: z.object({
