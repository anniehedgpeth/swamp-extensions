...
Use `swamp model type describe @swamp/gcp/chat/customemojis` to see the full
...
```bash
# Create a new customemojis model
swamp model create @swamp/gcp/chat/customemojis my-customemojis

# Edit the model to configure its properties
swamp model edit my-customemojis

# Create the resource in GCP
swamp model method run my-customemojis create

# Sync current state from GCP
swamp model method run my-customemojis sync
```
