...
Use `swamp model type describe @swamp/gcp/drive/about` to see the full list of
...
swamp model create @swamp/gcp/drive/about my-about

# Edit the model to configure its properties
swamp model edit my-about

# Create the resource in GCP
swamp model method run my-about create

# Sync current state from GCP
swamp model method run my-about sync
```
