...
Google Cloud recommender resources.
...
Use `swamp model type describe @swamp/gcp/recommender/insighttypes_insights` to
...
```bash
# Create a new insighttypes_insights model
swamp model create @swamp/gcp/recommender/insighttypes_insights my-insighttypes_insights

# Edit the model to configure its properties
swamp model edit my-insighttypes_insights

# Create the resource in GCP
swamp model method run my-insighttypes_insights create

# Sync current state from GCP
swamp model method run my-insighttypes_insights sync
```
