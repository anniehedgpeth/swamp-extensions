...
// Auto-generated extension model for @swamp/gcp/recommender/insighttypes-insights
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Recommender InsightTypes.Insights.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/insights/${shortName}`;
}
...
const StateSchema = z.object({
  associatedRecommendations: z.array(z.object({
  ...
  insightSubtype: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a insights",
      arguments: z.object({
        identifier: z.string().describe("The name of the insights"),
      }),
    ...
    sync: {
      description: "Sync insights state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific insights by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List insights resources",
      arguments: z.object({
