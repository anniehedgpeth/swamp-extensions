...
Use `swamp model type describe @swamp/gcp/pubsub/schemas` to see the full list
...
```bash
# Create a new schemas model
swamp model create @swamp/gcp/pubsub/schemas my-schemas

# Edit the model to configure its properties
swamp model edit my-schemas

# Create the resource in GCP
swamp model method run my-schemas create

# Sync current state from GCP
swamp model method run my-schemas sync
```
