...
Google Cloud cloudsearch resources.
...
Use
`swamp model type describe @swamp/gcp/cloudsearch/debug_datasources_items_unmappedids`
...
```bash
# Create a new debug_datasources_items_unmappedids model
swamp model create @swamp/gcp/cloudsearch/debug_datasources_items_unmappedids my-debug_datasources_items_unmappedids

# Edit the model to configure its properties
swamp model edit my-debug_datasources_items_unmappedids

# Create the resource in GCP
swamp model method run my-debug_datasources_items_unmappedids create

# Sync current state from GCP
swamp model method run my-debug_datasources_items_unmappedids sync
```
