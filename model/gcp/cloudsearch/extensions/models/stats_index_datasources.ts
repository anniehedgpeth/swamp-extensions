...
// Auto-generated extension model for @swamp/gcp/cloudsearch/stats-index-datasources
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Search Stats.Index.Datasources.
 *
...
const StateSchema = z.object({
  averageIndexedItemCount: z.string().optional(),
  stats: z.array(z.object({
    ...
    itemCountByStatus: z.array(z.object({
      count: z.string(),
      indexedItemsCount: z.string(),
      statusCode: z.string(),
    })),
  })).optional(),
}).passthrough();
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Gets indexed item statistics for a single data source. **Note:** This API req...",
      schema: StateSchema,
      lifetime: "infinite",
