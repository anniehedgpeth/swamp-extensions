...
// Auto-generated extension model for @swamp/gcp/looker/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Looker (Google Cloud core) Locations.
 *
...
/** Swamp extension model for Google Cloud Looker (Google Cloud core) Locations. Registered at `@swamp/gcp/looker/locations`. */
export const model = {
  type: "@swamp/gcp/looker/locations",
