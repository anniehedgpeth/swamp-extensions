...
Use `swamp model type describe @swamp/gcp/looker/instances_backups` to see the
...
```bash
# Create a new instances_backups model
swamp model create @swamp/gcp/looker/instances_backups my-instances_backups

# Edit the model to configure its properties
swamp model edit my-instances_backups

# Create the resource in GCP
swamp model method run my-instances_backups create

# Sync current state from GCP
swamp model method run my-instances_backups sync
```
