...
Google Cloud adsense resources.
...
Use `swamp model type describe @swamp/gcp/adsense/accounts_adclients_adunits` to
...
```bash
# Create a new accounts_adclients_adunits model
swamp model create @swamp/gcp/adsense/accounts_adclients_adunits my-accounts_adclients_adunits

# Edit the model to configure its properties
swamp model edit my-accounts_adclients_adunits

# Create the resource in GCP
swamp model method run my-accounts_adclients_adunits create

# Sync current state from GCP
swamp model method run my-accounts_adclients_adunits sync
```
