...
// Auto-generated extension model for @swamp/gcp/adsense/accounts-adclients-adunits
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud AdSense Management Accounts.Adclients.Adunits.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/adunits/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  state: z.enum(["STATE_UNSPECIFIED", "ACTIVE", "ARCHIVED"]).describe(
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Representation of an ad unit. An ad unit represents a saved ad unit with a sp...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["contentAdsSettings"] !== undefined) {
          body["contentAdsSettings"] = g["contentAdsSettings"];
        }
    ...
    get: {
      description: "Get a adunits",
      arguments: z.object({
        identifier: z.string().describe("The name of the adunits"),
      }),
    ...
    update: {
      description: "Update adunits attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific adunits by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    sync: {
      description: "Sync adunits state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific adunits by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List adunits resources",
      arguments: z.object({
    ...
    list_linked_custom_channels: {
      description: "list linked custom channels",
      arguments: z.object({}),
      execute: async (_args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const baseUrl = g["apiEndpoint"]?.toString() ??
