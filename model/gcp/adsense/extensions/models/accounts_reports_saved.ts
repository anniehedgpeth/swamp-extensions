...
// Auto-generated extension model for @swamp/gcp/adsense/accounts-reports-saved
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud AdSense Management Accounts.Reports.Saved.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a saved",
      arguments: z.object({
        identifier: z.string().describe("The name of the saved"),
      }),
    ...
    sync: {
      description: "Sync saved state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific saved by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List saved resources",
      arguments: z.object({
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "parameterOrder": ["name"],
            "parameters": {
              "currencyCode": { "location": "query" },
              "dateRange": { "location": "query" },
              "endDate.day": { "location": "query" },
              "endDate.month": { "location": "query" },
              "endDate.year": { "location": "query" },
              "languageCode": { "location": "query" },
              "name": { "location": "path", "required": true },
              "reportingTimeZone": { "location": "query" },
              "startDate.day": { "location": "query" },
              "startDate.month": { "location": "query" },
              "startDate.year": { "location": "query" },
            },
          },
          params,
          undefined,
