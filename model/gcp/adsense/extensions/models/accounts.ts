...
// Auto-generated extension model for @swamp/gcp/adsense/accounts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud AdSense Management Accounts.
 *
...
/** Swamp extension model for Google Cloud AdSense Management Accounts. Registered at `@swamp/gcp/adsense/accounts`. */
export const model = {
  type: "@swamp/gcp/adsense/accounts",
  ...
  methods: {
    ...
    get_ad_blocking_recovery_tag: {
      description: "get ad blocking recovery tag",
      arguments: z.object({}),
