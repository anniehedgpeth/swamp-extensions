...
// Auto-generated extension model for @swamp/gcp/adsense/accounts-policyissues
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/policyIssues/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  adClients: z.array(z.string()).optional(),
  adRequestCount: z.string().optional(),
  entityType: z.string().optional(),
  firstDetectedDate: z.object({
    day: z.number(),
    month: z.number(),
    year: z.number(),
  }).optional(),
  lastDetectedDate: z.object({
    day: z.number(),
    month: z.number(),
    year: z.number(),
  }).optional(),
  name: z.string(),
  policyTopics: z.array(z.object({
    mustFix: z.boolean(),
    topic: z.string(),
    type: z.string(),
  })).optional(),
  site: z.string().optional(),
  siteSection: z.string().optional(),
  uri: z.string().optional(),
  warningEscalationDate: z.object({
    day: z.number(),
    month: z.number(),
    year: z.number(),
  }).optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a policyIssues",
      arguments: z.object({
        identifier: z.string().describe("The name of the policyIssues"),
      }),
    ...
    sync: {
      description: "Sync policyIssues state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific policyIssues by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List policyIssues resources",
      arguments: z.object({
