...
// Auto-generated extension model for @swamp/gcp/adsense/accounts-adclients-customchannels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud AdSense Management Accounts.Adclients.Customchannels.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/customchannels/${shortName}`;
}

const BASE_URL = "https://adsense.googleapis.com/";
...
/** Swamp extension model for Google Cloud AdSense Management Accounts.Adclients.Customchannels. Registered at `@swamp/gcp/adsense/accounts-adclients-customchannels`. */
export const model = {
  type: "@swamp/gcp/adsense/accounts-adclients-customchannels",
  ...
  methods: {
    create: {
      description: "Create a customchannels",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a customchannels",
      arguments: z.object({
        identifier: z.string().describe("The name of the customchannels"),
      }),
    ...
    update: {
      description: "Update customchannels attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific customchannels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the customchannels",
      arguments: z.object({
        identifier: z.string().describe("The name of the customchannels"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync customchannels state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific customchannels by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List customchannels resources",
      arguments: z.object({
    ...
    list_linked_ad_units: {
      description: "list linked ad units",
      arguments: z.object({}),
