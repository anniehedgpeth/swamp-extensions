...
Google Cloud privateca resources.
...
Use
`swamp model type describe @swamp/gcp/privateca/capools_certificateauthorities_certificaterevocationlists`
...
```bash
# Create a new capools_certificateauthorities_certificaterevocationlists model
swamp model create @swamp/gcp/privateca/capools_certificateauthorities_certificaterevocationlists my-capools_certificateauthorities_certificaterevocationlists

# Edit the model to configure its properties
swamp model edit my-capools_certificateauthorities_certificaterevocationlists

# Create the resource in GCP
swamp model method run my-capools_certificateauthorities_certificaterevocationlists create

# Sync current state from GCP
swamp model method run my-capools_certificateauthorities_certificaterevocationlists sync
```
