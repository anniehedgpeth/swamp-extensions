...
/**
 * Swamp extension model for Google Cloud Certificate Authority CaPools.Certificates.
 *
...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description: "Removed: certificateDescription, revocationDetails",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          certificateDescription: _certificateDescription,
          revocationDetails: _revocationDetails,
          ...rest
        } = old;
        return rest;
      },
    ...
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["issuingCertificateAuthorityId"] !== undefined) {
          params["issuingCertificateAuthorityId"] = String(
