...
Use `swamp model type describe @swamp/gcp/gmail/users_drafts` to see the full
...
```bash
# Create a new users_drafts model
swamp model create @swamp/gcp/gmail/users_drafts my-users_drafts

# Edit the model to configure its properties
swamp model edit my-users_drafts

# Create the resource in GCP
swamp model method run my-users_drafts create

# Sync current state from GCP
swamp model method run my-users_drafts sync
```
