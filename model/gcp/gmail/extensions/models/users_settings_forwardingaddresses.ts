...
/**
 * Swamp extension model for Google Cloud Gmail Users.Settings.ForwardingAddresses.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific forwardingAddresses by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List forwardingAddresses resources",
      arguments: z.object({
