...
Google Cloud cloudsupport resources.
...
Use `swamp model type describe @swamp/gcp/cloudsupport/cases_attachments` to see
...
```bash
# Create a new cases_attachments model
swamp model create @swamp/gcp/cloudsupport/cases_attachments my-cases_attachments

# Edit the model to configure its properties
swamp model edit my-cases_attachments

# Create the resource in GCP
swamp model method run my-cases_attachments create

# Sync current state from GCP
swamp model method run my-cases_attachments sync
```
