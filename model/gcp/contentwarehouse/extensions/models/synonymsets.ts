...
// Auto-generated extension model for @swamp/gcp/contentwarehouse/synonymsets
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/synonymSets/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  })).describe("List of Synonyms for the context.").optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        'Represents a list of synonyms for a given context. For example a context "sal...',
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a synonymSets",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["synonyms"] !== undefined) body["synonyms"] = g["synonyms"];
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a synonymSets",
      arguments: z.object({
        identifier: z.string().describe("The name of the synonymSets"),
      }),
    ...
    update: {
      description: "Update synonymSets attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific synonymSets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the synonymSets",
      arguments: z.object({
        identifier: z.string().describe("The name of the synonymSets"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync synonymSets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific synonymSets by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List synonymSets resources",
      arguments: z.object({
