...
Google Cloud cloudkms resources.
...
Use `swamp model type describe @swamp/gcp/cloudkms/ekmconnections` to see the
...
```bash
# Create a new ekmconnections model
swamp model create @swamp/gcp/cloudkms/ekmconnections my-ekmconnections

# Edit the model to configure its properties
swamp model edit my-ekmconnections

# Create the resource in GCP
swamp model method run my-ekmconnections create

# Sync current state from GCP
swamp model method run my-ekmconnections sync
```
