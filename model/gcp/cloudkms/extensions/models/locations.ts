...
// Auto-generated extension model for @swamp/gcp/cloudkms/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Key Management Service (KMS) Locations.
 *
...
/** Swamp extension model for Google Cloud Key Management Service (KMS) Locations. Registered at `@swamp/gcp/cloudkms/locations`. */
export const model = {
  type: "@swamp/gcp/cloudkms/locations",
  ...
  methods: {
    ...
    generate_random_bytes: {
      ...
      arguments: z.object({
        lengthBytes: z.any().optional(),
        protectionLevel: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (args["lengthBytes"] !== undefined) {
          body["lengthBytes"] = args["lengthBytes"];
        }
        if (args["protectionLevel"] !== undefined) {
          body["protectionLevel"] = args["protectionLevel"];
        }
    ...
    update_ekm_config: {
      description: "update ekm config",
      arguments: z.object({
        defaultEkmConnection: z.any().optional(),
        name: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        ...
        if (g["name"] !== undefined) params["name"] = String(g["name"]);
        const body: Record<string, unknown> = {};
        if (args["defaultEkmConnection"] !== undefined) {
          body["defaultEkmConnection"] = args["defaultEkmConnection"];
        }
