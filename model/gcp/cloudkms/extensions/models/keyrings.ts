...
// Auto-generated extension model for @swamp/gcp/cloudkms/keyrings
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Key Management Service (KMS) KeyRings.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/keyRings/${shortName}`;
}
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["keyRingId"] !== undefined) {
          params["keyRingId"] = String(g["keyRingId"]);
        }
        if (g["name"] !== undefined) {
    ...
    sync: {
      description: "Sync keyRings state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific keyRings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List keyRings resources",
      arguments: z.object({
