...
/**
 * Swamp extension model for Google Cloud Key Management Service (KMS) EkmConnections.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["ekmConnectionId"] !== undefined) {
          params["ekmConnectionId"] = String(g["ekmConnectionId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific ekmConnections by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List ekmConnections resources",
      arguments: z.object({
