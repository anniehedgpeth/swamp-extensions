...
// Auto-generated extension model for @swamp/gcp/cloudkms/retiredresources
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Key Management Service (KMS) RetiredResources.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/retiredResources/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  name: z.string(),
  originalResource: z.string().optional(),
...
/** Swamp extension model for Google Cloud Key Management Service (KMS) RetiredResources. Registered at `@swamp/gcp/cloudkms/retiredresources`. */
export const model = {
  type: "@swamp/gcp/cloudkms/retiredresources",
  ...
  methods: {
    get: {
      description: "Get a retiredResources",
      arguments: z.object({
        identifier: z.string().describe("The name of the retiredResources"),
      }),
    ...
    sync: {
      description: "Sync retiredResources state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific retiredResources by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List retiredResources resources",
      arguments: z.object({
