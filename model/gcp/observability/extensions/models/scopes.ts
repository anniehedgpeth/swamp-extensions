...
/**
 * Swamp extension model for Google Cloud Observability Scopes.
 *
...
/** Swamp extension model for Google Cloud Observability Scopes. Registered at `@swamp/gcp/observability/scopes`. */
export const model = {
