...
// Auto-generated extension model for @swamp/gcp/observability/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Observability Locations.
 *
...
/** Swamp extension model for Google Cloud Observability Locations. Registered at `@swamp/gcp/observability/locations`. */
export const model = {
  type: "@swamp/gcp/observability/locations",
  ...
  methods: {
    ...
    update_settings: {
      ...
      arguments: z.object({
        defaultStorageLocation: z.any().optional(),
        kmsKeyName: z.any().optional(),
        name: z.any().optional(),
        serviceAccountId: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (args["defaultStorageLocation"] !== undefined) {
          body["defaultStorageLocation"] = args["defaultStorageLocation"];
        }
        ...
        if (args["serviceAccountId"] !== undefined) {
          body["serviceAccountId"] = args["serviceAccountId"];
        }
        const result = await createResource(
          BASE_URL,
          {
