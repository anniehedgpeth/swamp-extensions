...
// Auto-generated extension model for @swamp/gcp/observability/tracescopes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Observability TraceScopes.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/traceScopes/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  traceScopeId: z.string().describe(
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a traceScopes",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["traceScopeId"] !== undefined) {
          params["traceScopeId"] = String(g["traceScopeId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a traceScopes",
      arguments: z.object({
        identifier: z.string().describe("The name of the traceScopes"),
      }),
    ...
    update: {
      description: "Update traceScopes attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific traceScopes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the traceScopes",
      arguments: z.object({
        identifier: z.string().describe("The name of the traceScopes"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync traceScopes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific traceScopes by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List traceScopes resources",
      arguments: z.object({
