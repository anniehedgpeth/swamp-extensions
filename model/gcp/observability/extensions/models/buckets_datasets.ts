...
// Auto-generated extension model for @swamp/gcp/observability/buckets-datasets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Observability Buckets.Datasets.
 *
...
/** Swamp extension model for Google Cloud Observability Buckets.Datasets. Registered at `@swamp/gcp/observability/buckets-datasets`. */
export const model = {
  type: "@swamp/gcp/observability/buckets-datasets",
  ...
  resources: {
    state: {
      description:
        "A dataset is a collection of data that has a specific configuration. A datase...",
      schema: StateSchema,
      lifetime: "infinite",
