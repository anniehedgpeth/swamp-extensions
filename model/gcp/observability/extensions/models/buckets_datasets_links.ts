...
// Auto-generated extension model for @swamp/gcp/observability/buckets-datasets-links
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Observability Buckets.Datasets.Links.
 *
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Optional. Description of the link.")
    .optional(),
  displayName: z.string().describe("Optional. A user friendly display name.")
    .optional(),
  ...
  linkId: z.string().describe("Required. Id of the link to create.").optional(),
...
/** Swamp extension model for Google Cloud Observability Buckets.Datasets.Links. Registered at `@swamp/gcp/observability/buckets-datasets-links`. */
export const model = {
  type: "@swamp/gcp/observability/buckets-datasets-links",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["linkId"] !== undefined) params["linkId"] = String(g["linkId"]);
    ...
    update: {
      description: "Update links attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific links by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List links resources",
      arguments: z.object({
