...
Google Cloud observability resources.
...
Use `swamp model type describe @swamp/gcp/observability/buckets_datasets_links`
...
```bash
# Create a new buckets_datasets_links model
swamp model create @swamp/gcp/observability/buckets_datasets_links my-buckets_datasets_links

# Edit the model to configure its properties
swamp model edit my-buckets_datasets_links

# Create the resource in GCP
swamp model method run my-buckets_datasets_links create

# Sync current state from GCP
swamp model method run my-buckets_datasets_links sync
```
