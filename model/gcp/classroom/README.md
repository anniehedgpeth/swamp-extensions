...
Google Cloud classroom resources.
...
Use `swamp model type describe @swamp/gcp/classroom/courses_aliases` to see the
...
```bash
# Create a new courses_aliases model
swamp model create @swamp/gcp/classroom/courses_aliases my-courses_aliases

# Edit the model to configure its properties
swamp model edit my-courses_aliases

# Create the resource in GCP
swamp model method run my-courses_aliases create

# Sync current state from GCP
swamp model method run my-courses_aliases sync
```
