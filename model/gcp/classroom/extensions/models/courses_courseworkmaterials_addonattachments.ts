...
// Auto-generated extension model for @swamp/gcp/classroom/courses-courseworkmaterials-addonattachments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Classroom Courses.CourseWorkMaterials.AddOnAttachments.
 *
...
/** Swamp extension model for Google Cloud Google Classroom Courses.CourseWorkMaterials.AddOnAttachments. Registered at `@swamp/gcp/classroom/courses-courseworkmaterials-addonattachments`. */
export const model = {
  type: "@swamp/gcp/classroom/courses-courseworkmaterials-addonattachments",
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific addOnAttachments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List addOnAttachments resources",
      arguments: z.object({
