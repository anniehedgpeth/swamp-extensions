...
// Auto-generated extension model for @swamp/gcp/classroom/courses-coursework-addonattachments-studentsubmissions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Classroom Courses.CourseWork.AddOnAttachments.StudentSubmissions.
 *
...
/** Swamp extension model for Google Cloud Google Classroom Courses.CourseWork.AddOnAttachments.StudentSubmissions. Registered at `@swamp/gcp/classroom/courses-coursework-addonattachments-studentsubmissions`. */
export const model = {
  type:
