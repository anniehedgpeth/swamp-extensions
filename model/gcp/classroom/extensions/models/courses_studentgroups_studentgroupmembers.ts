...
export const model = {
  ...
  methods: {
        ...
        const result = await createResource(
          ...
          undefined,
          {
            ...
            listParams: {
              ...
              "studentGroupId": String(g["studentGroupId"] ?? ""),
            },
            matchField: "name",
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific studentGroupMembers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List studentGroupMembers resources",
      arguments: z.object({
