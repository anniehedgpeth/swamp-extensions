...
Google Cloud managedidentities resources.
...
Use
`swamp model type describe @swamp/gcp/managedidentities/global_domains_backups`
...
```bash
# Create a new global_domains_backups model
swamp model create @swamp/gcp/managedidentities/global_domains_backups my-global_domains_backups

# Edit the model to configure its properties
swamp model edit my-global_domains_backups

# Create the resource in GCP
swamp model method run my-global_domains_backups create

# Sync current state from GCP
swamp model method run my-global_domains_backups sync
```
