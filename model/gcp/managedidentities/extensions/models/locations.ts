...
// Auto-generated extension model for @swamp/gcp/managedidentities/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Microsoft Active Directory Locations.
 *
...
/** Swamp extension model for Google Cloud Managed Service for Microsoft Active Directory Locations. Registered at `@swamp/gcp/managedidentities/locations`. */
export const model = {
  type: "@swamp/gcp/managedidentities/locations",
