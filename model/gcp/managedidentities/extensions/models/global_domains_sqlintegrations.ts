...
// Auto-generated extension model for @swamp/gcp/managedidentities/global-domains-sqlintegrations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Microsoft Active Directory Global.Domains.SqlIntegrations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/sqlIntegrations/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Managed Service for Microsoft Active Directory Global.Domains.SqlIntegrations. Registered at `@swamp/gcp/managedidentities/global-domains-sqlintegrations`. */
export const model = {
  type: "@swamp/gcp/managedidentities/global-domains-sqlintegrations",
  ...
  methods: {
    get: {
      description: "Get a sqlIntegrations",
      arguments: z.object({
        identifier: z.string().describe("The name of the sqlIntegrations"),
      }),
    ...
    sync: {
      description: "Sync sqlIntegrations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sqlIntegrations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List sqlIntegrations resources",
      arguments: z.object({
