...
// Auto-generated extension model for @swamp/gcp/managedidentities/global-peerings
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Managed Service for Microsoft Active Directory Global.Peerings.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/peerings/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  domainResource: z.string().describe(
...
const StateSchema = z.object({
  ...
  domainResource: z.string().optional(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["domainResource"] !== undefined) {
          body["domainResource"] = g["domainResource"];
        }
        if (g["labels"] !== undefined) body["labels"] = g["labels"];
        if (g["peeringId"] !== undefined) {
          params["peeringId"] = String(g["peeringId"]);
        }
    ...
    get: {
      description: "Get a peerings",
      arguments: z.object({
        identifier: z.string().describe("The name of the peerings"),
      }),
    ...
    update: {
      description: "Update peerings attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific peerings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the peerings",
      arguments: z.object({
        identifier: z.string().describe("The name of the peerings"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync peerings state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific peerings by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List peerings resources",
      arguments: z.object({
