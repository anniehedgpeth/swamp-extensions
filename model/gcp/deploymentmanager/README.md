...
Google Cloud deploymentmanager resources.
...
Use `swamp model type describe @swamp/gcp/deploymentmanager/deployments` to see
...
```bash
# Create a new deployments model
swamp model create @swamp/gcp/deploymentmanager/deployments my-deployments
