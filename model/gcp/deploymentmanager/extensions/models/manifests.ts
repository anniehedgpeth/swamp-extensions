...
/**
 * Swamp extension model for Google Cloud Deployment Manager Manifests.
 *
...
/** Swamp extension model for Google Cloud Deployment Manager Manifests. Registered at `@swamp/gcp/deploymentmanager/manifests`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific manifests by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List manifests resources",
      arguments: z.object({
