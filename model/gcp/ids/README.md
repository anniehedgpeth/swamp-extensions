...
Use `swamp model type describe @swamp/gcp/ids/endpoints` to see the full list of
...
```bash
# Create a new endpoints model
swamp model create @swamp/gcp/ids/endpoints my-endpoints

# Edit the model to configure its properties
swamp model edit my-endpoints

# Create the resource in GCP
swamp model method run my-endpoints create

# Sync current state from GCP
swamp model method run my-endpoints sync
```
