...
// Auto-generated extension model for @swamp/gcp/run/namespaces-authorizeddomains
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Run Admin Namespaces.Authorizeddomains.
 *
...
/** Swamp extension model for Google Cloud Run Admin Namespaces.Authorizeddomains. Registered at `@swamp/gcp/run/namespaces-authorizeddomains`. */
export const model = {
  type: "@swamp/gcp/run/namespaces-authorizeddomains",
