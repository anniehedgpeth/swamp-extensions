...
// Auto-generated extension model for @swamp/gcp/run/authorizeddomains
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Run Admin Authorizeddomains.
 *
...
/** Swamp extension model for Google Cloud Run Admin Authorizeddomains. Registered at `@swamp/gcp/run/authorizeddomains`. */
export const model = {
  type: "@swamp/gcp/run/authorizeddomains",
