...
// Auto-generated extension model for @swamp/gcp/run/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Run Admin Locations.
 *
...
/** Swamp extension model for Google Cloud Run Admin Locations. Registered at `@swamp/gcp/run/locations`. */
export const model = {
