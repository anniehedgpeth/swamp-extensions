...
Google Cloud cloudprofiler resources.
...
Use `swamp model type describe @swamp/gcp/cloudprofiler/profiles` to see the
...
swamp model create @swamp/gcp/cloudprofiler/profiles my-profiles

# Edit the model to configure its properties
swamp model edit my-profiles

# Create the resource in GCP
swamp model method run my-profiles create

# Sync current state from GCP
swamp model method run my-profiles sync
```
