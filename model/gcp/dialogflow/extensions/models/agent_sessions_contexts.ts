...
// Auto-generated extension model for @swamp/gcp/dialogflow/agent-sessions-contexts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agent.Sessions.Contexts.
 *
 * GCP dialogflow Agent.Sessions.Contexts resource
 *
...
/** Swamp extension model for Google Cloud Dialogflow Agent.Sessions.Contexts. Registered at `@swamp/gcp/dialogflow/agent-sessions-contexts`. */
export const model = {
  type: "@swamp/gcp/dialogflow/agent-sessions-contexts",
  ...
  resources: {
    state: {
      description: "GCP dialogflow Agent.Sessions.Contexts resource",
      schema: StateSchema,
      lifetime: "infinite",
