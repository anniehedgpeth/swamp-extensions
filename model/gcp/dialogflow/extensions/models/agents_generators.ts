...
/**
 * Swamp extension model for Google Cloud Dialogflow Agents.Generators.
 *
 * GCP dialogflow Agents.Generators resource
 *
...
/** Swamp extension model for Google Cloud Dialogflow Agents.Generators. Registered at `@swamp/gcp/dialogflow/agents-generators`. */
export const model = {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific generators by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
