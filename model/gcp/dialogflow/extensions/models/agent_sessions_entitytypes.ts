...
// Auto-generated extension model for @swamp/gcp/dialogflow/agent-sessions-entitytypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agent.Sessions.EntityTypes.
 *
 * GCP dialogflow Agent.Sessions.EntityTypes resource
 *
...
/** Swamp extension model for Google Cloud Dialogflow Agent.Sessions.EntityTypes. Registered at `@swamp/gcp/dialogflow/agent-sessions-entitytypes`. */
export const model = {
  type: "@swamp/gcp/dialogflow/agent-sessions-entitytypes",
  ...
  resources: {
    state: {
      description: "GCP dialogflow Agent.Sessions.EntityTypes resource",
      schema: StateSchema,
      lifetime: "infinite",
