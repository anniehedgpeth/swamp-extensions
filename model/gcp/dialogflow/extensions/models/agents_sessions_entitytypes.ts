...
// Auto-generated extension model for @swamp/gcp/dialogflow/agents-sessions-entitytypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agents.Sessions.EntityTypes.
 *
 * GCP dialogflow Agents.Sessions.EntityTypes resource
 *
...
export const model = {
  ...
  resources: {
    state: {
      description: "GCP dialogflow Agents.Sessions.EntityTypes resource",
      schema: StateSchema,
      lifetime: "infinite",
