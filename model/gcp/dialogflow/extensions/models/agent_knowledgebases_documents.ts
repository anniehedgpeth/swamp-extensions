...
// Auto-generated extension model for @swamp/gcp/dialogflow/agent-knowledgebases-documents
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agent.KnowledgeBases.Documents.
 *
 * GCP dialogflow Agent.KnowledgeBases.Documents resource
 *
...
/** Swamp extension model for Google Cloud Dialogflow Agent.KnowledgeBases.Documents. Registered at `@swamp/gcp/dialogflow/agent-knowledgebases-documents`. */
export const model = {
  type: "@swamp/gcp/dialogflow/agent-knowledgebases-documents",
  ...
  resources: {
    state: {
      description: "GCP dialogflow Agent.KnowledgeBases.Documents resource",
      schema: StateSchema,
      lifetime: "infinite",
