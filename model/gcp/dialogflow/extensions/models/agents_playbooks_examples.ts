...
/**
 * Swamp extension model for Google Cloud Dialogflow Agents.Playbooks.Examples.
 *
 * GCP dialogflow Agents.Playbooks.Examples resource
 *
...
/** Swamp extension model for Google Cloud Dialogflow Agents.Playbooks.Examples. Registered at `@swamp/gcp/dialogflow/agents-playbooks-examples`. */
export const model = {
