...
// Auto-generated extension model for @swamp/gcp/dialogflow/agent-versions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agent.Versions.
 *
 * GCP dialogflow Agent.Versions resource
 *
...
/** Swamp extension model for Google Cloud Dialogflow Agent.Versions. Registered at `@swamp/gcp/dialogflow/agent-versions`. */
export const model = {
  type: "@swamp/gcp/dialogflow/agent-versions",
  version: "2026.07.21.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "GCP dialogflow Agent.Versions resource",
      schema: StateSchema,
      lifetime: "infinite",
