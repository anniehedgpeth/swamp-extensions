...
/**
 * Swamp extension model for Google Cloud Dialogflow Agents.EntityTypes.
 *
 * GCP dialogflow Agents.EntityTypes resource
 *
...
/** Swamp extension model for Google Cloud Dialogflow Agents.EntityTypes. Registered at `@swamp/gcp/dialogflow/agents-entitytypes`. */
export const model = {
