...
// Auto-generated extension model for @swamp/gcp/dialogflow/agents-environments-sessions-entitytypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agents.Environments.Sessions.EntityTypes.
 *
 * GCP dialogflow Agents.Environments.Sessions.EntityTypes resource
 *
...
/** Swamp extension model for Google Cloud Dialogflow Agents.Environments.Sessions.EntityTypes. Registered at `@swamp/gcp/dialogflow/agents-environments-sessions-entitytypes`. */
export const model = {
  type: "@swamp/gcp/dialogflow/agents-environments-sessions-entitytypes",
