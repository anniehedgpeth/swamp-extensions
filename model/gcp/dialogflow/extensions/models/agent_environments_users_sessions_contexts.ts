...
// Auto-generated extension model for @swamp/gcp/dialogflow/agent-environments-users-sessions-contexts
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agent.Environments.Users.Sessions.Contexts.
 *
 * GCP dialogflow Agent.Environments.Users.Sessions.Contexts resource
 *
...
const StateSchema = z.object({
  lifespanCount: z.number().optional(),
  name: z.string(),
...
/** Swamp extension model for Google Cloud Dialogflow Agent.Environments.Users.Sessions.Contexts. Registered at `@swamp/gcp/dialogflow/agent-environments-users-sessions-contexts`. */
export const model = {
  type: "@swamp/gcp/dialogflow/agent-environments-users-sessions-contexts",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["lifespanCount"] !== undefined) {
          body["lifespanCount"] = g["lifespanCount"];
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific contexts by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
