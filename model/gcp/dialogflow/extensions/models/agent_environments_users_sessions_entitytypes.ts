...
// Auto-generated extension model for @swamp/gcp/dialogflow/agent-environments-users-sessions-entitytypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agent.Environments.Users.Sessions.EntityTypes.
 *
 * GCP dialogflow Agent.Environments.Users.Sessions.EntityTypes resource
 *
...
const StateSchema = z.object({
  ...
  entityOverrideMode: z.string().optional(),
  name: z.string(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Dialogflow Agent.Environments.Users.Sessions.EntityTypes. Registered at `@swamp/gcp/dialogflow/agent-environments-users-sessions-entitytypes`. */
export const model = {
  type: "@swamp/gcp/dialogflow/agent-environments-users-sessions-entitytypes",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["entityOverrideMode"] !== undefined) {
          body["entityOverrideMode"] = g["entityOverrideMode"];
        }
