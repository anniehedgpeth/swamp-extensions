...
// Auto-generated extension model for @swamp/gcp/dialogflow/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Locations.
 *
 * GCP dialogflow Locations resource
 *
...
const InputsSchema = z.object({
  ...
  name: z.string().describe("The name for this resource").optional(),
});
...
/** Swamp extension model for Google Cloud Dialogflow Locations. Registered at `@swamp/gcp/dialogflow/locations`. */
export const model = {
  type: "@swamp/gcp/dialogflow/locations",
  ...
  resources: {
    state: {
      description: "GCP dialogflow Locations resource",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    list: {
      ...
      arguments: z.object({
        extraLocationTypes: z.string().optional(),
