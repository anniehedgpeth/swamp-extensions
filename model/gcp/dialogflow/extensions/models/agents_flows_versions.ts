...
// Auto-generated extension model for @swamp/gcp/dialogflow/agents-flows-versions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow Agents.Flows.Versions.
 *
 * GCP dialogflow Agents.Flows.Versions resource
 *
...
const GlobalArgsSchema = z.object({
  ...
  state: z.enum(["STATE_UNSPECIFIED", "RUNNING", "SUCCEEDED", "FAILED"])
    .optional(),
...
/** Swamp extension model for Google Cloud Dialogflow Agents.Flows.Versions. Registered at `@swamp/gcp/dialogflow/agents-flows-versions`. */
export const model = {
  type: "@swamp/gcp/dialogflow/agents-flows-versions",
  ...
  resources: {
    state: {
      description: "GCP dialogflow Agents.Flows.Versions resource",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    compare_versions: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["baseVersion"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const body: Record<string, unknown> = {};
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["baseVersion"],
            "parameters": {
              "baseVersion": { "location": "path", "required": true },
            },
          },
          params,
          body,
    ...
    load: {
      description: "load",
      arguments: z.object({
        allowOverrideAgentResources: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const baseUrl = g["apiEndpoint"]?.toString() ??
        ...
        const body: Record<string, unknown> = {};
        if (args["allowOverrideAgentResources"] !== undefined) {
          body["allowOverrideAgentResources"] =
            args["allowOverrideAgentResources"];
        }
        const result = await createResource(
          baseUrl,
          {
