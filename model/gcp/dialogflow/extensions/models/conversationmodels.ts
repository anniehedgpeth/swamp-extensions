...
// Auto-generated extension model for @swamp/gcp/dialogflow/conversationmodels
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow ConversationModels.
 *
 * GCP dialogflow ConversationModels resource
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/conversationModels/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  articleSuggestionModelMetadata: z.object({
    trainingModelType: z.enum([
  ...
  smartReplyModelMetadata: z.object({
    trainingModelType: z.enum([
      "MODEL_TYPE_UNSPECIFIED",
      "SMART_REPLY_DUAL_ENCODER_MODEL",
      "SMART_REPLY_BERT_MODEL",
...
export const model = {
  ...
  resources: {
    state: {
      description: "GCP dialogflow ConversationModels resource",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a conversationModels",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["articleSuggestionModelMetadata"] !== undefined) {
          body["articleSuggestionModelMetadata"] =
            g["articleSuggestionModelMetadata"];
        }
        ...
        if (g["smartReplyModelMetadata"] !== undefined) {
          body["smartReplyModelMetadata"] = g["smartReplyModelMetadata"];
        }
    ...
    get: {
      description: "Get a conversationModels",
      arguments: z.object({
        identifier: z.string().describe("The name of the conversationModels"),
      }),
    ...
    delete: {
      description: "Delete the conversationModels",
      arguments: z.object({
        identifier: z.string().describe("The name of the conversationModels"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync conversationModels state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific conversationModels by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List conversationModels resources",
      arguments: z.object({
