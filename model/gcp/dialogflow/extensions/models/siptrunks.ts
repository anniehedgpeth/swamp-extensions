...
// Auto-generated extension model for @swamp/gcp/dialogflow/siptrunks
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dialogflow SipTrunks.
 *
 * GCP dialogflow SipTrunks resource
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/sipTrunks/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description: "GCP dialogflow SipTrunks resource",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a sipTrunks",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a sipTrunks",
      arguments: z.object({
        identifier: z.string().describe("The name of the sipTrunks"),
      }),
    ...
    update: {
      description: "Update sipTrunks attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sipTrunks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the sipTrunks",
      arguments: z.object({
        identifier: z.string().describe("The name of the sipTrunks"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync sipTrunks state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sipTrunks by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List sipTrunks resources",
      arguments: z.object({
