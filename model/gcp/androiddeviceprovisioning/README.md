...
Google Cloud androiddeviceprovisioning resources.
...
Use
`swamp model type describe @swamp/gcp/androiddeviceprovisioning/customers_configurations`
...
```bash
# Create a new customers_configurations model
swamp model create @swamp/gcp/androiddeviceprovisioning/customers_configurations my-customers_configurations

# Edit the model to configure its properties
swamp model edit my-customers_configurations

# Create the resource in GCP
swamp model method run my-customers_configurations create

# Sync current state from GCP
swamp model method run my-customers_configurations sync
```
