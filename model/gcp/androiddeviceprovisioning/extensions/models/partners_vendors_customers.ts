...
// Auto-generated extension model for @swamp/gcp/androiddeviceprovisioning/partners-vendors-customers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Android Device Provisioning Partner Partners.Vendors.Customers.
 *
...
/** Swamp extension model for Google Cloud Android Device Provisioning Partner Partners.Vendors.Customers. Registered at `@swamp/gcp/androiddeviceprovisioning/partners-vendors-customers`. */
export const model = {
  type: "@swamp/gcp/androiddeviceprovisioning/partners-vendors-customers",
