...
Google Cloud cloudasset resources.
...
Use `swamp model type describe @swamp/gcp/cloudasset/assets` to see the full
...
swamp model create @swamp/gcp/cloudasset/assets my-assets
