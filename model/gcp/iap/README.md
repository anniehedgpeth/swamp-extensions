...
Use `swamp model type describe @swamp/gcp/iap/brands_identityawareproxyclients`
...
```bash
# Create a new brands_identityawareproxyclients model
swamp model create @swamp/gcp/iap/brands_identityawareproxyclients my-brands_identityawareproxyclients

# Edit the model to configure its properties
swamp model edit my-brands_identityawareproxyclients

# Create the resource in GCP
swamp model method run my-brands_identityawareproxyclients create

# Sync current state from GCP
swamp model method run my-brands_identityawareproxyclients sync
```
