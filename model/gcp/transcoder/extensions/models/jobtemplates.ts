...
/**
 * Swamp extension model for Google Cloud Transcoder JobTemplates.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["jobTemplateId"] !== undefined) {
          params["jobTemplateId"] = String(g["jobTemplateId"]);
        }
        if (g["name"] !== undefined) {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific jobTemplates by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List jobTemplates resources",
      arguments: z.object({
