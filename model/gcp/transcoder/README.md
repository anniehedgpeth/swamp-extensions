...
Google Cloud transcoder resources.
...
Use `swamp model type describe @swamp/gcp/transcoder/jobs` to see the full list
...
swamp model create @swamp/gcp/transcoder/jobs my-jobs
