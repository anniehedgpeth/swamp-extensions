...
Google Cloud cloudchannel resources.
...
Use
`swamp model type describe @swamp/gcp/cloudchannel/accounts_channelpartnerlinks_channelpartnerrepricingconfigs`
...
```bash
# Create a new accounts_channelpartnerlinks_channelpartnerrepricingconfigs model
swamp model create @swamp/gcp/cloudchannel/accounts_channelpartnerlinks_channelpartnerrepricingconfigs my-accounts_channelpartnerlinks_channelpartnerrepricingconfigs

# Edit the model to configure its properties
swamp model edit my-accounts_channelpartnerlinks_channelpartnerrepricingconfigs

# Create the resource in GCP
swamp model method run my-accounts_channelpartnerlinks_channelpartnerrepricingconfigs create

# Sync current state from GCP
swamp model method run my-accounts_channelpartnerlinks_channelpartnerrepricingconfigs sync
```
