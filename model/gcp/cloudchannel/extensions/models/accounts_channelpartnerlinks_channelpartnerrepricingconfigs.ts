...
// Auto-generated extension model for @swamp/gcp/cloudchannel/accounts-channelpartnerlinks-channelpartnerrepricingconfigs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Channel Accounts.ChannelPartnerLinks.ChannelPartnerRepricingConfigs.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/channelPartnerRepricingConfigs/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Channel Accounts.ChannelPartnerLinks.ChannelPartnerRepricingConfigs. Registered at `@swamp/gcp/cloudchannel/accounts-channelpartnerlinks-channelpartnerrepricingconfigs`. */
export const model = {
  type:
  ...
  methods: {
    create: {
      description: "Create a channelPartnerRepricingConfigs",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a channelPartnerRepricingConfigs",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the channelPartnerRepricingConfigs",
        ),
      }),
    ...
    update: {
      description: "Update channelPartnerRepricingConfigs attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific channelPartnerRepricingConfigs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the channelPartnerRepricingConfigs",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the channelPartnerRepricingConfigs",
        ),
    ...
    sync: {
      description: "Sync channelPartnerRepricingConfigs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific channelPartnerRepricingConfigs by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List channelPartnerRepricingConfigs resources",
      arguments: z.object({
