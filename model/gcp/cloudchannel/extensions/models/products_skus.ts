...
// Auto-generated extension model for @swamp/gcp/cloudchannel/products-skus
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Channel Products.Skus.
 *
...
/** Swamp extension model for Google Cloud Channel Products.Skus. Registered at `@swamp/gcp/cloudchannel/products-skus`. */
export const model = {
  type: "@swamp/gcp/cloudchannel/products-skus",
  ...
  resources: {
    state: {
      description:
        "Represents a product's purchasable Stock Keeping Unit (SKU). SKUs represent t...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific skus by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List skus resources",
      arguments: z.object({
