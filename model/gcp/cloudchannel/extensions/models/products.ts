...
// Auto-generated extension model for @swamp/gcp/cloudchannel/products
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Channel Products.
 *
...
/** Swamp extension model for Google Cloud Channel Products. Registered at `@swamp/gcp/cloudchannel/products`. */
export const model = {
  type: "@swamp/gcp/cloudchannel/products",
  ...
  resources: {
    state: {
      description:
        "A Product is the entity a customer uses when placing an order. For example, G...",
      schema: StateSchema,
      lifetime: "infinite",
