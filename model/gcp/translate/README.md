...
Google Cloud translate resources.
...
Use
`swamp model type describe @swamp/gcp/translate/adaptivemtdatasets_adaptivemtfiles_adaptivemtsentences`
...
```bash
# Create a new adaptivemtdatasets_adaptivemtfiles_adaptivemtsentences model
swamp model create @swamp/gcp/translate/adaptivemtdatasets_adaptivemtfiles_adaptivemtsentences my-adaptivemtdatasets_adaptivemtfiles_adaptivemtsentences

# Edit the model to configure its properties
swamp model edit my-adaptivemtdatasets_adaptivemtfiles_adaptivemtsentences

# Create the resource in GCP
swamp model method run my-adaptivemtdatasets_adaptivemtfiles_adaptivemtsentences create

# Sync current state from GCP
swamp model method run my-adaptivemtdatasets_adaptivemtfiles_adaptivemtsentences sync
```
