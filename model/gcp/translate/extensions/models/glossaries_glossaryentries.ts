...
/**
 * Swamp extension model for Google Cloud Translation Glossaries.GlossaryEntries.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific glossaryEntries by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List glossaryEntries resources",
      arguments: z.object({
