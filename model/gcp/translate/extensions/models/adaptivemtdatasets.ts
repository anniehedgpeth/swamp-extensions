...
// Auto-generated extension model for @swamp/gcp/translate/adaptivemtdatasets
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Translation AdaptiveMtDatasets.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/adaptiveMtDatasets/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a adaptiveMtDatasets",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["exampleCount"] !== undefined) {
          body["exampleCount"] = g["exampleCount"];
        }
    ...
    get: {
      description: "Get a adaptiveMtDatasets",
      arguments: z.object({
        identifier: z.string().describe("The name of the adaptiveMtDatasets"),
      }),
    ...
    delete: {
      description: "Delete the adaptiveMtDatasets",
      arguments: z.object({
        identifier: z.string().describe("The name of the adaptiveMtDatasets"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync adaptiveMtDatasets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific adaptiveMtDatasets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List adaptiveMtDatasets resources",
      arguments: z.object({
    ...
    import_adaptive_mt_file: {
      description: "import adaptive mt file",
      arguments: z.object({
        fileInputSource: z.any().optional(),
        gcsInputSource: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        const body: Record<string, unknown> = {};
        if (args["fileInputSource"] !== undefined) {
          body["fileInputSource"] = args["fileInputSource"];
        }
        if (args["gcsInputSource"] !== undefined) {
          body["gcsInputSource"] = args["gcsInputSource"];
        }
        const result = await createResource(
          BASE_URL,
          {
