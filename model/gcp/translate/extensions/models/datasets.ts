...
/**
 * Swamp extension model for Google Cloud Translation Datasets.
 *
...
/** Swamp extension model for Google Cloud Translation Datasets. Registered at `@swamp/gcp/translate/datasets`. */
export const model = {
