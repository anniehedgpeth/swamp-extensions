...
// Auto-generated extension model for @swamp/gcp/translate/datasets-examples
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Translation Datasets.Examples.
 *
 * A sentence pair.
 *
...
/** Swamp extension model for Google Cloud Translation Datasets.Examples. Registered at `@swamp/gcp/translate/datasets-examples`. */
export const model = {
  type: "@swamp/gcp/translate/datasets-examples",
