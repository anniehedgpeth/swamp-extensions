...
// Auto-generated extension model for @swamp/gcp/firebase/androidapps-sha
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase Management AndroidApps.Sha.
 *
...
const GlobalArgsSchema = z.object({
  ...
  certType: z.enum(["SHA_CERTIFICATE_TYPE_UNSPECIFIED", "SHA_1", "SHA_256"])
    .describe("The type of SHA certificate encoded in the hash.").optional(),
  ...
  shaHash: z.string().describe("The certificate hash for the `AndroidApp`.")
    .optional(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["certType"] !== undefined) body["certType"] = g["certType"];
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["shaHash"] !== undefined) body["shaHash"] = g["shaHash"];
    ...
    get: {
      description: "Get a sha",
      arguments: z.object({
        identifier: z.string().describe("The name of the sha"),
      }),
    ...
    sync: {
      description: "Sync sha state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sha by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List sha resources",
      arguments: z.object({
