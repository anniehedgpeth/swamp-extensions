...
// Auto-generated extension model for @swamp/gcp/firebase/availablelocations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase Management AvailableLocations.
 *
...
/** Swamp extension model for Google Cloud Firebase Management AvailableLocations. Registered at `@swamp/gcp/firebase/availablelocations`. */
export const model = {
  type: "@swamp/gcp/firebase/availablelocations",
  ...
  resources: {
    state: {
      description:
        "**DEPRECATED.** _This Location is no longer used to determine Firebase resour...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a availableLocations",
      arguments: z.object({
        identifier: z.string().describe("The name of the availableLocations"),
      }),
    ...
    sync: {
      description: "Sync availableLocations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific availableLocations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List availableLocations resources",
      arguments: z.object({
