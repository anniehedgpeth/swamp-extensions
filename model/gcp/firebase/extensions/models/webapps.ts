...
/**
 * Swamp extension model for Google Cloud Firebase Management WebApps.
 *
...
/** Swamp extension model for Google Cloud Firebase Management WebApps. Registered at `@swamp/gcp/firebase/webapps`. */
export const model = {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific webApps by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
