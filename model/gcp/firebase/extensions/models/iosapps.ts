...
// Auto-generated extension model for @swamp/gcp/firebase/iosapps
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Firebase Management IosApps.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/iosApps/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Firebase Management IosApps. Registered at `@swamp/gcp/firebase/iosapps`. */
export const model = {
  type: "@swamp/gcp/firebase/iosapps",
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["appStoreId"] !== undefined) body["appStoreId"] = g["appStoreId"];
        if (g["bundleId"] !== undefined) body["bundleId"] = g["bundleId"];
        if (g["displayName"] !== undefined) {
          body["displayName"] = g["displayName"];
        }
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["teamId"] !== undefined) body["teamId"] = g["teamId"];
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a iosApps",
      arguments: z.object({
        identifier: z.string().describe("The name of the iosApps"),
      }),
    ...
    update: {
      description: "Update iosApps attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific iosApps by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the iosApps",
      arguments: z.object({
        identifier: z.string().describe("The name of the iosApps"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync iosApps state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific iosApps by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List iosApps resources",
      arguments: z.object({
