...
Google Cloud mybusinessbusinessinformation resources.
...
Use
`swamp model type describe @swamp/gcp/mybusinessbusinessinformation/accounts` to
...
```bash
# Create a new accounts model
swamp model create @swamp/gcp/mybusinessbusinessinformation/accounts my-accounts

# Edit the model to configure its properties
swamp model edit my-accounts

# Create the resource in GCP
swamp model method run my-accounts create

# Sync current state from GCP
swamp model method run my-accounts sync
```
