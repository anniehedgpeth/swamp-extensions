...
/**
 * Swamp extension model for Google Cloud Google Analytics Admin Properties.CustomDimensions.
 *
...
/** Swamp extension model for Google Cloud Google Analytics Admin Properties.CustomDimensions. Registered at `@swamp/gcp/analyticsadmin/properties-customdimensions`. */
export const model = {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific customDimensions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
