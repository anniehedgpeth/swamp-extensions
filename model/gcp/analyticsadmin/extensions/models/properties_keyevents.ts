...
/**
 * Swamp extension model for Google Cloud Google Analytics Admin Properties.KeyEvents.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific keyEvents by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List keyEvents resources",
      arguments: z.object({
