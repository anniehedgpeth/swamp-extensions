...
// Auto-generated extension model for @swamp/gcp/analyticsadmin/properties-datastreams-measurementprotocolsecrets
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/measurementProtocolSecrets/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a measurementProtocolSecrets",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a measurementProtocolSecrets",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the measurementProtocolSecrets",
        ),
      }),
    ...
    update: {
      description: "Update measurementProtocolSecrets attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific measurementProtocolSecrets by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the measurementProtocolSecrets",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the measurementProtocolSecrets",
        ),
    ...
    sync: {
      description: "Sync measurementProtocolSecrets state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific measurementProtocolSecrets by name (e.g. one discovered by list)",
        ).optional(),
