...
// Auto-generated extension model for @swamp/gcp/analyticsadmin/accountsummaries
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Analytics Admin AccountSummaries.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A virtual resource representing an overview of an account and all its child G...",
      schema: StateSchema,
      lifetime: "infinite",
