...
// Auto-generated extension model for @swamp/gcp/analyticsadmin/properties-firebaselinks
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Analytics Admin Properties.FirebaseLinks.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a firebaseLinks",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a firebaseLinks",
      arguments: z.object({
        identifier: z.string().describe("The name of the firebaseLinks"),
      }),
    ...
    delete: {
      description: "Delete the firebaseLinks",
      arguments: z.object({
        identifier: z.string().describe("The name of the firebaseLinks"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync firebaseLinks state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific firebaseLinks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List firebaseLinks resources",
      arguments: z.object({
