...
// Auto-generated extension model for @swamp/gcp/analyticsadmin/properties-googleadslinks
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Analytics Admin Properties.GoogleAdsLinks.
 *
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a googleAdsLinks",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["adsPersonalizationEnabled"] !== undefined) {
    ...
    get: {
      description: "Get a googleAdsLinks",
      arguments: z.object({
        identifier: z.string().describe("The name of the googleAdsLinks"),
      }),
    ...
    update: {
      description: "Update googleAdsLinks attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific googleAdsLinks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the googleAdsLinks",
      arguments: z.object({
        identifier: z.string().describe("The name of the googleAdsLinks"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync googleAdsLinks state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific googleAdsLinks by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List googleAdsLinks resources",
      arguments: z.object({
