...
Google Cloud analyticsadmin resources.
...
Use `swamp model type describe @swamp/gcp/analyticsadmin/accounts` to see the
...
swamp model create @swamp/gcp/analyticsadmin/accounts my-accounts
