...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: completionStats, error, outputInfo, resourcesConsumed",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          completionStats: _completionStats,
          error: _error,
          outputInfo: _outputInfo,
          resourcesConsumed: _resourcesConsumed,
          ...rest
        } = old;
        return rest;
      },
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific batchPredictionJobs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List batchPredictionJobs resources",
      arguments: z.object({
