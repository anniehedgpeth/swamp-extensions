...
// Auto-generated extension model for @swamp/gcp/aiplatform/memorybanks-memories-revisions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Agent Platform MemoryBanks.Memories.Revisions.
 *
...
const GET_CONFIG = {
  "id": "aiplatform.projects.locations.memoryBanks.memories.revisions.get",
  "path": "v1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "aiplatform.projects.locations.memoryBanks.memories.revisions.list",
