...
// Auto-generated extension model for @swamp/gcp/aiplatform/tensorboards-experiments
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Description of this TensorboardExperiment.")
    .optional(),
  ...
  tensorboardExperimentId: z.string().describe(
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["tensorboardExperimentId"] !== undefined) {
          params["tensorboardExperimentId"] = String(
            g["tensorboardExperimentId"],
          );
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific experiments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    write: {
      description: "write",
      arguments: z.object({
        writeRunDataRequests: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["tensorboardExperiment"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const body: Record<string, unknown> = {};
        if (args["writeRunDataRequests"] !== undefined) {
          body["writeRunDataRequests"] = args["writeRunDataRequests"];
        }
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["tensorboardExperiment"],
            "parameters": {
              "tensorboardExperiment": { "location": "path", "required": true },
            },
          },
          params,
          body,
