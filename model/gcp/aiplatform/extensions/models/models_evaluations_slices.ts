...
// Auto-generated extension model for @swamp/gcp/aiplatform/models-evaluations-slices
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/slices/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A collection of metrics calculated by comparing Model's predictions on a slic...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a slices",
      arguments: z.object({
        identifier: z.string().describe("The name of the slices"),
      }),
    ...
    sync: {
      description: "Sync slices state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific slices by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List slices resources",
      arguments: z.object({
    ...
    batch_import: {
      ...
      arguments: z.object({
        evaluatedAnnotations: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (args["evaluatedAnnotations"] !== undefined) {
          body["evaluatedAnnotations"] = args["evaluatedAnnotations"];
        }
