...
// Auto-generated extension model for @swamp/gcp/aiplatform/specialistpools
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/specialistPools/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  specialistManagerEmails: z.array(z.string()).describe(
    "The email addresses of the managers in the SpecialistPool.",
  ).optional(),
  specialistWorkerEmails: z.array(z.string()).describe(
...
const StateSchema = z.object({
  ...
  name: z.string(),
  pendingDataLabelingJobs: z.array(z.string()).optional(),
  specialistManagerEmails: z.array(z.string()).optional(),
  specialistManagersCount: z.number().optional(),
  specialistWorkerEmails: z.array(z.string()).optional(),
}).passthrough();
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "SpecialistPool represents customers' own workforce to work on their data labe...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a specialistPools",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["specialistManagerEmails"] !== undefined) {
          body["specialistManagerEmails"] = g["specialistManagerEmails"];
        }
    ...
    get: {
      description: "Get a specialistPools",
      arguments: z.object({
        identifier: z.string().describe("The name of the specialistPools"),
      }),
    ...
    update: {
      description: "Update specialistPools attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific specialistPools by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the specialistPools",
      arguments: z.object({
        identifier: z.string().describe("The name of the specialistPools"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync specialistPools state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific specialistPools by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List specialistPools resources",
      arguments: z.object({
