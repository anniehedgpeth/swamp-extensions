...
// Auto-generated extension model for @swamp/gcp/aiplatform/nasjobs-nastrialdetails
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/nasTrialDetails/${shortName}`;
}
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Represents a NasTrial details along with its parameters. If there is a corres...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a nasTrialDetails",
      arguments: z.object({
        identifier: z.string().describe("The name of the nasTrialDetails"),
      }),
    ...
    sync: {
      description: "Sync nasTrialDetails state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific nasTrialDetails by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List nasTrialDetails resources",
      arguments: z.object({
