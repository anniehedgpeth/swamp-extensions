...
// Auto-generated extension model for @swamp/gcp/aiplatform/tensorboards-experiments-runs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Agent Platform Tensorboards.Experiments.Runs.
 *
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Description of this TensorboardRun.")
    .optional(),
  ...
  tensorboardRunId: z.string().describe(
...
/** Swamp extension model for Google Cloud Agent Platform Tensorboards.Experiments.Runs. Registered at `@swamp/gcp/aiplatform/tensorboards-experiments-runs`. */
export const model = {
  type: "@swamp/gcp/aiplatform/tensorboards-experiments-runs",
  ...
  resources: {
    state: {
      description:
        "TensorboardRun maps to a specific execution of a training job with a given se...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["tensorboardRunId"] !== undefined) {
          params["tensorboardRunId"] = String(g["tensorboardRunId"]);
        }
    ...
    get: {
      description: "Get a runs",
      arguments: z.object({
        identifier: z.string().describe("The name of the runs"),
      }),
    ...
    update: {
      description: "Update runs attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific runs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync runs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific runs by name (e.g. one discovered by list)",
        ).optional(),
    ...
    write: {
      description: "write",
      arguments: z.object({
        tensorboardRun: z.any().optional(),
        timeSeriesData: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["tensorboardRun"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const body: Record<string, unknown> = {};
        if (args["tensorboardRun"] !== undefined) {
          body["tensorboardRun"] = args["tensorboardRun"];
        }
        if (args["timeSeriesData"] !== undefined) {
          body["timeSeriesData"] = args["timeSeriesData"];
        }
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["tensorboardRun"],
            "parameters": {
              "tensorboardRun": { "location": "path", "required": true },
            },
          },
          params,
          body,
