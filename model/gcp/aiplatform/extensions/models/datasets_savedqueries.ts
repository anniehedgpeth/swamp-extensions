...
// Auto-generated extension model for @swamp/gcp/aiplatform/datasets-savedqueries
...
const StateSchema = z.object({
  annotationFilter: z.string().optional(),
  annotationSpecCount: z.number().optional(),
  ...
  supportAutomlTraining: z.boolean().optional(),
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific savedQueries by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List savedQueries resources",
      arguments: z.object({
