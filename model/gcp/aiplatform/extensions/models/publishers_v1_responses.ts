...
// Auto-generated extension model for @swamp/gcp/aiplatform/publishers-v1-responses
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Agent Platform Publishers.V1.Responses.
 *
...
const GET_CONFIG = {
  "id": "aiplatform.projects.locations.publishers.v1.responses.get",
  "path": "v1/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const DELETE_CONFIG = {
  "id": "aiplatform.projects.locations.publishers.v1.responses.delete",
  "path": "v1/{+name}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "name",
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            ...
            "parameters": {
              "deployedModelId": { "location": "query" },
