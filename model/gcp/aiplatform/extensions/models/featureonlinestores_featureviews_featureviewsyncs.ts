...
// Auto-generated extension model for @swamp/gcp/aiplatform/featureonlinestores-featureviews-featureviewsyncs
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/featureViewSyncs/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a featureViewSyncs",
      arguments: z.object({
        identifier: z.string().describe("The name of the featureViewSyncs"),
      }),
    ...
    sync: {
      description: "Sync featureViewSyncs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific featureViewSyncs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List featureViewSyncs resources",
      arguments: z.object({
