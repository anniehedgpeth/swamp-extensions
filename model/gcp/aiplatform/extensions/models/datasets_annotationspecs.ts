...
// Auto-generated extension model for @swamp/gcp/aiplatform/datasets-annotationspecs
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a annotationSpecs",
      arguments: z.object({
        identifier: z.string().describe("The name of the annotationSpecs"),
      }),
    ...
    sync: {
      description: "Sync annotationSpecs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific annotationSpecs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
