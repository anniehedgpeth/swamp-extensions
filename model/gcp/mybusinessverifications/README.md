# @swamp/gcp/mybusinessverifications

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Google Cloud mybusinessverifications resources.
...
Use `swamp model type describe @swamp/gcp/mybusinessverifications/verifications`
...
```bash
# Create a new verifications model
swamp model create @swamp/gcp/mybusinessverifications/verifications my-verifications

# Edit the model to configure its properties
swamp model edit my-verifications

# Create the resource in GCP
swamp model method run my-verifications create

# Sync current state from GCP
swamp model method run my-verifications sync
```
