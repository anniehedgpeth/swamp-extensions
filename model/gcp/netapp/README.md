...
Use `swamp model type describe @swamp/gcp/netapp/activedirectories` to see the
...
```bash
# Create a new activedirectories model
swamp model create @swamp/gcp/netapp/activedirectories my-activedirectories

# Edit the model to configure its properties
swamp model edit my-activedirectories

# Create the resource in GCP
swamp model method run my-activedirectories create

# Sync current state from GCP
swamp model method run my-activedirectories sync
```
