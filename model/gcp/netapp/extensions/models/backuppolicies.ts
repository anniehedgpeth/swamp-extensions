...
/**
 * Swamp extension model for Google Cloud NetApp BackupPolicies.
 *
 * Backup Policy.
 *
...
/** Swamp extension model for Google Cloud NetApp BackupPolicies. Registered at `@swamp/gcp/netapp/backuppolicies`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["backupPolicyId"] !== undefined) {
          params["backupPolicyId"] = String(g["backupPolicyId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific backupPolicies by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List backupPolicies resources",
      arguments: z.object({
