...
// Auto-generated extension model for @swamp/gcp/netapp/storagepools-backupconfigs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud NetApp StoragePools.BackupConfigs.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a backupConfigs",
      arguments: z.object({
        identifier: z.string().describe("The name of the backupConfigs"),
      }),
    ...
    sync: {
      description: "Sync backupConfigs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific backupConfigs by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List backupConfigs resources",
      arguments: z.object({
