...
/**
 * Swamp extension model for Google Cloud NetApp HostGroups.
 *
...
/** Swamp extension model for Google Cloud NetApp HostGroups. Registered at `@swamp/gcp/netapp/hostgroups`. */
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["hostGroupId"] !== undefined) {
          params["hostGroupId"] = String(g["hostGroupId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific hostGroups by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    list: {
      description: "List hostGroups resources",
      arguments: z.object({
        filter: z.string().describe("Optional. Filter to apply to the request.")
          .optional(),
