...
// Auto-generated extension model for @swamp/gcp/netapp/kmsconfigs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud NetApp KmsConfigs.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/kmsConfigs/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Description of the KmsConfig.").optional(),
...
export const model = {
  ...
  methods: {
    create: {
      description: "Create a kmsConfigs",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["kmsConfigId"] !== undefined) {
          params["kmsConfigId"] = String(g["kmsConfigId"]);
        }
        if (g["name"] !== undefined) {
    ...
    get: {
      description: "Get a kmsConfigs",
      arguments: z.object({
        identifier: z.string().describe("The name of the kmsConfigs"),
      }),
    ...
    delete: {
      description: "Delete the kmsConfigs",
      arguments: z.object({
        identifier: z.string().describe("The name of the kmsConfigs"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    list: {
      description: "List kmsConfigs resources",
      arguments: z.object({
