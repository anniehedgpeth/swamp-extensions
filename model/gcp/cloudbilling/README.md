...
Google Cloud cloudbilling resources.
...
Use `swamp model type describe @swamp/gcp/cloudbilling/billingaccounts` to see
...
```bash
# Create a new billingaccounts model
swamp model create @swamp/gcp/cloudbilling/billingaccounts my-billingaccounts

# Edit the model to configure its properties
swamp model edit my-billingaccounts

# Create the resource in GCP
swamp model method run my-billingaccounts create

# Sync current state from GCP
swamp model method run my-billingaccounts sync
```
