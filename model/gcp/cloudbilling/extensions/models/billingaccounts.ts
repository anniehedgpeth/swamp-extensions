...
/**
 * Swamp extension model for Google Cloud Billing BillingAccounts.
 *
...
/** Swamp extension model for Google Cloud Billing BillingAccounts. Registered at `@swamp/gcp/cloudbilling/billingaccounts`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific billingAccounts by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List billingAccounts resources",
      arguments: z.object({
