...
// Auto-generated extension model for @swamp/gcp/cloudbilling/projects
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Billing Projects.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Encapsulation of billing information for a Google Cloud Console project. A pr...",
      schema: StateSchema,
      lifetime: "infinite",
