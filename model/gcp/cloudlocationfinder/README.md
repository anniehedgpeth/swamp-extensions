...
Use `swamp model type describe @swamp/gcp/cloudlocationfinder/cloudlocations` to
...
```bash
# Create a new cloudlocations model
swamp model create @swamp/gcp/cloudlocationfinder/cloudlocations my-cloudlocations

# Edit the model to configure its properties
swamp model edit my-cloudlocations

# Create the resource in GCP
swamp model method run my-cloudlocations create

# Sync current state from GCP
swamp model method run my-cloudlocations sync
```
