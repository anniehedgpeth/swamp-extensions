...
// Auto-generated extension model for @swamp/gcp/cloudlocationfinder/cloudlocations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Location Finder CloudLocations.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/cloudLocations/${shortName}`;
}

const BASE_URL = "https://cloudlocationfinder.googleapis.com/";
...
const StateSchema = z.object({
  carbonFreeEnergyPercentage: z.number().optional(),
  cloudLocationType: z.string().optional(),
  cloudProvider: z.string().optional(),
  containingCloudLocation: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a cloudLocations",
      arguments: z.object({
        identifier: z.string().describe("The name of the cloudLocations"),
      }),
    ...
    sync: {
      description: "Sync cloudLocations state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific cloudLocations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List cloudLocations resources",
      arguments: z.object({
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "parameters": {
              ...
              "sourceCloudLocation": { "location": "query" },
            },
          },
          params,
          undefined,
