...
// Auto-generated extension model for @swamp/gcp/logging/exclusions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Logging Exclusions.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/exclusions/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Optional. A description of this exclusion.")
    .optional(),
...
/** Swamp extension model for Google Cloud Logging Exclusions. Registered at `@swamp/gcp/logging/exclusions`. */
export const model = {
  type: "@swamp/gcp/logging/exclusions",
  ...
  resources: {
    state: {
      description:
        "Specifies a set of log entries that are filtered out by a sink. If your Googl...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a exclusions",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a exclusions",
      arguments: z.object({
        identifier: z.string().describe("The name of the exclusions"),
      }),
    ...
    update: {
      description: "Update exclusions attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific exclusions by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the exclusions",
      arguments: z.object({
        identifier: z.string().describe("The name of the exclusions"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync exclusions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific exclusions by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List exclusions resources",
      arguments: z.object({
