...
// Auto-generated extension model for @swamp/gcp/logging/logscopes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Logging LogScopes.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/logScopes/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Logging LogScopes. Registered at `@swamp/gcp/logging/logscopes`. */
export const model = {
  type: "@swamp/gcp/logging/logscopes",
  ...
  methods: {
    create: {
      description: "Create a logScopes",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["resourceNames"] !== undefined) {
          body["resourceNames"] = g["resourceNames"];
        }
        if (g["logScopeId"] !== undefined) {
          params["logScopeId"] = String(g["logScopeId"]);
        }
    ...
    get: {
      description: "Get a logScopes",
      arguments: z.object({
        identifier: z.string().describe("The name of the logScopes"),
      }),
    ...
    update: {
      description: "Update logScopes attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific logScopes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the logScopes",
      arguments: z.object({
        identifier: z.string().describe("The name of the logScopes"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync logScopes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific logScopes by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List logScopes resources",
      arguments: z.object({
