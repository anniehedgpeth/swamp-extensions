...
Google Cloud logging resources.
...
Use `swamp model type describe @swamp/gcp/logging/buckets_links` to see the full
...
```bash
# Create a new buckets_links model
swamp model create @swamp/gcp/logging/buckets_links my-buckets_links

# Edit the model to configure its properties
swamp model edit my-buckets_links

# Create the resource in GCP
swamp model method run my-buckets_links create

# Sync current state from GCP
swamp model method run my-buckets_links sync
```
