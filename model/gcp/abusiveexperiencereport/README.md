# @swamp/gcp/abusiveexperiencereport

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Google Cloud abusiveexperiencereport resources.
...
Use `swamp model type describe @swamp/gcp/abusiveexperiencereport/sites` to see
...
```bash
# Create a new sites model
swamp model create @swamp/gcp/abusiveexperiencereport/sites my-sites

# Edit the model to configure its properties
swamp model edit my-sites

# Create the resource in GCP
swamp model method run my-sites create

# Sync current state from GCP
swamp model method run my-sites sync
```
