...
// Auto-generated extension model for @swamp/gcp/marketingplatformadmin/organizations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Marketing Platform Admin Organizations.
 *
...
/** Swamp extension model for Google Cloud Google Marketing Platform Admin Organizations. Registered at `@swamp/gcp/marketingplatformadmin/organizations`. */
export const model = {
  type: "@swamp/gcp/marketingplatformadmin/organizations",
  ...
  methods: {
    ...
    find_sales_partner_managed_clients: {
      description: "find sales partner managed clients",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["organization"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        ...
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "POST",
            "parameterOrder": ["organization"],
            "parameters": {
              "organization": { "location": "path", "required": true },
            },
          },
          params,
          body,
    ...
    report_property_usage: {
      description: "report property usage",
      arguments: z.object({
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        params["organization"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const body: Record<string, unknown> = {};
        if (args["month"] !== undefined) body["month"] = args["month"];
        const result = await createResource(
          BASE_URL,
          {
