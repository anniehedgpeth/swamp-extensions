...
/**
 * Swamp extension model for Google Cloud Google Play EMM Managedconfigurationssettings.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific managedconfigurationssettings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List managedconfigurationssettings resources",
      arguments: z.object({
