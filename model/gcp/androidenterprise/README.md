...
Google Cloud androidenterprise resources.
...
Use `swamp model type describe @swamp/gcp/androidenterprise/devices` to see the
...
```bash
# Create a new devices model
swamp model create @swamp/gcp/androidenterprise/devices my-devices

# Edit the model to configure its properties
swamp model edit my-devices

# Create the resource in GCP
swamp model method run my-devices create

# Sync current state from GCP
swamp model method run my-devices sync
```
