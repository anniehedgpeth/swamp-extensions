...
/**
 * Swamp extension model for Google Cloud Artifact Registry Locations.
 *
...
/** Swamp extension model for Google Cloud Artifact Registry Locations. Registered at `@swamp/gcp/artifactregistry/locations`. */
export const model = {
