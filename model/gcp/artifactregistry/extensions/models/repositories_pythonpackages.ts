...
// Auto-generated extension model for @swamp/gcp/artifactregistry/repositories-pythonpackages
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Artifact Registry Repositories.PythonPackages.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/pythonPackages/${shortName}`;
}
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a pythonPackages",
      arguments: z.object({
        identifier: z.string().describe("The name of the pythonPackages"),
      }),
    ...
    sync: {
      description: "Sync pythonPackages state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific pythonPackages by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List pythonPackages resources",
      arguments: z.object({
