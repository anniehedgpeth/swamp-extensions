...
// Auto-generated extension model for @swamp/gcp/artifactregistry/repositories-packages-tags
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Artifact Registry Repositories.Packages.Tags.
 *
...
const GlobalArgsSchema = z.object({
  ...
  tagId: z.string().describe("The tag id to use for this repository.")
    .optional(),
...
/** Swamp extension model for Google Cloud Artifact Registry Repositories.Packages.Tags. Registered at `@swamp/gcp/artifactregistry/repositories-packages-tags`. */
export const model = {
  type: "@swamp/gcp/artifactregistry/repositories-packages-tags",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["tagId"] !== undefined) params["tagId"] = String(g["tagId"]);
