...
// Auto-generated extension model for @swamp/gcp/artifactregistry/repositories-packages-versions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Artifact Registry Repositories.Packages.Versions.
 *
...
const GlobalArgsSchema = z.object({
  ...
  createTime: z.string().describe("The time when the version was created.")
    .optional(),
  description: z.string().describe(
    "Optional. Description of the version, as specified in its metadata.",
  ).optional(),
  fingerprints: z.array(z.object({
    type: z.enum(["HASH_TYPE_UNSPECIFIED", "SHA256", "MD5", "DIRSUM_SHA256"])
      .describe("The algorithm used to compute the hash value.").optional(),
    value: z.string().describe("The hash value.").optional(),
  })).describe(
  ...
  updateTime: z.string().describe("The time when the version was last updated.")
    .optional(),
...
/** Swamp extension model for Google Cloud Artifact Registry Repositories.Packages.Versions. Registered at `@swamp/gcp/artifactregistry/repositories-packages-versions`. */
export const model = {
  type: "@swamp/gcp/artifactregistry/repositories-packages-versions",
  ...
  methods: {
    ...
    update: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["fingerprints"] !== undefined) {
          body["fingerprints"] = g["fingerprints"];
        }
        if (g["metadata"] !== undefined) body["metadata"] = g["metadata"];
        if (g["relatedTags"] !== undefined) {
          body["relatedTags"] = g["relatedTags"];
        }
