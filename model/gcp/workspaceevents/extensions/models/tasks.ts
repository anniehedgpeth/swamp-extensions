...
/**
 * Swamp extension model for Google Cloud Google Workspace Events Tasks.
 *
...
/** Swamp extension model for Google Cloud Google Workspace Events Tasks. Registered at `@swamp/gcp/workspaceevents/tasks`. */
export const model = {
