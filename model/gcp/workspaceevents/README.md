...
Google Cloud workspaceevents resources.
...
Use `swamp model type describe @swamp/gcp/workspaceevents/subscriptions` to see
...
swamp model create @swamp/gcp/workspaceevents/subscriptions my-subscriptions
