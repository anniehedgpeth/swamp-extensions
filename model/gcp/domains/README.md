...
Google Cloud domains resources.
...
Use `swamp model type describe @swamp/gcp/domains/locations` to see the full
...
swamp model create @swamp/gcp/domains/locations my-locations
