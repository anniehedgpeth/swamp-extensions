...
// Auto-generated extension model for @swamp/gcp/books/volumes-mybooks
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Books Volumes.Mybooks.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a mybooks",
      arguments: z.object({
        identifier: z.string().describe("The name of the mybooks"),
      }),
    ...
    sync: {
      description: "Sync mybooks state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific mybooks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
