...
// Auto-generated extension model for @swamp/gcp/books/bookshelves-volumes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Books Bookshelves.Volumes.
 *
...
const GlobalArgsSchema = z.object({
  ...
  shelf: z.string().describe("ID of bookshelf to retrieve volumes."),
});
...
const InputsSchema = z.object({
  ...
  shelf: z.string().describe("ID of bookshelf to retrieve volumes.").optional(),
});
...
/** Swamp extension model for Google Cloud Books Bookshelves.Volumes. Registered at `@swamp/gcp/books/bookshelves-volumes`. */
export const model = {
  type: "@swamp/gcp/books/bookshelves-volumes",
  ...
  upgrades: [
    ...
    },
    {
      ...
      description: "Added: userId, shelf",
      upgradeAttributes: (old: Record<string, unknown>) => old,
    },
    {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific volumes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
        ...
        try {
          ...
          if (g["shelf"] !== undefined) params["shelf"] = String(g["shelf"]);
          else if (existing["shelf"]) {
            params["shelf"] = String(existing["shelf"]);
          }
