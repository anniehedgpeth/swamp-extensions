...
// Auto-generated extension model for @swamp/gcp/books/mylibrary-bookshelves-volumes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Books Mylibrary.Bookshelves.Volumes.
 *
...
const GlobalArgsSchema = z.object({
  ...
  shelf: z.string().describe("The bookshelf ID or name retrieve volumes for."),
});
