...
// Auto-generated extension model for @swamp/gcp/books/layers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Books Layers.
 *
...
const GlobalArgsSchema = z.object({
  ...
  volumeId: z.string().describe("The volume to retrieve layers for."),
});

const StateSchema = z.object({
  annotationCount: z.number().optional(),
  annotationTypes: z.array(z.string()).optional(),
  annotationsDataLink: z.string().optional(),
  annotationsLink: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a layers",
      arguments: z.object({
        identifier: z.string().describe("The name of the layers"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["summaryId"] = args.identifier;
    ...
    sync: {
      description: "Sync layers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific layers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
