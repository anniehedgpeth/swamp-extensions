...
// Auto-generated extension model for @swamp/gcp/books/bookshelves
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Books Bookshelves.
 *
...
const GlobalArgsSchema = z.object({
  ...
  userId: z.string().describe("ID of user for whom to retrieve bookshelves."),
});
...
/** Swamp extension model for Google Cloud Books Bookshelves. Registered at `@swamp/gcp/books/bookshelves`. */
export const model = {
  type: "@swamp/gcp/books/bookshelves",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific bookshelves by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List bookshelves resources",
      arguments: z.object({
