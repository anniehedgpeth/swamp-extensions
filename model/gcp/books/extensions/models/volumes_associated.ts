...
const GlobalArgsSchema = z.object({
  ...
  volumeId: z.string().describe("ID of the source volume."),
});
...
const InputsSchema = z.object({
  ...
  volumeId: z.string().describe("ID of the source volume.").optional(),
});
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific associated by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
