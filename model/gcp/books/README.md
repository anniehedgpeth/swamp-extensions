...
Use `swamp model type describe @swamp/gcp/books/bookshelves_volumes` to see the
...
```bash
# Create a new bookshelves_volumes model
swamp model create @swamp/gcp/books/bookshelves_volumes my-bookshelves_volumes

# Edit the model to configure its properties
swamp model edit my-bookshelves_volumes

# Create the resource in GCP
swamp model method run my-bookshelves_volumes create

# Sync current state from GCP
swamp model method run my-bookshelves_volumes sync
```
