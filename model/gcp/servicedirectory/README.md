...
Google Cloud servicedirectory resources.
...
Use `swamp model type describe @swamp/gcp/servicedirectory/locations` to see the
...
swamp model create @swamp/gcp/servicedirectory/locations my-locations
