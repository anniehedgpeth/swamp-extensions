...
// Auto-generated extension model for @swamp/gcp/servicedirectory/namespaces-services
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Service Directory Namespaces.Services.
 *
...
/** Swamp extension model for Google Cloud Service Directory Namespaces.Services. Registered at `@swamp/gcp/servicedirectory/namespaces-services`. */
export const model = {
  type: "@swamp/gcp/servicedirectory/namespaces-services",
  ...
  resources: {
    state: {
      description:
        "An individual service. A service contains a name and optional metadata. A ser...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    resolve: {
      description: "resolve",
      arguments: z.object({
        endpointFilter: z.any().optional(),
        maxEndpoints: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (args["endpointFilter"] !== undefined) {
          body["endpointFilter"] = args["endpointFilter"];
        }
        if (args["maxEndpoints"] !== undefined) {
          body["maxEndpoints"] = args["maxEndpoints"];
        }
        const result = await createResource(
          BASE_URL,
          {
