...
// Auto-generated extension model for @swamp/gcp/servicedirectory/namespaces-services-endpoints
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Service Directory Namespaces.Services.Endpoints.
 *
...
/** Swamp extension model for Google Cloud Service Directory Namespaces.Services.Endpoints. Registered at `@swamp/gcp/servicedirectory/namespaces-services-endpoints`. */
export const model = {
  type: "@swamp/gcp/servicedirectory/namespaces-services-endpoints",
  ...
  resources: {
    state: {
      description:
        "An individual endpoint that provides a service. The service must already exis...",
      schema: StateSchema,
      lifetime: "infinite",
