...
// Auto-generated extension model for @swamp/gcp/dlp/infotypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Sensitive Data Protection (DLP) InfoTypes.
 *
...
const StateSchema = z.object({
  ...
  locationSupport: z.object({
    locations: z.array(z.string()),
    regionalizationScope: z.string(),
  }).optional(),
  name: z.string(),
  sensitivityScore: z.object({
    score: z.string(),
  }).optional(),
  specificInfoTypes: z.array(z.string()).optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a infoTypes",
      arguments: z.object({
        identifier: z.string().describe("The name of the infoTypes"),
      }),
    ...
    sync: {
      description: "Sync infoTypes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific infoTypes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
