...
/**
 * Swamp extension model for Google Cloud Sensitive Data Protection (DLP) ColumnDataProfiles.
 *
...
/** Swamp extension model for Google Cloud Sensitive Data Protection (DLP) ColumnDataProfiles. Registered at `@swamp/gcp/dlp/columndataprofiles`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific columnDataProfiles by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List columnDataProfiles resources",
      arguments: z.object({
