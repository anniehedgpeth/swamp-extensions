...
// Auto-generated extension model for @swamp/gcp/dlp/projectdataprofiles
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Sensitive Data Protection (DLP) ProjectDataProfiles.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/projectDataProfiles/${shortName}`;
}

const BASE_URL = "https://dlp.googleapis.com/";

const GET_CONFIG = {
  "id": "dlp.organizations.locations.projectDataProfiles.get",
  "path": "v2/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const StateSchema = z.object({
  ...
  fileStoreDataProfileCount: z.string().optional(),
  name: z.string(),
  ...
  tableDataProfileCount: z.string().optional(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Sensitive Data Protection (DLP) ProjectDataProfiles. Registered at `@swamp/gcp/dlp/projectdataprofiles`. */
export const model = {
  type: "@swamp/gcp/dlp/projectdataprofiles",
  ...
  resources: {
    state: {
      description:
        "An aggregated profile for this project, based on the resources profiled withi...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a projectDataProfiles",
      arguments: z.object({
        identifier: z.string().describe("The name of the projectDataProfiles"),
      }),
    ...
    sync: {
      description: "Sync projectDataProfiles state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific projectDataProfiles by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List projectDataProfiles resources",
      arguments: z.object({
