...
Use `swamp model type describe @swamp/gcp/dlp/columndataprofiles` to see the
...
```bash
# Create a new columndataprofiles model
swamp model create @swamp/gcp/dlp/columndataprofiles my-columndataprofiles

# Edit the model to configure its properties
swamp model edit my-columndataprofiles

# Create the resource in GCP
swamp model method run my-columndataprofiles create

# Sync current state from GCP
swamp model method run my-columndataprofiles sync
```
