...
Google Cloud adsenseplatform resources.
...
Use
`swamp model type describe @swamp/gcp/adsenseplatform/platforms_accounts_sites`
...
```bash
# Create a new platforms_accounts_sites model
swamp model create @swamp/gcp/adsenseplatform/platforms_accounts_sites my-platforms_accounts_sites

# Edit the model to configure its properties
swamp model edit my-platforms_accounts_sites

# Create the resource in GCP
swamp model method run my-platforms_accounts_sites create

# Sync current state from GCP
swamp model method run my-platforms_accounts_sites sync
```
