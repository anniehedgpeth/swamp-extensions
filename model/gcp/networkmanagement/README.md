...
Google Cloud networkmanagement resources.
...
Use
`swamp model type describe @swamp/gcp/networkmanagement/global_connectivitytests`
...
```bash
# Create a new global_connectivitytests model
swamp model create @swamp/gcp/networkmanagement/global_connectivitytests my-global_connectivitytests

# Edit the model to configure its properties
swamp model edit my-global_connectivitytests

# Create the resource in GCP
swamp model method run my-global_connectivitytests create

# Sync current state from GCP
swamp model method run my-global_connectivitytests sync
```
