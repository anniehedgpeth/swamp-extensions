...
// Auto-generated extension model for @swamp/gcp/networkmanagement/networkmonitoringproviders-networkpaths
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Network Management NetworkMonitoringProviders.NetworkPaths.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/networkPaths/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  destinationMonitoringPointId: z.string().optional(),
  displayName: z.string().optional(),
  dualEnded: z.boolean().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a networkPaths",
      arguments: z.object({
        identifier: z.string().describe("The name of the networkPaths"),
      }),
    ...
    sync: {
      description: "Sync networkPaths state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific networkPaths by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List networkPaths resources",
      arguments: z.object({
