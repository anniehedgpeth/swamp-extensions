...
// Auto-generated extension model for @swamp/gcp/datafusion/versions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Data Fusion Versions.
 *
...
const StateSchema = z.object({
  ...
  defaultVersion: z.boolean().optional(),
...
export const model = {
  ...
  methods: {
    ...
    list: {
      ...
      arguments: z.object({
        latestPatchOnly: z.boolean().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["latestPatchOnly"] !== undefined) {
          params["latestPatchOnly"] = String(args["latestPatchOnly"]);
        }
