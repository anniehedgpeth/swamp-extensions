...
/**
 * Swamp extension model for Google Cloud Data Fusion Instances.DnsPeerings.
 *
...
export const model = {
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["dnsPeeringId"] !== undefined) {
          params["dnsPeeringId"] = String(g["dnsPeeringId"]);
        }
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific dnsPeerings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List dnsPeerings resources",
      arguments: z.object({
