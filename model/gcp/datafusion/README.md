...
Google Cloud datafusion resources.
...
Use `swamp model type describe @swamp/gcp/datafusion/instances_dnspeerings` to
...
```bash
# Create a new instances_dnspeerings model
swamp model create @swamp/gcp/datafusion/instances_dnspeerings my-instances_dnspeerings

# Edit the model to configure its properties
swamp model edit my-instances_dnspeerings

# Create the resource in GCP
swamp model method run my-instances_dnspeerings create

# Sync current state from GCP
swamp model method run my-instances_dnspeerings sync
```
