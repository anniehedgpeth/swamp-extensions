...
// Auto-generated extension model for @swamp/gcp/cloudcontrolspartner/customers-workloads
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Controls Partner Customers.Workloads.
 *
...
const StateSchema = z.object({
  ...
  keyManagementProjectId: z.string().optional(),
  location: z.string().optional(),
  name: z.string(),
  partner: z.string().optional(),
  workloadOnboardingState: z.object({
...
/** Swamp extension model for Google Cloud Controls Partner Customers.Workloads. Registered at `@swamp/gcp/cloudcontrolspartner/customers-workloads`. */
export const model = {
  type: "@swamp/gcp/cloudcontrolspartner/customers-workloads",
  ...
  resources: {
    state: {
      description:
        "Contains metadata around the [Workload resource](https://cloud.google.com/ass...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    get_ekm_connections: {
      description: "get ekm connections",
      arguments: z.object({}),
    ...
    get_partner_permissions: {
      description: "get partner permissions",
      arguments: z.object({}),
      execute: async (_args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
