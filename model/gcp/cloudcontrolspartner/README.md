...
Google Cloud cloudcontrolspartner resources.
...
Use
`swamp model type describe @swamp/gcp/cloudcontrolspartner/customers_workloads_accessapprovalrequests`
...
```bash
# Create a new customers_workloads_accessapprovalrequests model
swamp model create @swamp/gcp/cloudcontrolspartner/customers_workloads_accessapprovalrequests my-customers_workloads_accessapprovalrequests

# Edit the model to configure its properties
swamp model edit my-customers_workloads_accessapprovalrequests

# Create the resource in GCP
swamp model method run my-customers_workloads_accessapprovalrequests create

# Sync current state from GCP
swamp model method run my-customers_workloads_accessapprovalrequests sync
```
