...
Google Cloud bigquerydatapolicy resources.
...
Use `swamp model type describe @swamp/gcp/bigquerydatapolicy/datapolicies` to
...
```bash
# Create a new datapolicies model
swamp model create @swamp/gcp/bigquerydatapolicy/datapolicies my-datapolicies

# Edit the model to configure its properties
swamp model edit my-datapolicies

# Create the resource in GCP
swamp model method run my-datapolicies create

# Sync current state from GCP
swamp model method run my-datapolicies sync
```
