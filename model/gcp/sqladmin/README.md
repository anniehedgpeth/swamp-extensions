...
Google Cloud sqladmin resources.
...
Use `swamp model type describe @swamp/gcp/sqladmin/backupruns` to see the full
...
```bash
# Create a new backupruns model
swamp model create @swamp/gcp/sqladmin/backupruns my-backupruns

# Edit the model to configure its properties
swamp model edit my-backupruns

# Create the resource in GCP
swamp model method run my-backupruns create

# Sync current state from GCP
swamp model method run my-backupruns sync
```
