...
/**
 * Swamp extension model for Google Cloud SQL Admin SslCerts.
 *
 * SslCerts Resource
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific sslCerts by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List sslCerts resources",
      arguments: z.object({
