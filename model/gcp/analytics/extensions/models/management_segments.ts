...
// Auto-generated extension model for @swamp/gcp/analytics/management-segments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Analytics Management.Segments.
 *
...
/** Swamp extension model for Google Cloud Google Analytics Management.Segments. Registered at `@swamp/gcp/analytics/management-segments`. */
export const model = {
  type: "@swamp/gcp/analytics/management-segments",
  ...
  methods: {
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The name of the segments"),
      }),
    ...
    sync: {
      description: "Sync segments state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific segments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List segments resources",
      arguments: z.object({
