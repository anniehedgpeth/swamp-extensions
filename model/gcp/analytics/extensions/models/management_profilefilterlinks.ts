...
/**
 * Swamp extension model for Google Cloud Google Analytics Management.ProfileFilterLinks.
 *
...
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific profileFilterLinks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List profileFilterLinks resources",
      arguments: z.object({
