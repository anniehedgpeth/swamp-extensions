...
/**
 * Swamp extension model for Google Cloud Google Analytics Management.CustomDataSources.
 *
...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Added: accessToken, credentialsJson, project, scopes, accountId, webPropertyId",
      upgradeAttributes: (old: Record<string, unknown>) => old,
    },
  ],
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific customDataSources by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
