...
// Auto-generated extension model for @swamp/gcp/analytics/management-accountsummaries
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Analytics Management.AccountSummaries.
 *
...
const StateSchema = z.object({
  ...
  webProperties: z.array(z.object({
    id: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "JSON template for an Analytics AccountSummary. An AccountSummary is a lightwe...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a accountSummaries",
      arguments: z.object({
        identifier: z.string().describe("The name of the accountSummaries"),
      }),
    ...
    sync: {
      description: "Sync accountSummaries state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific accountSummaries by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
