...
Google Cloud analytics resources.
...
Use `swamp model type describe @swamp/gcp/analytics/data_ga` to see the full
...
```bash
# Create a new data_ga model
swamp model create @swamp/gcp/analytics/data_ga my-data_ga

# Edit the model to configure its properties
swamp model edit my-data_ga

# Create the resource in GCP
swamp model method run my-data_ga create

# Sync current state from GCP
swamp model method run my-data_ga sync
```
