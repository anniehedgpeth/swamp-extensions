...
// Auto-generated extension model for @swamp/gcp/dfareporting/mobileapps
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 MobileApps.
 *
...
/** Swamp extension model for Google Cloud Campaign Manager 360 MobileApps. Registered at `@swamp/gcp/dfareporting/mobileapps`. */
export const model = {
  type: "@swamp/gcp/dfareporting/mobileapps",
  ...
  methods: {
    get: {
      description: "Get a mobileApps",
      arguments: z.object({
        identifier: z.string().describe("The id of the mobileApps"),
      }),
    ...
    sync: {
      description: "Sync mobileApps state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific mobileApps by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List mobileApps resources",
      arguments: z.object({
        directories: z.string().describe(
          "Select only apps from these directories.",
        ).optional(),
        ids: z.string().describe("Select only apps with these IDs.").optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["directories"] !== undefined) {
          params["directories"] = String(args["directories"]);
        }
