...
/**
 * Swamp extension model for Google Cloud Campaign Manager 360 UserRoles.
 *
...
/** Swamp extension model for Google Cloud Campaign Manager 360 UserRoles. Registered at `@swamp/gcp/dfareporting/userroles`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userRoles by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List userRoles resources",
      arguments: z.object({
        accountUserRoleOnly: z.boolean().describe(
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["accountUserRoleOnly"] !== undefined) {
          params["accountUserRoleOnly"] = String(args["accountUserRoleOnly"]);
        }
