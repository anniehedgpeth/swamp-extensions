...
/**
 * Swamp extension model for Google Cloud Campaign Manager 360 Subaccounts.
 *
...
/** Swamp extension model for Google Cloud Campaign Manager 360 Subaccounts. Registered at `@swamp/gcp/dfareporting/subaccounts`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific subaccounts by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List subaccounts resources",
      arguments: z.object({
        ids: z.string().describe("Select only subaccounts with these IDs.")
          .optional(),
