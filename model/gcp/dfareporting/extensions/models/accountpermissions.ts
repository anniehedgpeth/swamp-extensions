...
/**
 * Swamp extension model for Google Cloud Campaign Manager 360 AccountPermissions.
 *
...
/** Swamp extension model for Google Cloud Campaign Manager 360 AccountPermissions. Registered at `@swamp/gcp/dfareporting/accountpermissions`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific accountPermissions by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List accountPermissions resources",
      arguments: z.object({
