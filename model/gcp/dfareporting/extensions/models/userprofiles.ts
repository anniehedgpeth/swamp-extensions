...
// Auto-generated extension model for @swamp/gcp/dfareporting/userprofiles
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 UserProfiles.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A UserProfile resource lets you list all DFA user profiles that are associate...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a userProfiles",
      arguments: z.object({
        identifier: z.string().describe("The name of the userProfiles"),
      }),
    ...
    sync: {
      description: "Sync userProfiles state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userProfiles by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List userProfiles resources",
      arguments: z.object({
