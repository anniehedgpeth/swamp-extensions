...
// Auto-generated extension model for @swamp/gcp/dfareporting/operatingsystems
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 OperatingSystems.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a operatingSystems",
      arguments: z.object({
        identifier: z.string().describe("The name of the operatingSystems"),
      }),
    ...
    sync: {
      description: "Sync operatingSystems state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific operatingSystems by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List operatingSystems resources",
      arguments: z.object({
