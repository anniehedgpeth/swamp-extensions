...
// Auto-generated extension model for @swamp/gcp/dfareporting/userrolepermissions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 UserRolePermissions.
 *
...
/** Swamp extension model for Google Cloud Campaign Manager 360 UserRolePermissions. Registered at `@swamp/gcp/dfareporting/userrolepermissions`. */
export const model = {
  type: "@swamp/gcp/dfareporting/userrolepermissions",
  ...
  methods: {
    get: {
      description: "Get a userRolePermissions",
      arguments: z.object({
        identifier: z.string().describe("The id of the userRolePermissions"),
      }),
    ...
    sync: {
      description: "Sync userRolePermissions state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userRolePermissions by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List userRolePermissions resources",
      arguments: z.object({
