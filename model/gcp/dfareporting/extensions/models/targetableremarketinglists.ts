...
// Auto-generated extension model for @swamp/gcp/dfareporting/targetableremarketinglists
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 TargetableRemarketingLists.
 *
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a targetableRemarketingLists",
      arguments: z.object({
        identifier: z.string().describe(
          "The id of the targetableRemarketingLists",
        ),
      }),
    ...
    sync: {
      description: "Sync targetableRemarketingLists state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific targetableRemarketingLists by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
