...
// Auto-generated extension model for @swamp/gcp/dfareporting/videoformats
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 VideoFormats.
 *
...
/** Swamp extension model for Google Cloud Campaign Manager 360 VideoFormats. Registered at `@swamp/gcp/dfareporting/videoformats`. */
export const model = {
  type: "@swamp/gcp/dfareporting/videoformats",
  ...
  methods: {
    get: {
      description: "Get a videoFormats",
      arguments: z.object({
        identifier: z.string().describe("The id of the videoFormats"),
      }),
    ...
    sync: {
      description: "Sync videoFormats state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific videoFormats by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List videoFormats resources",
      arguments: z.object({
