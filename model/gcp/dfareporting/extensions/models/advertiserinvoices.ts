...
/**
 * Swamp extension model for Google Cloud Campaign Manager 360 AdvertiserInvoices.
 *
...
const GlobalArgsSchema = z.object({
  ...
  advertiserId: z.string().describe("Advertiser ID of this invoice."),
});
...
/** Swamp extension model for Google Cloud Campaign Manager 360 AdvertiserInvoices. Registered at `@swamp/gcp/dfareporting/advertiserinvoices`. */
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific advertiserInvoices by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List advertiserInvoices resources",
      arguments: z.object({
