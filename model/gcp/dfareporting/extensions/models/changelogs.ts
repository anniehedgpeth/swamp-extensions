...
// Auto-generated extension model for @swamp/gcp/dfareporting/changelogs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 ChangeLogs.
 *
...
export const model = {
  ...
  methods: {
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The id of the changeLogs"),
      }),
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific changeLogs by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
