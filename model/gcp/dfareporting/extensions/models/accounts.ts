...
/**
 * Swamp extension model for Google Cloud Campaign Manager 360 Accounts.
 *
...
const GlobalArgsSchema = z.object({
  ...
  reportsConfiguration: z.object({
    ...
    }).describe("Default lookback windows for new advertisers in this account.")
      .optional(),
  ...
  }).describe("Reporting configuration of this account.").optional(),
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific accounts by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
