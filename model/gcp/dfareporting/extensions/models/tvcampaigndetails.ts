...
// Auto-generated extension model for @swamp/gcp/dfareporting/tvcampaigndetails
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 TvCampaignDetails.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "TvCampaignDetail contains data from a TV campaign for specific start dates an...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a tvCampaignDetails",
      arguments: z.object({
        identifier: z.string().describe("The id of the tvCampaignDetails"),
      }),
    ...
    sync: {
      description: "Sync tvCampaignDetails state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific tvCampaignDetails by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
