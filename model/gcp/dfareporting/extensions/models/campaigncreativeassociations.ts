...
/**
 * Swamp extension model for Google Cloud Campaign Manager 360 CampaignCreativeAssociations.
 *
...
export const model = {
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific campaignCreativeAssociations by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List campaignCreativeAssociations resources",
      arguments: z.object({
