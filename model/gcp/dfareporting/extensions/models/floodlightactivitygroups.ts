...
// Auto-generated extension model for @swamp/gcp/dfareporting/floodlightactivitygroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 FloodlightActivityGroups.
 *
...
const GlobalArgsSchema = z.object({
  ...
  type: z.enum(["COUNTER", "SALE"]).describe(
...
/** Swamp extension model for Google Cloud Campaign Manager 360 FloodlightActivityGroups. Registered at `@swamp/gcp/dfareporting/floodlightactivitygroups`. */
export const model = {
  type: "@swamp/gcp/dfareporting/floodlightactivitygroups",
  ...
  methods: {
    create: {
      description: "Create a floodlightActivityGroups",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a floodlightActivityGroups",
      arguments: z.object({
        identifier: z.string().describe(
          "The id of the floodlightActivityGroups",
        ),
      }),
    ...
    update: {
      description: "Update floodlightActivityGroups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific floodlightActivityGroups by id (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync floodlightActivityGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific floodlightActivityGroups by id (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List floodlightActivityGroups resources",
      arguments: z.object({
        advertiserId: z.string().describe(
