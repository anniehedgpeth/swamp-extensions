...
Google Cloud dfareporting resources.
...
Use `swamp model type describe @swamp/gcp/dfareporting/accountactiveadsummaries`
...
```bash
# Create a new accountactiveadsummaries model
swamp model create @swamp/gcp/dfareporting/accountactiveadsummaries my-accountactiveadsummaries

# Edit the model to configure its properties
swamp model edit my-accountactiveadsummaries

# Create the resource in GCP
swamp model method run my-accountactiveadsummaries create

# Sync current state from GCP
swamp model method run my-accountactiveadsummaries sync
```
