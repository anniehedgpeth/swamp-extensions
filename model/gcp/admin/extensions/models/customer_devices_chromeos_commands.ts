...
// Auto-generated extension model for @swamp/gcp/admin/customer-devices-chromeos-commands
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Admin SDK Customer.Devices.Chromeos.Commands.
 *
...
const StateSchema = z.object({
  commandExpireTime: z.string().optional(),
  commandId: z.string().optional(),
  commandResult: z.object({
    commandResultPayload: z.string(),
  ...
  methods: {
    get: {
      ...
      execute: async (args: { identifier: string }, context: any) => {
        ...
        params["commandId"] = args.identifier;
