...
// Auto-generated extension model for @swamp/gcp/admin/customers-chrome-printservers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Admin SDK Customers.Chrome.PrintServers.
 *
...
/** Swamp extension model for Google Cloud Admin SDK Customers.Chrome.PrintServers. Registered at `@swamp/gcp/admin/customers-chrome-printservers`. */
export const model = {
  type: "@swamp/gcp/admin/customers-chrome-printservers",
  ...
  methods: {
    create: {
      description: "Create a printServers",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a printServers",
      arguments: z.object({
        identifier: z.string().describe("The name of the printServers"),
      }),
    ...
    update: {
      description: "Update printServers attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific printServers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the printServers",
      arguments: z.object({
        identifier: z.string().describe("The name of the printServers"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync printServers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific printServers by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List printServers resources",
      arguments: z.object({
    ...
    batch_create_print_servers: {
      description: "batch create print servers",
      arguments: z.object({
    ...
    batch_delete_print_servers: {
      description: "batch delete print servers",
      arguments: z.object({
        printServerIds: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (g["parent"] !== undefined) params["parent"] = String(g["parent"]);
        const body: Record<string, unknown> = {};
        if (args["printServerIds"] !== undefined) {
          body["printServerIds"] = args["printServerIds"];
        }
        const result = await createResource(
          BASE_URL,
          {
