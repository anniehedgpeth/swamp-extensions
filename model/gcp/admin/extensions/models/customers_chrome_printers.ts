...
// Auto-generated extension model for @swamp/gcp/admin/customers-chrome-printers
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Admin SDK Customers.Chrome.Printers.
 *
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Editable. Description of printer.")
    .optional(),
  displayName: z.string().describe("Editable. Name of printer.").optional(),
  id: z.string().describe(
    "Id of the printer. (During printer creation leave empty)",
  ).optional(),
  makeAndModel: z.string().describe(
  ...
  uri: z.string().describe("Editable. Printer URI.").optional(),
...
const StateSchema = z.object({
  auxiliaryMessages: z.array(z.object({
    auxiliaryMessage: z.string(),
    fieldMask: z.string(),
    severity: z.string(),
  })).optional(),
  ...
  useDriverlessConfig: z.boolean().optional(),
}).passthrough();
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["makeAndModel"] !== undefined) {
          body["makeAndModel"] = g["makeAndModel"];
        }
    ...
    get: {
      description: "Get a printers",
      arguments: z.object({
        identifier: z.string().describe("The name of the printers"),
      }),
    ...
    update: {
      description: "Update printers attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific printers by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the printers",
      arguments: z.object({
        identifier: z.string().describe("The name of the printers"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync printers state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific printers by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List printers resources",
      arguments: z.object({
    ...
    batch_create_printers: {
      description: "batch create printers",
      arguments: z.object({
    ...
    batch_delete_printers: {
      description: "batch delete printers",
      arguments: z.object({
        printerIds: z.any().optional(),
      }),
      execute: async (args: Record<string, unknown>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildGcpCredentials(g);
        ...
        if (g["parent"] !== undefined) params["parent"] = String(g["parent"]);
        const body: Record<string, unknown> = {};
        if (args["printerIds"] !== undefined) {
          body["printerIds"] = args["printerIds"];
        }
        const result = await createResource(
          BASE_URL,
          {
