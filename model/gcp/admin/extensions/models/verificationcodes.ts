...
// Auto-generated extension model for @swamp/gcp/admin/verificationcodes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Admin SDK VerificationCodes.
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "The Directory API allows you to view, generate, and invalidate backup verific...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a verificationCodes",
      arguments: z.object({
        identifier: z.string().describe("The name of the verificationCodes"),
      }),
    ...
    sync: {
      description: "Sync verificationCodes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific verificationCodes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List verificationCodes resources",
      arguments: z.object({
