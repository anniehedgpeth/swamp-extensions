...
// Auto-generated extension model for @swamp/gcp/admin/applications
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Admin SDK Applications.
 *
...
const StateSchema = z.object({
  ...
  name: z.string(),
  transferParams: z.array(z.object({
    key: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Application resources represent applications installed on the domain that sup...",
      schema: StateSchema,
      lifetime: "infinite",
