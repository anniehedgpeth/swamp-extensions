...
Use `swamp model type describe @swamp/gcp/admin/activities` to see the full list
...
```bash
# Create a new activities model
swamp model create @swamp/gcp/admin/activities my-activities

# Edit the model to configure its properties
swamp model edit my-activities

# Create the resource in GCP
swamp model method run my-activities create

# Sync current state from GCP
swamp model method run my-activities sync
```
