# @swamp/gcp/doubleclickbidmanager

Auto-generated [swamp](https://github.com/swamp-club/swamp) extension models for
Google Cloud doubleclickbidmanager resources.
...
Use `swamp model type describe @swamp/gcp/doubleclickbidmanager/queries_reports`
...
```bash
# Create a new queries_reports model
swamp model create @swamp/gcp/doubleclickbidmanager/queries_reports my-queries_reports

# Edit the model to configure its properties
swamp model edit my-queries_reports

# Create the resource in GCP
swamp model method run my-queries_reports create

# Sync current state from GCP
swamp model method run my-queries_reports sync
```
