...
Google Cloud datastore resources.
...
Use `swamp model type describe @swamp/gcp/datastore/indexes` to see the full
...
swamp model create @swamp/gcp/datastore/indexes my-indexes
