...
// Auto-generated extension model for @swamp/gcp/mybusinessplaceactions/placeactiontypemetadata
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud My Business Place Actions PlaceActionTypeMetadata.
 *
...
/** Swamp extension model for Google Cloud My Business Place Actions PlaceActionTypeMetadata. Registered at `@swamp/gcp/mybusinessplaceactions/placeactiontypemetadata`. */
export const model = {
  type: "@swamp/gcp/mybusinessplaceactions/placeactiontypemetadata",
  ...
  methods: {
    get: {
      description: "Get a placeActionTypeMetadata",
      arguments: z.object({
        identifier: z.string().describe(
          "The name of the placeActionTypeMetadata",
        ),
      }),
    ...
    sync: {
      description: "Sync placeActionTypeMetadata state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific placeActionTypeMetadata by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List placeActionTypeMetadata resources",
      arguments: z.object({
