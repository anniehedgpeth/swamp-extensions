...
/**
 * Swamp extension model for Google Cloud My Business Place Actions PlaceActionLinks.
 *
...
/** Swamp extension model for Google Cloud My Business Place Actions PlaceActionLinks. Registered at `@swamp/gcp/mybusinessplaceactions/placeactionlinks`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific placeActionLinks by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List placeActionLinks resources",
      arguments: z.object({
