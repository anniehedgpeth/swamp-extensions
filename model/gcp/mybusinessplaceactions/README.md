...
Google Cloud mybusinessplaceactions resources.
...
Use
`swamp model type describe @swamp/gcp/mybusinessplaceactions/placeactionlinks`
...
```bash
# Create a new placeactionlinks model
swamp model create @swamp/gcp/mybusinessplaceactions/placeactionlinks my-placeactionlinks

# Edit the model to configure its properties
swamp model edit my-placeactionlinks

# Create the resource in GCP
swamp model method run my-placeactionlinks create

# Sync current state from GCP
swamp model method run my-placeactionlinks sync
```
