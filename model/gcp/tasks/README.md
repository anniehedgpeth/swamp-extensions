...
Use `swamp model type describe @swamp/gcp/tasks/tasklists` to see the full list
...
```bash
# Create a new tasklists model
swamp model create @swamp/gcp/tasks/tasklists my-tasklists

# Edit the model to configure its properties
swamp model edit my-tasklists

# Create the resource in GCP
swamp model method run my-tasklists create

# Sync current state from GCP
swamp model method run my-tasklists sync
```
