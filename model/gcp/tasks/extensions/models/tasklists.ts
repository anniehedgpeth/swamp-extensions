...
/**
 * Swamp extension model for Google Cloud Google Tasks Tasklists.
 *
...
/** Swamp extension model for Google Cloud Google Tasks Tasklists. Registered at `@swamp/gcp/tasks/tasklists`. */
export const model = {
  ...
  methods: {
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific tasklists by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List tasklists resources",
      arguments: z.object({
