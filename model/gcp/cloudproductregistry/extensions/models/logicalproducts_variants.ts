...
// Auto-generated extension model for @swamp/gcp/cloudproductregistry/logicalproducts-variants
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Product Registry LogicalProducts.Variants.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/variants/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Product Registry LogicalProducts.Variants. Registered at `@swamp/gcp/cloudproductregistry/logicalproducts-variants`. */
export const model = {
  type: "@swamp/gcp/cloudproductregistry/logicalproducts-variants",
  ...
  resources: {
    state: {
      description:
        "Represents a distinct offering derived from a primary product that retains co...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific variants by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List variants resources",
      arguments: z.object({
