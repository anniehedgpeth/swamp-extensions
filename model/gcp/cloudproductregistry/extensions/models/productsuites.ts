...
// Auto-generated extension model for @swamp/gcp/cloudproductregistry/productsuites
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Product Registry ProductSuites.
 *
...
const StateSchema = z.object({
  logicalProducts: z.array(z.string()).optional(),
  name: z.string(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "Represents a unified grouping of products sharing a common brand and market p...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a productSuites",
      arguments: z.object({
        identifier: z.string().describe("The name of the productSuites"),
      }),
    ...
    sync: {
      description: "Sync productSuites state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific productSuites by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List productSuites resources",
      arguments: z.object({
