...
Use
`swamp model type describe @swamp/gcp/cloudproductregistry/logicalproducts_variants`
...
```bash
# Create a new logicalproducts_variants model
swamp model create @swamp/gcp/cloudproductregistry/logicalproducts_variants my-logicalproducts_variants

# Edit the model to configure its properties
swamp model edit my-logicalproducts_variants

# Create the resource in GCP
swamp model method run my-logicalproducts_variants create

# Sync current state from GCP
swamp model method run my-logicalproducts_variants sync
```
