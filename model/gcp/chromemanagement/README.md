...
Google Cloud chromemanagement resources.
...
Use
`swamp model type describe @swamp/gcp/chromemanagement/customers_apps_android`
...
```bash
# Create a new customers_apps_android model
swamp model create @swamp/gcp/chromemanagement/customers_apps_android my-customers_apps_android

# Edit the model to configure its properties
swamp model edit my-customers_apps_android

# Create the resource in GCP
swamp model method run my-customers_apps_android create

# Sync current state from GCP
swamp model method run my-customers_apps_android sync
```
