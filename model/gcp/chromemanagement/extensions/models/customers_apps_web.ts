...
// Auto-generated extension model for @swamp/gcp/chromemanagement/customers-apps-web
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Chrome Management Customers.Apps.Web.
 *
...
/** Swamp extension model for Google Cloud Chrome Management Customers.Apps.Web. Registered at `@swamp/gcp/chromemanagement/customers-apps-web`. */
export const model = {
  type: "@swamp/gcp/chromemanagement/customers-apps-web",
  ...
  methods: {
    get: {
      description: "Get a web",
      arguments: z.object({
        identifier: z.string().describe("The name of the web"),
      }),
    ...
    sync: {
      description: "Sync web state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific web by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
