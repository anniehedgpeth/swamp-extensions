...
Use `swamp model type describe @swamp/gcp/cloudshell/users_environments` to see
...
```bash
# Create a new users_environments model
swamp model create @swamp/gcp/cloudshell/users_environments my-users_environments

# Edit the model to configure its properties
swamp model edit my-users_environments

# Create the resource in GCP
swamp model method run my-users_environments create

# Sync current state from GCP
swamp model method run my-users_environments sync
```
