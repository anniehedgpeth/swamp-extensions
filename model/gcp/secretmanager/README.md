...
Google Cloud secretmanager resources.
...
Use `swamp model type describe @swamp/gcp/secretmanager/locations` to see the
...
swamp model create @swamp/gcp/secretmanager/locations my-locations
