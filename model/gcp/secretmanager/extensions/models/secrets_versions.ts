...
// Auto-generated extension model for @swamp/gcp/secretmanager/secrets-versions
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Secret Manager Secrets.Versions.
 *
...
const StateSchema = z.object({
  clientSpecifiedPayloadChecksum: z.boolean().optional(),
  ...
  scheduledDestroyTime: z.string().optional(),
...
/** Swamp extension model for Google Cloud Secret Manager Secrets.Versions. Registered at `@swamp/gcp/secretmanager/secrets-versions`. */
export const model = {
