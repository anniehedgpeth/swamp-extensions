...
Google Cloud documentai resources.
...
Use `swamp model type describe @swamp/gcp/documentai/locations` to see the full
...
swamp model create @swamp/gcp/documentai/locations my-locations
