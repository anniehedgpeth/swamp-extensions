...
// Auto-generated extension model for @swamp/gcp/documentai/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Document AI Locations.
 *
...
/** Swamp extension model for Google Cloud Document AI Locations. Registered at `@swamp/gcp/documentai/locations`. */
export const model = {
  type: "@swamp/gcp/documentai/locations",
  ...
  methods: {
    ...
    fetch_processor_types: {
      description: "fetch processor types",
      arguments: z.object({}),
