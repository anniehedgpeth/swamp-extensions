...
// Auto-generated extension model for @swamp/gcp/documentai/processortypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Document AI ProcessorTypes.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/processorTypes/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  name: z.string(),
  sampleDocumentUris: z.array(z.string()).optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A processor type is responsible for performing a certain document understandi...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    get: {
      description: "Get a processorTypes",
      arguments: z.object({
        identifier: z.string().describe("The name of the processorTypes"),
      }),
    ...
    sync: {
      description: "Sync processorTypes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific processorTypes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List processorTypes resources",
      arguments: z.object({
