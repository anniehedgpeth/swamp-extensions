...
// Auto-generated extension model for @swamp/gcp/dataform/teamfolders
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Dataform TeamFolders.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/teamFolders/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  name: z.string().describe("Identifier. The TeamFolder's name.").optional(),
...
const StateSchema = z.object({
  ...
  creatorIamPrincipal: z.string().optional(),
...
/** Swamp extension model for Google Cloud Dataform TeamFolders. Registered at `@swamp/gcp/dataform/teamfolders`. */
export const model = {
  type: "@swamp/gcp/dataform/teamfolders",
  ...
  methods: {
    create: {
      description: "Create a teamFolders",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a teamFolders",
      arguments: z.object({
        identifier: z.string().describe("The name of the teamFolders"),
      }),
    ...
    update: {
      description: "Update teamFolders attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific teamFolders by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the teamFolders",
      arguments: z.object({
        identifier: z.string().describe("The name of the teamFolders"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync teamFolders state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific teamFolders by name (e.g. one discovered by list)",
        ).optional(),
    ...
    query_contents: {
      ...
      execute: async (_args: Record<string, unknown>, context: any) => {
        ...
        const existing = JSON.parse(new TextDecoder().decode(content));
        params["teamFolder"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        const result = await createResource(
          BASE_URL,
          {
            ...
            "httpMethod": "GET",
            "parameterOrder": ["teamFolder"],
            "parameters": {
              "filter": { "location": "query" },
              "orderBy": { "location": "query" },
              "pageSize": { "location": "query" },
              "pageToken": { "location": "query" },
              "teamFolder": { "location": "path", "required": true },
            },
          },
          params,
          {},
