...
Google Cloud dataform resources.
...
Use `swamp model type describe @swamp/gcp/dataform/folders` to see the full list
...
```bash
# Create a new folders model
swamp model create @swamp/gcp/dataform/folders my-folders

# Edit the model to configure its properties
swamp model edit my-folders

# Create the resource in GCP
swamp model method run my-folders create

# Sync current state from GCP
swamp model method run my-folders sync
```
