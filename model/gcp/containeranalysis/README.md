...
Google Cloud containeranalysis resources.
...
Use `swamp model type describe @swamp/gcp/containeranalysis/notes_occurrences`
...
```bash
# Create a new notes_occurrences model
swamp model create @swamp/gcp/containeranalysis/notes_occurrences my-notes_occurrences

# Edit the model to configure its properties
swamp model edit my-notes_occurrences

# Create the resource in GCP
swamp model method run my-notes_occurrences create

# Sync current state from GCP
swamp model method run my-notes_occurrences sync
```
