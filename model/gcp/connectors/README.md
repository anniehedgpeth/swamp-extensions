...
Use `swamp model type describe @swamp/gcp/connectors/connections_actions` to see
...
```bash
# Create a new connections_actions model
swamp model create @swamp/gcp/connectors/connections_actions my-connections_actions

# Edit the model to configure its properties
swamp model edit my-connections_actions

# Create the resource in GCP
swamp model method run my-connections_actions create

# Sync current state from GCP
swamp model method run my-connections_actions sync
```
