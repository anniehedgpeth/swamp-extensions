...
// Auto-generated extension model for @swamp/gcp/connectors/connections-resources
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Connectors Connections.Resources.
 *
...
/** Swamp extension model for Google Cloud Connectors Connections.Resources. Registered at `@swamp/gcp/connectors/connections-resources`. */
export const model = {
  type: "@swamp/gcp/connectors/connections-resources",
  ...
  methods: {
    ...
    list: {
      ...
      arguments: z.object({
        ...
        pageSize: z.number().describe("Optional. Page size for the request.")
          .optional(),
    ...
    get_resource_post: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["toolSpec"] !== undefined) body["toolSpec"] = args["toolSpec"];
