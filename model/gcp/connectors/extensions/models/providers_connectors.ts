...
// Auto-generated extension model for @swamp/gcp/connectors/providers-connectors
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Connectors Providers.Connectors.
 *
...
const StateSchema = z.object({
  ...
  eventingDetails: z.object({
    customEventTypes: z.boolean(),
    description: z.string(),
    documentationLink: z.string(),
    iconLocation: z.string(),
  ...
  marketplaceConnectorDetails: z.object({
  ...
  webAssetsLocation: z.string().optional(),
}).passthrough();
...
/** Swamp extension model for Google Cloud Connectors Providers.Connectors. Registered at `@swamp/gcp/connectors/providers-connectors`. */
export const model = {
  type: "@swamp/gcp/connectors/providers-connectors",
  ...
  methods: {
    ...
    sync: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific connectors by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List connectors resources",
      arguments: z.object({
