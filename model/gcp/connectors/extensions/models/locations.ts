...
// Auto-generated extension model for @swamp/gcp/connectors/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Connectors Locations.
 *
    ...
    update_regional_settings: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["provisioned"] !== undefined) {
          body["provisioned"] = args["provisioned"];
        }
        const result = await createResource(
          BASE_URL,
          {
