...
// Auto-generated extension model for @swamp/gcp/connectors/providers-connectors-versions-eventtypes
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Connectors Providers.Connectors.Versions.Eventtypes.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/eventtypes/${shortName}`;
}
...
const StateSchema = z.object({
  ...
  enrichedEventPayloadSchema: z.string().optional(),
  entityType: z.string().optional(),
  eventPayloadSchema: z.string().optional(),
...
export const model = {
  ...
  methods: {
    get: {
      description: "Get a eventtypes",
      arguments: z.object({
        identifier: z.string().describe("The name of the eventtypes"),
      }),
    ...
    sync: {
      description: "Sync eventtypes state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific eventtypes by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List eventtypes resources",
      arguments: z.object({
