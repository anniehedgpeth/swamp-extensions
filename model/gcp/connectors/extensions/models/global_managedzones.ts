...
// Auto-generated extension model for @swamp/gcp/connectors/global-managedzones
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Connectors Global.ManagedZones.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/managedZones/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Optional. Description of the resource.")
    .optional(),
  dns: z.string().describe("Required. DNS Name of the resource").optional(),
  labels: z.record(z.string(), z.string()).describe(
    "Optional. Resource labels to represent user-provided metadata. Refer to cloud documentation on labels for more details. https://cloud.google.com/compute/docs/labeling-resources",
  ).optional(),
  targetProject: z.string().describe("Required. The name of the Target Project")
    .optional(),
  targetVpc: z.string().describe(
    "Required. The name of the Target Project VPC Network",
  ).optional(),
  managedZoneId: z.string().describe(
...
/** Swamp extension model for Google Cloud Connectors Global.ManagedZones. Registered at `@swamp/gcp/connectors/global-managedzones`. */
export const model = {
  type: "@swamp/gcp/connectors/global-managedzones",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["targetVpc"] !== undefined) body["targetVpc"] = g["targetVpc"];
        if (g["managedZoneId"] !== undefined) {
          params["managedZoneId"] = String(g["managedZoneId"]);
        }
    ...
    update: {
      ...
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific managedZones by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List managedZones resources",
      arguments: z.object({
