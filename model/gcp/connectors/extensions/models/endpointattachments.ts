...
// Auto-generated extension model for @swamp/gcp/connectors/endpointattachments
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Connectors EndpointAttachments.
 *
...
const GlobalArgsSchema = z.object({
  ...
  description: z.string().describe("Optional. Description of the resource.")
    .optional(),
  endpointGlobalAccess: z.boolean().describe(
...
const StateSchema = z.object({
  ...
  endpointGlobalAccess: z.boolean().optional(),
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["endpointGlobalAccess"] !== undefined) {
          body["endpointGlobalAccess"] = g["endpointGlobalAccess"];
        }
        ...
        if (g["endpointAttachmentId"] !== undefined) {
          params["endpointAttachmentId"] = String(g["endpointAttachmentId"]);
        }
        if (g["name"] !== undefined) {
    ...
    update: {
      description: "Update endpointAttachments attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific endpointAttachments by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    list: {
      description: "List endpointAttachments resources",
      arguments: z.object({
