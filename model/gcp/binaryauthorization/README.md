...
Google Cloud binaryauthorization resources.
...
Use `swamp model type describe @swamp/gcp/binaryauthorization/attestors` to see
...
```bash
# Create a new attestors model
swamp model create @swamp/gcp/binaryauthorization/attestors my-attestors

# Edit the model to configure its properties
swamp model edit my-attestors

# Create the resource in GCP
swamp model method run my-attestors create

# Sync current state from GCP
swamp model method run my-attestors sync
```
